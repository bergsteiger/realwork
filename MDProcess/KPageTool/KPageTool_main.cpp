////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/MDProcess/KPageTool/KPageTool_main.cpp"
// генератор файлов реализации C++ (.cpp)
// Generated from UML model, root element: <<ExeTarget::Category>> MDProcess::KPageTool
//
// утилита для чтения/записи текста страницы
//
//
...
void print_usage (const Core::Root::LibHomeManager& lhm) {
	std::cout << "KPageTool - утилита для чтения/записи текста страницы\n";
	std::cout << std::endl;
	lhm.print_usage ();
	std::cout << "\nВсе права принадлежат ООО НПП \"Гарант-Сервис\"\n";
}
...
public:
	static int execute (int argc, char** argv) {
		...
		lhm.registrate_lib_home (&KPageToolLib::LibHomeFactory::get ());
