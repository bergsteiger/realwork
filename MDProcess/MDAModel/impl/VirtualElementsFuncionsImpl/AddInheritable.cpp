////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/MDProcess/MDAModel/impl/VirtualElementsFuncionsImpl/AddInheritable.cpp"
...
AddInheritable::AddInheritable ()
//#UC START# *4A2CBB5C0268_4A2CBBD20008_4A2DFDE80022_BASE_INIT*
//#UC END# *4A2CBB5C0268_4A2CBBD20008_4A2DFDE80022_BASE_INIT*
{
	//#UC START# *4A2CBB5C0268_4A2CBBD20008_4A2DFDE80022_BODY*
	//#UC END# *4A2CBB5C0268_4A2CBBD20008_4A2DFDE80022_BODY*
}

AddInheritable::~AddInheritable () {
	//#UC START# *4A2DFDE80022_DESTR_BODY*
	//#UC END# *4A2DFDE80022_DESTR_BODY*
}
...
const std::string AddInheritable::execute_impl (
	...
	//#UC START# *4A2DFD7B0291_4A2DFDE80022*
	if (params.size () < 1) {
	...
	if (rad) {
		...
		if (item) {
			...
			if (virtual_cls) {
				...
				ATL::CComObject<RoseInternal::RoseInheritRelationImpl>* obj;
				...
				short count = virtual_cls->get_inherite_relations ()->Count;
				...
				virtual_cls->add_inherit_relation (rel);
			}

			if (!rad->is_supplier_with_stereotype (target_rad, ST_LINK_INH)) {
				...
				painter->invalidate_dumpers_list (SX_3_GENERALIZATION, rad);
				painter->invalidate_dumpers_list (SX_3_REQURSIVE_GENERALIZATION, rad);
	...
	return std::string ();
	//#UC END# *4A2DFD7B0291_4A2DFDE80022*
}
} // namespace VirtualElementsFuncionsImpl
