...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/MDProcess/MDPSpecific/MDPSpecific.tpl"
// Генерация мета-шаблонов
// Generated from UML model, root element: <<MDATemplates::Category>> MDProcess::MDPSpecific
//
// Модель шаблонов специфичных для MDP (содержит шаблоны генерации плагинов для К и меташаблоны)
//
//
...
group "All" {
	...
	group "Генератор настроек" {
		generator "config" {
			Description: Генерация настроек в ini-файл (.ini)
		}
	}
	...
	group "Тестовый сценарий" {
		generator "test_scenario.txt" {
			Description: файл со сценарием тестирования
		}
	}
	...
	group "Мета-MDA" {
		...
		group "Проектные файлы" {
			generator "ue_prj" {
				Description: Генератор проекта для UE
			}
		}
	}
	...
	group "Документация" {
		...
		group "ModelSerialize" {
			...
			generator "structure" {
				Description: генератор структуры модели в новый формат хранения
			}
		}
	}
	...
	group "Грамматика" {
		generator "g.cpp" {
			Description: Генератор грамматики для ANTLR (целевой язык c++)
		}
		generator "g.java" {
			Description: Генератор грамматики для ANTLR (целевой язык java)
		}
	}
