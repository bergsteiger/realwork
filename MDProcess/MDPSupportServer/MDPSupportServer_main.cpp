////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/MDProcess/MDPSupportServer/MDPSupportServer_main.cpp"
// генератор файлов реализации C++ (.cpp)
// Generated from UML model, root element: <<ExeTarget::Category>> MDProcess::MDPSupportServer
//
// Исполняемый модуль сервера залочек
//
//
...
void print_usage (const Core::Root::LibHomeManager& lhm) {
	std::cout << "MDPSupportServer - Исполняемый модуль сервера залочек\n";
	std::cout << std::endl;
	lhm.print_usage ();
	std::cout << "\nВсе права принадлежат ООО НПП \"Гарант-Сервис\"\n";
}
...
public:
	static int execute (int argc, char** argv) {
		...
		try {
			Core::ParamManagerInitData init = {"MDPSupportServer", "Core::RegistryHelper::KEY_LOCAL_MACHINE\\Software\\Garant\\MDProcess\\MDPSupportServer"};
		...
		lhm.registrate_lib_home (&RosePackageLocking::ServerLibHomeFactory::get ());
		lhm.registrate_lib_home (&Security::LibHomeFactory::get ());
