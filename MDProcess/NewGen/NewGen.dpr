...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/MDProcess/NewGen/NewGen.dpr"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<VCMGUI::Category>> MDProcess$NewGen$Interface::NewGen
//
//
...
uses
  ...
  NewGenMainPrim_Form in 'NewGenMainPrim_Form.pas',
  Main_ut_Main_UserType in 'Main_ut_Main_UserType.pas',
  Main_Form in 'Main_Form.pas' {MainForm: TvcmMainForm}
  {$If defined(NewGen) AND not defined(NoScripts)}
  ,
  MainKeywordsPack in 'MainKeywordsPack.pas'
  ...
  NewGenRes in 'NewGenRes.pas' {NewGenRes: TDataModule},
  l3MouseWheelHelper
  ;
{$IfEnd} //NewGen
...
begin
 StdRes.TdmStdRes.Run(str_NewGenTitle, '');
end.