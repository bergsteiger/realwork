////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/MDProcess/TestModel/NewAdapterTarget/NewAdapterTarget_tie.cpp"
...
#include "TestModel/NewAdapterTarget/NewAdapterTarget_tie.h"
...
_DLL_TRY
	root = NewInstallerTarget::Root_tie::instance();
	root->addref();
_DLL_CATCH
}