 ...
 * @generated
 */
public class DependecyCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public DependecyCreateCommand(CreateRelationshipRequest request,
			EObject source, EObject target) {
		super(request);
		this.source = source;
		this.target = target;
		if (request.getContainmentFeature() == null) {
			setContainmentFeature(EumlPackage.eINSTANCE.getClass_Dependencies());
		}
	...
	public boolean canExecute() {
		...
		return UmlBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateDependecy_4001(getSource(), getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		Dependecy newElement = EumlFactory.eINSTANCE.createDependecy();
		getSource().getDependencies().add(newElement);
