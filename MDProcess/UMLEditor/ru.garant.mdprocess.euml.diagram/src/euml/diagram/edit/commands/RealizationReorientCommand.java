...
public class RealizationReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRealization_4002(getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return UmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRealization_4002(source, getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getRealizations().remove(getLink());
		getNewSource().getRealizations().add(getLink());
