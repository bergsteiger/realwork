...
import euml.diagram.edit.policies.ClassItemSemanticEditPolicy;
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == UmlElementTypes.Attribute_3001) {
									EditPart compartmentEditPart = getChildBySemanticHint(UmlVisualIDRegistry
