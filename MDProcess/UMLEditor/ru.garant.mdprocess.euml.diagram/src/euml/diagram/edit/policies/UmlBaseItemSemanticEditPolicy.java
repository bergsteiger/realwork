...
import euml.diagram.edit.helpers.UmlBaseEditHelper;
import euml.diagram.expressions.UmlAbstractExpression;
import euml.diagram.expressions.UmlOCLFactory;
...
public class UmlBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		private static UmlAbstractExpression Dependecy_4001_SourceExpression;
		/**
		 * @generated
		 */
		private static UmlAbstractExpression Realization_4002_SourceExpression;
		/**
		 * @generated
		 */
		 ...
		 * @generated
		 */
		public static boolean canCreateDependecy_4001(Class source,
				NamedElement target) {
			return canExistDependecy_4001(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateRealization_4002(Class source,
				NamedElement target) {
			return canExistRealization_4002(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateGeneralization_4003(Class source,
				NamedElement target) {
			return canExistGeneralization_4003(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistDependecy_4001(Class source,
				NamedElement target) {
			try {
				if (source == null) {
					return true;
				}
				if (Dependecy_4001_SourceExpression == null) {
					Map env = Collections.singletonMap(OPPOSITE_END_VAR,
							EumlPackage.eINSTANCE.getNamedElement());
					Dependecy_4001_SourceExpression = UmlOCLFactory
							.getExpression(
									"self <> oppositeEnd", EumlPackage.eINSTANCE.getClass_(), env); //$NON-NLS-1$
				}
				Object sourceVal = Dependecy_4001_SourceExpression.evaluate(
		 ...
		 * @generated
		 */
		public static boolean canExistRealization_4002(Class source,
				NamedElement target) {
			try {
				if (source == null) {
					return true;
				}
				if (Realization_4002_SourceExpression == null) {
					Map env = Collections.singletonMap(OPPOSITE_END_VAR,
							EumlPackage.eINSTANCE.getNamedElement());
					Realization_4002_SourceExpression = UmlOCLFactory
							.getExpression(
									"self <> oppositeEnd", EumlPackage.eINSTANCE.getClass_(), env); //$NON-NLS-1$
				}
				Object sourceVal = Realization_4002_SourceExpression.evaluate(
						source, Collections.singletonMap(OPPOSITE_END_VAR,
								target));
				if (false == sourceVal instanceof Boolean
						|| !((Boolean) sourceVal).booleanValue()) {
		 ...
		 * @generated
		 */
		public static boolean canExistGeneralization_4003(Class source,
				NamedElement target) {
			try {
				if (source == null) {
					return true;
