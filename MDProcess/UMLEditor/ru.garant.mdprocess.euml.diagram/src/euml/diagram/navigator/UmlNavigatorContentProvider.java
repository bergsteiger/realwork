...
import euml.diagram.part.Messages;
...
public class UmlNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ClassEditPart.VISUAL_ID: {
			...
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), ClassAttributesEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					AttributeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					ClassOperationsEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					OperationEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getIncomingLinksByType(
					Collections.singleton(view), DependecyEditPart.VISUAL_ID);
			...
			outgoinglinks.addChildren(createNavigatorItems(connectedViews,
					outgoinglinks, true));
			connectedViews = getIncomingLinksByType(
					Collections.singleton(view), RealizationEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
					incominglinks, true));
			connectedViews = getOutgoingLinksByType(
					Collections.singleton(view), RealizationEditPart.VISUAL_ID);
		...
		case Package2EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			UmlNavigatorGroup incominglinks = new UmlNavigatorGroup(
					Messages.NavigatorGroupName_Package_2004_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependecyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
					incominglinks, true));
			connectedViews = getIncomingLinksByType(
					Collections.singleton(view), RealizationEditPart.VISUAL_ID);
		...
		case AttributeEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			UmlNavigatorGroup incominglinks = new UmlNavigatorGroup(
					Messages.NavigatorGroupName_Attribute_3003_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependecyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case OperationEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			UmlNavigatorGroup incominglinks = new UmlNavigatorGroup(
					Messages.NavigatorGroupName_Operation_3004_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependecyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case DependecyEditPart.VISUAL_ID: {
			...
			UmlNavigatorGroup target = new UmlNavigatorGroup(
					Messages.NavigatorGroupName_Dependecy_4004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			UmlNavigatorGroup source = new UmlNavigatorGroup(
					Messages.NavigatorGroupName_Dependecy_4004_source,
		...
		case RealizationEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			UmlNavigatorGroup target = new UmlNavigatorGroup(
					Messages.NavigatorGroupName_Realization_4005_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			UmlNavigatorGroup source = new UmlNavigatorGroup(
					Messages.NavigatorGroupName_Realization_4005_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), ClassEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
		...
		case GeneralizationEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			UmlNavigatorGroup target = new UmlNavigatorGroup(
					Messages.NavigatorGroupName_Generalization_4006_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			UmlNavigatorGroup source = new UmlNavigatorGroup(
					Messages.NavigatorGroupName_Generalization_4006_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), ClassEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
