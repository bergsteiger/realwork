...
public class UmlDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.UmlDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS
									.bind(
											Messages.UmlDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
											fileName));
		}
		return resource;
	}
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					modelResource.save(euml.diagram.part.UmlDiagramEditorUtil
							.getSaveOptions());
					diagramResource.save(euml.diagram.part.UmlDiagramEditorUtil
							.getSaveOptions());
				} catch (IOException e) {
	...
	private static Package createInitialModel() {
		return EumlFactory.eINSTANCE.createPackage();
	}
