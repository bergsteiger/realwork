...
// Стереотип: "TestCase"
// Элемент модели: "K330140819" MUID: (4F1FA10C0009)
// Имя типа: "TK330140819"
...
type
 TK330140819 = class({$If NOT Defined(NoScripts)}
 TArchiInsiderTest
 {$IfEnd} // NOT Defined(NoScripts)
 )
  {* [Requestlink:330140819] }
...
uses
 l3ImplUses
 , TestFrameWork
 //#UC START# *4F1FA10C0009impl_uses*
 //#UC END# *4F1FA10C0009impl_uses*
;
