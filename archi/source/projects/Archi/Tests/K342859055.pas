...
// Стереотип: "TestCase"
// Элемент модели: "K342859055" MUID: (4F606C5E035E)
// Имя типа: "TK342859055"
...
type
 TK342859055 = class({$If NOT Defined(NoScripts)}
 TArchiInsiderTest
 {$IfEnd} // NOT Defined(NoScripts)
 )
  {* [Requestlink:342859055] }
...
uses
 l3ImplUses
 , TestFrameWork
 //#UC START# *4F606C5E035Eimpl_uses*
 //#UC END# *4F606C5E035Eimpl_uses*
;
