...
// Стереотип: "TestCase"
// Элемент модели: "K370383768" MUID: (4FF584D60379)
// Имя типа: "TK370383768"
...
type
 TK370383768 = class({$If NOT Defined(NoScripts)}
 TArchiInsiderTest
 {$IfEnd} // NOT Defined(NoScripts)
 )
  {* [Requestlink:370383768] }
...
uses
 l3ImplUses
 , TestFrameWork
 //#UC START# *4FF584D60379impl_uses*
 //#UC END# *4FF584D60379impl_uses*
;
