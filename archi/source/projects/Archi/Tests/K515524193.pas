...
// Стереотип: "TestCase"
// Элемент модели: "K515524193" MUID: (532821E6028E)
// Имя типа: "TK515524193"
...
type
 TK515524193 = class({$If NOT Defined(NoScripts)}
 TArchiInsiderTest
 {$IfEnd} // NOT Defined(NoScripts)
 )
  {* [Requestlink:515524193] }
...
uses
 l3ImplUses
 , TestFrameWork
 //#UC START# *532821E6028Eimpl_uses*
 //#UC END# *532821E6028Eimpl_uses*
;
