...
//				   LID		lidExpected,
//                                   LID FAR  *lpLid);
  TSpellVerifyMdrFunc = function(PathMdr: PAnsiChar; LidExpected: TLID; var Lid: TLID): TSEC; cdecl;
...
//				   LID		lidExpected,
//                                   LPMDRS   lpMdrs);
  TSpellOpenMdrFunc = function(splid: TSPLID; PathMain, PathExc: PAnsiChar; CreateUdrExc,
...
//				   BOOL FAR *lpfReadonly);
  TSpellOpenUdrFunc = function(splid: TSPLID; PathUdr: PAnsiChar; CreateUdr: Boolean;
                               udrPropType: Word; var Udr: TUDR; var ReadOnly: Boolean): TSEC; cdecl;
//extern GLOBALSEC SpellAddUdr(      SPLID    splid,
//                                   UDR      udr,
//                                   CHAR FAR *lpszAdd);
  TSpellAddUdrFunc = function(splid: TSPLID; udr: TUDR; Add: PAnsiChar): TSEC; cdecl;
//extern GLOBALSEC SpellAddChangeUdr(SPLID    splid,
//                                   UDR      udr,
//                                   CHAR FAR *lpszAdd,
//                                   CHAR FAR *lpszChange);
  TSpellAddChangeUdrFunc = function(splid: TSPLID; udr: TUDR; Add, Change: PAnsiChar): TSEC; cdecl;
//extern GLOBALSEC SpellDelUdr(      SPLID    splid,
//                                   UDR      udr,
//                                   CHAR FAR *lpszDel);
  TSpellDelUdrFunc = function(splid: TSPLID; udr: TUDR; Del: PAnsiChar): TSEC; cdecl;
...
//extern Handle HCsapiResInit(char *stzFileName, short vRef, long dirId);
  THCsapiResInit = function(FileName: PAnsiChar; vRef: SmallInt; dirId: Integer): THandle; cdecl;
