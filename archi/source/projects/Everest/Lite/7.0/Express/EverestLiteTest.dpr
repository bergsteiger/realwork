...
// Generated from UML model, root element: <<TestTarget::Category>> archi$EverestLite$Test::EverestLite$Test
//
// Тесты Эвереста
//
//
...
uses
  ...
  {$If not defined(NoScripts)}
  //,
  //tfwStoredValuesGlobalStack in 'w:\common\components\rtl\Garant\ScriptEngine\tfwStoredValuesGlobalStack.pas'
  {$IfEnd} //not NoScripts
  ...
  {$If not defined(NoScripts)}
  //,
  //kwVarWorkerCompiledCode in 'w:\common\components\rtl\Garant\ScriptEngine\kwVarWorkerCompiledCode.pas'
  {$IfEnd} //not NoScripts

  {$If not defined(NoScripts)}
  //,
  //tfwVarWorker in 'w:\common\components\rtl\Garant\ScriptEngine\tfwVarWorker.pas'
  {$IfEnd} //not NoScripts
  ...
  ,
  K431386215 in 'Tests\K431386215.pas',
  K403079732 in 'Tests\K403079732.pas',
  K514874341 in 'Tests\K514874341.pas',
  K514874360 in 'Tests\K514874360.pas',
  K517783699 in 'Tests\K517783699.pas',
  toK in 'toK.pas'
  {$If defined(nsTest) AND not defined(NoScripts)}
  ,
  ...
  {$IfEnd} //InsiderTest AND nsTest AND not NoScripts
  ,
  MainEditor in 'Main\MainEditor.pas',
  EverestLiteAdapter in 'EverestTestSupport\EverestLiteAdapter.pas'
  {$If defined(InsiderTest) AND defined(nsTest) AND not defined(NoScripts)}
  ,
  kwCreate in 'EverestTestSupport\kwCreate.pas'
  {$IfEnd} //InsiderTest AND nsTest AND not NoScripts
  
  {$If defined(InsiderTest) AND defined(nsTest) AND not defined(NoScripts)}
  ,
  kwOpen in 'EverestTestSupport\kwOpen.pas'
  {$IfEnd} //InsiderTest AND nsTest AND not NoScripts
  
  {$If defined(InsiderTest) AND defined(nsTest) AND not defined(NoScripts)}
  ,
  kwCloseActiveWindow in 'EverestTestSupport\kwCloseActiveWindow.pas'
  {$IfEnd} //InsiderTest AND nsTest AND not NoScripts
  
  {$If defined(InsiderTest) AND defined(nsTest) AND not defined(NoScripts)}
  ,
  kwSaveWithOtherExtention in 'EverestTestSupport\kwSaveWithOtherExtention.pas'
  {$IfEnd} //InsiderTest AND nsTest AND not NoScripts
  
  {$If defined(InsiderTest) AND defined(nsTest) AND not defined(NoScripts)}
  ,
  kwOpenWith in 'EverestTestSupport\kwOpenWith.pas'
  {$IfEnd} //InsiderTest AND nsTest AND not NoScripts
  
  {$If defined(InsiderTest) AND defined(nsTest) AND not defined(NoScripts)}
  ,
  kwIsPreviewInProgress in 'EverestTestSupport\kwIsPreviewInProgress.pas'
  {$IfEnd} //InsiderTest AND nsTest AND not NoScripts
  ,
  ...
  {$If defined(InsiderTest) AND defined(nsTest) AND not defined(NoScripts)}
  ,
  archiEditorWindowWordsPack in 'EverestTestSupport\archiEditorWindowWordsPack.pas'
  {$IfEnd} //InsiderTest AND nsTest AND not NoScripts
  ,
  EdWin in 'Main\EdWin.pas'
  {$If defined(InsiderTest) AND defined(nsTest) AND not defined(NoScripts)}
  ,
  EverestLiteKeyWords in 'EverestTestSupport\EverestLiteKeyWords.pas'
  {$IfEnd} //InsiderTest AND nsTest AND not NoScripts
  ...
  {$IfEnd} //InsiderTest AND nsTest AND not NoScripts
  ,
  EverestLiteTestSuite in 'EverestInsiderTests\EverestLiteTestSuite.pas',
  toKT in 'toKT.pas',
  EverestLiteTestRes in 'EverestLiteTestRes.pas'
