...
uses
 ...
 , ControlResizeBugFix
 {$IfEnd} // NOT Defined(NoVCL)
 , EverestLiteTestRes in 'w:\archi\source\projects\Everest\Lite\7.0\Express\EverestLiteTestRes.pas'
 ...
 , toK in 'w:\archi\source\projects\Everest\Lite\7.0\Express\toK.pas'
 , EverestLiteTestSuite in 'w:\archi\source\projects\Everest\Lite\7.0\Express\EverestInsiderTests\EverestLiteTestSuite.pas'
 {$If NOT Defined(NoScripts)}
 ...
 {$IfEnd} // NOT Defined(NoVCL)
 {$If NOT Defined(NoScripts)}
 , EverestLiteKeyWords in 'w:\archi\source\projects\Everest\Lite\7.0\Express\EverestTestSupport\EverestLiteKeyWords.pas'
 {$IfEnd} // NOT Defined(NoScripts)
 {$If NOT Defined(NoScripts)}
 , kwCreate in 'w:\archi\source\projects\Everest\Lite\7.0\Express\EverestTestSupport\kwCreate.pas'
 {$IfEnd} // NOT Defined(NoScripts)
 , EverestLiteAdapter in 'w:\archi\source\projects\Everest\Lite\7.0\Express\EverestTestSupport\EverestLiteAdapter.pas'
 , MainEditor in 'w:\archi\source\projects\Everest\Lite\7.0\Express\Main\MainEditor.pas'
 ...
 {$If NOT Defined(NoScripts)}
 , kwOpen in 'w:\archi\source\projects\Everest\Lite\7.0\Express\EverestTestSupport\kwOpen.pas'
 {$IfEnd} // NOT Defined(NoScripts)
 {$If NOT Defined(NoScripts)}
 , kwCloseActiveWindow in 'w:\archi\source\projects\Everest\Lite\7.0\Express\EverestTestSupport\kwCloseActiveWindow.pas'
 {$IfEnd} // NOT Defined(NoScripts)
 {$If NOT Defined(NoScripts)}
 , kwSaveWithOtherExtention in 'w:\archi\source\projects\Everest\Lite\7.0\Express\EverestTestSupport\kwSaveWithOtherExtention.pas'
 {$IfEnd} // NOT Defined(NoScripts)
 {$If NOT Defined(NoScripts)}
 , kwOpenWith in 'w:\archi\source\projects\Everest\Lite\7.0\Express\EverestTestSupport\kwOpenWith.pas'
 {$IfEnd} // NOT Defined(NoScripts)
 {$If NOT Defined(NoScripts)}
 , kwIsPreviewInProgress in 'w:\archi\source\projects\Everest\Lite\7.0\Express\EverestTestSupport\kwIsPreviewInProgress.pas'
 {$IfEnd} // NOT Defined(NoScripts)
 {$If NOT Defined(NoScripts)}
 , archiEditorWindowWordsPack in 'w:\archi\source\projects\Everest\Lite\7.0\Express\EverestTestSupport\archiEditorWindowWordsPack.pas'
 {$IfEnd} // NOT Defined(NoScripts)
 , EdWin in 'w:\archi\source\projects\Everest\Lite\7.0\Express\Main\EdWin.pas'
 ...
 //#UC END# *512AF4A800AAmanualuses*
;
{$IfEnd} // Defined(nsTest) AND Defined(InsiderTest)

{$If Defined(nsTest) AND Defined(InsiderTest)}
{$IfEnd} // Defined(nsTest) AND Defined(InsiderTest)
{$R EverestLiteTest.res}

//#UC START# *512AF4A800AAmanualres*
{$R versioninfo.res} // включаем Version Info
//#UC END# *512AF4A800AAmanualres*
...
begin
 ...
 TEverestLiteTestRes.ReadyToRun;
 // ------
 Application.Run;
 //#UC END# *512AF4A800AAmanualcode*
end.
