program ImportExportTest;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "W:/archi/source/projects/ImportExportTest/ImportExportTest.dpr"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<TestTarget::Category>> archi$ImportExprortTest::ImportExport
//
//
...
uses
  ...
  {$If defined(nsTest)}
  ,
  archiDBTest in 'ArchiDBTests\archiDBTest.pas'
  {$IfEnd} //nsTest
  ,
  ...
  {$If defined(nsTest)}
  ,
  ietBaseTest in 'ietBaseTest.pas'
  {$IfEnd} //nsTest
  ...
  {$If defined(nsTest)}
  ,
  K455105826 in 'K455105826.pas'
  {$IfEnd} //nsTest
  
  {$If defined(nsTest)}
  ,
  K465700807 in 'K465700807.pas'
  {$IfEnd} //nsTest
  ,
  ddFileIterator in 'w:\common\components\rtl\Garant\dd\ddFileIterator.pas'
  {$If defined(nsTest)}
  ,
  ExportPipeTestPrim in 'ExportPipeTestPrim.pas'
  {$IfEnd} //nsTest
  
  {$If defined(nsTest)}
  ,
  ExportToSeparateNSRTest in 'ExportToSeparateNSRTest.pas'
  {$IfEnd} //nsTest
  
  {$If defined(nsTest)}
  ,
  ExportToSingleNSRTest in 'ExportToSingleNSRTest.pas'
  {$IfEnd} //nsTest
  
  {$If defined(nsTest)}
  ,
  ExportSeparatedByMainTest in 'ExportSeparatedByMainTest.pas'
  {$IfEnd} //nsTest
  
  {$If defined(nsTest)}
  ,
  ExportSeparatedBySizeTest in 'ExportSeparatedBySizeTest.pas'
  {$IfEnd} //nsTest
  
  {$If defined(nsTest)}
  ,
  ExportByMainRelNamedTest in 'ExportByMainRelNamedTest.pas'
  {$IfEnd} //nsTest
  
  {$If defined(nsTest)}
  ,
  ExportBySizeAndMain in 'ExportBySizeAndMain.pas'
  {$IfEnd} //nsTest
  
  ;

{$R ImportExportTest.res}

begin
 {$IfDef nsTest}
 g_CVSPath := 'W:\archi\source\projects\ImportExportTest';
 {$EndIf nsTest}
 //#UC START# *51946564017FCVSPath*
 //#UC END# *51946564017FCVSPath*
 try
