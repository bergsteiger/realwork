...
// Generated from UML model, root element: <<TestTarget::Category>> archi$AutoPipeServer$Garant::AutoPipeServer$Test
//
...
uses
  ...
  ,
  alcuServerAsyncExecutionInterfaces in 'Tasks\alcuServerAsyncExecutionInterfaces.pas'
  {$IfEnd} //AppServerSide AND ServerTasks
  ,
  alcuBaseEngine in 'Server\alcuBaseEngine.pas',
  alcuBaseEngineHolder in 'Server\alcuBaseEngineHolder.pas',
  ddServerTaskManagerPrim in 'Server\ddServerTaskManagerPrim.pas',
  ...
  {$If defined(AppServerSide) AND defined(ServerTasks)}
  ,
  alcuAsyncTaskFinishedNotifierList in 'Tasks\alcuAsyncTaskFinishedNotifierList.pas'
  {$IfEnd} //AppServerSide AND ServerTasks
  ,
  l3Base64 in 'w:\common\components\rtl\Garant\L3\l3Base64.pas'
  {$If defined(AppServerSide) AND defined(ServerTasks)}
  ,
  alcuAsyncSubmitter in 'Tasks\alcuAsyncSubmitter.pas'
  {$IfEnd} //AppServerSide AND ServerTasks
  
  {$If defined(AppServerSide) AND defined(ServerTasks)}
  ,
  alcuSubmitterWorkThreadList in 'Tasks\alcuSubmitterWorkThreadList.pas'
  {$IfEnd} //AppServerSide AND ServerTasks
  ...
  {$If defined(AppServerSide) AND defined(ServerTasks)}
  ,
  alcuSubmitterWorkPool in 'Tasks\alcuSubmitterWorkPool.pas'
  {$IfEnd} //AppServerSide AND ServerTasks
  
  {$If defined(ServerTasks)}
  ,
  alcuDeliveryInterfaces in 'Tasks\alcuDeliveryInterfaces.pas'
  {$IfEnd} //ServerTasks
  
  {$If defined(ServerTasks)}
  ,
  alcuDetachedExecutorList in 'Tasks\alcuDetachedExecutorList.pas'
  {$IfEnd} //ServerTasks
  
  {$If defined(ServerTasks)}
  ,
  alcuDetachedExecutorPool in 'Tasks\alcuDetachedExecutorPool.pas'
  {$IfEnd} //ServerTasks
  ,
  alcuTaskExecutingList in 'Server\alcuTaskExecutingList.pas'
  {$If not defined(Nemesis)}
  ,
  dt_UserTypes in 'w:\common\components\rtl\Garant\DT\dt_UserTypes.pas'
  {$IfEnd} //not Nemesis
  ...
  alcuAsyncSubmitterManager in 'Server\alcuAsyncSubmitterManager.pas'
  {$If defined(ServerTasks)}
  ,
  alcuTaskListPrim in 'Tasks\alcuTaskListPrim.pas'
  {$IfEnd} //ServerTasks
  
  {$If defined(AppServerSide) AND defined(ServerTasks)}
  ,
  alcuTaskListBasePrim in 'Tasks\alcuTaskListBasePrim.pas'
  {$IfEnd} //AppServerSide AND ServerTasks
  
  {$If defined(AppServerSide) AND defined(ServerTasks)}
  ,
  alcuTaskListBase in 'Tasks\alcuTaskListBase.pas'
  {$IfEnd} //AppServerSide AND ServerTasks
  
  {$If defined(AppServerSide) AND defined(ServerTasks)}
  ,
  alcuSortedTaskList in 'Tasks\alcuSortedTaskList.pas'
  {$IfEnd} //AppServerSide AND ServerTasks
  
  {$If defined(AppServerSide) AND defined(ServerTasks)}
  ,
  alcuTaskList in 'Tasks\alcuTaskList.pas'
  {$IfEnd} //AppServerSide AND ServerTasks
  ,
  ...
  {$If defined(ServerTasks)}
  ,
  alcuExecutorWithTaskList in 'Tasks\alcuExecutorWithTaskList.pas'
  {$IfEnd} //ServerTasks
  ...
  {$If defined(ServerTasks)}
  ,
  alcuGetReadyToDeliveryTasksExecutor in 'Tasks\alcuGetReadyToDeliveryTasksExecutor.pas'
  {$IfEnd} //ServerTasks
  ...
  {$If defined(ServerTasks)}
  ,
  alcuGetTaskDescriptionExecutor in 'Tasks\alcuGetTaskDescriptionExecutor.pas'
  {$IfEnd} //ServerTasks
  ...
  {$If defined(ServerTasks)}
  ,
  alcuTaskProgressExecutor in 'Tasks\alcuTaskProgressExecutor.pas'
  {$IfEnd} //ServerTasks
  ...
  {$If defined(ServerTasks)}
  ,
  alcuDeliveryResultExecutor in 'Tasks\alcuDeliveryResultExecutor.pas'
  {$IfEnd} //ServerTasks
  ...
  {$If defined(ServerTasks)}
  ,
  alcuGetFilePartExecutor in 'Tasks\alcuGetFilePartExecutor.pas'
  {$IfEnd} //ServerTasks
  ...
  {$If defined(ServerTasks)}
  ,
  alcuExecutorWithIncomingTaskList in 'Tasks\alcuExecutorWithIncomingTaskList.pas'
  {$IfEnd} //ServerTasks
  ...
  {$If defined(ServerTasks)}
  ,
  alcuTaskFileTransferServices in 'Tasks\alcuTaskFileTransferServices.pas'
  {$IfEnd} //ServerTasks
  
  {$If defined(ServerTasks)}
  ,
  alcuSendTaskExecutor in 'Tasks\alcuSendTaskExecutor.pas'
  {$IfEnd} //ServerTasks
  ...
  {$If defined(ServerTasks)}
  ,
  alcuCorrectFolderExecutor in 'Tasks\alcuCorrectFolderExecutor.pas'
  {$IfEnd} //ServerTasks
  
  {$If defined(ServerTasks)}
  ,
  alcuDetachedExecutor in 'Tasks\alcuDetachedExecutor.pas'
  {$IfEnd} //ServerTasks
  ,
  l3ProcessingEnabledService in 'w:\common\components\rtl\Garant\L3\l3ProcessingEnabledService.pas',
  alcuProcessingEnabledService in 'Server\alcuProcessingEnabledService.pas'
  {$If defined(AppServerSide) AND defined(ServerTasks)}
  ,
  alcuNotSortedTaskList in 'Tasks\alcuNotSortedTaskList.pas'
  {$IfEnd} //AppServerSide AND ServerTasks
  ,
  alcuTaskManager in 'Server\alcuTaskManager.pas',
  ...
  ,
  alcuDictChangeMDPSynchronizator in 'Server\alcuDictChangeMDPSynchronizator.pas'
  ...
  {$If defined(AppServerSide) AND defined(MDPSyncIntegrated)}
  ,
  alcuMdpDocImporter in 'Server\alcuMdpDocImporter.pas'
  {$IfEnd} //AppServerSide AND MDPSyncIntegrated
  ,
  alcuServerTaskManagerFactory in 'Server\alcuServerTaskManagerFactory.pas',
  alcuAutoPipeServer in 'Server\alcuAutoPipeServer.pas',
  ...
  alcuTaskChangeHelper in 'Server\alcuTaskChangeHelper.pas',
  alcuServer in 'Server\alcuServer.pas',
  AutoPipeServerForm in 'AutoPipeServerForm.pas'
  ...
  ,
  ddServerTaskManagerForTests in 'Tests\ddServerTaskManagerForTests.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K515862135 in 'Tests\Tasks\Processing\K515862135.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K578892941 in 'Tests\Tasks\Processing\K578892941.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TCheckSaveToStream in 'Tests\Tasks\SaveLoad\K517772970_TCheckSaveToStream.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddTaskItem in 'Tests\Tasks\SaveLoad\K517772970_TddTaskItem.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddProcessTask in 'Tests\Tasks\SaveLoad\K517772970_TddProcessTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ,
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddRequestTask in 'Tests\Tasks\SaveLoad\K517772970_TddRequestTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddClientMessage in 'Tests\Tasks\SaveLoad\K517772970_TddClientMessage.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddCommonDataRequest in 'Tests\Tasks\SaveLoad\K517772970_TddCommonDataRequest.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddBaseStatusRequest in 'Tests\Tasks\SaveLoad\K517772970_TddBaseStatusRequest.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  ,
  K517772970_TddNonEditableDictsRequest in 'Tests\Tasks\SaveLoad\K517772970_TddNonEditableDictsRequest.pas'
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddServerStatusRequest in 'Tests\Tasks\SaveLoad\K517772970_TddServerStatusRequest.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TaskRequest in 'Tests\Tasks\SaveLoad\K517772970_TaskRequest.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddTaskResultRequest in 'Tests\Tasks\SaveLoad\K517772970_TddTaskResultRequest.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddGetTaskRequest in 'Tests\Tasks\SaveLoad\K517772970_TddGetTaskRequest.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsExportResultRequest in 'Tests\Tasks\SaveLoad\K517772970_TcsExportResultRequest.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsLineRequest in 'Tests\Tasks\SaveLoad\K517772970_TcsLineRequest.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuAutoClassTask in 'Tests\Tasks\SaveLoad\K517772970_TalcuAutoClassTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsExport in 'Tests\Tasks\SaveLoad\K517772970_TcsExport.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ,
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsImportTaskItem in 'Tests\Tasks\SaveLoad\K517772970_TcsImportTaskItem.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuRegionAutoExportTask in 'Tests\Tasks\SaveLoad\K517772970_TalcuRegionAutoExportTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuAutoSpellTask in 'Tests\Tasks\SaveLoad\K517772970_TalcuAutoSpellTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddRunCommandTask in 'Tests\Tasks\SaveLoad\K517772970_TddRunCommandTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuAnnotationTask in 'Tests\Tasks\SaveLoad\K517772970_TalcuAnnotationTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TUserEditQuery in 'Tests\Tasks\SaveLoad\K517772970_TUserEditQuery.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest) AND defined(RemoteDict)}
  ,
  K517772970_TRemoteDictEditQuery in 'Tests\Tasks\SaveLoad\K517772970_TRemoteDictEditQuery.pas'
  {$IfEnd} //AppServerSide AND InsiderTest AND RemoteDict
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuAutoExportTask in 'Tests\Tasks\SaveLoad\K517772970_TalcuAutoExportTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TDeleteDocsQuery in 'Tests\Tasks\SaveLoad\K517772970_TDeleteDocsQuery.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TDictEditQuery in 'Tests\Tasks\SaveLoad\K517772970_TDictEditQuery.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsAutoAnnoExport in 'Tests\Tasks\SaveLoad\K517772970_TcsAutoAnnoExport.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddCaseCodeTask in 'Tests\Tasks\SaveLoad\K517772970_TddCaseCodeTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuExport in 'Tests\Tasks\SaveLoad\K517772970_TalcuExport.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuAnoncedExport in 'Tests\Tasks\SaveLoad\K517772970_TalcuAnoncedExport.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuHavanskyExportTask in 'Tests\Tasks\SaveLoad\K517772970_TalcuHavanskyExportTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TGetDictEditQuery in 'Tests\Tasks\SaveLoad\K517772970_TGetDictEditQuery.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuImport in 'Tests\Tasks\SaveLoad\K517772970_TalcuImport.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuRelPublishTask in 'Tests\Tasks\SaveLoad\K517772970_TalcuRelPublishTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsAACImport in 'Tests\Tasks\SaveLoad\K517772970_TcsAACImport.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsSpellCorrectTask in 'Tests\Tasks\SaveLoad\K517772970_TcsSpellCorrectTask.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsUserDefinedExport in 'Tests\Tasks\SaveLoad\K517772970_TcsUserDefinedExport.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  alcuImportTest in 'Tests\Tasks\Import\Abstract\alcuImportTest.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TCheckSaveToStreamDefault in 'Tests\Tasks\SaveLoadWithDefault\Abstract\K517772970_TCheckSaveToStreamDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517789752 in 'Tests\Tasks\Import\K517789752.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddTaskItemDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddTaskItemDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuAnnotationTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TalcuAnnotationTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuAnoncedExportDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TalcuAnoncedExportDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuAutoClassTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TalcuAutoClassTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuExportDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TalcuExportDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuHavanskyExportTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TalcuHavanskyExportTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuImportDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TalcuImportDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuRelPublishTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TalcuRelPublishTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TaskRequestDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TaskRequestDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsAACImportDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TcsAACImportDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsAutoAnnoExportDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TcsAutoAnnoExportDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuAutoSpellTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TalcuAutoSpellTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsExportDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TcsExportDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsExportResultRequestDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TcsExportResultRequestDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsImportTaskItemDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TcsImportTaskItemDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsLineRequestDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TcsLineRequestDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuAutoExportTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TalcuAutoExportTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddBaseStatusRequestDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddBaseStatusRequestDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddCaseCodeTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddCaseCodeTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddClientMessageDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddClientMessageDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddCommonDataRequestDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddCommonDataRequestDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddGetTaskRequestDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddGetTaskRequestDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest) AND defined(RemoteDict)}
  ,
  K517772970_TddNonEditableDictsRequestDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddNonEditableDictsRequestDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest AND RemoteDict
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddProcessTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddProcessTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TalcuRegionAutoExportTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TalcuRegionAutoExportTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddRequestTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddRequestTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddRunCommandTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddRunCommandTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddServerStatusRequestDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddServerStatusRequestDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TddTaskResultRequestDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TddTaskResultRequestDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TDeleteDocsQueryDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TDeleteDocsQueryDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TDictEditQueryDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TDictEditQueryDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TGetDictEditQueryDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TGetDictEditQueryDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest) AND defined(RemoteDict)}
  ,
  K517772970_TRemoteDictEditQueryDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TRemoteDictEditQueryDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest AND RemoteDict
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TUserEditQueryDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TUserEditQueryDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsSpellCorrectTaskDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TcsSpellCorrectTaskDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  K517772970_TcsUserDefinedExportDefault in 'Tests\Tasks\SaveLoadWithDefault\K517772970_TcsUserDefinedExportDefault.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ...
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  RegisteredRepliesTest in 'Tests\RegisteredRepliesTest.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  
  {$If defined(AppServerSide) AND defined(InsiderTest)}
  ,
  archiExportActionTest in 'Tests\NewActions\Export\archiExportActionTest.pas'
  {$IfEnd} //AppServerSide AND InsiderTest
  ,
  toK in 'toK.pas'
  {$If defined(nsTest) AND not defined(NoScripts)}
  ...
  {$IfEnd} //InsiderTest AND nsTest AND not NoScripts
  ,
  AutoPipeServerTestsRunner in 'AutoPipeServerTestsRunner.pas'
