...
{ $Id: Main.pas,v 1.14 2005/07/05 12:01:28 lulin Exp $ }
...
uses
  ...
  vtSpin, l3InterfacedComponent, m3DBInterfaces, Mask, ToolEdit, l3Control;
...
type
  TMainForm = class(TForm)
    ...
    gbInfo: TGroupBox;
    rbErrors: TRadioButton;
    rbHyperlinks: TRadioButton;
    rbSubs: TRadioButton;
    ...
    procedure rbErrorsClick(Sender: TObject);
  private
...
procedure TMainForm.rbErrorsClick(Sender: TObject);
var
 l_Enabled : Bool;
begin
 l_Enabled := rbErrors.Checked;
 cbHyphen.Enabled := l_Enabled;
 cbDict.Enabled := l_Enabled;
 cbAlternate.Enabled := l_Enabled;
end;
