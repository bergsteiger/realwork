...
//
// $Id: lzdecode.dpr,v 1.3 2000/01/06 14:39:12 migel Exp $
//
*)
program LZDecode; {$R *.res}
       ...
       try
        ...
        LPHUStream2:=TmgExFileStream.Create(ParamStr(2),fmCreate);
         try
          ...
          LLZOStream:=TmgLZOStream.Create(LPHUStream1,CmgArcStrDecode);
           try

            LPHUStream2.CopyFrom(LLZOStream,0);
