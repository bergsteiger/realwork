...
:main
	:main.begin
		...
		pushd "%~dp0"
			set PROJECT=SHARED DELPHI TOOLS
			...
			set BUILD_SHARE=Shared Delphi Tools
			...
			pushd "W:\"
				ren "Shared Delphi Tools" "Shared Delphi Tools-UNKNOWN-X.XXX" 1>nul 2>&1& ren "Shared Delphi Tools-%PROJECT%" "Shared Delphi Tools" 1>nul 2>&1
			popd
			...
			pushd "W:\"
				ren "Shared Delphi Tools" "Shared Delphi Tools-%PROJECT%" 1>nul 2>&1& ren "Shared Delphi Tools-UNKNOWN-X.XXX" "Shared Delphi Tools" 1>nul 2>&1
			popd
		popd
