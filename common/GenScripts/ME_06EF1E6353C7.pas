...
uses
 ...
 , ControlResizeBugFix
 , ReleasetoK in 'w:\common\components\DailyTest\ReleasetoK.pas'
 ...
 , ReleaseItsLAW in 'w:\common\components\DailyTest\ReleaseItsLAW.pas'
 , ReleaseArchi2 in 'w:\common\components\DailyTest\ReleaseArchi2.pas'
 , ReleasetoK64 in 'w:\common\components\DailyTest\ReleasetoK64.pas'
 , ReleasetoKT in 'w:\common\components\DailyTest\ReleasetoKT.pas'
 ...
 , m3DBInterfaces in 'w:\common\components\rtl\Garant\m3\NOT_COMPLETED_m3DBInterfaces.pas'
 , m3Interfaces in 'w:\common\components\rtl\Garant\m3\m3Interfaces.pas'
 , m3StorageInterfaces in 'w:\common\components\rtl\Garant\m3\NOT_COMPLETED_m3StorageInterfaces.pas'
...
{$If Defined(nsTest) AND NOT Defined(NoScripts)}
{$IfEnd} // Defined(nsTest) AND NOT Defined(NoScripts)
{$R ReleaseDailyTest.res}

begin
 {$IfDef nsTest}
 g_CVSPath := 'w:\common\components\DailyTest';
 {$EndIf nsTest}
 //#UC START# *06EF1E6353C7CVSPath*
 //#UC END# *06EF1E6353C7CVSPath*
 TAutoTestsSuite.Register;
 try
  if KTestRunner.NeedKTestRunner([TReleasetoK, TReleaseItsLAW, TReleaseArchi2, TReleasetoK64, TReleasetoKT]) then
