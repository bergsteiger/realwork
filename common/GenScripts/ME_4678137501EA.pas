...
function L2_Mk2InterfaceFactory_IterateCursors_Action(anAction: pointer): Mk2InterfaceFactory_IterateCursors_Action;
...
asm
 jmp l3LocalStub
end;//L2_Mk2InterfaceFactory_IterateCursors_Action
