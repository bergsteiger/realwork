...
// ћодуль: "w:\common\components\rtl\Garant\L3\l3ControlsTypes.pas"
// —тереотип: "Interfaces"
// Ёлемент модели: "l3ControlsTypes" MUID: (47D036150077)
...
type
 TvtViewOption = (
  ...
  , voWithoutImages
   {* ImageList не используетс€, и не создаетс€ фиктивный из ресурса. }
  , voShowItemEdgeLine
  , voShowSelectAsArrow
