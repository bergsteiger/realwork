...
// Ìîäóëü: "w:\quality\test\garant6x\AdapterTest\atCommon.pas"
// Ñòåðåîòèï: "UtilityPack"
// Ýëåìåíò ìîäåëè: "atCommon" MUID: (48172C290190)
...
//#UC START# *48172C380180_48172C290190_var*
  const
    chars = '1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZabxdefghijklmnopqratuvwxyzÀÁÂÃÄÅ¨ÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäå¸æçèéêëìíîïðñòóôõö÷øùúûüýþÿ';
  var
    i, chrLen : integer;
