...
// ћодуль: "w:\common\components\gui\Garant\VT\ComboTree\ctComboBoxStringsItemNode.pas"
...
type
 IctNodeWrap = interface
  {* ќбЄртка над нодой, позвол€юща€ получить реализацию. }
