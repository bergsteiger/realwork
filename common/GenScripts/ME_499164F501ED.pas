...
type
 ...
 InsPageSettingsInfo = interface(InsEditSettingsInfo)
  ...
  procedure pm_SetColontituls(aIndex: TevPageColontituls;
   const aValue: Tl3WString);
  function pm_GetMetrics(aIndex: TnsMetricsIndex): Double;
  procedure pm_SetMetrics(aIndex: TnsMetricsIndex;
   aValue: Double);
 ...
 InsDuplicateConfigNameChecker = interface
 ...
 InsConfigurationList = interface
  {* Список конфигураций }
