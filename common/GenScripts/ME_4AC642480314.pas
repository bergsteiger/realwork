...
begin
 inherited;
 f_FontScrollBox := TScrollBox.Create(Self);
 f_FontScrollBox.Name := 'FontScrollBox';
 f_FontScrollBox.Parent := Self;
 ...
 f_FontStrikeoutInheritanceButton := TElPopupButton.Create(Self);
 f_FontStrikeoutInheritanceButton.Name := 'FontStrikeoutInheritanceButton';
 f_FontStrikeoutInheritanceButton.Parent := FontScrollBox;
 f_FontSizeInheritanceButton := TElPopupButton.Create(Self);
 f_FontSizeInheritanceButton.Name := 'FontSizeInheritanceButton';
 f_FontSizeInheritanceButton.Parent := FontScrollBox;
 f_FontNameInheritanceButton := TElPopupButton.Create(Self);
 f_FontNameInheritanceButton.Name := 'FontNameInheritanceButton';
 f_FontNameInheritanceButton.Parent := FontScrollBox;
 f_FontItalicInheritanceButton := TElPopupButton.Create(Self);
 f_FontItalicInheritanceButton.Name := 'FontItalicInheritanceButton';
 f_FontItalicInheritanceButton.Parent := FontScrollBox;
 f_FontForeColorInheritanceButton := TElPopupButton.Create(Self);
 f_FontForeColorInheritanceButton.Name := 'FontForeColorInheritanceButton';
 f_FontForeColorInheritanceButton.Parent := FontScrollBox;
 f_FontBoldInheritanceButton := TElPopupButton.Create(Self);
 f_FontBoldInheritanceButton.Name := 'FontBoldInheritanceButton';
 f_FontBoldInheritanceButton.Parent := FontScrollBox;
 f_FontBackColorInheritanceButton := TElPopupButton.Create(Self);
 f_FontBackColorInheritanceButton.Name := 'FontBackColorInheritanceButton';
 f_FontBackColorInheritanceButton.Parent := FontScrollBox;
 f_FontUnderlineInheritanceButton := TElPopupButton.Create(Self);
 f_FontUnderlineInheritanceButton.Name := 'FontUnderlineInheritanceButton';
 f_FontUnderlineInheritanceButton.Parent := FontScrollBox;
 f_FontUnderlineCheckBox := TvtCheckBox.Create(Self);
 f_FontUnderlineCheckBox.Name := 'FontUnderlineCheckBox';
 f_FontUnderlineCheckBox.Parent := FontScrollBox;
 f_FontStrikeoutCheckBox := TvtCheckBox.Create(Self);
 f_FontStrikeoutCheckBox.Name := 'FontStrikeoutCheckBox';
 f_FontStrikeoutCheckBox.Parent := FontScrollBox;
 f_FontSizeComboBox := TvtComboBoxQS.Create(Self);
 f_FontSizeComboBox.Name := 'FontSizeComboBox';
 f_FontSizeComboBox.Parent := FontScrollBox;
 f_FontNameComboBox := TvtComboBoxQS.Create(Self);
 f_FontNameComboBox.Name := 'FontNameComboBox';
 f_FontNameComboBox.Parent := FontScrollBox;
 f_FontItalicCheckBox := TvtCheckBox.Create(Self);
 f_FontItalicCheckBox.Name := 'FontItalicCheckBox';
 f_FontItalicCheckBox.Parent := FontScrollBox;
 f_FontForeColorBox := TvtColorBox.Create(Self);
 f_FontForeColorBox.Name := 'FontForeColorBox';
 f_FontForeColorBox.Parent := FontScrollBox;
 f_FontBoldCheckBox := TvtCheckBox.Create(Self);
 f_FontBoldCheckBox.Name := 'FontBoldCheckBox';
 f_FontBoldCheckBox.Parent := FontScrollBox;
 f_FontBackColorBox := TvtColorBox.Create(Self);
 f_FontBackColorBox.Name := 'FontBackColorBox';
 f_FontBackColorBox.Parent := FontScrollBox;
 f_FontScalableCheckBox := TvtCheckBox.Create(Self);
 f_FontScalableCheckBox.Name := 'FontScalableCheckBox';
 f_FontScalableCheckBox.Parent := FontScrollBox;
 ...
 f_LeftIndentInheritanceButton := TElPopupButton.Create(Self);
 f_LeftIndentInheritanceButton.Name := 'LeftIndentInheritanceButton';
 f_LeftIndentInheritanceButton.Parent := FontScrollBox;
 f_RightIndentInheritanceButton := TElPopupButton.Create(Self);
 f_RightIndentInheritanceButton.Name := 'RightIndentInheritanceButton';
 f_RightIndentInheritanceButton.Parent := FontScrollBox;
 f_FirstIndentInheritanceButton := TElPopupButton.Create(Self);
 f_FirstIndentInheritanceButton.Name := 'FirstIndentInheritanceButton';
 f_FirstIndentInheritanceButton.Parent := FontScrollBox;
 f_SpaceBeforeInheritanceButton := TElPopupButton.Create(Self);
 f_SpaceBeforeInheritanceButton.Name := 'SpaceBeforeInheritanceButton';
 f_SpaceBeforeInheritanceButton.Parent := FontScrollBox;
 f_SpaceAfterInheritanceButton := TElPopupButton.Create(Self);
 f_SpaceAfterInheritanceButton.Name := 'SpaceAfterInheritanceButton';
 f_SpaceAfterInheritanceButton.Parent := FontScrollBox;
