...
// ћодуль: "w:\quality\test\garant6x\AdapterTest\CoreObjects\atLockFile.pas"
// —тереотип: "SimpleClass"
// Ёлемент модели: "TatLockFile" MUID: (4FEB10B100CD)
 ...
 TatLockFile = class(TObject)
  ...
  protected
   ...
   procedure AfterConstruction; override;
    {* AfterConstruction is called automatically after the objectТs last constructor has executed. Do not call it explicitly in your applications.
