...
function Tl3TabbedContainersDispatcher.IsTabClosing(const aTab: Il3FormTab): Boolean;
//#UC START# *27138C52AC0C_553213D902E0_var*
//#UC END# *27138C52AC0C_553213D902E0_var*
begin
//#UC START# *27138C52AC0C_553213D902E0_impl*
 Result := f_Alien.IsTabClosing(aTab);
//#UC END# *27138C52AC0C_553213D902E0_impl*
end;//Tl3TabbedContainersDispatcher.IsTabClosing
