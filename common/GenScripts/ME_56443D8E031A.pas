...
type
 TnsFiltersEnumerator = class(Tl3ProtoObject, InsFiltersEnumerator)
  ...
  public
   constructor Create(const aFilters: IFiltersFromQuery); reintroduce; overload;
   ...
   constructor Create(const aFirstFilters: IFiltersFromQuery;
    const aSecondFilters: IFiltersFromQuery); reintroduce; overload;
