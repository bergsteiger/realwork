...
// Generated from UML model, root element: <<TestTarget::Category>> Shared Delphi Tests::ReleaseDaily$Test
//
...
uses
  ...
  ReleaseArchi2 in 'ReleaseArchi2.pas',
  ReleasetoK64 in 'ReleasetoK64.pas',
  ReleasetoKT in 'ReleasetoKT.pas'
  ;
