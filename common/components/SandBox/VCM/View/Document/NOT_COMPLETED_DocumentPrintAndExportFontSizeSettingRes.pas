unit NOT_COMPLETED_DocumentPrintAndExportFontSizeSettingRes;
 {* Ресурсы для настройки "Использовать для экспорта и печати следующий размер шрифта" }

// Модуль: "w:\common\components\SandBox\VCM\View\Document\NOT_COMPLETED_DocumentPrintAndExportFontSizeSettingRes.pas"
