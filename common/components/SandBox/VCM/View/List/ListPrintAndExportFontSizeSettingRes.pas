...
//
// Библиотека "View"
// Модуль: "ListPrintAndExportFontSizeSettingRes.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: UtilityPack::Class Shared Delphi Sand Box$UC::List::View::List::ListPrintAndExportFontSizeSettingRes
//
