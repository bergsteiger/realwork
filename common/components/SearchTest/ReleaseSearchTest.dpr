program ReleaseSearchTest;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/common/components/SearchTest/ReleaseSearchTest.dpr"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<TestTarget::Category>> Shared Delphi Search Tests::ReleaseSearch
//
// Пускач для тестов поиска сервера F1 (Ромина тулза) (релизный вариант)
//
//
...
uses
  ...
  {$IfEnd} //not NoScripts
  ,
  ReleaseToK in 'ReleaseToK.pas',
  ReleaseToK2 in 'ReleaseToK2.pas',
  ReleaseToK3 in 'ReleaseToK3.pas'
  ;
{$IfEnd} //nsTest

{$R ReleaseSearchTest.res}

begin
 {$IfDef nsTest}
 g_CVSPath := 'w:\common\components\SearchTest';
 {$EndIf nsTest}
 //#UC START# *4114A74FDFBCCVSPath*
 //#UC END# *4114A74FDFBCCVSPath*
 TAutoTestsSuite.Register;
 try
  if KTestRunner.NeedKTestRunner([TReleaseToK, TReleaseToK2, TReleaseToK3]) then
