...
// Generated from UML model, root element: <<TestTarget::Category>> Shared Delphi Tests::ReleaseTFW
//
...
{$R ReleaseTFWTest.res}

begin
 {$IfDef nsTest}
 g_CVSPath := 'w:\common\components\TFWTest';
 {$EndIf nsTest}
 //#UC START# *ECB151341247CVSPath*
 //#UC END# *ECB151341247CVSPath*
