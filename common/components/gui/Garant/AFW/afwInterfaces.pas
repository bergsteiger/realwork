...
// Начат: 20.12.2004 15:50
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<Interfaces::Category>> Shared Delphi::AFW::afwInterfaces
//
// Интерфейсы библиотеки afw, предназначенные для унифицированного общения со скелетом приложения.
//
//
