...
// ћодуль: "w:\common\components\gui\Garant\AFW\implementation\Visual\afwCustomCaretType.pas"
// —тереотип: "SimpleClass"
// Ёлемент модели: "TafwCustomCaretType" MUID: (480DC4B90226)
 ...
 TafwCustomCaretType = class(Tl3_Base)
  ...
  private
   f_OnChange: TNotifyEvent;
    {* нотификаци€ об изменении параметров каретки. }
   ...
   f_BlinkTime: Word;
    {* период мигани€ курсора (в милисекундах). }
