...
// Элемент модели: "QFLikeTextLoadKeywordsPack" MUID: (4CA090120212_Pack)
...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4CA090120212_Packimpl_uses*
 //#UC END# *4CA090120212_Packimpl_uses*
;
...
[code]форма::QFLikeTextLoad TryFocus ASSERT[code] }
  protected
...
class procedure Tkw_Form_QFLikeTextLoad.RegisterInEngine;
begin
 inherited;
 TtfwClassRef.Register(TQFLikeTextLoadForm);
end;//Tkw_Form_QFLikeTextLoad.RegisterInEngine
...
initialization
 ...
 {* Регистрация типа TQFLikeTextLoadForm }
