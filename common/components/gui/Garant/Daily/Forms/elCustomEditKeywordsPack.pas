...
// Элемент модели: "elCustomEditKeywordsPack" MUID: (4BCE9D210265_Pack)
...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4BCE9D210265_Packimpl_uses*
 //#UC END# *4BCE9D210265_Packimpl_uses*
;
...
[code]форма::elCustomEdit TryFocus ASSERT[code] }
  protected
...
----
*Пример использования*:
[code]компонент::Edit TryFocus ASSERT[code] }
  protected
   function GetString: AnsiString; override;
   class procedure RegisterInEngine; override;
   class function GetWordNameForRegister: AnsiString; override;
