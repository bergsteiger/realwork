unit NOT_COMPLETED_evTableCursorPair;
 {* ¬ыделение дл€ таблицы. }

// ћодуль: "w:\common\components\gui\Garant\Everest\NOT_COMPLETED_evTableCursorPair.pas"
// —тереотип: "SimpleClass"
// Ёлемент модели: "TevTableCursorPair" MUID: (5108D3850245)
