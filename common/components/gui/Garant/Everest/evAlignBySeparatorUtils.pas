unit evAlignBySeparatorUtils;
 {* ”тилиты работы с выравниванием по точке. }

// ћодуль: "w:\common\components\gui\Garant\Everest\evAlignBySeparatorUtils.pas"
// —тереотип: "UtilityPack"
// Ёлемент модели: "evAlignBySeparatorUtils" MUID: (4E3BB8760238)
