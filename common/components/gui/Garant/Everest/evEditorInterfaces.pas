...
// Начат: 03.05.2000 16:19
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<Interfaces::Category>> Shared Delphi::Everest::evEditorInterfaces
//
...
type
 ...
 IedParagraphFormatting = interface(IUnknown)
 ...
 { - предварительное описание IedFramePart. }


  PIedFramePart = ^IedFramePart;

 IedFramePart = interface(IUnknown)
 ...
 IedProcessorObject = interface(IUnknown)
...
type
 ...
 IedTable = interface;
 { - предварительное описание IedTable. }
 ...
 { - предварительное описание IedRowsIterator. }

 IedColumn = interface;
 { - предварительное описание IedColumn. }

 IedColumnsIterator = interface;
 { - предварительное описание IedColumnsIterator. }

 IedCells = interface;
 { - предварительное описание IedCells. }
...
type
 IedRangeSource = interface(IUnknown)
 ...
 TedTabelType = (
  {* Тип таблицы - попытка заточить выравнивание для таблиц определенного вида. }
   ed_tsNone
 , ed_tsWithHeader // Таблица с заголовоком.
 , ed_tsForm // Таблица - форма.
 , ed_tsChessTable // Таблица - "шахматка".
 );//TedTabelType
