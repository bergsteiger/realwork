...
const
 {* Алиасы для значений nevTypes.TevLoadFlag }
 ev_lfInternal = nevTypes.ev_lfInternal;
 ev_lfNeedJoin = nevTypes.ev_lfNeedJoin;
 ev_lfAtEnd = nevTypes.ev_lfAtEnd;
 ev_lfSkipSubdocuments = nevTypes.ev_lfSkipSubdocuments;
...
type
 ...
 TevLoadFlag = nevTypes.TevLoadFlag;
