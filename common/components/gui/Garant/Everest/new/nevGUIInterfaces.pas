...
// Библиотека "Everest"
// Автор: Люлин А.В.
// Модуль: "w:/common/components/gui/Garant/Everest/new/nevGUIInterfaces.pas"
// Начат: 29.05.2009 15:50
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<Interfaces::Category>> Shared Delphi::Everest::nevGUIInterfaces
//
// Интерфейсы для взаимодействия пользователя с редактором, через GUI Windows при помощи устройств
