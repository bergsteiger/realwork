...
// Библиотека "Everest"
// Автор: Люлин А.В.
// Модуль: "w:/common/components/gui/Garant/Everest/new/nevNavigation.pas"
// Начат: 02.06.2009 16:39
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<Interfaces::Category>> Shared Delphi::Everest::nevNavigation
//
...
type
 IevAddressList = interface(IUnknown)
  {* Список адресов }
   ['{FF3E2BB3-B94A-4C87-9725-E6EF1E93079A}']
   function pm_GetCount: Integer;
   function pm_GetItem(anIndex: Integer): TevAddress;
   procedure pm_SetItem(anIndex: Integer; const aValue: TevAddress);
   function pm_GetName(anIndex: Integer): Tl3PCharLen;
   procedure pm_SetName(anIndex: Integer; const aValue: Tl3PCharLen);
 ...
 IevAddressHolder = interface(IUnknown)
 ...
 IevHyperlink = interface(IUnknown)
