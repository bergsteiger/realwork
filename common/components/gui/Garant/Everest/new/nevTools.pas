...
const
 {* Алиасы для значений nevTypes.TevInsertParaFlag }
 ev_ipfCheckPrev = nevTypes.ev_ipfCheckPrev;
 ev_ipfNeedFire = nevTypes.ev_ipfNeedFire;
 ev_ipfForce = nevTypes.ev_ipfForce;
 ev_ipfAtEnd = nevTypes.ev_ipfAtEnd;
 ...
 *)
 ...
 TevInsertParaFlag = nevTypes.TevInsertParaFlag;
