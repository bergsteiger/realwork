...
// Generated from UML model, root element: <<Interfaces::Category>> Shared Delphi::Everest::evQueryCardInt
//
// интерфейсы для КЗ.
//
//
...
type
 ...
 { - предварительное описание IevControlIterator. }
 ...
 TevQueryType = (
  {* Тип КЗ. }
   ev_qtAttributeSearch // ППР
 , ev_qtLegistationReview // Обзор законодательства
 , ev_qtPostingsOrder // Заказ рассылки
 , ev_qtSearchWithLawSupport // Поиск с правовой поддержкой (машина Доброва)
 , ev_qtConsultations // Правовая поддержка
 , ev_qtInpharm // Поиск лекарственного препарата
 );//TevQueryType

 IevEditorControl = interface;
 { - предварительное описание IevEditorControl. }

 IevModelListener = interface;
 { - предварительное описание IevModelListener. }

 IevEditorFieldWithTree = interface;
 { - предварительное описание IevEditorFieldWithTree. }

 IevReq = interface;
 { - предварительное описание IevReq. }
 ...
 { - предварительное описание IevEditorControlField. }
 ...
 { - предварительное описание IevEditorControlButton. }

 IevEditorControlList = interface;
 { - предварительное описание IevEditorControlList. }
...
У Димы - Get_Checked/Set_Checked. }
 ...
 { - предварительное описание IevQueryGroup. }

 IevQueryCard = interface;
 { - предварительное описание IevQueryCard. }
