unit NOT_COMPLETED_eeHotSpot;

// Модуль: "w:\common\components\gui\Garant\Everest_Engine\NOT_COMPLETED_eeHotSpot.pas"
// Стереотип: "SimpleClass"
// Элемент модели: "TeeHotSpot" MUID: (5481DD0C0363)
