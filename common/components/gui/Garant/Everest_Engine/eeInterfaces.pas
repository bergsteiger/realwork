...
// Модуль: "w:/common/components/gui/Garant/Everest_Engine/eeInterfaces.pas"
...
type
 ...
 IeeNode = interface;
 { - предварительное описание IeeNode. }

 TeeNodeAction = function (const anIntf: IeeNode): Boolean;

 IeeSubList = interface;
 { - предварительное описание IeeSubList. }

 IeeBlock = interface;
 { - предварительное описание IeeBlock. }

 IeeDocument = interface;
 { - предварительное описание IeeDocument. }
...
//#UC START# *4912DD020283unit_intf*
{$Include l3IterMode.inc}
//#UC END# *4912DD020283unit_intf*
