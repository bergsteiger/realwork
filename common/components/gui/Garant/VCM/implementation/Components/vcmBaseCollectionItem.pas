...
// Generated from UML model, root element: <<SimpleClass::Class>> Shared Delphi::VCM::Collections::TvcmBaseCollectionItem
//
//
...
type
 ...
 // protected methods
   ...
   procedure CaptionChanged; virtual;
     {* Сигнатура метода CaptionChanged }
...
// start class TvcmBaseCollectionItemPrim
