...
// Generated from UML model, root element: <<Impurity::Class>> Shared Delphi::VCM$Visual::Visual$ChromeLike::vcmContainedForm
//
//
...
{$If not defined(NoTabs) AND not defined(NoVCM) AND not defined(NoVGScene)}
 _vcmContainedForm_ = {mixin} class(_vcmContainedForm_Parent_, IvcmFormSetIconProvider, IvcmSizeableForm, IvcmContainedForm)
 private
 // private fields
...
// start class _vcmContainedForm_
