...
{ $Id: vcmMainForm.pas,v 1.505 2016/09/13 18:32:44 kostitsin Exp $ }

// $Log: vcmMainForm.pas,v $
// Revision 1.505  2016/09/13 18:32:44  kostitsin
...
begin
 f_TasksPanelZone := -1;
 l_NeedSubscribe := not TvcmDispatcher.Exists;
...
function TvcmMainForm.CanRemoveInKillFromVCM: Boolean;
  ...
  {-}
begin
 Result := not (HandleAllocated and TvcmDispatcher.Exists and TvcmDispatcher.Instance.As_IvcmDispatcher.InOp);
