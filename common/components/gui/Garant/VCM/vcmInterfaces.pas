...
(*
 vcmEntitiesContainer = PureMixIn
...
*)
 ...
 IvcmHistoryItems = interface;
   { - предварительное описание IvcmHistoryItems. }
 ...
 IvcmMainFormProvider = interface;
  { - предварительное описание IvcmMainFormProvider. }
 ...
 { - предварительное описание IvcmEntityFormsIterable. }
 ...
 { - предварительное описание IvcmFormSetSimpleFactory. }
 ...
 IvcmEntityFormsIterable = interface(IvcmBase)
 ...
 IvcmFormSetSimpleFactory = interface(IvcmBase)
 ...
 IvcmResourceHolder = interface(IvcmBase)
 ...
 IvcmContainedForm = interface(IvcmBase)
 ...
 IvcmFormSetHistory = interface(IvcmBase)
 ...
 IvcmSelectedTabDependent = l3TabbedContainersDispatcher.Il3SelectedTabDependent;
