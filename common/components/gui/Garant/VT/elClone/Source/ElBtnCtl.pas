...
// $Id: ElBtnCtl.pas,v 1.6 2008/02/07 11:59:51 lulin Exp $

// $Log: ElBtnCtl.pas,v $
// Revision 1.6  2008/02/07 11:59:51  lulin
// - распилили наследие ElPack'а по двум библиотекам.
//
// Revision 1.5  2007/08/14 14:44:15  lulin
// - оптимизируем перемещение блоков памяти.
//
// Revision 1.4  2007/08/14 14:30:01  lulin
// - оптимизируем перемещение блоков памяти.
//
...
procedure TElButtonControl.Cleanup;
begin
  inherited;
end;
