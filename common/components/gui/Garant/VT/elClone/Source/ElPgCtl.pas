...
//
// Revision 1.88  2015/04/16 13:54:24  lulin
// - перерисовываем.
//
// Revision 1.87  2015/02/26 09:28:57  kostitsin
// List*ner -> Listener
//
// Revision 1.86  2015/02/25 13:53:16  kostitsin
// List*ner -> Listener
//
// Revision 1.85  2015/02/19 08:34:40  morozov
// {RequestLink: 588832246}
//
// Revision 1.84  2015/02/13 13:31:08  morozov
// {RequestLink: 588575925}
//
// Revision 1.83  2015/02/13 07:01:17  morozov
// {RequestLink: 587164624}
//
// Revision 1.82  2015/02/10 13:44:33  morozov
// {RequestLink: 587164624}
//
// Revision 1.81  2014/02/14 15:33:42  lulin
// - избавляемся от ошибок молодости.
//
// Revision 1.80  2013/12/02 08:47:24  morozov
// {RequestLink: 506714332}
//
// Revision 1.79  2013/04/05 12:02:49  lulin
// - портируем.
//
// Revision 1.78  2013/02/13 10:01:42  lulin
// - убираем лишние зависимости.
//
// Revision 1.77  2012/12/13 15:43:32  kostitsin
// [$417890914]
//
// Revision 1.76  2012/08/15 12:25:25  lulin
// [$385026626]
//
// Revision 1.75  2012/01/24 13:54:00  gensnet
// http://mdp.garant.ru/pages/viewpage.action?pageId=327820311
//
// Revision 1.74  2011/12/15 14:27:05  gensnet
// +Устраняем "залипание" страниц в FActivesStack.
// Найдено в процессе осмотра (но с задачей не связано):
// http://mdp.garant.ru/pages/viewpage.action?pageId=312443853
//
// Revision 1.73  2011/12/12 11:14:40  lulin
// {RequestLink:308215959}
//
// Revision 1.72  2011/11/18 15:09:14  gensnet
// http://mdp.garant.ru/pages/viewpage.action?pageId=300029517
//
// Revision 1.71  2011/11/17 14:28:23  gensnet
// http://mdp.garant.ru/pages/viewpage.action?pageId=299141686
//
// Revision 1.70  2011/11/17 13:29:01  lulin
// {RequestLink:232098711}
//
// Revision 1.69  2011/11/14 11:50:14  gensnet
// http://mdp.garant.ru/pages/viewpage.action?pageId=297713320
//
// Revision 1.68  2011/11/14 11:21:19  gensnet
// http://mdp.garant.ru/pages/viewpage.action?pageId=297710494
//
// Revision 1.67  2011/11/11 08:17:35  lulin
// - bug fix: не собирался Админ Архивариуса.
//
// Revision 1.66  2011/11/10 15:25:43  lulin
// - небольшой рефакторинг и правки:
// http://mdp.garant.ru/pages/viewpage.action?pageId=297705676&focusedCommentId=297708258#comment-297708258
//
// Revision 1.65  2011/11/10 13:27:53  gensnet
// http://mdp.garant.ru/pages/viewpage.action?pageId=297705676
//
// Revision 1.64  2011/11/09 13:53:08  gensnet
// http://mdp.garant.ru/pages/viewpage.action?pageId=297703389
//
// Revision 1.63  2011/11/08 10:35:43  gensnet
// http://mdp.garant.ru/pages/viewpage.action?pageId=296627734
//
// Revision 1.62  2011/08/02 13:32:01  lulin
// {RequestLink:276545981}.
//
// Revision 1.61  2011/08/01 15:47:33  lulin
// {RequestLink:274825697}.
//
// Revision 1.60  2011/08/01 14:51:39  lulin
// {RequestLink:274825697}.
//
// Revision 1.59  2011/07/08 17:06:47  lulin
// {RequestLink:228688745}.
//
// Revision 1.58  2011/06/20 10:33:52  lulin
// {RequestLink:269081211}.
//
// Revision 1.57  2011/06/17 11:59:07  lulin
// {RequestLink:228688486}.
//
// Revision 1.56  2011/06/15 19:48:07  lulin
// {RequestLink:253664876}.
//
// Revision 1.55  2011/05/19 12:23:19  lulin
// {RequestLink:266409354}.
//
// Revision 1.54  2011/03/15 16:19:43  lulin
// {RequestLink:228688510}.
// [$255978845].
// [$255983129].
// - не даём таскать сплиттер у толкования без перевода.
//
// Revision 1.53  2010/07/28 14:47:53  lulin
// {RequestLink:228692580}.
// - выделяем утилитную функию для узнавания того, что работает под 64-разрядной операционной системой.
//
// Revision 1.52  2010/07/26 16:35:54  lulin
// {RequestLink:227479666}.
// - проверяем, что запущены под x64.
//
// Revision 1.51  2010/07/26 16:11:42  lulin
// {RequestLink:227479666}.
// - написан комментарий.
//
// Revision 1.50  2010/07/26 16:02:52  lulin
// {RequestLink:227479666}.
//
// Revision 1.49  2009/10/15 14:43:37  lulin
// {RequestLink:166856141}.
//
// Revision 1.48  2009/01/21 15:30:20  lulin
// - боремся со шрифтами.
//
// Revision 1.47  2008/09/01 12:03:40  lulin
// - трудимся над <K>: 88080897.
//
// Revision 1.46  2008/05/13 13:15:41  lulin
// - чистка в рамках <K>: 90441490.
//
// Revision 1.45  2008/05/13 12:16:45  lulin
// - чистка в рамках <K>: 90441490.
//
// Revision 1.44  2008/04/29 08:36:06  mmorozov
// - change: используем Remove вместо Delete;
//
// Revision 1.43  2008/04/29 05:52:21  mmorozov
// Список активных вкладок:
// - всегда чистим из списка удаляемую вкладку, не только когда она является активной;
// - перед удалении проверяем, что вкладка присутствует в списке активных (index of bounds).
//
// Revision 1.42  2008/04/28 15:32:59  lulin
// - <K>: 89108595. Мишаня Морозов, посмотри внимательно.
//
// Revision 1.41  2008/04/26 05:26:42  mmorozov
// - bugfix: перед использованим Last нужно проверить не пустой ли спискок.
//
// Revision 1.40  2008/04/25 11:15:07  mmorozov
// - bugfix: в стеке активных закладок не очищали удаленные закладки.
//
// Revision 1.39  2008/02/07 11:59:51  lulin
// - распилили наследие ElPack'а по двум библиотекам.
//
// Revision 1.38  2008/02/06 09:30:45  lulin
// - базовые списки объектов выделяем в отдельные файлы.
//
// Revision 1.37  2008/02/01 15:14:40  lulin
// - избавляемся от излишней универсальности списков.
//
// Revision 1.36  2008/01/31 20:38:05  lulin
// - избавляемся от излишней универсальности списков.
//
// Revision 1.35  2008/01/31 18:53:38  lulin
// - избавляемся от излишней универсальности списков.
//
// Revision 1.34  2007/09/11 09:56:26  oman
// - fix: Если убирали последнюю вкладку мог быть AV (cq26640)
//
// Revision 1.33  2007/08/14 19:31:43  lulin
// - оптимизируем очистку памяти.
//
// Revision 1.32  2007/08/14 14:30:01  lulin
// - оптимизируем перемещение блоков памяти.
//
// Revision 1.31  2007/07/11 11:11:10  oman
// - new: Вытащен флаг "Меняем закладку от мыши" (cq25768)
//
// Revision 1.30  2007/05/15 06:26:14  oman
// - fix: Не собиралась библиотека
//
// Revision 1.29  2007/05/14 14:59:51  oman
// - fix: Ставим фокус как можно раньше (cq25145)
//
// Revision 1.28  2007/05/14 10:49:30  oman
// - fix: При переставлении фокуса _ActivePage может не быть
//
// Revision 1.27  2007/05/10 14:56:36  oman
// - fix: Закладка стирала фон не смотря на флаг InUpdating - лишний
//  раз рисовали фон на переходных процессах (cq25145)
//
// Revision 1.26  2007/05/04 12:39:02  oman
// - fix: Для рисования фокусной рамки на ярлыке Tab'а ползуем цвет
//  от шрифта которым рисовался заголовок этого Tab'а
//
// Revision 1.25  2007/04/13 11:45:12  mmorozov
// - bugfix: при присвоении иконки вкладке пересчитываем размер области вкладок, т.к. размер иконки используется для вычисления, см. CQ: OIT5-24585;
//
// Revision 1.24  2007/04/09 06:05:21  lulin
// - используем родные битмапы.
//
// Revision 1.23  2007/03/27 13:08:01  lulin
// - используем родной список.
//
// Revision 1.22  2007/03/27 12:54:10  lulin
// - используем родной список.
//
// Revision 1.21  2007/03/27 11:57:06  lulin
// - cleanup.
//
// Revision 1.20  2007/03/23 13:35:20  lulin
// - убран лишний параметр.
//
// Revision 1.19  2007/03/23 11:24:40  lulin
// - используем кошерные функции распределения памяти.
//
// Revision 1.18  2007/03/22 07:14:29  lulin
// - используем кошерных предков.
//
// Revision 1.17  2007/03/21 16:00:40  lulin
// - cleanup.
//
// Revision 1.16  2007/03/21 15:49:23  lulin
// - очищаем освобождаемые указатели.
//
// Revision 1.15  2007/03/21 15:22:56  lulin
// - выделен интерфейс контрола с текстом.
//
// Revision 1.14  2007/03/21 14:53:56  lulin
// - теперь текст закладки поддерживает кодировки.
//
// Revision 1.13  2007/03/21 13:44:18  lulin
// - реализуем стек на основе родного списка.
//
// Revision 1.12  2007/03/21 13:17:26  lulin
// - cleanup.
//
// Revision 1.11  2007/03/21 13:07:57  lulin
// - cleanup.
//
// Revision 1.10  2007/03/21 12:45:29  lulin
// - убираем доморощенный цикл.
//
// Revision 1.9  2007/03/21 12:41:45  lulin
// - правильнее отрезаем строку по концу строки.
//
// Revision 1.8  2007/03/21 11:40:42  lulin
// - посылаем докам нотификацию о смене текста.
//
// Revision 1.7  2007/03/21 11:27:52  lulin
// - все ЭлПаковские контролы насленуем от кошерного предка.
//
// Revision 1.6  2007/03/21 09:49:18  lulin
// - исправляем кривые зависимости.
//
// Revision 1.5  2007/03/21 09:45:36  lulin
// - исправляем кривые зависимости.
//
// Revision 1.4  2007/03/21 09:33:31  lulin
// - исправляем кривые зависимости.
//
// Revision 1.3  2007/03/21 08:10:51  lulin
// - cleanup.
//
// Revision 1.2  2007/03/21 07:55:23  lulin
// - cleanup.
//
// Revision 1.1  2007/03/21 07:29:14  lulin
...
type
  ...
  TElMeasureTabEvent = procedure(Sender: TObject; aCanvas: TCanvas; Page:
    TElTabSheet;
    var Size: TSize) of object;

  TElPaintTabEvent = procedure(Sender: TObject; aCanvas: TCanvas; Page:
...
{$ENDIF}
    ...
    property Color default clWhite{clBtnFace};
...
{$ENDIF}
  ...
  TpcHistory = class(Tl3ProtoObject, IpcHistory)
  private
  // property methods
  ...
  // public methods
    constructor Create;
      reintroduce;
      {-}
    class function Make: IpcHistory;
      {-}
    procedure Assign(const aHistory : IpcHistory);
      reintroduce;
      {-}
  ...
  TStackPointers = class(Tl3ObjectList)
    {* - стек указателей. }
  public
  // public methods
    constructor Create;
      override;
      {-}
    procedure Push(const aValue : TObject);
      {-}
  ...
  // internal fields
    ...
    FChangingActivePageByMouse: Boolean;
      {* - меняем _ActivePage от мыши - при этом новый табшит должен переставить фокус в нужное место }
    FActivePageForTimer: TElTabSheet;
    FActivePageTimer: TTimer;
  private
  // internal methods
    function NextActiveTabFromStack(aRemoveTab : TElTabSheet) : TElTabSheet;
      {-}
    ...
    function TriggerOnDblClickUnDock(aControl : TControl) : Boolean;
      {-}
    procedure SetActivePageIfInUpdating(Value: TElTabSheet);
    procedure OnActivePageTimer(Sender: TObject);
  protected
  // ptotected methods
...
{$ENDIF}
    ...
    procedure TriggerGetImageEvent(PageIndex: integer; var ImageIndex: integer);
      virtual;
    procedure TriggerMeasureTabEvent(aCanvas: TCanvas; Page: TElTabSheet; var
      Size: TSize); virtual;
...
{$ENDIF}
    ...
    procedure TriggerDrawTabEvent(aCanvas: TCanvas; Page: TElTabSheet; Rect:
      TRect; DrawStep:
    ...
    procedure DrawTabs(ACanvas: TCanvas; R: TRect; DoDraw: boolean; var Size:
        TSize);
    function GetRotatedFont(aCanvas: TCanvas; RotationAngle: integer): HFont;
    ...
    *)
    property ChangingActivePageByMouse: Boolean
      read FChangingActivePageByMouse;
 {$IfDef Nemesis}
  private
  // private methods
  //////////////////////////////////////////////////////////////////////////////
    procedure SetFocusOnMouseActivate(aControl: TWinControl);
 {$EndIf Nemesis}
  public
  // public methods
  //////////////////////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////////////
    ...
    default clBtnFace;
    property Color default cDefBack{clBtnFace};
    ...
    SetInactiveTabColor default cDefBack{clBtnFace};
...
{$ENDIF}
  ...
  protected
    ...
    procedure DrawTabContents(aCanvas: TCanvas; R: TRect; TabSheet: TElTabSheet);
      virtual;
    procedure DrawSpace(aCanvas: TCanvas; var cx, cy: integer; mx, my: integer);
      virtual;
    ...
    procedure AdjustFillSize(After: boolean; var R: TRect; TabSheet:
      TElTabSheet); virtual;
    procedure DrawTabLine(aCanvas: TCanvas; R: TRect); virtual;
    procedure FillSpace(aCanvas: TCanvas; Rect: TRect); virtual;
    procedure FillTab(aCanvas: TCanvas; Rect: TRect; TabSheet: TElTabSheet);
      virtual;
    procedure DrawButtons(aCanvas: TCanvas; LeftRect, RightRect: TRect; CSL, CSR:
      boolean); virtual;
    function GetRowMargin: Integer; virtual;

    function IsThemeApplied: Boolean;
    procedure DrawTabEdges(aCanvas: TCanvas; var R: TRect; TabSheet:
      TElTabSheet);
      virtual; abstract;
    procedure DrawCloseButton(aCanvas: TCanvas; var R: TRect; TabSheet:
      TElTabSheet);
      virtual;
    function GetContentMargin: Integer; virtual;
    procedure FixupTab(aCanvas: TCanvas; R: TRect; TabSheet: TElTabSheet);
      virtual;
  ...
  protected
    ...
    procedure DrawTabLine(aCanvas: TCanvas; R: TRect); override;
    procedure AdjustFillSize(After: boolean; var R: TRect; TabSheet:
  ...
  protected
    ...
    procedure DrawTabLine(aCanvas: TCanvas; R: TRect); override;
    function GetAscend: Integer; override;
    procedure FillSpace(aCanvas: TCanvas; Rect: TRect); override;
    procedure AdjustFillSize(After: boolean; var R: TRect; TabSheet:
      TElTabSheet); override;
    procedure FillTab(aCanvas: TCanvas; Rect: TRect; TabSheet: TElTabSheet);
      override;
...
begin
  ...
  begin
    ...
    if TabVisible and (FPageControl <> nil) then
     FPageControl.RebuildTabs(False);
      // - пересчитываем размер области закладок, т.к. размер иконки
      //   используется для вычисления, см. CQ: OIT5-24585;
  end;
end;
...
function TElTabSheet.GetClientOrigin: TPoint; //override;
begin
 Result.X := FRect.Left;
 Result.Y := 0;
...
procedure TElTabSheet.CMTextChanged(var Message: TMessage);
  //message CM_TEXTCHANGED;
  {-}
begin
  if TabVisible and (FPageControl <> nil) then
...
{$IfDef Nemesis}
  ...
  var
   l_Notify : IafwTabSheetControl;
  begin
   // компонент поддерживает интерфейс IafwTabSheetControl
   if Supports(aComponent, IafwTabSheetControl, l_Notify) then
   try
    case aActive of
     True:
      l_Notify.PageActive;
...
begin
  ...
  begin
    l_Canvas := Self.Canvas;
    l_Canvas.Handle := Msg.DC;
...
begin
 ...
 if (ActivePage.ControlCount > 0) and
  Supports(ActivePage.Controls[0], IafwGUIDHolder, lForm) then
 try
...
begin
 ...
 begin
  ...
  begin
   ...
   begin
    if (Pages[l_Index].Name = FHistory.EmptyPageName)
        and (FHistory.EmptyPageName <> '') // http://mdp.garant.ru/pages/viewpage.action?pageId=299141686
    then
    begin
   ...
   if (Pages[l_Index].ControlCount > 0) and
    Supports(Pages[l_Index].Controls[0], IafwGUIDHolder, l_Form) then
   try
...
begin
 ...
 if Assigned(FActivePage) then
  FActivesStack.Push(Pointer(ActivePage));
 {$IfDef Nemesis}
 ...
 try
  try
   ...
   if (DockCtl is TCustomForm) then
    if Supports(DockCtl, IafwTextControl, l_TC) then
     FNewDockSheet.CCaption := l_TC.CCaption
    else
...
begin
 ...
 if (Page <> nil) then
  case Message.NotifyRec.ClientMsg of
   afw_CM_TEXTCHANGED: // <hack> // LAW
    Page.CCaption := l3Prefix(Il3CString(Message.NotifyRec.MsgLParam), [#13, #10]);
   WM_SETTEXT:
    Page.CCaption := l3Prefix(l3CStr(PChar(Message.NotifyRec.MsgLParam)), [#13, #10]);
   CM_VISIBLECHANGED:
    Page.TabVisible := Boolean(Message.NotifyRec.MsgWParam);
  end;//Message.NotifyRec.ClientMsg
 inherited;
end;
{$ENDIF}
...
begin
  ...
  begin
    FUndockingPage := Page;
    if not (csDestroying in Message.Client.ComponentState) then
...
var
  APage          : TElTabSheet;
  l_NextTabSheet : TElTabSheet;
begin
  if (FUndockingPage <> nil) then
  begin
    // если существует вкладка, которая позже станет активной, то используем ее
    if (FActivePageForTimer <> nil) // http://mdp.garant.ru/pages/viewpage.action?pageId=297710494
       and (FActivePageForTimer <> FUndockingPage) // http://mdp.garant.ru/pages/viewpage.action?pageId=300029517
    then
    begin
       // удалим из стека активных, т.к. не вызывается NextActiveTabFromStack
       // а FUndockingPage ниже будет удалена 
       FActivesStack.Remove(Pointer(FUndockingPage));
       APage := FActivePageForTimer;
    end
    else
    begin
      l_NextTabSheet := NextActiveTabFromStack(FUndockingPage);
      // если следующая активная из стека определена, то используем ее
      if Assigned(l_NextTabSheet) then
       APage := l_NextTabSheet
      else
      // ищем следующую
      begin
       if ActivePage = FUndockingPage then
        ...
        APage := ActivePage;
      end;//Assigned(l_NextTabSheet)
    end;//FActivePageForTimer <> nil

    ActivePage := APage;

    if (FActivePage = FUndockingPage) then
     FActivePage := nil;
    if (FActivePageForTimer = FUndockingPage) then
     FActivePageForTimer := nil;

    l3Free(FUndockingPage);
    DoEndDragControl;
  end;//FUndockingPage <> nil
end;
{$ENDIF}
...
function TElCustomPageControl.NextActiveTabFromStack(aRemoveTab : TElTabSheet) : TElTabSheet;
var
 l_NextActive : Pointer;
begin
 Result := nil;
 // Удалим из стека активных:
 FActivesStack.Remove(Pointer(aRemoveTab));
 // Если удаляется активная, то выберем следующую активную:
 if not (csDestroying in ComponentState) and (aRemoveTab = ActivePage) then
 begin
  // Предыдущая активная:
  l_NextActive := FActivesStack.Pop;
  // Установим новую активную, только если она не удалена:
  // http://mdp.garant.ru/pages/editpage.action?pageId=297713320
  if (l_NextActive <> nil) and (FPages.IndexOf(l_NextActive) <> -1) then
   Result := TElTabSheet(l_NextActive);
 end;//if not (csDestroying in ComponentState) and...
end;//NextActiveTabFromStack
...
{$ENDIF}
  ...
  begin
   ...
   begin
    ...
    ActiveFromStack := NextActiveTabFromStack(TabSheet);
...
procedure TElCustomPageControl.SetActivePageIfInUpdating(Value: TElTabSheet);
begin
 Assert(Value <> nil, 'http://mdp.garant.ru/pages/viewpage.action?pageId=297705676&focusedCommentId=297708266#comment-297708266');
 if (Value <> nil) then
 begin
  {$IfDef Nemesis}
  FHistory.Clear;
  // http://mdp.garant.ru/pages/viewpage.action?pageId=297705676&focusedCommentId=297708262#comment-297708262
  {$EndIf Nemesis}
  FActivePageForTimer := Value;
  if (FActivePageTimer = nil) then
    FActivePageTimer := TTimer.Create(nil);
  FActivePageTimer.Enabled := false;
  try
   FActivePageTimer.OnTimer := OnActivePageTimer;
   FActivePageTimer.Interval := 50{100};
  finally
   FActivePageTimer.Enabled := true;
  end;//try..finally
 end;//Value <> nil
end;

procedure TElCustomPageControl.OnActivePageTimer(Sender: TObject);
var
 l_ActivePageForTimer : TElTabSheet;
begin
 if not InUpdating then
 begin
  FActivePageTimer.Enabled := false;
  l_ActivePageForTimer := FActivePageForTimer;
  if (l_ActivePageForTimer <> nil) then
  begin
   FActivePageForTimer := nil;
   SetActivePage(l_ActivePageForTimer);
(*   if (fActivePage = l_ActivePageForTimer) then
    PostMessage(Handle, PM_REFRESHACTIVEPAGE, 0, 0);*)
    // http://mdp.garant.ru/pages/viewpage.action?pageId=308215959
    // - не помогает :-(
  end;//l_ActivePageForTimer <> nil
 end;//not InUpdating
end;
...
begin
  //begin http://mdp.garant.ru/pages/viewpage.action?pageId=296627734
  //так вкладка будет перересовываться, (PageCount > 1) - т.к. для одной вкладки итак все хорошо
  if InUpdating and (PageCount > 1) then
    SetActivePageIfInUpdating(Value)
  else
  //end http://mdp.garant.ru/pages/viewpage.action?pageId=296627734
  if (FActivePage <> Value)
     // begin http://mdp.garant.ru/pages/viewpage.action?pageId=327820311
     or (FActivePageForTimer <> nil) and (FActivePageForTimer <> Value)
     // end http://mdp.garant.ru/pages/viewpage.action?pageId=327820311
  then     
  begin
    FActivePageForTimer := nil;
    ...
    begin
      ...
      if (Value <> nil) then
       ...
       begin
        // http://mdp.garant.ru/pages/viewpage.action?pageId=274825697
        // http://mdp.garant.ru/pages/viewpage.action?pageId=276543734
        // http://mdp.garant.ru/pages/viewpage.action?pageId=276545981
        Value.Action.Execute;
        Exit;
       end;//Value.Action <> nil
...
procedure TElCustomPageControl.TriggerMeasureTabEvent(aCanvas: TCanvas; Page:
  TElTabSheet; var Size: TSize);
begin
  Size.cx := 0;
  Size.cy := 0;
  if Assigned(OnMeasureTab) then
    OnMeasureTab(Self, aCanvas, Page, Size);
end;
...
{$ENDIF}
 if (ActivePage <> nil) then
 // - эта вся красота ниже нужна, потому что вот - http://mdp.garant.ru/pages/viewpage.action?pageId=227479666&focusedCommentId=228690333#comment-228690333
 ...
 begin
  ...
  begin
   if (ControlCount = 1) then
    ...
    begin
     l_WinControl := TWinControl(Controls[0]);
     // Нужно проверить есть ли хэндл, иначе возможно
     // http://mdp.garant.ru/pages/viewpage.action?pageId=506714332
     if l_WinControl.HandleAllocated then
      if (l_WinControl.Align = alClient) then
      begin
       if (l_WinControl.Width <> ClientWidth) then
        SetWindowPos(l_WinControl.Handle, 0,
        ...
        SetWindowPos(l_WinControl.Handle, 0,
                     ...
                     SWP_FRAMECHANGED + SWP_NOZORDER + SWP_NOACTIVATE);
       l_WinControl.Realign;
      end;//Controls[0].Align = alClient
...
*)
  ...
  FTabBkColor := cDefBack{clBtnFace};
  FShowTabHints := true;
  ...
  {$IfDef Nemesis}
  FHistory := TpcHistory.Make;
  UseXPThemes := False;
  {$EndIf Nemesis}
  //////////////////////////////////////////////////////////////////////////////
end;

procedure TElCustomPageControl.Cleanup;
var
  i: integer;
begin
  ...
  l3Free(FScrollTimer);
  FScrollTimer := nil;
  l3Free(FActivePageTimer);
  FActivePageTimer := nil;
  for i := 0 to FPages.Count - 1 do
...
begin
  ...
  begin
    ...
    *)
    ...
    if P <> nil then
      Windows.InvalidateRect(Handle, P, false)
    else
    begin
      R := ClientRect;
      P := @R;
...
begin
  // Во время перетаскивания запрещаем перерисовку, чтобы на вкладках не
  // оставалось рудиментов отрисовки:
  ...
  begin
    ...
    bitblt(DC, Clp.Left, Clp.Top, Clp.Right - Clp.Left, Clp.Bottom - Clp.Top,
      l_C.Handle, Clp.Left, Clp.Top, { 0, 0,} SRCCOPY);
    {$EndIf NoCache}  
  end;
  {$IfNDef NoCache}
  l3Free(TmpBmp);
...
procedure TElCustomPageControl.WMKillFocus(var Message: TWMKillFocus);
begin
 inherited;
 Invalidate;
 // - http://mdp.garant.ru/pages/viewpage.action?pageId=587164624
end;

procedure TElCustomPageControl.WMSetFocus(var Message: TWMSetFocus);
begin
 inherited;
 Invalidate;
 // - http://mdp.garant.ru/pages/viewpage.action?pageId=587164624
...
begin
  ...
  if not (csDesigning in ComponentState) then
    with ScreenToClient(Point(Message.XPos, Message.YPos)) do
    DoHitTest(X, Y, integer(Message.Result));
end;
...
procedure TElCustomPageControl.ArrangePagesByWeight;
 ...
 function lp_Control(const aIndex: Integer): IafwTabSheetControl;
 begin
  Result := nil;
  if (Pages[aIndex].ControlCount > 0) then
   Supports(Pages[aIndex].Controls[0], IafwTabSheetControl, Result);
 end;//lp_Control

var
 J          : Integer;
 l_Pred     : IafwTabSheetControl;
 l_Current  : IafwTabSheetControl;
 l_Stop     : Boolean;
begin
 l_Stop := False;
 while not l_Stop do
...
begin
  inherited;
  if (not InUpdating) and (FActivePageForTimer = nil) then // http://mdp.garant.ru/pages/viewpage.action?pageId=297705676
    PostMessage(Handle, PM_REFRESHACTIVEPAGE, 0, 0);
  // if Multiline then
end;
...
procedure TElTab.DrawTabContents(aCanvas: TCanvas; R: TRect; TabSheet:
  TElTabSheet);
var
  FPageControl: TElCustomPageControl;
  SR, R2: TRect;
  ...
  l_ActiveTabCaptionFontColor: TCOlor;
...
begin
  ...
  if (not TabSheet.ParentFont) and TabSheet.UseFontForTabs then
   aCanvas.Font.Assign(TabSheet.Font)
  else
   aCanvas.Font.Assign(FPageControl.Font);
  if (not TabSheet.TabEnabled) then
    aCanvas.Font.Color := clBtnShadow;
  l_ActiveTabCaptionFontColor := aCanvas.Font.Color;
  case FPageControl.TabPosition of
    etpLeft:
      AFont := FOwner.GetRotatedFont(aCanvas, 900);
    etpRight:
      AFont := FOwner.GetRotatedFont(aCanvas, -900);
  else
    AFont := FOwner.GetRotatedFont(aCanvas, 0);
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        AlphaCopyRect2(aCanvas.Handle, R2, BMP.Canvas.Handle,
          Rect(0, 0, R2.Right - R2.Left, R2.Bottom - R2.Top), amBMP, 255);

        l3Free(amBMP);
      end
      else
        aCanvas.CopyRect(R2, BMP.Canvas, Rect(0, 0, R2.Right - R2.Left, R2.Bottom
          - R2.Top));
...
{$IFDEF ELPACK_UNICODE}
  ...
  begin
    ElVCLUtils.DrawTextW(aCanvas.Handle, PWideChar(WideString(TabSheet.Caption)),
      Length(TabSheet.Caption), R2, DT_CALCRECT);
    Size.cx := R2.Right - R2.Left;
    Size.cy := R2.Bottom - R2.Top;
  end
  else
    GetTextExtentPoint32W(aCanvas.Handle, PWideChar(TabSheet.Caption),
      Length(TabSheet.Caption), Size);
{$ELSE}
  if Pos(ElFCRLF, TabSheet.Caption) > 0 then
  begin
    DrawText(aCanvas.Handle, PChar(TabSheet.Caption), Length(TabSheet.Caption),
      R2, DT_CALCRECT);
    Size.cx := R2.Right - R2.Left;
    Size.cy := R2.Bottom - R2.Top;
  end
  else
    GetTextExtentPoint32(aCanvas.Handle, PChar(TabSheet.Caption),
      Length(TabSheet.Caption), Size);
{$ENDIF}
...
{$IFDEF ELPACK_UNICODE}
  if aPosition in [etpTop, etpBottom] then
    DrawTextW(aCanvas.Handle, PWideChar(TabSheet.Caption),
    ...
    ExtTextOutW(aCanvas.Handle, x, y, ETO_CLIPPED, @R,
...
{$ELSE}
  if (aPosition in [etpTop, etpBottom]) then
    ...
    ExtTextOut(aCanvas.Handle, x, y, ETO_CLIPPED, @R, PChar(TabSheet.Caption),
...
{$ENDIF}
  ...
  begin
    // Вместо FPageControl.Font.Color пользуем цвет шрифта которым 
    // рисовался текст
    aCanvas.Pen.Color := l_ActiveTabCaptionFontColor;
    AdjustFocusRect(SR);
    ElVCLUtils.DrawFocus(aCanvas, SR);
  end;
end;

procedure TElTab.DrawSpace(aCanvas: TCanvas; var cx, cy: integer; mx, my:
  integer);
begin
...
procedure TElTab.DrawCloseButton(aCanvas: TCanvas; var R: TRect; TabSheet:
  TElTabSheet);
const
  ...
  end;
{
  ...
  begin
    ...
    DrawThemeBackground(CloseBtnTheme, aCanvas.Handle, WP_SMALLCLOSEBUTTON,
      iStateId, tr, nil)
  end
  else
  {$endif}
  begin
    DrawButtonFrameEx3(aCanvas.Handle, tr, not FOwner.Flat,
...
procedure TElTab.DrawTabLine(aCanvas: TCanvas; R: TRect);
begin
  // intentionally left blank
end;

procedure TElTab.FillSpace(aCanvas: TCanvas; Rect: TRect);
var
  R: TRect;
  OldP: TPoint;
begin
  ...
  begin
    ...
    SetViewPortOrgEx(aCanvas.Handle, -OldP.x, -OldP.y, @OldP);
    SendMessage(FOwner.Parent.Handle, WM_ERASEBKGND, aCanvas.Handle, 0);
    SetViewPortOrgEx(aCanvas.Handle, OldP.x, OldP.y, nil);
    SetMapMode(aCanvas.Handle, MM_TEXT);
  end
  else
  {$endif}
  begin
    aCanvas.Brush.Color := FOwner.TabBkColor;
    aCanvas.FillRect(Rect);
  end;
end;

procedure TElTab.FillTab(aCanvas: TCanvas; Rect: TRect; TabSheet:
  TElTabSheet);
begin
  ...
  begin
    ...
    if TabSheet.UseTabColor then
      aCanvas.Brush.Color := TabSheet.TabColor
    else
      if TabSheet = FOwner.FActivePage then
      aCanvas.Brush.Color := FOwner.FActiveTabColor
    else
      aCanvas.Brush.Color := FOwner.FInactiveTabColor;
    aCanvas.FillRect(Rect);
  end;
  AdjustFillSize(true, Rect, TabSheet);
end;

procedure TElTab.DrawButtons(aCanvas: TCanvas; LeftRect, RightRect: TRect; CSL,
  CSR: boolean);
var
  {$ifdef MSWINDOWS}
  iPartId: Integer;
...
begin
  ...
  begin
    ...
    DrawThemeBackground(ScrollTheme, aCanvas.Handle, iPartId, iStateId, LeftRect, nil);
    if FOwner.TabPosition in [etpLeft, etpRight] then
    begin
      if FOwner.TabPosition = etpLeft then
        iPartId := SPNP_UP
    ...
    DrawThemeBackground(ScrollTheme, aCanvas.Handle, iPartId, iStateId, RightRect, nil);
  end
  else
  {$endif}
  begin
    DrawButtonFrameEx3(aCanvas.Handle, LeftRect, not FOwner.Flat,
      FOwner.ScrollBtnState = pbsLeftBtnDown,
        FOwner.Color, false, AllBorderSides);
    DrawButtonFrameEx3(aCanvas.Handle, RightRect, not FOwner.Flat,
    ...
    case FOwner.TabPosition of
      etpTop,
        etpBottom:
        begin
          ElVCLUtils.DrawArrow(aCanvas, eadLeft, LeftRect, clBtnText, csl);
          ElVCLUtils.DrawArrow(aCanvas, eadRight, RightRect, clBtnText, csr);
        end;
      etpLeft:
        begin
          ElVCLUtils.DrawArrow(aCanvas, eadDown, LeftRect, clBtnText, csl);
          ElVCLUtils.DrawArrow(aCanvas, eadUp, RightRect, clBtnText, csr);
        end;
      etpRight:
        begin
          ElVCLUtils.DrawArrow(aCanvas, eadUp, LeftRect, clBtnText, csl);
          ElVCLUtils.DrawArrow(aCanvas, eadDown, RightRect, clBtnText, csr);
        end;
    end;
  end;
end;
...
procedure TElStdTab.DrawTabEdges(aCanvas: TCanvas; var R: TRect; TabSheet:
  TElTabSheet);
const
  ROUND_CORNER_SIZE = 2;
var
...
begin
  ...
  begin
    ...
    DrawThemeBackground(TabTheme, aCanvas.Handle, iPartId, iStateId, R, nil);
    GetThemeBackgroundContentRect(TabTheme, aCanvas.Handle, iPartId, iStateId, R,
      R);
    case FOwner.TabPosition of
      etpLeft:
        dec(R.Right, 1);
...
procedure TElStdTab.DrawTabLine(aCanvas: TCanvas; R: TRect);
var
  ASheet: TElTabSheet;
  R1: TRect;
begin
  ...
  begin
    case FOwner.TabPosition of
      ...
      DrawThemeBackground(TabTheme, aCanvas.Handle, TABP_PANE, 0, R, nil);
    exit;
  end;
  {$endif}
  with aCanvas do
...
procedure TElStdTab.FillTab(aCanvas: TCanvas; Rect: TRect; TabSheet:
  TElTabSheet);
begin
  AdjustFillSize(false, Rect, TabSheet);
  begin
...
procedure TElBtnTab.AdjustFillSize(After: boolean; var R: TRect; TabSheet:
  TElTabSheet); //override;
begin
 inherited;
 {$IfDef Nemesis}
 // http://mdp.garant.ru/pages/viewpage.action?pageId=253664876
 if (TabSheet = FOwner.ActivePage) then
 begin
  if After then
   Inc(R.Right, 2)
  else
   Dec(R.Right, 2);
  if (TabSheet <> FOwner.FirstTab) then
  begin
   if After then
    Inc(R.Left, 2)
   else
    Dec(R.Left, 2);
  end;//TabSheet <> FOwner.FirstTab
 end;//TabSheet = FOwner.ActivePage
 {$EndIf Nemesis}
end;

procedure TElBtnTab.DrawTabEdges(aCanvas: TCanvas; var R: TRect; TabSheet:
  TElTabSheet);
var
  b: boolean;
  iPartId: Integer;
...
begin
  ...
  begin
    ...
    DrawThemeBackground(BtnTheme, aCanvas.Handle, iPartId, iStateId, R, nil);
    GetThemeBackgroundContentRect(BtnTheme, aCanvas.Handle, iPartId, iStateId, R,
      R);
  end
  else
  {$endif}
  begin
    ...
    l_R := R;
    l_Sides := AllBorderSides;
    {$IfDef Nemesis}
    // http://mdp.garant.ru/pages/viewpage.action?pageId=253664876
    Inc(l_R.Top, 4);
    Dec(l_R.Bottom, 4);
    //Dec(l_R.Right, 2);
    l_Sides := l_Sides - [ebsTop, ebsBottom];
    if (TabSheet = FOwner.FirstTab) then
     l_Sides := l_Sides - [ebsLeft];
    if b AND (TabSheet <> FOwner.FirstTab) then
    begin
     l_Sides := l_Sides - [ebsLeft];
     //Dec(l_R.Left, 3);
    end;//b.. 
    {$EndIf Nemesis}
    l_C := aCanvas.Brush.Color;
    try
     {$IfNDef Nemesis}
     aCanvas.Brush.Color := FOwner.FInactiveTabColor;
     DrawButtonFrameEx3(aCanvas.Handle, l_R, not FOwner.Flat, b,
       FOwner.ActiveTabColor, FOwner.Flat, l_Sides);
     if b then
     {$EndIf  Nemesis}
      if (ebsRight in l_Sides) then
      begin
       l_PC := aCanvas.Pen.Color;
       try
        aCanvas.Pen.Color := clBtnShadow;
        aCanvas.Pen.Width := 1;
        aCanvas.MoveTo(l_R.Right, l_R.Top);
        aCanvas.LineTo(l_R.Right, l_R.Bottom);
       finally
        aCanvas.Pen.Color := l_PC;
       end;//try..finally
      end;//ebsRight in l_Sides
     InflateRect(R, -2, -2);
    finally
     aCanvas.Brush.Color := l_C;
    end;//try..finally
    {$IfDef Nemesis}
    //Dec(R.Right, 2);
    {$EndIf Nemesis}
...
procedure TElBtnTab.DrawSpace(aCanvas: TCanvas; var cx, cy: integer; mx, my:
  integer);
begin
  case FOwner.TabPosition of
    etpTop,
...
procedure TElFlatBtnTab.DrawSpace(aCanvas: TCanvas; var cx, cy: integer; mx,
  my: integer);
begin
  {$ifdef MSWINDOWS}
    ...
    case FOwner.TabPosition of
      etpTop,
        ...
        begin
          ...
          aCanvas.Pen.Color := clBtnShadow;
          aCanvas.MoveTo(cx - 1, cy);
          aCanvas.LineTo(cx - 1, cy + my);
          aCanvas.Pen.Color := clBtnHighlight;
          aCanvas.MoveTo(cx, cy);
          aCanvas.LineTo(cx, cy + my);
          inc(cx, (GetInnerMargin - 2) div 2);
        end;
      etpLeft:
        begin
          ...
          aCanvas.Pen.Color := clBtnHighlight;
          aCanvas.MoveTo(cx, cy + 1);
          aCanvas.LineTo(cx + mx, cy + 1);
          aCanvas.Pen.Color := clBtnShadow;
          aCanvas.MoveTo(cx, cy);
          aCanvas.LineTo(cx + mx, cy);
          dec(cy, (GetInnerMargin - 2) div 2);
        end;
      etpRight:
        begin
...
procedure TElFlatBtnTab.DrawTabEdges(aCanvas: TCanvas; var R: TRect; TabSheet
  : TElTabSheet);
var
  iPartId: Integer;
  iStateId: Integer;
begin
  ...
  begin
    if TabSheet = FOwner.FActivePage then
    begin
      DrawButtonFrameEx3(aCanvas.Handle, R, false, true,
    ...
    begin
      ...
      if TabSheet = FOwner.FTrackTab then
    begin
      DrawButtonFrameEx3(aCanvas.Handle, R, false, false,
...
procedure TElNetTab.DrawTabEdges(aCanvas: TCanvas; var R: TRect; TabSheet:
  TElTabSheet);
var
  iPartId: Integer;
  iStateId: Integer;
begin
  ...
  begin
    ...
    begin
      DrawThemeBackground(TabTheme, aCanvas.Handle, iPartId, iStateId, R, nil);
      GetThemeBackgroundContentRect(TabTheme, aCanvas.Handle, iPartId, iStateId, R, R);
    end
    else
    begin
      DrawThemeBackground(TabTheme, aCanvas.Handle, TABP_BODY, 0, R, nil);
      GetThemeBackgroundContentRect(TabTheme, aCanvas.Handle, TABP_BODY, 0, R, R);
    end;
  end
  else
  *)
  ...
  begin
    if TabSheet = FOwner.FActivePage then
    begin
      aCanvas.Pen.Color := IncColor(clBtnHighlight, 20, 20, 20);
...
procedure TElNetTab.DrawSpace(aCanvas: TCanvas; var cx, cy: integer; mx, my:
  integer);
begin
  {$ifdef MSWINDOWS}
  if IsThemeApplied and (TabPosition = etpTop) then
    ...
    case FOwner.TabPosition of
      etpTop:
        begin
          ...
          aCanvas.MoveTo(cx, cy);
          aCanvas.LineTo(cx, cy + my - GetInnerMargin - 1);
          inc(cx, GetInnerMargin div 2);
        end;
      etpBottom:
        begin
          inc(cx, GetInnerMargin div 2);
          aCanvas.Pen.Color := clBtnFace;
          aCanvas.MoveTo(cx, cy + GetInnerMargin);
          aCanvas.LineTo(cx, cy + my - 1);
          inc(cx, GetInnerMargin div 2);
        end;
      etpLeft:
        begin
          ...
          aCanvas.Pen.Color := clBtnFace;
          aCanvas.MoveTo(cx, cy);
          aCanvas.LineTo(cx + mx - GetInnerMargin - 1, cy);
          dec(cy, GetInnerMargin div 2);
        end;
      etpRight:
        begin
          ...
          aCanvas.Pen.Color := clBtnFace;
          aCanvas.MoveTo(cx + GetInnerMargin, cy);
          aCanvas.LineTo(cx + mx, cy);
          inc(cy, GetInnerMargin div 2);
        end;
    end;
...
procedure TElNetTab.DrawTabLine(aCanvas: TCanvas; R: TRect);
var
  ASheet: TElTabSheet;
  R1: TRect;
begin
...
procedure TElNetTab.FillSpace(aCanvas: TCanvas; Rect: TRect);
begin
  {$ifdef MSWINDOWS}
  if IsThemeApplied and (TabPosition = etpTop) then
  begin
  ...
  {$endif}
  begin
    aCanvas.Brush.Color := FOwner.TabBkColorNetStyle;
    aCanvas.FillRect(Rect);
  end;
end;
...
procedure TElNetTab.FillTab(aCanvas: TCanvas; Rect: TRect; TabSheet:
  TElTabSheet);
begin
  if TabSheet = FOwner.FActivePage then inherited;
end;

procedure TElNetTab.DrawButtons(aCanvas: TCanvas; LeftRect, RightRect: TRect;
  CSL, CSR: boolean);
var
...
begin
  ...
  begin
    ...
    if CSL and (PageControl.FScrollBtnState in [pbsLeftBtnOver, pbsLeftBtnDown])
      then
      DrawButtonFrameEx3(aCanvas.Handle, LeftRect, false,
    ...
    if CSR and (PageControl.FScrollBtnState in [pbsRightBtnOver,
      ...
      DrawButtonFrameEx3(aCanvas.Handle, RightRect, false,
    ...
    case PageControl.TabPosition of
      etpTop,
        etpBottom:
        begin
          ElVCLUtils.DrawArrow(aCanvas, eadLeft, LeftRect, ColorLeft, csl);
          ElVCLUtils.DrawArrow(aCanvas, eadRight, RightRect, ColorRight, csr);
        end;
      etpLeft:
        begin
          ElVCLUtils.DrawArrow(aCanvas, eadDown, LeftRect, ColorLeft, csl);
          ElVCLUtils.DrawArrow(aCanvas, eadUp, RightRect, ColorRight, csr);
        end;
      etpRight:
        begin
          ElVCLUtils.DrawArrow(aCanvas, eadUp, LeftRect, ColorLeft, csl);
          ElVCLUtils.DrawArrow(aCanvas, eadDown, RightRect, ColorRight, csr);
        end;
    end;
  end;
end;
...
var
  ...
  begin
    ...
    try
      ...
      l3System.GetLocalMemZ(Bitmap, BitmapInfoSize + BitmapBitsSize);
      try
...
begin
  ...
  l3Move(PChar(S)^, HintInfo.HintStr[1], Length(S) + 1);

  l3Move(WS[1], HintInfo.HintStr[Length(S) + 2], Length(WS) * 2);
  T := #0;
  l3Move(T, HintInfo.HintStr[l + 1], sizeof(T));
  T := #$FFFE;
  l3Move(T, HintInfo.HintStr[l + 3], sizeof(T));
end;
...
begin
  ...
  l3Move(FHint[1], S[i + 2], Length(FHint) * 2);
  T := #0;
...
procedure TElCustomPageControl.TriggerDrawTabEvent(aCanvas: TCanvas; Page: TElTabSheet;
  Rect: TRect;
  DrawStep: TElTabDrawState; var DefaultDrawing: boolean);
begin
  DefaultDrawing := true;
  if assigned(FOnDrawTab) then
    FOnDrawTab(Self, aCanvas, Page, Rect, DrawStep, DefaultDrawing);
end;
...
begin
  ...
  begin
    ...
    begin
      if (TabSheet.Action <> nil) then
      begin
       // http://mdp.garant.ru/pages/viewpage.action?pageId=274825697
       // http://mdp.garant.ru/pages/viewpage.action?pageId=276543734
       TabSheet.Action.Execute;
       Exit;
      end;//TabSheet.Action <> nil
        ...
        UpdateTab(TabSheet);
{
      ...
      begin
        if ActivePage <> TabSheet then
        begin
          FChangingActivePageByMouse := True;
          try
            ActivePage := TabSheet;
          finally
            FChangingActivePageByMouse := False;
          end;
        end
        else
        {$IfDef Nemesis}
        ...
        begin
         if Assigned(ActivePage) then
           SetFocusOnMouseActivate(ActivePage)
         else
           SetFocusOnMouseActivate(Self);
        end;
        {$Else}
...
begin
 ...
 if l_TotalWidth <= l_Compare then
  FFirstTab := TElTabSheet(fPages.First);
end;
...
function TElCustomPageControl.GetRotatedFont(aCanvas: TCanvas; RotationAngle:
    integer): HFont;
var
  LogFont: TLogFont;
begin
...
procedure TElTab.FixupTab(aCanvas: TCanvas; R: TRect; TabSheet: TElTabSheet);
begin
  // intentionally left blank
end;
...
procedure TElBtnTab.FillTab(aCanvas: TCanvas; Rect: TRect;
  TabSheet: TElTabSheet);
begin
  if not IsThemeApplied then
  begin
...
procedure TElFlatBtnTab.FillTab(aCanvas: TCanvas; Rect: TRect;
  TabSheet: TElTabSheet);
begin
  if not IsThemeApplied then
  begin
...
procedure TEl2DFlatTab.DrawTabEdges(aCanvas: TCanvas; var R: TRect; TabSheet:
  TElTabSheet);
  ...
  begin
   ...
   aCanvas.Pen.Color := FOwner.FlatTabBorderColor;
   case FOwner.TabPosition of
    etpLeft, etpRight:
     with aCanvas do
     begin
...
begin
  ...
  begin
    ...
    begin
      DrawThemeBackground(TabTheme, aCanvas.Handle, iPartId, iStateId, R, nil);
      GetThemeBackgroundContentRect(TabTheme, aCanvas.Handle, iPartId, iStateId,
        R, R);
    end
    else
    begin
      DrawThemeBackground(TabTheme, aCanvas.Handle, TABP_BODY, 0, R, nil);
      GetThemeBackgroundContentRect(TabTheme, aCanvas.Handle, TABP_BODY, 0, R,
        R);
    end;
  end
  else
...
procedure TEl2DFlatTab.DrawTabLine(aCanvas: TCanvas; R: TRect);
var
  ASheet: TElTabSheet;
  R1: TRect;
begin
...
procedure TEl2DFlatTab.FillTab(aCanvas: TCanvas; Rect: TRect; TabSheet:
  TElTabSheet);
begin
  AdjustFillSize(false, Rect, TabSheet);
  begin
...
procedure TElAngledTab.DrawTabEdges(aCanvas: TCanvas; var R: TRect; TabSheet:
  TElTabSheet);
begin
  begin
    // if TabSheet = FOwner.FActivePage then
...
procedure TElAngledTab.DrawTabLine(aCanvas: TCanvas; R: TRect);
var
  ASheet: TElTabSheet;
  R1: TRect;
begin
...
procedure TElAngledTab.FillTab(aCanvas: TCanvas; Rect: TRect; TabSheet:
  TElTabSheet);
var
...
begin
  ...
  SaveDCState := SaveDC(aCanvas.Handle);
  NRgn := CreatePolygonRgn(Points, pc, WINDING);
  SelectClipRgn(aCanvas.Handle, NRgn);
  ...
  begin
    ...
    if TabSheet.UseTabColor then
      ...
      aCanvas.Brush.Color := FOwner.FInactiveTabColor;
    FillRgn(aCanvas.Handle, NRgn, aCanvas.Brush.Handle);
    aCanvas.Brush.Style := bsClear;
  end;
  DeleteObject(NRgn);
  AdjustFillSize(true, Rect, TabSheet);
...
procedure TElAngledTab.FixupTab(aCanvas: TCanvas; R: TRect; TabSheet:
  TElTabSheet);
begin
  RestoreDC(aCanvas.Handle, SaveDCState);
end;
...
class function TpcHistory.Make: IpcHistory;
  {-}
var
 l_H : TpcHistory;
begin
...
begin
 f_IsActiveEmpty := False;
 f_EmptyPageName := '';
 l3FillChar(f_GuidForm, SizeOf(TGUID), 0);
end;
...
procedure TStackPointers.Push(const aValue : TObject);
begin
 Remove(aValue);
 Add(aValue);
 // - кладем на верхушку
...
function TStackPointers.Pop: Pointer;
begin
 if Count = 0 then
  Result := nil
 else
...
procedure TElTabSheet.CMVisibleChanged(var Message: TMessage);
begin
 {$IfDef Nemesis}
 if Assigned(FPageControl) and FPageControl.FChangingActivePageByMouse and Visible then
 begin
  (* Фокус передаётся самому верхнему (первому встреченному) компоненту,
     у которого нет Controls *)
  if not (csDesigning in ComponentState) then
    FPageControl.SetFocusOnMouseActivate(Self);
 end;
 {$EndIf Nemesis}
 inherited;
end;
 ...
 {$IfDef Nemesis}
procedure TElCustomPageControl.SetFocusOnMouseActivate(
  aControl: TWinControl);
begin
 vtFocusWinControlEx(aControl, FFocusOnTabIfNotControls)
end;
 {$EndIf Nemesis}
