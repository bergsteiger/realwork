...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\gui\Garant\VT\elClone\Source\ElUxtheme.pas initialization enter'); {$EndIf}
{$ifdef MSWINDOWS}
  InitializeUxTheme;
{$endif}

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\gui\Garant\VT\elClone\Source\ElUxtheme.pas initialization leave'); {$EndIf}
finalization
{$ifdef MSWINDOWS}
  FinalizeUxTheme;
{$endif}
