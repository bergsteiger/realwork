...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\gui\Garant\VT\rx\RxGIF.pas initialization enter'); {$EndIf}
...
{$IFDEF USE_RX_GIF}
 ...
 {$IFDEF RX_D3}
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\gui\Garant\VT\rx\RxGIF.pas initialization leave'); {$EndIf}
finalization
