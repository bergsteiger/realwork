...
{ These functions initialises this _module }
...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\gui\Garant\VT\rx\RxGraph.pas initialization enter'); {$EndIf}
  InitTruncTables;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\gui\Garant\VT\rx\RxGraph.pas initialization leave'); {$EndIf}
end.
