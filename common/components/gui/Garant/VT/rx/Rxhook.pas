...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\gui\Garant\VT\rx\Rxhook.pas initialization enter'); {$EndIf}
  HookList := nil;
{$IFDEF WIN32}
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\gui\Garant\VT\rx\Rxhook.pas initialization leave'); {$EndIf}
finalization
  DropHookList;
{$ELSE}
