...
то Index картинки считать не надо (используется для получения ImageList) }
  ...
  protected
   ...
   function pm_GetTotal: LongInt; virtual;
...
function TvtCustomListerPrim.pm_GetTotal: LongInt;
//#UC START# *514C89A601FE_4CFFE36B00FAget_var*
//#UC END# *514C89A601FE_4CFFE36B00FAget_var*
begin
//#UC START# *514C89A601FE_4CFFE36B00FAget_impl*
 Result := f_Total;
//#UC END# *514C89A601FE_4CFFE36B00FAget_impl*
end;//TvtCustomListerPrim.pm_GetTotal
