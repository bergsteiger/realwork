...
// ћодуль: "w:\common\components\gui\Garant\VT\vtScrollBar.pas"
// —тереотип: "GuiControl"
// Ёлемент модели: "TvtScrollBar" MUID: (50220B0E0061)
...
//#UC START# *505894EC0371_50220B0E0061_impl*
 ...
 // без проверки на видимость, WM_PAINT'ы приход€т невидимым контролам, в результате
...
//#UC START# *47E136A80191_50220B0E0061_impl*
 // ƒва case тут дл€ удобства отладки
 case Message.Msg of
  WM_ERASEBKGND,
  WM_NCPAINT,
  WM_PAINT:
