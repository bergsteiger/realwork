...
// ћодуль: "w:\common\components\gui\Garant\msm\msmListLikeModel.pas"
// —тереотип: "SimpleClass"
// Ёлемент модели: "TmsmListLikeModel" MUID: (57B57EDB003F)
 ...
 TmsmListLikeModel = {abstract} class(TmsmModel, ImsmListLikeModel, ImsmCaptionModel, ImsmDragAndDropModel)
  ...
  protected
   ...
   function As_ImsmDragAndDropModel: ImsmDragAndDropModel;
    {* ћетод приведени€ нашего интерфейса к ImsmDragAndDropModel }
 ...
 procedure DoDeleteElement;
  ...
  begin//DoElement
   ...
   begin
    ...
    // - здесь ещЄ надо вставить проверку того, что элемент принадлежит списку
    // »наче можно огрести как с пустым Inherits.
