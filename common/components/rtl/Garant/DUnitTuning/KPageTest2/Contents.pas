...
type
  ...
  protected
    ...
    function create_child(const name: AnsiString): IServerGate_Contents_KPage; virtual; abstract;
  ...
  protected
    ...
    function create_child(const name: AnsiString): IServerGate_Contents_KPage; override;
  ...
  protected
    ...
    function create_child(const name: AnsiString): IServerGate_Contents_KPage; virtual;
...
function TServerGate_Contents_KPage_stub.create_child(const name: AnsiString): IServerGate_Contents_KPage;
var
  req: IStaticRequest;
  _name: IStaticAny;
  _result: IStaticAny;
begin
  ...
  req := StaticRequest(self,'create_child');
  req.add_in_arg(_name);
  req.set_result(_result);
  req.set_exceptions_tc([_tc_ServerGate_Contents_CantCreatePage.typecode, _tc_ServerGate_Contents_PermissionException.typecode]);
  req.invoke;
  dorb_static_throw(req,[ServerGate_Contents_CantCreatePage_marshaller, 'IDL:garant.ru/ServerGate/Contents/CantCreatePage:1.0', ServerGate_Contents_PermissionException_marshaller, 'IDL:garant.ru/ServerGate/Contents/PermissionException:1.0']);
end;
...
function TServerGate_Contents_KPage_stub_clp.create_child(const name: AnsiString): IServerGate_Contents_KPage;
var
  _srv: IServant;
  srv: IServerGate_Contents_KPage;
begin
...
var
  ...
  create_child_result: IServerGate_Contents_KPage;
  create_child_name: AnsiString;
...
begin
  ...
  else if req.op_name = 'create_child' then
    begin
      req.add_in_arg(StaticAny(stat_string,@create_child_name) as IStaticAny);
      req.set_result(StaticAny(ServerGate_Contents_KPage_marshaller,@create_child_result) as IStaticAny);
      if not req.read_args() then  exit;
      req.set_exceptions_tc([_tc_ServerGate_Contents_CantCreatePage.typecode, _tc_ServerGate_Contents_PermissionException.typecode]);
      try
        create_child_result := create_child(create_child_name);
      except
...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\Garant\DUnitTuning\KPageTest2\Contents.pas initialization enter'); {$EndIf}
...
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\Garant\DUnitTuning\KPageTest2\Contents.pas initialization leave'); {$EndIf}
end.
