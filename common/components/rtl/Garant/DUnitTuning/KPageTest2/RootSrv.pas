...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\Garant\DUnitTuning\KPageTest2\RootSrv.pas initialization enter'); {$EndIf}
...
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\Garant\DUnitTuning\KPageTest2\RootSrv.pas initialization leave'); {$EndIf}
end.
