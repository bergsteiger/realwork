...
// Стереотип: "TestCase"
// Элемент модели: "K210436976" MUID: (4C08B91B002B)
// Имя типа: "TK210436976"
...
type
 TK210436976 = class({$If NOT Defined(NoVCM)}
 TScrollTest
 {$IfEnd} // NOT Defined(NoVCM)
 )
  {* [RequestLink:210436976] }
...
uses
 ...
 , l3Base
 //#UC START# *4C08B91B002Bimpl_uses*
 //#UC END# *4C08B91B002Bimpl_uses*
;
