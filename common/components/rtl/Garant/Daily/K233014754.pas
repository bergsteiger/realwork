...
// Стереотип: "TestCase"
// Элемент модели: "K233014754" MUID: (4C6CDC7B00F2)
// Имя типа: "TK233014754"
...
type
 TK233014754 = class({$If NOT Defined(NoVCM)}
 TScrollTest
 {$IfEnd} // NOT Defined(NoVCM)
 )
  {* [$233014754] }
...
uses
 ...
 , l3Base
 //#UC START# *4C6CDC7B00F2impl_uses*
 //#UC END# *4C6CDC7B00F2impl_uses*
;
