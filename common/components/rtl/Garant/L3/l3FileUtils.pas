...
//
// Revision 1.85  2015/10/15 11:24:28  fireton
...
function l3IsSameFileName(const aFName1, aFName2: AnsiString): Boolean;
   {* - Являются ли имена файлов одинаковыми, даже если пути к ним разные? }
...
function l3IsSameFileName(const aFName1, aFName2: AnsiString): Boolean;
var
 l_F1, l_F2: AnsiString;
begin
 l_F1 := ExtractFileName(aFName1);
 l_F2 := ExtractFileName(aFName2);
 Result := AnsiSameText(l_F1, l_F2);
end;
