...
{ $Id: l3IEBitmapContainer.pas,v 1.39 2015/10/15 12:34:17 kostitsin Exp $ }

// $Log: l3IEBitmapContainer.pas,v $
// Revision 1.39  2015/10/15 12:34:17  kostitsin
// {requestlink: 604476865 }
//
...
procedure Tl3IEBitmapContainer.StretchDraw(const aRect: Tl3Rect; const aCanvas: Il3Canvas);
  ...
  function lpIsNullRect(const aRect: Tl3Rect): Boolean;
  begin
   with aRect.R do
