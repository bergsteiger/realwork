...
// Элемент модели: "l3ListenersHooks" MUID: (4F67149B024A)
...
//#UC START# *4F67157402EF_4F67149B024A_impl*
 ...
 if (Tl3ListenersManager.Instance.WndProcListeners <> nil) then
 begin
 ...
 end;//Tl3ListenersManager.Instance.WndProcListeners
 Result := CallNextHookEx(Tl3ListenersManager.Instance.WndProcHook, Code, WParam, Longint(Msg));
...
//#UC START# *4F6715D20141_4F67149B024A_impl*
 ...
 begin
  if (Tl3ListenersManager.Instance.GetMessageListeners <> nil) then
  begin
   l_Index := 0;
  ...
  end;//Tl3ListenersManager.Instance.GetMessageListeners <> nil
 end;
 Result := CallNextHookEx(Tl3ListenersManager.Instance.GetMessageHook, Code, WParam, Longint(Msg));
