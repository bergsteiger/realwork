...
// ћодуль: "w:\common\components\rtl\Garant\L3\l3SearchNode.pas"
// —тереотип: "SimpleClass"
// Ёлемент модели: "Tl3SearchNode" MUID: (4E5CDF9303B7)
...
type
 Tl3SearchNode = class(Tl3SearchNodePrim)
  ...
  protected
   ...
   procedure pm_SetChildren(anIndex: Integer;
    aValue: Tl3SearchNode);
...
procedure Tl3SearchNode.pm_SetChildren(anIndex: Integer;
 aValue: Tl3SearchNode);
