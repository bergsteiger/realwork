...
//
// Revision 1.59  2015/10/05 11:29:13  lulin
// {RequestLink:607751255}.
//
// Revision 1.58  2015/10/05 11:02:04  lulin
// {RequestLink:607751255}.
//
...
begin
 ...
 Case aCodePage of
  ...
  begin
   if (aCodePage = CP_RussianDOS) then
   begin
    for l_Index := 0 to Pred(aInLen) do
    begin
     Case aIn[l_Index] of
      cc_LTDoubleQuote,
      cc_RTDoubleQuote:
       aIn[l_Index] := cc_DoubleQuote;
     end;//Case aIn[l_Index]
    end;//for l_Index
   end;//aCodePage = CP_RussianDOS
