...
// Модуль: "IedTableWordsPack.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: ScriptKeywordsPack::Class Shared Delphi::ScriptEngine$Everest::EditorFromStackKeyWords::IedTableWordsPack
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
type
 TkwPopTableInsertRows = {final scriptword} class(TtfwClassLike)
...
// start class TkwPopTableInsertRows
...
type
 TkwPopTableSplit = {final scriptword} class(TtfwClassLike)
...
type
 TkwPopTableMerge = {final scriptword} class(TtfwClassLike)
...
type
 TkwPopTableDelete = {final scriptword} class(TtfwClassLike)
...
type
 TkwPopTableRowCount = {final scriptword} class(TtfwClassLike)
...
// start class TkwPopTableRowCount
...
type
 TkwPopTableCell = {final scriptword} class(TtfwClassLike)
...
type
 TkwPopTableCells = {final scriptword} class(TtfwClassLike)
...
type
 TkwPopTableColumn = {final scriptword} class(TtfwClassLike)
...
type
 TkwPopTableColumnsIterator = {final scriptword} class(TtfwClassLike)
...
// start class TkwPopTableColumnsIterator
...
type
 TkwPopTableRowsIterator = {final scriptword} class(TtfwClassLike)
...
// start class TkwPopTableRowsIterator
...
type
 TkwPopTableOldNSRC = {final scriptword} class(TtfwPropertyLike)
...
// start class TkwPopTableOldNSRC
...
begin
 try
  ...
  on E: Exception do
  begin
   RunnerError('Ошибка при получении параметра l_Table: IedTable : ' + E.Message, aCtx);
   Exit;
  end;//on E: Exception
 end;//try..except
