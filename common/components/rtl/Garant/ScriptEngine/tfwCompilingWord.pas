...
procedure TtfwCompilingWord.CheckWordInfoOnCompile(const aCtx: TtfwContext);
//#UC START# *560941240035_4DB6C8F30161_var*
//#UC END# *560941240035_4DB6C8F30161_var*
begin
//#UC START# *560941240035_4DB6C8F30161_impl*
 CompilerAssert(aCtx.rTypeInfo.Empty, 'Неверные модификаторы перед словом', aCtx);
//#UC END# *560941240035_4DB6C8F30161_impl*
end;//TtfwCompilingWord.CheckWordInfoOnCompile
