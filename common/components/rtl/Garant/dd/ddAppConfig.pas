...
// Generated from UML model, root element: <<UtilityPack::Class>> Shared Delphi::dd$AppConfig::AppConfig::ddAppConfig
//
//
...
type
 ...
 TddCaptionPanelType = (
  {* настройка вида панели названия узла }
   cptNormalBevel // установить панели, с именем узла в дереве, BevelWidth = 1
 );//TddCaptionPanelType
 ...
 // private methods
   ...
   procedure CheckEnabledStatus;
     {* Сигнатура метода CheckEnabledStatus }
   ...
   procedure SetFontName;
     {* Сигнатура метода SetFontName }
   procedure WorkupChanged;
     {* Сигнатура метода WorkupChanged }
 ...
 // property methods
   ...
   procedure pm_SetAsBoolean(const Alias: AnsiString; aValue: Boolean);
   function pm_GetAsDateTime(const Alias: AnsiString): TDateTime;
   procedure pm_SetAsDateTime(const Alias: AnsiString; aValue: TDateTime);
   function pm_GetAsInteger(const Alias: AnsiString): Integer;
   procedure pm_SetAsInteger(const Alias: AnsiString; aValue: Integer);
   function pm_GetAsObject(const Alias: AnsiString): TObject;
   procedure pm_SetAsObject(const Alias: AnsiString; aValue: TObject);
   function pm_GetAsString(const Alias: AnsiString): AnsiString;
   procedure pm_SetAsString(const Alias: AnsiString; const aValue: AnsiString);
   ...
   procedure pm_SetValues(const Alias: AnsiString; const aValue: TddConfigValue);
 ...
 // public methods
   ...
   procedure CloseMasterSlaveItem;
     {* Сигнатура метода CloseMasterSlaveItem }
   ...
   procedure ClearNode;
     {* Сигнатура метода ClearNode }
   procedure CloseChild;
     {* Сигнатура метода CloseChild }
   procedure CloseGroup;
     {* Сигнатура метода CloseGroup }
   ...
   procedure ReloadDefault;
     {* Сигнатура метода ReloadDefault }
...
// start class TddAppConfiguration
...
begin
//#UC START# *5214A03602D0_4B990F100126_impl*      l3inifile
 _work(f_Root);
...
procedure TddAppConfiguration.pm_SetAsBoolean(const Alias: AnsiString; aValue: Boolean);
...
procedure TddAppConfiguration.pm_SetAsDateTime(const Alias: AnsiString; aValue: TDateTime);
...
procedure TddAppConfiguration.pm_SetAsInteger(const Alias: AnsiString; aValue: Integer);
...
procedure TddAppConfiguration.pm_SetAsObject(const Alias: AnsiString; aValue: TObject);
...
procedure TddAppConfiguration.pm_SetAsString(const Alias: AnsiString; const aValue: AnsiString);
...
procedure TddAppConfiguration.pm_SetValues(const Alias: AnsiString; const aValue: TddConfigValue);
