...
//#UC START# *5214AB33027F_4B990F100126_impl*
  ...
  begin
   ...
   {$ENDIF Nemesis}
   {$ifdef Nemesis}
   l_Panel := TvtSizeablePanel.Create(aForm);
   l_Panel.Parent := aForm;
   ...
   {$ifdef Nemesis}
   l_Tree.Parent := l_Panel;//aForm;
   l_Tree.Align := alClient;
   l_Panel.BevelOuter := bvNone;
   l_Panel.Constraints.MinWidth := l_Tree.Width;
   l_Panel.Constraints.MaxWidth := l_Tree.Width * 2;
   l_Panel.Width := afw.Settings.LoadInteger('SettingsForm_Tree_Width', l_Tree.Width);
   l_Panel.OnResize := TreePanelResize;
   f_WorkFrame.Align := alClient;
   {$else}
   l_Tree.Parent := aForm;
   {$endif}
...
//#UC START# *5722121600CB_4B990F100126_impl*
 {$ifdef nemesis}
 afw.Settings.SaveInteger('SettingsForm_Tree_Width', (Sender as TvtSizeablePanel).Width);
 {$endif}
