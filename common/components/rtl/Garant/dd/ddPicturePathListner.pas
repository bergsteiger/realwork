...
// Generated from UML model, root element: <<SimpleClass::Class>> Shared Delphi::dd::ddCommon::TddPicturePathListner
//
//
...
// start class TddPicturePathListner
...
// start class TddPicturePathService
