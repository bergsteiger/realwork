...
// ћодуль: "w:\common\components\rtl\Garant\m3\m3StoreHeaderData.pas"
// —тереотип: "SimpleClass"
// Ёлемент модели: "Tm3StoreHeaderData" MUID: (54071860020E)
...
type
 ...
 //#UC START# *54070C54022Cpubl*
   rNextPosition: Int64;
     {* - позици€ следующего свободного элемента каталога (дл€ св€зывани€ в цепочки). }
   {$IfDef m3StoreHasCRC}
   rBodyCRC: LongInt;
     {* - контрольна€ сумма. }
   {$EndIf m3StoreHasCRC}
   ...
   rTOCItemListPosition: Int64;
     {* - указатель на позицию где в данном потоке находитс€ оглавление. }
   rRealSize: Int64;
     {* - реальный размер потока. }
   {$IfDef m3StoreHasGUID}
   rCLSID: TGUID;
     {* - GUID потока (дл€ поддержки идеологии Microsoft OLE). }
...
uses
 ...
 , m2COMLib
 , m3Exceptions
 //#UC START# *54071860020Eimpl_uses*
 //#UC END# *54071860020Eimpl_uses*
;
...
//#UC START# *54104EA90033_54071860020E_impl*
 ...
 // - это специально, чтобы ¬Ќќ¬№ созданный блок был модифицированным
