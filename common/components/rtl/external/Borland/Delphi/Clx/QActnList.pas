...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QActnList.pas initialization enter'); {$EndIf}
{$IFDEF MSWINDOWS}
...
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QActnList.pas initialization leave'); {$EndIf}
end.
