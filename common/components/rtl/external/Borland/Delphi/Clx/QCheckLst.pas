...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QCheckLst.pas initialization enter'); {$EndIf}

  GetCheckSize;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QCheckLst.pas initialization leave'); {$EndIf}
finalization
