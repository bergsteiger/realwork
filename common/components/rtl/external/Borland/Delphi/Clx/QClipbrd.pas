...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QClipbrd.pas initialization enter'); {$EndIf}
{$IFDEF MSWINDOWS}
...
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QClipbrd.pas initialization leave'); {$EndIf}
finalization
  FClipboard.Free;
