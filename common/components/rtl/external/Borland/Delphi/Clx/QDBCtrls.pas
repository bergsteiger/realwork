...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QDBCtrls.pas initialization enter'); {$EndIf}
  DB.DBScreen := TCLXScreenApplication.Create as IDBScreen;
  DB.DBApplication := DB.DBScreen as IDBApplication;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QDBCtrls.pas initialization leave'); {$EndIf}
finalization
  DB.DBScreen := nil;
