...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QDBPWDlg.pas initialization enter'); {$EndIf}
  DB.PasswordDialog := PasswordDialog;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QDBPWDlg.pas initialization leave'); {$EndIf}
finalization
