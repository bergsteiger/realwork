...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QExtCtrls.pas initialization enter'); {$EndIf}
  StartClassGroup(TControl);
  GroupDescendentsWith(TTimer, QControls.TControl);

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QExtCtrls.pas initialization leave'); {$EndIf}
finalization
{$ENDIF}
