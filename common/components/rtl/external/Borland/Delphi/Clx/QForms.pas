...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QForms.pas initialization enter'); {$EndIf}
  Classes.RegisterFindGlobalComponentProc(FindGlobalComponent);

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QForms.pas initialization leave'); {$EndIf}
finalization
