...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QGraphics.pas initialization enter'); {$EndIf}
  RegisterIntegerConsts(TypeInfo(TColor), IdentToColor, ColorToIdent);
  InitializeCriticalSection(CounterLock);
  PatternManager := TPatternManager.Create;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Clx\QGraphics.pas initialization leave'); {$EndIf}
finalization
  FileFormats.Free;
