...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Decision Cube\mxarrays.pas initialization enter'); {$EndIf}
  { determine available memory }
  AvailableMemory := GetAvailableMem;
  TotalAllocatedMemory := 0;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Decision Cube\mxarrays.pas initialization leave'); {$EndIf}
end.
