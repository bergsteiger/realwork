...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Decision Cube\mxdb.pas initialization enter'); {$EndIf}
  StartClassGroup(TControl);
  GroupDescendentsWith(TDecisionCube, TControl);
  GroupDescendentsWith(TDecisionSource, TControl);

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Decision Cube\mxdb.pas initialization leave'); {$EndIf}
end.
