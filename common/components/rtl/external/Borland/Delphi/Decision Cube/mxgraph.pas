...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Decision Cube\mxgraph.pas initialization enter'); {$EndIf}
  StartClassGroup(TControl);
  GroupDescendentsWith(TDecisionGraph, TControl);

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Decision Cube\mxgraph.pas initialization leave'); {$EndIf}
end.
