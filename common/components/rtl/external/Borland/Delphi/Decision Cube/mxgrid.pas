...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Decision Cube\mxgrid.pas initialization enter'); {$EndIf}
  StartClassGroup(TControl);
  GroupDescendentsWith(TDecisionGrid, TControl);

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Decision Cube\mxgrid.pas initialization leave'); {$EndIf}
end.
