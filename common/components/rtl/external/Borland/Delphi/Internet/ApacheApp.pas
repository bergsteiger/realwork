...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\ApacheApp.pas initialization enter'); {$EndIf}
  InitApplication;
  AddExitProc(DoneApplication);
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\ApacheApp.pas initialization leave'); {$EndIf}
end.
