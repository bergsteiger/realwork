...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\AutoAdap.pas initialization enter'); {$EndIf}
  InitScriptComServer;
...
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\AutoAdap.pas initialization leave'); {$EndIf}
end.
