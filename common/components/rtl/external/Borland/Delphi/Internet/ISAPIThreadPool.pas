...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\ISAPIThreadPool.pas initialization enter'); {$EndIf}
  ...
  NumberOfThreads := 25;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\ISAPIThreadPool.pas initialization leave'); {$EndIf}
finalization
  FreeAndNil(ThreadPool);
end.
