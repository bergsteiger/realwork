...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\IsapiStubApp.pas initialization enter'); {$EndIf}
  TISAPIStubFactory.Create;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\IsapiStubApp.pas initialization leave'); {$EndIf}
end.
