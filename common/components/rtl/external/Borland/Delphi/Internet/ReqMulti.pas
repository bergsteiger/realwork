...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\ReqMulti.pas initialization enter'); {$EndIf}
  RegisterContentParser(TMultipartContentParser);
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\ReqMulti.pas initialization leave'); {$EndIf}
end.
