...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\Sockets.pas initialization enter'); {$EndIf}
  Startup;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\Sockets.pas initialization leave'); {$EndIf}
finalization
  Cleanup;
{$ENDIF}
