...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\SvrHTTP.pas initialization enter'); {$EndIf}
  InitialializeRootDirVariable('DELPHI');  { do not localize }
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\SvrHTTP.pas initialization leave'); {$EndIf}
end.
