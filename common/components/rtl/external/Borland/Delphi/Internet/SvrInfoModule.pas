...
begin
  ...
  begin
    ...
    '<INPUT TYPE=HIDDEN NAME="ClassID" VALUE="%s"/><INPUT TYPE=SUBMIT VALUE="Clean"/></FORM>', { do not localize }
...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\SvrInfoModule.pas initialization enter'); {$EndIf}
  WebRequestHandler.WebModuleClass := TWebModule2;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\SvrInfoModule.pas initialization leave'); {$EndIf}
end.
