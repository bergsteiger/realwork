...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\WebAuto.pas initialization enter'); {$EndIf}
  InitScriptComServer;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\WebAuto.pas initialization leave'); {$EndIf}
finalization
