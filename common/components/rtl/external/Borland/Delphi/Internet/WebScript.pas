...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\WebScript.pas initialization enter'); {$EndIf}
  if ScriptSiteClass = nil then
...
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\WebScript.pas initialization leave'); {$EndIf}
finalization
