...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\cgiapp.pas initialization enter'); {$EndIf}
  InitApplication;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\cgiapp.pas initialization leave'); {$EndIf}
end.
