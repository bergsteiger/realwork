...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\ibmxmldom.pas initialization enter'); {$EndIf}
  IBMXML_DOM := TIBMDOMImplementationFactory.Create;
  RegisterDOMVendor(IBMXML_DOM);
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\ibmxmldom.pas initialization leave'); {$EndIf}
finalization
