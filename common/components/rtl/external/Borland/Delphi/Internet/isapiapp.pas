...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\isapiapp.pas initialization enter'); {$EndIf}
  InitApplication;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\isapiapp.pas initialization leave'); {$EndIf}
end.
