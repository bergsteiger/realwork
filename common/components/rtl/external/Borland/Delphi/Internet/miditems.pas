...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\miditems.pas initialization enter'); {$EndIf}
  XMLDataSetList := TList.Create;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\miditems.pas initialization leave'); {$EndIf}
finalization
  XMLDataSetList.Free;
  XMLDataSetList := nil;
end.
