...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\xmldom.pas initialization enter'); {$EndIf}
{$IFDEF MSWINDOWS}
...
{$ENDIF}  
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Internet\xmldom.pas initialization leave'); {$EndIf}
finalization
