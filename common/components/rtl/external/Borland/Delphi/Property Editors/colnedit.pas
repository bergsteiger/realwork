...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Property Editors\colnedit.pas initialization enter'); {$EndIf}
  RegisterPropertyEditor(TypeInfo(TCollection), nil, '', TCollectionProperty);

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Property Editors\colnedit.pas initialization leave'); {$EndIf}
finalization
