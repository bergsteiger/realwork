...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Property Editors\dbinpreq.pas initialization enter'); {$EndIf}
  InputReqClass := TInputReqClass.Create;
  RegisterBDEInitProc(InitProc);
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Property Editors\dbinpreq.pas initialization leave'); {$EndIf}
finalization
  InputReqClass.Free;
end.
