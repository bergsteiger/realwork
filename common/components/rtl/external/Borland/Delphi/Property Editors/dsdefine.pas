...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Property Editors\dsdefine.pas initialization enter'); {$EndIf}
  RegisterFieldsProc := RegFields;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Property Editors\dsdefine.pas initialization leave'); {$EndIf}
end.
