...
{$IFDEF MSWINDOWS}
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Property Editors\dsdesign.pas initialization enter'); {$EndIf}
  RegisterDragTarget(TDragFields.ClassName, TFieldsTarget);
{$ENDIF}
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Property Editors\dsdesign.pas initialization leave'); {$EndIf}
end.
