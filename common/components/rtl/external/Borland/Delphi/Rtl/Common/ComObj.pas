...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Common\ComObj.pas initialization enter'); {$EndIf}
begin
  LoadComExProcs;
...
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Common\ComObj.pas initialization leave'); {$EndIf}
finalization
begin
