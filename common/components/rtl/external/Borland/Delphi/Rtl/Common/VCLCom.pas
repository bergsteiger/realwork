...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Common\VCLCom.pas initialization enter'); {$EndIf}
  CreateVCLComObjectProc := CreateVCLComObject;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Common\VCLCom.pas initialization leave'); {$EndIf}
finalization
