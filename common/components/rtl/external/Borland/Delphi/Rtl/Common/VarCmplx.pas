...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Common\VarCmplx.pas initialization enter'); {$EndIf}
  ComplexVariantType := TComplexVariantType.Create;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Common\VarCmplx.pas initialization leave'); {$EndIf}
finalization
