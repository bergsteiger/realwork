...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Common\VarConv.pas initialization enter'); {$EndIf}
  ConvertVariantType := TConvertVariantType.Create;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Common\VarConv.pas initialization leave'); {$EndIf}
finalization
