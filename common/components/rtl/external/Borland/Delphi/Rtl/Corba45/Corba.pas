...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Corba45\Corba.pas initialization enter'); {$EndIf}
  IsMultiThread := True;  // Make memory manager thread safe
  InterfaceIDManager := TInterfaceIDManager.Create;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Corba45\Corba.pas initialization leave'); {$EndIf}
finalization
