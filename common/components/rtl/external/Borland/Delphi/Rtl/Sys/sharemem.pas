...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Sys\sharemem.pas initialization enter'); {$EndIf}
  if not IsMemoryManagerSet then
    InitMemoryManager;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Sys\sharemem.pas initialization leave'); {$EndIf}
end.
