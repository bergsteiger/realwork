...
{$IF Declared(GPL)}
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Sys\sysinit.pas initialization enter'); {$EndIf}
...
{$IFEND}
{$ENDIF}
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Sys\sysinit.pas initialization leave'); {$EndIf}
end.
