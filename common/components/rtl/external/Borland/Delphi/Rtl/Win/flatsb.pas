...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Win\flatsb.pas initialization enter'); {$EndIf}
  InitFlatSB;
  
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Win\flatsb.pas initialization leave'); {$EndIf}
end.
