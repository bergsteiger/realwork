...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Win\multimon.pas initialization enter'); {$EndIf}
  InitMultiMonStubs;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Rtl\Win\multimon.pas initialization leave'); {$EndIf}
end.
