...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\ShellControls\ShellCtrls.pas initialization enter'); {$EndIf}

  CreateDesktopFolder;
  InitializeCriticalSection(CS);
  OleInitialize(nil);
  
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\ShellControls\ShellCtrls.pas initialization leave'); {$EndIf}
finalization
