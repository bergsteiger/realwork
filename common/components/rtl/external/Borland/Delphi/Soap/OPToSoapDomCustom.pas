...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Soap\OPToSoapDomCustom.pas initialization enter'); {$EndIf}
   ConverterRegistry := TOPToSoapDomCustomRegistry.Create;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Soap\OPToSoapDomCustom.pas initialization leave'); {$EndIf}
finalization
