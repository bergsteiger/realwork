...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Soap\TypeTrans.pas initialization enter'); {$EndIf}
  TypeTranslator := TTypeTranslator.Create;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Soap\TypeTrans.pas initialization leave'); {$EndIf}
finalization
  TypeTranslator.Free;
