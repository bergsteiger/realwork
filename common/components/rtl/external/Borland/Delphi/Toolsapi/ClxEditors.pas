...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Toolsapi\ClxEditors.pas initialization enter'); {$EndIf}
  NotifyGroupChange(UnregisterActionGroup);

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Toolsapi\ClxEditors.pas initialization leave'); {$EndIf}
finalization
