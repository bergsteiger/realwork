...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Toolsapi\TreeIntf.pas initialization enter'); {$EndIf}
  NotifyGroupChange(FlushSprigTypes);

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Toolsapi\TreeIntf.pas initialization leave'); {$EndIf}
finalization
