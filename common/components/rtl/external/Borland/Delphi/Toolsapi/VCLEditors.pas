...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Toolsapi\VCLEditors.pas initialization enter'); {$EndIf}
  CF_COMPONENTS := RegisterClipboardFormat('Delphi Components');
  NotifyGroupChange(UnregisterActionGroup);

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Toolsapi\VCLEditors.pas initialization leave'); {$EndIf}
finalization
