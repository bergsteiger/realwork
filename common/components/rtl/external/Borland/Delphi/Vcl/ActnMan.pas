...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\ActnMan.pas initialization enter'); {$EndIf}
  ActionBarStyles := nil;
  GroupDescendentsWith(TCustomActionBarColorMap, TControl);
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\ActnMan.pas initialization leave'); {$EndIf}
end.
