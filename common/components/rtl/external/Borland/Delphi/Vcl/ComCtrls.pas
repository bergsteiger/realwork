...
begin
  if (csLoading in ComponentState) or
     (csDestroying in ComponentState) or {V}
...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\ComCtrls.pas initialization enter'); {$EndIf}

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\ComCtrls.pas initialization leave'); {$EndIf}
finalization
