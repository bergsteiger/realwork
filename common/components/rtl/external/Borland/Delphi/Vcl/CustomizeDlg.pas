...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\CustomizeDlg.pas initialization enter'); {$EndIf}
  GroupDescendentsWith(TCustomizeDlg, Controls.TControl);

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\CustomizeDlg.pas initialization leave'); {$EndIf}
end.
