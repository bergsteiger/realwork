...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\FMTBcd.pas initialization enter'); {$EndIf}
  FMTBcdVariantType := TFMTBcdVariantType.Create;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\FMTBcd.pas initialization leave'); {$EndIf}
finalization
