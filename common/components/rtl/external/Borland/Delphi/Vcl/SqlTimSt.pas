...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\SqlTimSt.pas initialization enter'); {$EndIf}
  SQLTimeStampVariantType := TSQLTimeStampVariantType.Create;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\SqlTimSt.pas initialization leave'); {$EndIf}
finalization
