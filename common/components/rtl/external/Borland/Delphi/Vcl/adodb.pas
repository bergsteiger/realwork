...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\adodb.pas initialization enter'); {$EndIf}
  OleCheck(CoGetMalloc(1, GlobalMalloc));
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\adodb.pas initialization leave'); {$EndIf}
finalization
  GlobalMalloc := nil;
end.
