...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\axctrls.pas initialization enter'); {$EndIf}
  TPicture.RegisterFileFormat('', '', TOleGraphic);
  InitOlePro32;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\axctrls.pas initialization leave'); {$EndIf}
finalization
