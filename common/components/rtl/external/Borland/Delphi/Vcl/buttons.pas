...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\buttons.pas initialization enter'); {$EndIf}
  FillChar(BitBtnGlyphs, SizeOf(BitBtnGlyphs), 0);
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\buttons.pas initialization leave'); {$EndIf}
finalization
  DestroyLocals;
end.
