...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\checklst.pas initialization enter'); {$EndIf}
  GetCheckSize;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\checklst.pas initialization leave'); {$EndIf}
end.
