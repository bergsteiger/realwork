...
resourcestring
  ...
  SMsgDlgRetry    = 'Пов&торить';          //'&Retry';
  SMsgDlgIgnore   = '&Игнорировать';       //'&Ignore';
  SMsgDlgAll      = '&Все';                //'&All';
  SMsgDlgNoToAll  = '&Нет для всех';       //'N&o to All';
  SMsgDlgYesToAll = '&Да для всех';        //'Yes to &All';
  ...
  SmkcCtrl = 'Ctrl+';
  SmkcAlt = 'Alt+';
  SmkcApps = 'Apps'; {migel: VK_APPS support}
