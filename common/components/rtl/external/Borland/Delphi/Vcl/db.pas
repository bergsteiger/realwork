...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\db.pas initialization enter'); {$EndIf}
  DBScreen := TDefaultDBScreenApplication.Create as IDBScreen;
  DBApplication := DBScreen as IDBApplication;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\db.pas initialization leave'); {$EndIf}
end.
