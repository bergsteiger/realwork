...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\dbctrls.pas initialization enter'); {$EndIf}
  DB.DBScreen := TVCLScreenApplication.Create as IDBScreen;
  DB.DBApplication := DB.DBScreen as IDBApplication;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\dbctrls.pas initialization leave'); {$EndIf}
finalization
  DB.DBScreen := nil;
