...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\dbpwdlg.pas initialization enter'); {$EndIf}
  DB.PasswordDialog := PasswordDialog;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\dbpwdlg.pas initialization leave'); {$EndIf}
finalization
