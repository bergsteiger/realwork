...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\dsintf.pas initialization enter'); {$EndIf}
  InitializeCriticalSection(Loading);
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\dsintf.pas initialization leave'); {$EndIf}
finalization
{$IFDEF MSWINDOWS}
