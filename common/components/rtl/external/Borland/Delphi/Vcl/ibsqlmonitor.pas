...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\ibsqlmonitor.pas initialization enter'); {$EndIf}
...
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\ibsqlmonitor.pas initialization leave'); {$EndIf}
finalization
  try
    bDone := True;
    if Assigned(FReaderThread) then
