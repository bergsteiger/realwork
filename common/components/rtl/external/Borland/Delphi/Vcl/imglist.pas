...
{ TCustomImageList }
  ...
  public
    ...
    function IsSmart: Boolean; {V}
      virtual;
      {-}
    function ImageExtent(anIndex: Integer): TPoint;  {V}
      virtual;
      {-}
...
function TCustomImageList.IsSmart: Boolean; {V}
  //virtual;
  {-}
begin               
 Result := false;
...
function TCustomImageList.ImageExtent(anIndex: Integer): TPoint; {V}
  //virtual;
  {-}
begin
 Result.X := Width;
