...
{ TCustomMaskEdit }
  ...
  protected
    ...
    function TextFromClipboard: String; virtual; {V}
...
function TCustomMaskEdit.TextFromClipboard: String; {V}
begin
 Clipboard.Open;
...
procedure TCustomMaskEdit.GetSel(var SelStart: Integer; var SelStop: Integer); {V}
var
 lResult : HResult;
begin
  lResult := SendMessage(Handle, EM_GETSEL, 0, 0);
  SelStart := LoWord(lResult);
  SelStop  := HiWord(lResult);
