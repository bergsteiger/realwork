...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\oleauto.pas initialization enter'); {$EndIf}
begin
  OleInitialize(nil);
...
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\oleauto.pas initialization leave'); {$EndIf}
finalization
begin
  Automation.Free;
  OleUninitialize;
