...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\olectnrs.pas initialization enter'); {$EndIf}
  OleInitialize(nil);
  Initialize;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\olectnrs.pas initialization leave'); {$EndIf}
finalization
  OleUninitialize;
end.
