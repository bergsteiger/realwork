...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\olectrls.pas initialization enter'); {$EndIf}
  GroupDescendentsWith(TOleControl, Controls.TControl);
  EmptyParam := Variants.EmptyParam;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\olectrls.pas initialization leave'); {$EndIf}
end.
