...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\oleserver.pas initialization enter'); {$EndIf}
  GroupDescendentsWith(TOleServer, Controls.TControl);
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\oleserver.pas initialization leave'); {$EndIf}
end.
