...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\svcmgr.pas initialization enter'); {$EndIf}
  InitApplication;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Vcl\svcmgr.pas initialization leave'); {$EndIf}
finalization
  DoneApplication;
end.
