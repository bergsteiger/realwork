...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\DBAdaptImg.pas initialization enter'); {$EndIf}
  DataSetAdapterImageFieldClass := TDataSetAdapterImageField;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\DBAdaptImg.pas initialization leave'); {$EndIf}
end.
