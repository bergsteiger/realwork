...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\MidItems.pas initialization enter'); {$EndIf}
  XMLDataSetList := TList.Create;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\MidItems.pas initialization leave'); {$EndIf}
finalization
  XMLDataSetList.Free;
  XMLDataSetList := nil;
end.
