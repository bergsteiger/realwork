...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\ReqMulti.pas initialization enter'); {$EndIf}
  RegisterContentParser(TMultipartContentParser);
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\ReqMulti.pas initialization leave'); {$EndIf}
end.
