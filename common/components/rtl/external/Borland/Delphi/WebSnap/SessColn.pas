...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\SessColn.pas initialization enter'); {$EndIf}
  if Sessions = nil then
    Sessions := TSessions.Create;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\SessColn.pas initialization leave'); {$EndIf}
finalization
  FreeAndNil(Sessions);
end.
