...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\SiteComp.pas initialization enter'); {$EndIf}
  WebCntxt.GetWebEndUserProc := GetWebEndUser;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\SiteComp.pas initialization leave'); {$EndIf}
end.
