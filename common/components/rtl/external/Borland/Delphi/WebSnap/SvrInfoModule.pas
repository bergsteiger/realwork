...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\SvrInfoModule.pas initialization enter'); {$EndIf}
  WebRequestHandler.WebModuleClass := TWebModule2;

{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\SvrInfoModule.pas initialization leave'); {$EndIf}
end.
