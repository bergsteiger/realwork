...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\WebScript.pas initialization enter'); {$EndIf}
  if ScriptEnginesList = nil then
    TScriptEnginesList.Create;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\WebScript.pas initialization leave'); {$EndIf}
finalization
