...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\WebScriptAS.pas initialization enter'); {$EndIf}
  ActiveScriptEngine := TActiveScriptEngine.Create;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\WebSnap\WebScriptAS.pas initialization leave'); {$EndIf}
finalization
