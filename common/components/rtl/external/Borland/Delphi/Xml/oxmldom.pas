...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Xml\oxmldom.pas initialization enter'); {$EndIf}
  OpenXMLFactory := TOXDOMImplementationFactory.Create;
  RegisterDOMVendor(OpenXMLFactory);
  InitParserLanguage;
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Xml\oxmldom.pas initialization leave'); {$EndIf}
finalization
{$IFDEF MSWINDOWS}
