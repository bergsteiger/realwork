...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Xml\xercesxmldom.pas initialization enter'); {$EndIf}
  XercesDOM := TXercesDOMImplementationFactory.Create(SXercesXML, SXercesLibName);
  RegisterDOMVendor(XercesDOM);
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\rtl\external\Borland\Delphi\Xml\xercesxmldom.pas initialization leave'); {$EndIf}
finalization
