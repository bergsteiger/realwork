...
uses
  ...
  ElTree, ElTools, StdCtrls, ElHeader, ElVCLUtils, ElTreeStdEditors,
...
begin
  ComboBox := InplaceCombo.Editor;
  TComboBox(Combobox).Style := csDropDownList;
