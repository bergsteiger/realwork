...
USEFORMNS("Design\frmStyleImageSelect.pas", frmStyleImageSelect, TStyleImageSelectForm);
USEFORMNS("Design\ElStyleManProp.pas", ElStyleManProp, TStyleManEditDialog);
USEUNIT("ElReg.pas");
