...
begin
  case Msg.Msg of
    WM_CREATE:
      if (Control<>nil) and (Control is TWinControl) and UseXPThemes and ThemesAvailable then
        CreateThemeHandle;
    WM_NCCALCSIZE:
      begin
...
begin
  case Msg.Msg of
    ...
    EL_THEMECHANGED:
      begin
        if ThemesAvailable and UseXPThemes and (Control<>nil) and (Control is TWinControl) then
        begin
          FreeThemeHandle;
          CreateThemeHandle;
          SetWindowPos(
