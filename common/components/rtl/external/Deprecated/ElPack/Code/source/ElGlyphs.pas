...
type
  ...
  public
    ...
    function CalcButtonWidth(Canvas : TCanvas; var MaxHeight : integer; const
        ...
        : integer; ShowAccelChar : boolean{$ifdef HAS_HTML_RENDER}; IsHTML : boolean; HTMLRender : TElHTMLRender{$endif}): Integer;
...
procedure TElButtonGlyph.CalcButtonLayout(Canvas : TCanvas; const Client :
    ...
    integer; UseThemesForText : boolean; Theme : HTheme; ThemePart, ThemeState
    : integer; ShowAccelChar : boolean{$ifdef HAS_HTML_RENDER};  IsHTML : boolean; HTMLRender : TElHTMLRender{$endif});
var
  TextPos : TPoint;
...
begin
  CalcButtonLayout(Canvas, Client, Offset, Caption, Layout, Margin, Spacing,
    ...
    Theme, ThemePart, ThemeState, ShowAccelChar {$ifdef HAS_HTML_RENDER}, IsHTML, HTMLRender{$endif});
  if ShowGlyph then
