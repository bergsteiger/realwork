...
07/06/2003
  ...
  BorderColor* properties added. They control the colors of thumb area border.

02/10/2003

  Fixed FocusRect coloring

12/24/2002

  Improved drawing to handle fbtColorLineBorder for thumb and track line
...
type
    ...
    published
      ...
      property ThumbActiveBorderType: TElFlatBorderType read FThumbActiveBorderType
          write SetThumbActiveBorderType default fbtSunken;
...
procedure TElTrackBar.SetHint(Value: TElFString);
var S : String;
    i,
    l : integer;
    T : WideChar;
