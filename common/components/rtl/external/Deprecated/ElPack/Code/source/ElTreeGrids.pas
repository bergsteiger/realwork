...
12/31/2002
  ...
  Fixed handling of hidden columns and rows when navigating through the grid
  Added OnRowAdded event

10/31/2002

  Added CLX compatibility
  Improved Tab, Shift-Tab and arrow keys behaviour

09/19/2002

  Up and Down arrow keys move focus to other item when inplace editor is active.
  Published Virtuality properties and events
...
{$endif}
     ...
     protected
       ...
       function GetIncSearchColumnText(Item : TElTreeItem): TElFString; override;
     public
       constructor Create(Owner : TComponent); override;
