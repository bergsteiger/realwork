...
08/22/2002
  ...
  Fixed an AV that happened when printing the tree without columns

08/05/2002

  Leftmost vertical line is drawn now
  Fixed a bug when additional cells used font styles and colors of main tree cell
...
{$endif}
  ...
  published
      ...
      property ShowInvisibleSections: Boolean read FShowInvisibleSections write
          SetShowInvisibleSections default false;
...
{$endif}
    begin
      ...
      TextFlags := TextFlags or DT_NOPREFIX
{$ifndef LITE}
      or MultiLineFlags[Item.Multiline] or
