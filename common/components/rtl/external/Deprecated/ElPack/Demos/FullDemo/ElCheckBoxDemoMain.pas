...
type
  TElCheckBoxDemoMainForm = class(TForm)
    ...
    Label2: TLabel;
    ElCheckBoxAlignmentCombo: TElComboBox;
...
procedure TElCheckBoxDemoMainForm.ElCheckBoxAlignmentComboChange(
  Sender: TObject);
begin
  sampleElCheckBox.CheckAlignment := TLeftRight(ElCheckBoxAlignmentCombo.ItemIndex);
end;
