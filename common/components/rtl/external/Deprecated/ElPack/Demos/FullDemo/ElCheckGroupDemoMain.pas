...
type
  TElCheckGroupDemoMainForm = class(TForm)
    ...
    Label1: TLabel;
    Label6: TLabel;
    ElCheckGroupImageTypeCombo: TElComboBox;
    ...
    procedure ElCheckGroupShowCheckBoxCBClick(Sender: TObject);
  private
...
procedure TElCheckGroupDemoMainForm.ElCheckGroupShowCheckBoxCBClick(
  Sender: TObject);
begin
  sampleElCheckGroup.ShowCheckBox := ElCheckGroupShowCheckBoxCB.Checked;
end;
