...
uses
  ...
  ElXPThemedControl, ImgList, ElEdits, ElCombos;
...
type
  TElPopupButtonDemoMainForm = class(TForm)
    ...
    Label2: TLabel;
    ElPopupButtonGlyphLayoutCombo: TElComboBox;
    Label1: TLabel;
    ...
    Label3: TLabel;
    ElPopupButtonImageTypeCombo: TElComboBox;
    Label6: TLabel;
