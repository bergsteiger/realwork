...
uses
  ...
  ElXPThemedControl, ElScrollBar, ElImgFrm, StdCtrls, ElSpin,
  ElVCLUtils, ElBtnCtl, ElStrUtils, ElCheckCtl, ExtCtrls, ElPanel,
  ElGroupBox, ElClrCmb, ElEdits, ElBtnEdit, ElCombos, ElSBCtrl;
...
type
  TElScrollBarDemoMainForm = class(TForm)
    ...
    ElScrollBarOrientationCombo: TElComboBox;
    Label3: TLabel;
    ElScrollBarFlatCB: TElCheckBox;
    ElScrollBarActiveFlatCB: TElCheckBox;
    ElScrollBarSecondaryButtonsCombo: TElComboBox;
...
begin
  SampleElScrollBar.ShowBorder := ElScrollBarDrawFramesCB.Checked;
  ElScrollBarDrawArrowFramesCB.Checked := SampleElScrollBar.DrawArrowFrames;
  ElScrollBarFlatCB.Enabled := SampleElScrollBar.ShowBorder;
...
procedure TElScrollBarDemoMainForm.ElScrollBarThinFramesCBClick(
  Sender: TObject);
begin
  sampleElScrollBar.ThinFrame := ElScrollBarthinFramesCB.Checked;
end;
