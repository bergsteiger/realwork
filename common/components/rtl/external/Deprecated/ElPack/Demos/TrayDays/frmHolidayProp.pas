...
uses
  ...
  StdCtrls, ExtCtrls, ElPopBtn, ElCalendar, ElBtnCtl, ElCheckCtl,
  ElCalendarDefs, ElXPThemedControl, ElEdits, ElBtnEdit, ElCombos;
...
type
  THolidayPropForm = class(TForm)
    ...
    Panel2: TPanel;
    Label9: TLabel;
    FloatDayCombo: TElComboBox;
    FloatDOWCombo: TElComboBox;
    FloatMonthCombo: TElComboBox;
    FloatDateRB: TElRadioButton;
    Panel3: TPanel;
    Label2: TLabel;
    FixedDayCombo: TElComboBox;
    FixedMonthCombo: TElComboBox;
    FixedDateRB: TElRadioButton;
    DescriptionEdit: TElEdit;
    Label1: TLabel;
