...
{ $Id: RxCombos.pas,v 1.1 2007/12/05 15:37:45 lulin Exp $}

// $Log: RxCombos.pas,v $
// Revision 1.1  2007/12/05 15:37:45  lulin
...
begin
  ...
  with Canvas do begin
    if odDisabled in State then
     DrawColor := clGrayText
    else
     DrawColor := TColor(Items.Objects[Index]);
    FillRect(Rect);
    Safer := Brush.Color;
    Pen.Color := ColorToBorderColor(ColorToRGB(DrawColor));
