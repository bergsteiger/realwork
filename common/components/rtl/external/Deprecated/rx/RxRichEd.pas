...
{$ENDIF}
  ...
  if RichEditVersion >= 2 then Mask := Mask or ENM_LINK or ENM_MOUSEEVENTS;
         ...
         WM_RBUTTONUP:
          begin
           ...
           begin
            ...
            X.Lo := lP.X;
            X.Hi := lP.Y;
            PostMessage(Self.Handle, WM_CONTEXTMENU, Self.Handle, Longint(X));
           end;
          end;
        end;
       end;
...
procedure TRxCustomRichEdit.WMContextMenu(var Message: TWMContextMenu);
begin
 inherited;
end;
