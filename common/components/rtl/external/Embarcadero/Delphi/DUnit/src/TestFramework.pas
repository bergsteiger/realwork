{#(@)$Id: TestFramework.pas,v 1.2 2013/05/24 13:30:11 lulin Exp $ }
...
const
  rcs_id: string = '#(@)$Id: TestFramework.pas,v 1.2 2013/05/24 13:30:11 lulin Exp $';
  rcs_version : string = '$Revision: 1.2 $';
...
{$ENDIF}
  {$IFNDEF CLR}
  //SysDebug('CreateRegistry: %s',[MyName]);
  {$ENDIF !CLR}
