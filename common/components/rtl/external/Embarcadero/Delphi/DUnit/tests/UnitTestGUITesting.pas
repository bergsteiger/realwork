{ #(@)$Id: UnitTestGUITesting.pas,v 1.2 2013/05/24 13:30:13 lulin Exp $ }
{: DUnit: An XTreme testing framework for Delphi programs.
   @author  The DUnit Group.
   @version $Revision: 1.2 $ uberto 08/03/2001
}
(*
...
const
  rcs_id: string = '#(@)$Id: UnitTestGUITesting.pas,v 1.2 2013/05/24 13:30:13 lulin Exp $';
