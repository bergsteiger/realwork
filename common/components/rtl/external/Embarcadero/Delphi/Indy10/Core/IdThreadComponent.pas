{
  ...
  $Revision: 1.2 $
  $DateUTC$
  $Id: IdThreadComponent.pas,v 1.2 2013/05/24 13:30:14 lulin Exp $
...
}
{
  ...
  2002-05-03 -Andrew P.Rybin
   -StÈphane GrobÈty (Fulgan) suggestion: component is Data owner, don't FreeAndNIL Data property
