{
  ...
  $Revision: 1.2 $
  $DateUTC$
  $Id: IdDNSServer.pas,v 1.2 2013/05/24 13:30:16 lulin Exp $
  ...
  $Log: IdDNSServer.pas,v $
  Revision 1.2  2013/05/24 13:30:16  lulin
  - Á‡ÎË‚‡ÂÏ ËÒıÓ‰ÌËÍË XE4.
  ...
  instead of ToBytes() and AppendBytes().
    ...
    Rev 1.37    2005/1/25 §U§» 12:25:26  DChang
  Modify UpdateTree method, make the NS record can be save in the lower level
  node.


    Rev 1.36    2005/1/5 §U§» 04:21:06  DChang    Version: 1.36
  ...
  will be treated as TXT message.
    ...
    Rev 1.35    2004/12/15 §U§» 12:05:26  DChang    Version: 1.35
  ...
  Removed local variable from TIdDNS_ProcessThread.SendData(), not needed
    ...
    Rev 1.26    2004/7/21 §U§» 06:37:48  DChang
  ...
  to comments in TIdDNS_ProcessThread.SaveToCache.
    ...
    Rev 1.25    2004/7/19 §U§» 09:55:52  DChang
  ...
  Compile todos
    ...
    Rev 1.10    2003/5/14 §W§» 01:17:36  DChang
  ...
  to RRName.
    ...
    Rev 1.9    2003/5/10 §W§» 01:09:42  DChang
  Patch the domainlist update when axfr action.


    Rev 1.8    2003/5/9 §W§» 10:03:36  DChang
  ...
  mail host A record can be additional record section.
    ...
    Rev 1.7    2003/5/8 §U§» 08:11:34  DChang
  ...
  necessary.
    ...
    Rev 1.6    2003/5/2 §U§» 03:39:38  DChang
