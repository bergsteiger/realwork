{
  ...
  $Revision: 1.2 $
  $DateUTC$
  $Id: IdFTPListParseMPEiX.pas,v 1.2 2013/05/24 13:30:16 lulin Exp $
...
begin
  ...
  LCols := TStringList.Create;
  try
    //According to "HP ARPA File Transfer Protocol, UserТs Guide, HP 3000 MPE/iX Computer Systems,Edition 6"
