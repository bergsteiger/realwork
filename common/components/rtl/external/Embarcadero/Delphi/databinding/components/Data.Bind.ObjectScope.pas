...
{ TBindFieldDef }
  ...
  protected
    ...
    class function CreateRttiPropertyField<T>(AProperty: TRttiProperty; ABindSourceAdapter: TBindSourceAdapter;
      const AGetMemberObject: IGetMemberObject; AMemberType: TScopeMemberType): TBindSourceAdapterField;
  ...
  private
    ...
    class function CreateField<T>(AFieldDef: TGeneratorFieldDef;
      ABindSourceAdapter: TBindSourceAdapter;
      const AGetMemberObject: IGetMemberObject): TBindSourceAdapterField; static;
...
begin
  if (AForce or AutoEdit) and not(State in [seEdit, seInsert]) then // and not Inserting then
  begin
...
class function TCustomDataGeneratorAdapter.CreateField<T>(AFieldDef: TGeneratorFieldDef; ABindSourceAdapter: TBindSourceAdapter;
  const AGetMemberObject: IGetMemberObject): TBindSourceAdapterField;
var
  LTypeInfo: PTypeInfo;
begin
