...
begin
  ...
  if not(csDesigning in AControl.ComponentState) then
    ...
    begin
      AControl.Touch.GestureEngine := TIOSGestureEngine.GetGestureEngine(AControl);
    end;
end;
...
class function TPlatformGestureEngine.IsGesture(const Points: array of TPointF; const Items: TGestureList; GestureTypes: TGestureTypes; var EventInfo: TGestureEventInfo): Boolean;
var
...
constructor TIOSGestureEngine.Create(const AControl: TFmxObject);
begin
  inherited;
end;
...
function TGestureRecognizer.IsPointsGesture(const Points, GesturePoints: array of TPointF; GestureID: TGestureID; Deviation, ErrorMargin: Integer; var Percentages: array of Double): Integer;
...
function TGestureRecognizer.Match(const Points, GesturePoints: array of TPointF; const Options: TGestureOptions; GestureID: TGestureID; Deviation, ErrorMargin: Integer): Single;
var
...
function TGestureRecognizer.RotatePoints(const Points, GesturePoints: array of TPointF; ErrorMargin: Integer; var Angle: Double): TGesturePointArray;
...
function TGestureRecognizer.ScalePoints(const Points, GesturePoints: array of TPointF; MinScale: Integer; Scaling: Boolean): TGesturePointArray;
var
  Index: Integer;
