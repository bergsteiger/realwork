...
uses System.UIConsts, System.Math, System.RTLConsts, FMX.Import,
  ...
  begin
    ...
    try
      ...
      begin
        ...
        begin
          B := Path.FlattenToPolygon(VP, FFlatness / Factor);
          ...
          begin
            ...
            begin
              Context.FillPolygon(Vector3D(Width / 2, Height / 2, 0), Vector3D(RectWidth(r) / Factor, RectHeight(r) / Factor,
                Depth), RectF(0, 0, 0, 0), VP, TMaterialSource.ValidMaterial(MaterialSource), AbsoluteOpacity, False, True, False);
            end;
            { back }
            if TExtrudedShapeSide.esBack in FSides then
            begin
              Context.FillPolygon(Vector3D(Width / 2, Height / 2, 0), Vector3D(RectWidth(r) / Factor, RectHeight(r) / Factor,
                Depth), RectF(0, 0, 0, 0), VP, TMaterialSource.ValidMaterial(MaterialBackSource), AbsoluteOpacity, True, False, False);
            end;
            { left }
            if TExtrudedShapeSide.esShaft in FSides then
            begin
              Context.FillPolygon(Vector3D(Width / 2, Height / 2, 0), Vector3D(RectWidth(r) / Factor, RectHeight(r) / Factor,
                Depth), RectF(0, 0, 0, 0), VP, TMaterialSource.ValidMaterial(MaterialShaftSource), AbsoluteOpacity, False, False, True);
            end;
          end;
        end;
      end
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              Context.FillPolygon(Vector3D(Width / 2, Height / 2, 0), Vector3D(RectWidth(r) / Factor, RectHeight(r) / Factor,
                Depth), r, VP, TMaterialSource.ValidMaterial(MaterialSource), AbsoluteOpacity, False, True, False);
            end;
            { back }
            if TExtrudedShapeSide.esBack in FSides then
            begin
              Context.FillPolygon(Vector3D(Width / 2, Height / 2, 0), Vector3D(RectWidth(r) / Factor, RectHeight(r) / Factor,
                Depth), r, VP, TMaterialSource.ValidMaterial(MaterialBackSource), AbsoluteOpacity, True, False, False);
            end;
            { left }
            if TExtrudedShapeSide.esShaft in FSides then
            begin
              Context.FillPolygon(Vector3D(Width / 2, Height / 2, 0), Vector3D(RectWidth(r) / Factor, RectHeight(r) / Factor,
                Depth), r, VP, TMaterialSource.ValidMaterial(MaterialShaftSource), AbsoluteOpacity, False, False, True);
            end;
          end;
        end;
      end;
