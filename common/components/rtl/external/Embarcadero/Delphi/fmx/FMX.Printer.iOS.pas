...
// TODO -odtotoliciu -cImplement: function Equals
...
// TODO -odtotoliciu -cInvestigate: The canvas should have been created in GetCanvas
...
// TODO -odtotoliciu -cInvestigate: Using FCanvas avoids application hanging;
...
var
  ...
  Ok: Boolean;
begin
 TODO -odtotoliciu -cInvestigate: It would also work using PMPaperGetMargins() which directly returns the margins
  PMSessionValidatePageFormat(PrintInfo.PMPrintSession, PrintInfo.PMPageFormat, @Ok);
...
// TODO -odtotoliciu -cImplement: Store in Driver the ReleaseInfo, too
