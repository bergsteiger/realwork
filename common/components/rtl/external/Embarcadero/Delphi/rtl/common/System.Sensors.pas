...
// region monitoring will not work
  ...
  private class var
    ...
    class function GetProtectedGpsStatusImplementer: TGpsStatusClass;
  protected
...
class function TGpsStatus.GetProtectedGpsStatusImplementer: TGpsStatusClass;
begin
  Result := GetGpsStatusImplementer;
end;
