...
uses
  Macapi.ObjectiveC, iOSapi.CocoaTypes, Macapi.CoreFoundation, iOSapi.Foundation,
...
procedure GLKMatrix3MultiplyVector3Array(matrix: GLKMatrix3; vectors: PGLKVector3; vectorCount: Longword); cdecl; external libGLKit name _PU + 'GLKMatrix3MultiplyVector3Array';
...
procedure GLKMatrix4MultiplyAndProjectVector3Array(matrix: GLKMatrix4; vectors: PGLKVector3; vectorCount: Longword); cdecl; external libGLKit name _PU + 'GLKMatrix4MultiplyAndProjectVector3Array';
...
procedure GLKMatrix4MultiplyVector3Array(matrix: GLKMatrix4; vectors: PGLKVector3; vectorCount: Longword); cdecl; external libGLKit name _PU + 'GLKMatrix4MultiplyVector3Array';
procedure GLKMatrix4MultiplyVector3ArrayWithTranslation(matrix: GLKMatrix4; vectors: PGLKVector3; vectorCount: Longword); cdecl; external libGLKit name _PU + 'GLKMatrix4MultiplyVector3ArrayWithTranslation';
...
procedure GLKMatrix4MultiplyVector4Array(matrix: GLKMatrix4; vectors: PGLKVector4; vectorCount: Longword); cdecl; external libGLKit name _PU + 'GLKMatrix4MultiplyVector4Array';
...
procedure GLKQuaternionRotateVector3Array(quaternion: GLKQuaternion; vectors: PGLKVector3; vectorCount: Longword); cdecl; external libGLKit name _PU + 'GLKQuaternionRotateVector3Array';
...
procedure GLKQuaternionRotateVector4Array(quaternion: GLKQuaternion; vectors: PGLKVector4; vectorCount: Longword); cdecl; external libGLKit name _PU + 'GLKQuaternionRotateVector4Array';
