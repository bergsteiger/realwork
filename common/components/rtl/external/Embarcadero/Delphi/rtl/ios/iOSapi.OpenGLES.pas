...
uses Macapi.ObjCRuntime, Macapi.ObjectiveC, iOSapi.Foundation, iOSapi.CocoaTypes;
//  iOSapi.ObjCRuntime,
//  iOSapi.ObjectiveC,
//  iOSapi.CocoaTypes,
//  iOSapi.IOKit;
...
procedure EAGLGetVersion(major: Punsigned; minor: Punsigned); cdecl; external libOpenGLES name _PU + 'EAGLGetVersion';
