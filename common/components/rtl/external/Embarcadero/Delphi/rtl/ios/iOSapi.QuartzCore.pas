...
function CATransform3DMakeRotation(angle: Single; x: Single; y: Single; z: Single): CATransform3D; cdecl; external libQuartzCore name _PU + 'CATransform3DMakeRotation';
function CATransform3DMakeScale(sx: Single; sy: Single; sz: Single): CATransform3D; cdecl; external libQuartzCore name _PU + 'CATransform3DMakeScale';
function CATransform3DMakeTranslation(tx: Single; ty: Single; tz: Single): CATransform3D; cdecl; external libQuartzCore name _PU + 'CATransform3DMakeTranslation';
function CATransform3DRotate(t: CATransform3D; angle: Single; x: Single; y: Single; z: Single): CATransform3D; cdecl; external libQuartzCore name _PU + 'CATransform3DRotate';
function CATransform3DScale(t: CATransform3D; sx: Single; sy: Single; sz: Single): CATransform3D; cdecl; external libQuartzCore name _PU + 'CATransform3DScale';
function CATransform3DTranslate(t: CATransform3D; tx: Single; ty: Single; tz: Single): CATransform3D; cdecl; external libQuartzCore name _PU + 'CATransform3DTranslate';
...
//    procedure insertSublayer(layer: CALayer; below: CALayer); cdecl; overload;
    ...
    procedure setAnchorPointZ(anchorPointZ: Single); cdecl;
    ...
    procedure setEdgeAntialiasingMask(edgeAntialiasingMask: Longword); cdecl;
    ...
    procedure setZPosition(zPosition: Single); cdecl;
  ...
  CAEmitterCell = interface(NSObject)
    ...
    function contents: Pointer; cdecl;
    function contentsRect: CGRect; cdecl;
    function emissionLatitude: Single; cdecl;
    function emissionLongitude: Single; cdecl;
    ...
    function scaleRange: Single; cdecl;
    function scaleSpeed: Single; cdecl;
    ...
    procedure setContents(contents: Pointer); cdecl;
    procedure setContentsRect(contentsRect: CGRect); cdecl;
    procedure setEmissionLatitude(emissionLatitude: Single); cdecl;
    procedure setEmissionLongitude(emissionLongitude: Single); cdecl;
    procedure setEmissionRange(emissionRange: Single); cdecl;
    ...
    procedure setScaleRange(scaleRange: Single); cdecl;
    procedure setScaleSpeed(scaleSpeed: Single); cdecl;
    procedure setSpin(spin: Single); cdecl;
    procedure setSpinRange(spinRange: Single); cdecl;
    procedure setStyle(style: NSDictionary); cdecl;
    procedure setVelocity(velocity: Single); cdecl;
    procedure setVelocityRange(velocityRange: Single); cdecl;
    procedure setXAcceleration(xAcceleration: Single); cdecl;
    procedure setYAcceleration(yAcceleration: Single); cdecl;
    procedure setZAcceleration(zAcceleration: Single); cdecl;
    function shouldArchiveValueForKey(key: NSString): Boolean; cdecl;
    function spin: Single; cdecl;
    function spinRange: Single; cdecl;
    function style: NSDictionary; cdecl;
    function velocity: Single; cdecl;
    function velocityRange: Single; cdecl;
    function xAcceleration: Single; cdecl;
    function yAcceleration: Single; cdecl;
    function zAcceleration: Single; cdecl;
  end;
  ...
  CAShapeLayer = interface(CALayer)
    ...
    procedure setLineDashPhase(lineDashPhase: Single); cdecl;
    ...
    procedure setStrokeEnd(strokeEnd: Single); cdecl;
    procedure setStrokeStart(strokeStart: Single); cdecl;
    function strokeColor: CGColorRef; cdecl;
    function strokeEnd: Single; cdecl;
    function strokeStart: Single; cdecl;
  end;
  ...
  CAEmitterLayer = interface(CALayer)
    ...
    procedure setBirthRate(birthRate: Single); cdecl;
    procedure setEmitterCells(emitterCells: NSArray); cdecl;
    procedure setEmitterDepth(emitterDepth: Single); cdecl;
