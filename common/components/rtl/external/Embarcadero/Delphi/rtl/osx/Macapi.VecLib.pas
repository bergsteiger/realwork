...
//
//{$HPPEMIT ''}
//{$HPPEMIT '#include <Accelerate.framework/Accelerate.h>'}
//{$HPPEMIT ''}
...
const
  libVeclib = '/System/Library/Frameworks/Accelerate.framework/Accelerate';
...
type
	vDSP_Length = UInt32; //typedef unsigned long                   vDSP_Length;
{    vDSP_Length is for numbers of elements in arrays and indices of
	...
	vDSP_Stride = Int32; //typedef long                            vDSP_Stride;
...
//};
 ...
 TDSPComplex = _DSPComplex;
 PDSPComplex = ^TDSPComplex;
...
//  float *             imagp;
//};
 _DSPSplitComplex = record
	realp: PSingle;
	imagp: PSingle;
 end;
 TDSPSplitComplex = _DSPSplitComplex;
 PDSPSplitComplex = ^TDSPSplitComplex;
...
//typedef struct DSPDoubleComplex         DSPDoubleComplex;
 _DSPDoubleComplex = record
	real: Double;
	imag: Double;
 end;
 TDSPDoubleComplex = _DSPDoubleComplex;
 PDSPDoubleComplex = ^TDSPDoubleComplex;
//struct DSPDoubleSplitComplex {
//  double *            realp;
//  double *            imagp;
//};
//typedef struct DSPDoubleSplitComplex    DSPDoubleSplitComplex;
 _DSPDoubleSplitComplex = record
	realp: PDouble;
	imagp: PDouble;
 end;
 TDSPDoubleSplitComplex = _DSPDoubleSplitComplex;
 PDSPDoubleSplitComplex = ^TDSPDoubleSplitComplex;

//typedef struct OpaqueFFTSetup*          FFTSetup;
//typedef struct OpaqueFFTSetupD*         FFTSetupD;
  _OpaqueFFTSetup = record
  end;
  TFFTSetup = _OpaqueFFTSetup;
  PFFTSetup = ^TFFTSetUP;

  _OpaqueFFTSetupD = record
  end;
  TFFTSetupD = _OpaqueFFTSetupD;
  PFFTSetupD = ^TFFTSetUPD;
...
//};
  FFTDirection = (kFFTDirection_Inverse         = -1, kFFTDirection_Forward         = 1);
...
//  kFFTRadix5                    = 2
//};
  FFTRadix = (kFFTRadix2, kFFTRadix3, kFFTRadix5);
...
//  vDSP_HANN_NORM                = 2
//};
  vDSP_NEED_NAME_ENUM = (vDSP_HANN_DENORM, vDSP_HALF_WINDOW, vDSP_HANN_NORM);
...
function vDSP_create_fftsetup(__vDSP_log2n: vDSP_Length; __vDSP_radix: FFTRadix): PFFTSetup; cdecl;
  external libVecLib name _PU + 'vDSP_create_fftsetup';
...
procedure vDSP_destroy_fftsetup(__vDSP_setup:PFFTSetup); cdecl;
  external libVeclib name _PU+ 'vDSP_destroy_fftsetup';
...
function vDSP_create_fftsetupD(__vDSP_log2n: vDSP_Length; __vDSP_radix: FFTRadix): PFFTSetupD; cdecl;
  external libVecLib name _PU + 'vDSP_create_fftsetupD';
...
procedure vDSP_destroy_fftsetupD(__vDSP_setup:PFFTSetupD); cdecl;
...
procedure vDSP_ctoz(
  const   __vDSP_C: PDSPComplex;
          __vDSP_strideC: vDSP_Stride;
          __vDSP_Z: PDSPSplitComplex;
          __vDSP_strideZ: vDSP_Stride;
          __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_ctoz';
...
//  vDSP_Length              __vDSP_size) __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_4_0);
procedure vDSP_ztoc(
  const   __vDSP_Z: PDSPSplitComplex;
          __vDSP_strideZ: vDSP_Stride;
          __vDSP_C: PDSPComplex;
          __vDSP_strideC: vDSP_Stride;
          __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_ztoc';
...
procedure vDSP_ctozD(
  const   __vDSP_C: PDSPDoubleComplex;
          __vDSP_strideC: vDSP_Stride;
          __vDSP_Z: PDSPDoubleSplitComplex;
          __vDSP_strideZ: vDSP_Stride;
          __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_ctozD';
...
//  vDSP_Stride                    __vDSP_strideC,
//  vDSP_Length                    __vDSP_size) __OSX_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_4_0);
procedure vDSP_ztocD(
  const   __vDSP_Z: PDSPDoubleSplitComplex;
          __vDSP_strideZ: vDSP_Stride;
          __vDSP_C: PDSPDoubleComplex;
          __vDSP_strideC: vDSP_Stride;
          __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_ztocD';
...
procedure vDSP_mtrans(
  __vDSP_a: PSingle;
  __vDSP_aStride: vDSP_Stride;
  __vDSP_c: PSingle;
  __vDSP_cStride: vDSP_Stride;
  __vDSP_M: vDSP_Length;
  __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_mtrans';
...
procedure vDSP_mtransD(
  ...
  __vDSP_M: vDSP_Length;
  __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_mtransD';
...
procedure vDSP_mmul(
    ...
    __vDSP_aStride: vDSP_Stride;
    __vDSP_b: PSingle;
    __vDSP_bStride: vDSP_Stride;
    __vDSP_c: PSingle;
    __vDSP_cStride: vDSP_Stride;
    __vDSP_M: vDSP_Length;
    __vDSP_N: vDSP_Length;
    __vDSP_P: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_mmul';
...
procedure vDSP_mmulD(
    ...
    __vDSP_N: vDSP_Length;
    __vDSP_P: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_mmulD';
...
//  vDSP_Length        __vDSP_P) __OSX_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_4_0);
procedure vDSP_zmma(
    __vDSP_a: PDSPSplitComplex;
    __vDSP_i: vDSP_Stride;
    __vDSP_b: PDSPSplitComplex;
    __vDSP_j: vDSP_Stride;
    __vDSP_c: PDSPSplitComplex;
    __vDSP_k: vDSP_Stride;
    __vDSP_d: PDSPSplitComplex;
    __vDSP_l: vDSP_Stride;
    __vDSP_M: vDSP_Length;
    __vDSP_N: vDSP_Length;
    __vDSP_P: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zmma';
...
//  vDSP_Length              __vDSP_N,
//  vDSP_Length              __vDSP_P) __OSX_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_4_0);
procedure vDSP_zmmaD(
    __vDSP_a: PDSPDoubleSplitComplex;
    __vDSP_i: vDSP_Stride;
    __vDSP_b: PDSPDoubleSplitComplex;
    __vDSP_j: vDSP_Stride;
    __vDSP_c: PDSPDoubleSplitComplex;
    __vDSP_k: vDSP_Stride;
    __vDSP_d: PDSPDoubleSplitComplex;
    __vDSP_l: vDSP_Stride;
    __vDSP_M: vDSP_Length;
    __vDSP_N: vDSP_Length;
    __vDSP_P: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zmmaD';
...
procedure vDSP_zmms(
    ...
    __vDSP_N: vDSP_Length;
    __vDSP_P: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zmms';
...
procedure vDSP_zmmsD(
    ...
    __vDSP_N: vDSP_Length;
    __vDSP_P: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zmmsD';
...
procedure vDSP_zmsm(
    ...
    __vDSP_N: vDSP_Length;
    __vDSP_P: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zmsm';
...
procedure vDSP_zmsmD(
    ...
    __vDSP_N: vDSP_Length;
    __vDSP_P: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zmsmD';
...
procedure vDSP_zmmul(
    ...
    __vDSP_N: vDSP_Length;
    __vDSP_P: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zmmul';
...
procedure vDSP_zmmulD(
    ...
    __vDSP_N: vDSP_Length;
    __vDSP_P: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zmmulD';
...
//  vDSP_Length   __vDSP_size) __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_4_0);
procedure vDSP_vadd(
    __vDSP_input1: PSingle;
    __vDSP_stride1: vDSP_Stride;
    __vDSP_input2: PSingle;
    __vDSP_stride2: vDSP_Stride;
    __vDSP_result: PSingle;
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vadd';
...
//  vDSP_Stride    __vDSP_strideResult,
//  vDSP_Length    __vDSP_size) __OSX_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_4_0);
procedure vDSP_vaddD(
    __vDSP_input1: PDouble;
    __vDSP_stride1: vDSP_Stride;
    __vDSP_input2: PDouble;
    __vDSP_stride2: vDSP_Stride;
    __vDSP_result: PDouble;
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vaddD';
...
procedure vDSP_vsub(
    ...
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vsub';
...
procedure vDSP_vsubD(
    ...
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vsubD';
...
procedure vDSP_vmul(
    ...
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vmul';
...
procedure vDSP_vmulD(
    ...
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vmulD';
...
procedure vDSP_vsmul(
    ...
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vsmul';
...
procedure vDSP_vsmulD(
    ...
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vsmulD';
...
//  vDSP_Length   __vDSP_size) __OSX_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_4_0);
procedure vDSP_vsq(
    __vDSP_input: PSingle;
    __vDSP_strideInput: vDSP_Stride;
    __vDSP_result: PSingle;
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vsq';
...
//  vDSP_Length    __vDSP_size) __OSX_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_4_0);
procedure vDSP_vsqD(
    __vDSP_input: PDouble;
    __vDSP_strideInput: vDSP_Stride;
    __vDSP_result: PDouble;
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vsqD';
...
procedure vDSP_vssq(
    ...
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vssq';
...
//  vDSP_Stride    __vDSP_strideResult,
//  vDSP_Length    __vDSP_size) __OSX_AVAILABLE_STARTING(__MAC_10_2, __IPHONE_4_0);
procedure vDSP_vssqD(
    __vDSP_input: PDouble;
    __vDSP_strideInput: vDSP_Stride;
    __vDSP_result: PDouble;
    __vDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vssqD';
...
procedure vDSP_dotpr(
    ...
    __vDSP_result: PSingle;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_dotpr';
...
procedure vDSP_dotprD(
    ...
    __vDSP_result: PDouble;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_dotprD';
...
procedure vDSP_vam(
    ...
    __vDSP_input2: PSingle;
    __vDSP_stride2: vDSP_Stride;
    __vDSP_input3: PSingle;
    __vDSP_stride3: vDSP_Stride;
    __vDSP_result: PSingle;
    __VDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vam';
...
procedure vDSP_vamD(
    ...
    __vDSP_input2: PDouble;
    __vDSP_stride2: vDSP_Stride;
    __vDSP_input3: PDouble;
    __vDSP_stride3: vDSP_Stride;
    __vDSP_result: PDouble;
    __VDSP_strideResult: vDSP_Stride;
    __vDSP_size: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vamD';
...
procedure vDSP_vdpsp(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vdpsp';
...
//  vDSP_Stride   __vDSP_K,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_vspdp(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vspdp';
...
//  vDSP_Stride   __vDSP_K,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_vabsi(
    __vDSP_A: PInteger;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PInteger;
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vabsi';
...
procedure vDSP_veqvi(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_veqvi';
...
procedure vDSP_vdivi(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vdivi';
...
//  vDSP_Stride   __vDSP_K,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_vfilli(
    __vDSP_A: PInteger;
    __vDSP_C: PInteger;
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vfilli';
...
procedure vDSP_vsaddi(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vsaddi';
...
procedure vDSP_vsdivi(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vsdivi';
...
//  float *            __vDSP_C,
//  vDSP_Length        __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_zaspec(
    __vDSP_A: PDSPSplitComplex;
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zaspec';
...
//  double *                 __vDSP_C,
//  vDSP_Length              __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_zaspecD(
    __vDSP_A: PDSPDoubleSplitComplex;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zaspecD';
...
procedure vDSP_blkman_window(
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length;
    __vDSP_FLAG: Integer); cdecl;
  external libVecLib name _PU + 'vDSP_blkman_window';
...
//  vDSP_Length   __vDSP_N,
//  int           __vDSP_FLAG) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_blkman_windowD(
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length;
    __vDSP_FLAG: Integer); cdecl;
  external libVecLib name _PU + 'vDSP_blkman_windowD';
...
//  float *            __vDSP_D,
//  vDSP_Length        __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_zcoher(
    __vDSP_A: PSingle;
    __vDSP_B: PSingle;
    __vDSP_C: PDSPSplitComplex;
    __vDSP_DC: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zcoher';
...
//  double *                 __vDSP_D,
//  vDSP_Length              __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_zcoherD(
    __vDSP_A: PDouble;
    __vDSP_B: PDouble;
    __vDSP_C: PDSPDoubleSplitComplex;
    __vDSP_DC: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_zcoherD';
...
procedure vDSP_deq22(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_deq22';
...
procedure vDSP_deq22D(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_deq22D';
...
//  vDSP_Length   __vDSP_N,
//  vDSP_Length   __vDSP_M) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_desamp(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_B: PSingle;
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length;
    __vDSP_M: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_desamp';
...
procedure vDSP_desampD(
    ...
    __vDSP_N: vDSP_Length;
    __vDSP_M: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_desampD';
...
//  vDSP_Length   __vDSP_N,
//  int           __vDSP_FLAG) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_hamm_window(
    __vDSP_A: PSingle;
    __vDSP_N: vDSP_Length;
    __vDSP_FLAG: Integer); cdecl;
  external libVecLib name _PU + 'vDSP_hamm_window';
...
//  vDSP_Length   __vDSP_N,
//  int           __vDSP_FLAG) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_hamm_windowD(
    __vDSP_A: PDouble;
    __vDSP_N: vDSP_Length;
    __vDSP_FLAG: Integer); cdecl;
  external libVecLib name _PU + 'vDSP_hamm_windowD';
...
//  vDSP_Length   __vDSP_N,
//  int           __vDSP_FLAG) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_hann_window(
    __vDSP_A: PSingle;
    __vDSP_N: vDSP_Length;
    __vDSP_FLAG: Integer); cdecl;
  external libVecLib name _PU + 'vDSP_hann_window';
...
//  vDSP_Length   __vDSP_N,
//  int           __vDSP_FLAG) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_hann_windowD(
    __vDSP_A: PDouble;
    __vDSP_N: vDSP_Length;
    __vDSP_FLAG: Integer); cdecl;
  external libVecLib name _PU + 'vDSP_hann_windowD';
...
//  float *        __vDSP_C,
//  vDSP_Length    __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_maxmgv(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_maxmgv';
...
//  double *        __vDSP_C,
//  vDSP_Length     __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_maxmgvD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_maxmgvD';
...
//  vDSP_Length    __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_maxmgvi(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    var __vDSP_IC: vDSP_Length;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_maxmgvi';
...
//  vDSP_Length *  __vDSP_IC,
//  vDSP_Length    __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_maxmgviD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    var __vDSP_IC: vDSP_Length;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_maxmgviD';
...
procedure vDSP_maxv(
    ...
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_maxv';
...
//  double *      __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_maxvD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_maxvD';
...
//  vDSP_Length *  __vDSP_IC,
//  vDSP_Length    __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_maxvi(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    var __vDSP_IC: vDSP_Length;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_maxvi';
...
//  vDSP_Length *  __vDSP_IC,
//  vDSP_Length    __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_maxviD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    var __vDSP_IC: vDSP_Length;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_maxviD';
...
//  float *       __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_meamgv(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_meamgv';
...
//  double *      __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_meamgvD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_meamgvD';
...
//  float *       __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_meanv(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_meanv';
...
//  double *      __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_meanvD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_meanvD';
...
//  float *       __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_measqv(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_measqv';
...
//  double *      __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_measqvD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_measqvD';
...
//  float *       __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_minmgv(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_minmgv';
...
//  double *      __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_minmgvD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_minmgvD';
...
//  vDSP_Length *  __vDSP_IC,
//  vDSP_Length    __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_minmgvi(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    var __vDSP_IC: vDSP_Length;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_minmgvi';
...
//  vDSP_Length *  __vDSP_IC,
//  vDSP_Length    __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_minmgviD(
        __vDSP_A: PDouble;
        __vDSP_I: vDSP_Stride;
        __vDSP_C: PDouble;
    var __vDSP_IC: vDSP_Length;
        __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_minmgviD';
...
procedure vDSP_minv(
    ...
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_minv';
...
//  double *      __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_minvD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_minvD';
...
//  vDSP_Length *  __vDSP_IC,
//  vDSP_Length    __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_minvi(
        __vDSP_A: PSingle;
        __vDSP_I: vDSP_Stride;
        __vDSP_C: PSingle;
    var __vDSP_IC: vDSP_Length;
        __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_minvi';
...
//  vDSP_Length *  __vDSP_IC,
//  vDSP_Length    __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_minviD(
        __vDSP_A: PDouble;
        __vDSP_I: vDSP_Stride;
        __vDSP_C: PDouble;
    var __vDSP_IC: vDSP_Length;
        __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_minviD';
...
procedure vDSP_mmov(
        __vDSP_A: PSingle;
        __vDSP_C: PSingle;
        __vDSP_NC: vDSP_Length;
        __vDSP_NR: vDSP_Length;
        __vDSP_TCA: vDSP_Length;
        __vDSP_TCC: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_mmov';
...
procedure vDSP_mmovD(
        ...
        __vDSP_TCA: vDSP_Length;
        __vDSP_TCC: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_mmovD';
...
//  float *       __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_mvessq(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_mvessq';
...
//  double *      __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_mvessqD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_mvessqD';
...
//  vDSP_Length    __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_nzcros(
        __vDSP_A: PSingle;
        __vDSP_I: vDSP_Stride;
        __vDSP_B: vDSP_Length;
    var __vDSP_C: vDSP_Length;
    var __vDSP_D: vDSP_Length;
        __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_nzcros';
...
procedure vDSP_nzcrosD(
    ...
    var __vDSP_D: vDSP_Length;
        __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_nzcrosD';
...
//  vDSP_Stride   __vDSP_K,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_polar(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_polar';
...
//  vDSP_Stride   __vDSP_K,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_polarD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_polarD';
...
procedure vDSP_rect(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_rect';
...
//  vDSP_Stride   __vDSP_K,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_rectD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_rectD';
...
//  float *       __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_rmsqv(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_rmsqv';
...
//  double *      __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_rmsqvD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_rmsqvD';
...
procedure vDSP_svdiv(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_svdiv';
...
procedure vDSP_svdivD(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_svdivD';
...
procedure vDSP_sve(
    ...
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_sve';
...
procedure vDSP_sveD(
    ...
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_sveD';
...
//  float *       __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_svemg(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_svemg';
...
//  double *      __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_svemgD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_svemgD';
...
//  float *       __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_svesq(
    __vDSP_A: PSingle;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_svesq';
...
//  double *      __vDSP_C,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_svesqD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_svesqD';
...
procedure vDSP_svs(
    ...
    __vDSP_C: PSingle;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_svs';
...
procedure vDSP_svsD(
    ...
    __vDSP_C: PDouble;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_svsD';
...
procedure vDSP_vaam(
    ...
    __vDSP_L: vDSP_Stride;
    __vDSP_E: PSingle;
    __vDSP_M: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vaam';
...
procedure vDSP_vaamD(
    ...
    __vDSP_M: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vaamD';
...
procedure vDSP_vabs(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vabs';
...
//  vDSP_Stride   __vDSP_K,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_vabsD(
    __vDSP_A: PDouble;
    __vDSP_I: vDSP_Stride;
    __vDSP_C: PDouble;
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vabsD';
...
procedure vDSP_vasbm(
    ...
    __vDSP_M: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vasbm';
...
procedure vDSP_vasbmD(
    ...
    __vDSP_M: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vasbmD';
...
procedure vDSP_vasm(
    ...
    __vDSP_L: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vasm';
...
procedure vDSP_vasmD(
    ...
    __vDSP_L: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vasmD';
...
procedure vDSP_vavlin(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vavlin';
...
procedure vDSP_vavlinD(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vavlinD';
...
procedure vDSP_vclip(
    ...
    __vDSP_L: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vclip';
...
procedure vDSP_vclipD(
    ...
    __vDSP_L: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vclipD';
...
procedure vDSP_vclipc(
    ...
    __vDSP_L: vDSP_Stride;
    __vDSP_N: vDSP_Length;
    var __vDSP_NLOW: vDSP_Length;
    var __vDSP_NHI: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vclipc';
...
procedure vDSP_vclipcD(
    ...
    var __vDSP_NLOW: vDSP_Length;
    var __vDSP_NHI: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vclipcD';
...
procedure vDSP_vclr(
    ...
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vclr';
...
//  vDSP_Stride   __vDSP_K,
//  vDSP_Length   __vDSP_N) __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_4_0);
procedure vDSP_vclrD(
    __vDSP_C: PDouble;
    __vDSP_K: vDSP_Stride;
    __vDSP_N: vDSP_Length); cdecl;
  external libVecLib name _PU + 'vDSP_vclrD';
...
type
	vDSP_DFT_Direction = ( vDSP_DFT_FORWARD = +1, vDSP_DFT_INVERSE = -1);
