...
{*                                                                            *}
{*----------------------------------------------------------------------------*}
{*  $Id: Winapi.DirectMusic.pas,v 1.2 2013/05/24 13:31:00 lulin Exp $ }
{******************************************************************************}
...
type
  ...
  {$EXTERNALSYM PReference_Time}
  TReference_Time = TReferenceTime;
  {$EXTERNALSYM TReference_Time}
