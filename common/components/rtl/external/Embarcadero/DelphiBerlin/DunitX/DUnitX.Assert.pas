...
{$ENDIF}
    ...
    ///   is to complement <see_ cref="DUnitX.TestFramework|Assert.WillRaiseAny(TTestLocalMethod,string)">
    ...
    /// <summary>
    ///   Checks that an exception of Any type not will be raised. This method
    ///   is to complement <see_ cref="DUnitX.TestFramework|Assert.WillRaiseAny(TTestMethod,string)">
    ///   WillRaiseAny</see> method, and is not required, as the default behavior of a test
    ///   is to fail when any exception is raised.
    /// </summary>
