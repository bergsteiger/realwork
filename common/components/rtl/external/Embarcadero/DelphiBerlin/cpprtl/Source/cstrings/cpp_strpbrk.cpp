...
const _TCHAR * _RTLENTRY _EXPFUNC _tcspbrk(const _TCHAR *s1, const _TCHAR *s2)
{
...
_TCHAR * _RTLENTRY _EXPFUNC _tcspbrk(_TCHAR *s1, const _TCHAR *s2)
{
     return (_TCHAR *) _tcspbrk((const _TCHAR *)s1, s2);
}
