...
const _TCHAR * _RTLENTRY _EXPFUNC _tcsstr(const _TCHAR *str1, const _TCHAR *str2)
{
...
_TCHAR * _RTLENTRY _EXPFUNC _tcsstr(_TCHAR *str1, const _TCHAR *str2)
{
    return (_TCHAR *) _tcsstr((const _TCHAR *) str1, (const _TCHAR *) str2);
}
