...
_CRTIMP2P _Max_type _PCDECL _MP_Get(_MP_arr);
_CRTIMP2P void _PCDECL _MP_Add(_MP_arr, _Max_type);
_CRTIMP2P void _PCDECL _MP_Mul(_MP_arr, _Max_type, _Max_type);
_CRTIMP2P void _PCDECL _MP_Rem(_MP_arr, _Max_type);
...
_Max_type _PCDECL _MP_Get(_MP_arr u)
...
void _PCDECL _MP_Add(_MP_arr u, _Max_type v0)
...
void _PCDECL _MP_Mul(_MP_arr w, _Max_type u0, _Max_type v0)
...
void _PCDECL _MP_Rem(_MP_arr u, _Max_type v0)
