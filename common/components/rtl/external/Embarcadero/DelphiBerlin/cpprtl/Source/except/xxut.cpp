...
//
void _RTLENTRY _EXPFUNC _NO_RETURN_DECL terminate(void)
{
    ...
    PFV _RTLENTRY _EXPFUNC set_terminate(PFV ptr) throw()
#else
...
#if defined(_DINKUMWARE)
PFV _RTLENTRY _EXPFUNC set_unexpected(PFV ptr) throw()
#else
