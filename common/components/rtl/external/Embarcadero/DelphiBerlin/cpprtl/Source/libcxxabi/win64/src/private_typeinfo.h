...
class __attribute__ ((__visibility__("hidden"))) _CRTIMP2 __shim_type_info
...
public:
    ...
    /**
       Returns true if this type is the same as another.  The comparison is not a
       simple pointer comparison, but a deep comparison of the types.  This allows
       type info comparison to work across DLL boundaries, where two type infos
       for the same class definition may actually be present in the runtime image.

       The default implementation here will do a pointer comparison, backed up by
       a name comparison of the type.
     */
	...
	if (!prhs)
	    return false;
	return this->equals(*prhs);
    }
};

class __attribute__ ((__visibility__("default"))) _CRTIMP2 __fundamental_type_info
...
class __attribute__ ((__visibility__("default"))) _CRTIMP2 __array_type_info
    : public __shim_type_info
{
public:
...
class __attribute__ ((__visibility__("default"))) _CRTIMP2 __function_type_info
    : public __shim_type_info
{
public:
...
class __attribute__ ((__visibility__("default"))) _CRTIMP2 __enum_type_info
    : public __shim_type_info
{
public:
...
// Has no base class
class __attribute__ ((__visibility__("default"))) _CRTIMP2 __class_type_info
    : public __shim_type_info
{
public:
...
class __attribute__ ((__visibility__("default"))) _CRTIMP2 __si_class_type_info
...
struct _CRTIMP2 __base_class_type_info
{
public:
    const __class_type_info* __base_type;
    long __offset_flags;
...
class __attribute__ ((__visibility__("default"))) _CRTIMP2 __vmi_class_type_info
    : public __class_type_info
{
public:
...
class __attribute__ ((__visibility__("default"))) _CRTIMP2 __pbase_type_info
    : public __shim_type_info
{
public:
    unsigned int __flags;
...
class __attribute__ ((__visibility__("default"))) _CRTIMP2 __pointer_type_info
...
class __attribute__ ((__visibility__("default"))) _CRTIMP2 __pointer_to_member_type_info
    : public __pbase_type_info
{
public:
