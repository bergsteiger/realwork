...
#define MAX_87_EXP      LDBL_MAX_10_EXP
...
/* Exponents > LDBL_MAX_10_EXP become infinities.  Exponents < -LDBL_MAX_10_EXP become 0. */
...
#if defined(_WIN64)
typedef unsigned short int  extend [4];     /* 64-bit constants */

static  const   extend  eINF  = {0x0000, 0x0000, 0x8000, 0x7ff};

#if 1  /* These constants map to closest representation */
static  const   long double  e32   = 1.e32;
static  const   long double  e64   = 1.e64;
static  const   long double  e128  = 1.e128;
static  const   long double  e256  = 1.e256;
#else
static  const   extend  e32   = {0x6E17, 0xB505, 0xB8B5, 0x4693};
static  const   extend  e64   = {0xF9F5, 0xE93F, 0x4F03, 0x4D38};
static  const   extend  e128  = {0x1D32, 0xF930, 0x7748, 0x5A82};
static  const   extend  e256  = {0xBF3C, 0x7F73, 0x4FDD, 0x7515};
#endif
