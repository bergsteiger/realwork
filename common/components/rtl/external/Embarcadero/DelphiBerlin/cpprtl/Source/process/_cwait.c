...
Description     This function waits for a child process to terminate.
                ...
                contains the return value or the exception code that was
                returned from the child process as returned by GetExitCodeProcess.
