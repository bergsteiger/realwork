...
_DATA           SEGMENT PUBLIC DWORD USE32 PUBLIC 'DATA'
                db      'Embarcadero RAD Studio - Copyright 2015 Embarcadero Technologies, Inc.',0
_DATA           ENDS
...
ifdef CLANG32
EXTRN           ___backpatch_data_references:NEAR
endif
...
ifndef  NOXX
EXTRN           __internal_dbk_fcall_wrapper
endif        
_DATA           ENDS
...
ifndef NOVCL
                ...
                dd      0 ; offset FLAT:__matherr	
                dd      0 ; offset FLAT:__matherrl
endif       
                dd      0                       ; stack base
...
ifndef _UNICODE
                ...
                dd      offset FLAT:__turboFloat   ; for setting up cvt_init
                                                   ; and scan_init
ifdef FMX
                dd      offset FLAT:_FMXmain       ; need reference since we pass thunk
                                                   ; but have debug info pointing to FMXmain
endif
endif
;
; END TABLE - misc
...
ifndef  NOXX
                dd      offset __dbk_fcall_wrapper
endif        
skip_dbg_vector:
ifdef CLANG32
ifndef DLL
                call    ___backpatch_data_references
endif        
endif
                mov     eax, __TLS_index
                shl     eax, 2
...
ifdef   DLL
  ...
  ifndef  _UNICODE
                ...
                mov     __hInstance, edx        ; initialize _hInstance
...
ifndef  NOXX
__dbk_fcall_wrapper segment virtual
@__dbk_fcall_wrapper  proc    near
                mov     eax, __internal_dbk_fcall_wrapper
                jmp     eax
@__dbk_fcall_wrapper ENDP
__dbk_fcall_wrapper ENDS        
endif
...
;
extrn @Sysinit@@PackageLoad$qqrxp23System@PackageInfoTable:near
extrn @Sysinit@@PackageUnload$qqrxp23System@PackageInfoTable:near
...
Initialize proc near
                mov     eax, offset __PackageInfoTable
                mov     edx, [eax]
                call    @Sysinit@@PackageLoad$qqrxp23System@PackageInfoTable
                ret
;@PackageLoad endp
Initialize endp
...
Finalize proc near
                mov     eax, offset __PackageInfoTable
                mov     edx, [eax]
                call    @Sysinit@@PackageUnload$qqrxp23System@PackageInfoTable
                ret
;@PackageUnload endp
Finalize endp
