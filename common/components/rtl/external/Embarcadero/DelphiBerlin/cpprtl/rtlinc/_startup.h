...
#if defined(MINIRTL_EDG) || defined(_WIN64)
#pragma pack(4)
#else
#pragma pack(2)
#endif
...
#ifndef _UNICODE
void __cdecl  _EXPFUNC _startup(MODULE_DATA *mod_table);
#else	//UNICODE
void __cdecl  _EXPFUNC _wstartup(MODULE_DATA *mod_table);
#endif
...
#if defined(MINIRTL)
void            _init_exit_proc (int __is_exit);
#else
