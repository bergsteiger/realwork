...
#define __tfopen_helper                      __fopen_helper
...
#define __isttypeEx                          __isctypeEx
...
#define _scannert_s                          _scanner_s
#define __Gett                               __Get
#define __UnGett                             __UnGet
#define _tmaperror                           _maperror
#define _ttzsetx                             _tzsetx
...
#define _tgetenv_nolock                      _wgetenv_nolock
...
#define _tmake_arglist                       _wmake_arglist
...
#define ___topen                             __wopen
#define __topenfp                            __wopenfp
#define __tfopen_helper                      __wfopen_helper
...
#define __isttypeEx                          __iswctypeEx
...
#define _scannert_s                          _scannerw_s
#define __Gett                               __Getw
#define __UnGett                             __UnGetw
#define _tmaperror                           _wmaperror
#define _ttzsetx                             _wtzsetx
#endif
