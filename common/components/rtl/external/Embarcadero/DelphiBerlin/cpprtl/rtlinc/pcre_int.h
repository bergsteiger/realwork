...
the Borland C++ RTL.  Not all of the files contained in the full version of
PCRE are in this version.

-- Inprise development.

=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-

This file was originally named internal.h
...
/* The following externs marked 'const' by Inprise for Borland C++ */
extern const uschar pcre_lcc[];
extern const uschar pcre_fcc[];
extern const uschar pcre_cbits[];
extern const uschar pcre_ctypes[];
