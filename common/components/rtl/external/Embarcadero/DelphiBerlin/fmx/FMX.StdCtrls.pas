    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (SiblingControl.Align in [TAlignLayout.Left, TAlignLayout.Right, TAlignLayout.MostLeft, TAlignLayout.MostRight]) then
      ...
      begin
        ...
        begin
          if not(Parent.Children[i] is TControl) then
            Continue;
          SiblingControl := TControl(Parent.Children[i]);
          if SiblingControl.Align in [TAlignLayout.Top, TAlignLayout.Bottom] then
