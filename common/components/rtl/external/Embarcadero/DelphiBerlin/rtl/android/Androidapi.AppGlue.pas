...
uses
  Posix.SysTypes, Posix.StdLib, Posix.Unistd, Posix.DlfCn, Posix.Pthread, Androidapi.Configuration, Androidapi.Looper,
  Androidapi.Input, Androidapi.Rect, Androidapi.NativeWindow, Androidapi.NativeActivity;

// Additional information regarding concrete details of this implementation can be found at:
//   [Android NDK]\sources\android\native_app_glue\android_native_app_glue.c
