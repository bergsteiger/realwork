...
{$M-}
  ...
  private
    ...
    class procedure AddReturnValue(Obj: Pointer; AValue: JNIObject); overload; static;
...
begin
  ...
  case RetValue.Kind of
    ...
    begin
      ...
      AObject := LJNIEnvRes^.NewObjectA(LJNIEnvRes, AClass, ConstructorID, PJNIValue(ArgsToJNIValues(
        [RetValue.AsInteger])));
      GlobalRef := TJNIResolver.NewGlobalRef(AObject);
      TJNIResolver.DeleteLocalRef(AObject);
      Result := GlobalRef;
      TJNIResolver.AddReturnValue(DelphiObject, Result);
    end;
...
class procedure TJNIResolver.AddReturnValue(Obj: Pointer; AValue: JNIObject);
begin
  TMonitor.Enter(ReturnValuesJNIObject);
  try
    ReturnValuesJNIObject.Add(Obj, AValue);
  finally
