...
uses
  ...
  Androidapi.Sensor, Androidapi.AppGlue, Androidapi.Looper, System.Math, Androidapi.Jni, Androidapi.JNIBridge,
  Androidapi.JNI.Location, Androidapi.JNI.JavaTypes, Androidapi.JNI.Os, Androidapi.JNI.App,
...
class function TNativeSensor.NativeCallBack(FileDescriptor, Events: Integer; Data: Pointer): Integer;
const
