...
begin
  FDefaultPool.DisposeOf;
  FObjectCaches.DisposeOf;
{$IFDEF AUTOREFCOUNT}
  FDefaultPool.__ObjRelease;
  FObjectCaches.__ObjRelease;
{$ENDIF}
end;
...
begin
  ...
  begin
    ...
    Pointer(LObjectCaches) := TInterlocked.CompareExchange(Pointer(FObjectCaches), Pointer(LObjectCaches), Pointer(nil));
    LObjectCaches.Free;
  end;
...
function TEventWrapper.WaitFor(Timeout: LongWord): TWaitResult;
begin
...
function TCountdownEventWrapper.WaitFor(Timeout: LongWord): TWaitResult;
begin
