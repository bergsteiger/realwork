...
begin
  ...
  if (FGatt.FConnectionStatus = TBluetoothDeviceState.None) and Assigned(FGatt.OnDisconnect) then
...
begin
  ...
  begin
    ...
    begin
      ...
      LContext := TAndroidBluetoothLEManager(TBluetoothLEManager.Current).FContext;
      FJGatt := FJDevice.connectGatt(LContext, FAutoConnect, FJGattCallback);
    end
    else
      FJGatt.connect;

    FServicesEvent.WaitFor(CallbackGattTimeout);
