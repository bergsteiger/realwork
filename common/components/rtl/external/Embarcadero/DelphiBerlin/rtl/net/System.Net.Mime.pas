...
type
  ...
  public
    ...
    constructor Create(AOwnsStream: Boolean = True);
...
constructor TMultipartFormData.Create(AOwnsStream: Boolean);
begin
  inherited Create;
...
begin
  ...
  WriteStringLn('Content-Disposition: form-data; name="' + AField + '"' + #13#10); // We need 2 line break here   // do not localize
