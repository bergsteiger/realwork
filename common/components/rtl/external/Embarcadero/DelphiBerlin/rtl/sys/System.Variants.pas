...
{$ENDIF !NEXTGEN}
procedure _VarToLStr(var S: RawByteString; const V: TVarData);
...
{$ENDIF}
        ...
        begin
          ...
          begin
            ...
            PVarParm^.VLongWord := VarArgGetValue(VAList, Cardinal);
        end;
...
{$ENDIF}
        ...
        begin
          ...
          begin
            ...
            PVarParm^.VLongWord := PCardinal(Params)^;
        end;
...
begin
  case Source.VType and not varByRef of
    ...
    varLongWord: Variant(Dest) := PCardinal(Source.VPointer)^;
      ...
      case V.VType of
        ...
        if V.VType and varByRef <> 0 then
          case V.VType and not varByRef of
            ...
            {$RANGECHECKS ON}
            varLongWord: Result := PCardinal(V.VPointer)^;
    ...
    case V.VType of
      ...
      if V.VType and varByRef <> 0 then
        case V.VType and not varByRef of
          ...
          varLongWord: Result := PCardinal(V.VPointer)^ <> 0;
...
function VarToLStrAny(const V: TVarData): RawByteString;
var
  LTemp: TVarData;
begin
  VariantInit(LTemp);
...
function VarToLStrCustom(const V: TVarData; out AValue: RawByteString): Boolean;
var
  LHandler: TCustomVariantType;
  LTemp: TVarData;
begin
  ...
  begin
    ...
    try
      ...
      AValue := RawByteString(LTemp.VString);
    finally
      _VarClear(LTemp);
    end;
  end;
...
procedure NegateLongWord(const Value: Cardinal; var Dest: TVarData);
begin
    ...
    case Dest.VType of
      ...
      if (Dest.VType and varByRef) <> 0 then
        case Dest.VType and not varByRef of
          ...
          varLongWord: NegateLongWord(PCardinal(Dest.VPointer)^, Dest);
    ...
    case Dest.VType of
      ...
      if (Dest.VType and varByRef) <> 0 then
        case Dest.VType and not varByRef of
          ...
          varLongWord: Variant(Dest) := not PCardinal(Dest.VPointer)^;
    ...
    repeat
      ...
      begin
        case DAVarType of
          ...
          varLongWord:  Value := PCardinal(PDAData)^;
    ...
    repeat
      ...
      begin
        ...
        case DAVarType of
          ...
          varLongWord:  PCardinal(PDAData)^     := Value;
