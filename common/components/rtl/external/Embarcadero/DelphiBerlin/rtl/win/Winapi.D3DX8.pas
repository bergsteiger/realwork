...
//-------------------------------------------------------------------------
function D3DXGetErrorString(hr: HResult; pBuffer: LPCWSTR; BufferLen: LongWord): HResult; stdcall; external d3dx8dll name 'D3DXGetErrorStringW'; overload; 
{$EXTERNALSYM D3DXGetErrorString}
function D3DXGetErrorStringA(hr: HResult; pBuffer: LPCSTR; BufferLen: LongWord): HResult; stdcall; external d3dx8dll name 'D3DXGetErrorStringA'; overload; 
{$EXTERNALSYM D3DXGetErrorStringA}
function D3DXGetErrorStringW(hr: HResult; pBuffer: LPCWSTR; BufferLen: LongWord): HResult; stdcall; external d3dx8dll name 'D3DXGetErrorStringW'; overload; 
...
begin
  ...
  SetLength(Result, System.AnsiStrings.StrLen(PAnsiChar(@Buffer)));
