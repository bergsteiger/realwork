...
class PACKAGE TCDirectoryOutline : public Vcl::Outline::TCustomOutline
{
private:
...
protected:
    ...
    void __fastcall SetDirectory(System::Sysutils::TFileName NewDirectory);
...
public:
    ...
    __property System::Sysutils::TFileName Directory =
