// -----------------------------------------------------------------------------------
// datetime.cpp - Supports Delphi TDateTime type
//
// $Rev: 86413 $
//
...
namespace System
{
  ...
  __fastcall TDateTime::TDateTime(const System::String& src, TDateTimeFlag flag)
  {
    TDateTime tmp;
    if (flag == DateTime )
          ...
          unsigned short sec, unsigned short msec)
  {
    ...
    TDateTime t(hour, min, sec, msec);
    d += t;
    Val = d.Val;
  }


  __fastcall TDateTime::operator System::String() const
  {
    if (Val < 1)
  ...
  System::String __fastcall TDateTime::DateString() const
  {
    return Sysutils::DateToStr(*this);
  }

  System::String __fastcall TDateTime::TimeString() const
  {
    return Sysutils::TimeToStr(*this);
  }

  System::String __fastcall TDateTime::DateTimeString() const
  {
    return Sysutils::DateTimeToStr(*this);
  }
