...
{$IF True}{defined(LONGINT64)}
function TUtilsWideStringStream.Seek(const Offset: Int64; Origin: TSeekOrigin): Int64;
{$ELSE !LONGINT64}
...
{$IFDEF LONGINT64}
procedure TUtilsWideStringStream.SetSize(const NewSize: Int64);
{$ELSE !LONGINT64}
