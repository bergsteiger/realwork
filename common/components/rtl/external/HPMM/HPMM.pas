...
// $Id: HPMM.pas,v 1.2 2001/02/01 14:21:20 law Exp $ 
...
begin
  ...
  begin
    ...
    begin
      if NewSizeIndex+5>HighOrderBit(Block.Size) then
      ...
      begin // Resize
        Result:=addr;
        Resize(Block,NewSizeIndex+5);
        {$IfDef Analysis}
        inc(FAllocSize,(1 shl (NewSizeIndex+5))-AlignedSize);
        {$Endif}
        Block.SetSize(Size,AlignedSize);
        exit;
      end
