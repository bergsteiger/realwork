...
uses Windows, Messages, classes, Graphics, Db, dbctrls, ImageEnView, ImageEnio, hyiedefs;
...
procedure TImageEnDBView.PaintToEx(ABitmap:TBitmap; ABitmapScanline:ppointerarray; UpdRect:PRect);
var
   ie:TImageEnView;
   bmp:TIEBitmap;
begin
