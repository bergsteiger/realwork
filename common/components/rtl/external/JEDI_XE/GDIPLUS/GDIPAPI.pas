...
function IsGDIPlus: Boolean;

implementation

var
 gTriedToLoadGP : Boolean = False;
 gGDIPDLLHandle : HMODULE = 0;
...
begin
 gTriedToLoadGP := True;
 gGDIPDLLHandle := LoadLibrary(WINGDIPDLL);

 if gGDIPDLLHandle = 0 then
  Exit;

 @GdipAlloc := GetProcAddress(gGDIPDLLHandle, 'GdipAlloc');
 @GdipFree := GetProcAddress(gGDIPDLLHandle, 'GdipFree');
 @GdiplusStartup := GetProcAddress(gGDIPDLLHandle, 'GdiplusStartup');
 @GdiplusShutdown := GetProcAddress(gGDIPDLLHandle, 'GdiplusShutdown');

 @GdipCreatePath := GetProcAddress(gGDIPDLLHandle, 'GdipCreatePath');
 @GdipCreatePath2 := GetProcAddress(gGDIPDLLHandle, 'GdipCreatePath2');
 @GdipCreatePath2I := GetProcAddress(gGDIPDLLHandle, 'GdipCreatePath2I');
 @GdipClonePath := GetProcAddress(gGDIPDLLHandle, 'GdipClonePath');
 @GdipDeletePath := GetProcAddress(gGDIPDLLHandle, 'GdipDeletePath');
 @GdipResetPath := GetProcAddress(gGDIPDLLHandle, 'GdipResetPath');
 @GdipGetPointCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetPointCount');
 @GdipGetPathTypes := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathTypes');
 @GdipGetPathPoints := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathPoints');
 @GdipGetPathPointsI := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathPointsI');
 @GdipGetPathFillMode := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathFillMode');
 @GdipSetPathFillMode := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathFillMode');
 @GdipGetPathData := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathData');
 @GdipStartPathFigure := GetProcAddress(gGDIPDLLHandle, 'GdipStartPathFigure');
 @GdipClosePathFigure := GetProcAddress(gGDIPDLLHandle, 'GdipClosePathFigure');
 @GdipClosePathFigures := GetProcAddress(gGDIPDLLHandle, 'GdipClosePathFigures');
 @GdipSetPathMarker := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathMarker');
 @GdipClearPathMarkers := GetProcAddress(gGDIPDLLHandle, 'GdipClearPathMarkers');
 @GdipReversePath := GetProcAddress(gGDIPDLLHandle, 'GdipReversePath');
 @GdipGetPathLastPoint := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathLastPoint');
 @GdipAddPathLine := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathLine');
 @GdipAddPathLine2 := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathLine2');
 @GdipAddPathArc := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathArc');
 @GdipAddPathBezier := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathBezier');
 @GdipAddPathBeziers := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathBeziers');
 @GdipAddPathCurve := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathCurve');
 @GdipAddPathCurve2 := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathCurve2');
 @GdipAddPathCurve3 := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathCurve3');
 @GdipAddPathClosedCurve := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathClosedCurve');
 @GdipAddPathClosedCurve2 := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathClosedCurve2');
 @GdipAddPathRectangle := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathRectangle');
 @GdipAddPathRectangles := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathRectangles');
 @GdipAddPathEllipse := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathEllipse');
 @GdipAddPathPie := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathPie');
 @GdipAddPathPolygon := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathPolygon');
 @GdipAddPathPath := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathPath');
 @GdipAddPathString := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathString');
 @GdipAddPathStringI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathStringI');
 @GdipAddPathLineI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathLineI');
 @GdipAddPathLine2I := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathLine2I');
 @GdipAddPathArcI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathArcI');
 @GdipAddPathBezierI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathBezierI');
 @GdipAddPathBeziersI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathBeziersI');
 @GdipAddPathCurveI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathCurveI');
 @GdipAddPathCurve2I := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathCurve2I');
 @GdipAddPathCurve3I := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathCurve3I');
 @GdipAddPathClosedCurveI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathClosedCurveI');
 @GdipAddPathClosedCurve2I := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathClosedCurve2I');
 @GdipAddPathRectangleI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathRectangleI');
 @GdipAddPathRectanglesI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathRectanglesI');
 @GdipAddPathEllipseI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathEllipseI');
 @GdipAddPathPieI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathPieI');
 @GdipAddPathPolygonI := GetProcAddress(gGDIPDLLHandle, 'GdipAddPathPolygonI');
 @GdipFlattenPath := GetProcAddress(gGDIPDLLHandle, 'GdipFlattenPath');
 @GdipWindingModeOutline := GetProcAddress(gGDIPDLLHandle, 'GdipWindingModeOutline');
 @GdipWidenPath := GetProcAddress(gGDIPDLLHandle, 'GdipWidenPath');
 @GdipWarpPath := GetProcAddress(gGDIPDLLHandle, 'GdipWarpPath');
 @GdipTransformPath := GetProcAddress(gGDIPDLLHandle, 'GdipTransformPath');
 @GdipGetPathWorldBounds := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathWorldBounds');
 @GdipGetPathWorldBoundsI := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathWorldBoundsI');
 @GdipIsVisiblePathPoint := GetProcAddress(gGDIPDLLHandle, 'GdipIsVisiblePathPoint');
 @GdipIsVisiblePathPointI := GetProcAddress(gGDIPDLLHandle, 'GdipIsVisiblePathPointI');
 @GdipIsOutlineVisiblePathPoint := GetProcAddress(gGDIPDLLHandle, 'GdipIsOutlineVisiblePathPoint');
 @GdipIsOutlineVisiblePathPointI := GetProcAddress(gGDIPDLLHandle, 'GdipIsOutlineVisiblePathPointI');
 @GdipCreatePathIter := GetProcAddress(gGDIPDLLHandle, 'GdipCreatePathIter');
 @GdipDeletePathIter := GetProcAddress(gGDIPDLLHandle, 'GdipDeletePathIter');
 @GdipPathIterNextSubpath := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterNextSubpath');
 @GdipPathIterNextSubpathPath := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterNextSubpathPath');
 @GdipPathIterNextPathType := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterNextPathType');
 @GdipPathIterNextMarker := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterNextMarker');
 @GdipPathIterNextMarkerPath := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterNextMarkerPath');
 @GdipPathIterGetCount := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterGetCount');
 @GdipPathIterGetSubpathCount := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterGetSubpathCount');
 @GdipPathIterIsValid := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterIsValid');
 @GdipPathIterHasCurve := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterHasCurve');
 @GdipPathIterRewind := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterRewind');
 @GdipPathIterEnumerate := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterEnumerate');
 @GdipPathIterCopyData := GetProcAddress(gGDIPDLLHandle, 'GdipPathIterCopyData');
 @GdipCreateMatrix := GetProcAddress(gGDIPDLLHandle, 'GdipCreateMatrix');
 @GdipCreateMatrix2 := GetProcAddress(gGDIPDLLHandle, 'GdipCreateMatrix2');
 @GdipCreateMatrix3 := GetProcAddress(gGDIPDLLHandle, 'GdipCreateMatrix3');
 @GdipCreateMatrix3I := GetProcAddress(gGDIPDLLHandle, 'GdipCreateMatrix3I');
 @GdipCloneMatrix := GetProcAddress(gGDIPDLLHandle, 'GdipCloneMatrix');
 @GdipDeleteMatrix := GetProcAddress(gGDIPDLLHandle, 'GdipDeleteMatrix');
 @GdipSetMatrixElements := GetProcAddress(gGDIPDLLHandle, 'GdipSetMatrixElements');
 @GdipMultiplyMatrix := GetProcAddress(gGDIPDLLHandle, 'GdipMultiplyMatrix');
 @GdipTranslateMatrix := GetProcAddress(gGDIPDLLHandle, 'GdipTranslateMatrix');
 @GdipScaleMatrix := GetProcAddress(gGDIPDLLHandle, 'GdipScaleMatrix');
 @GdipRotateMatrix := GetProcAddress(gGDIPDLLHandle, 'GdipRotateMatrix');
 @GdipShearMatrix := GetProcAddress(gGDIPDLLHandle, 'GdipShearMatrix');
 @GdipInvertMatrix := GetProcAddress(gGDIPDLLHandle, 'GdipInvertMatrix');
 @GdipTransformMatrixPoints := GetProcAddress(gGDIPDLLHandle, 'GdipTransformMatrixPoints');
 @GdipTransformMatrixPointsI := GetProcAddress(gGDIPDLLHandle, 'GdipTransformMatrixPointsI');
 @GdipVectorTransformMatrixPoints := GetProcAddress(gGDIPDLLHandle, 'GdipVectorTransformMatrixPoints');
 @GdipVectorTransformMatrixPointsI := GetProcAddress(gGDIPDLLHandle, 'GdipVectorTransformMatrixPointsI');
 @GdipGetMatrixElements := GetProcAddress(gGDIPDLLHandle, 'GdipGetMatrixElements');
 @GdipIsMatrixInvertible := GetProcAddress(gGDIPDLLHandle, 'GdipIsMatrixInvertible');
 @GdipIsMatrixIdentity := GetProcAddress(gGDIPDLLHandle, 'GdipIsMatrixIdentity');
 @GdipIsMatrixEqual := GetProcAddress(gGDIPDLLHandle, 'GdipIsMatrixEqual');
 @GdipCreateRegion := GetProcAddress(gGDIPDLLHandle, 'GdipCreateRegion');
 @GdipCreateRegionRect := GetProcAddress(gGDIPDLLHandle, 'GdipCreateRegionRect');
 @GdipCreateRegionRectI := GetProcAddress(gGDIPDLLHandle, 'GdipCreateRegionRectI');
 @GdipCreateRegionPath := GetProcAddress(gGDIPDLLHandle, 'GdipCreateRegionPath');
 @GdipCreateRegionRgnData := GetProcAddress(gGDIPDLLHandle, 'GdipCreateRegionRgnData');
 @GdipCreateRegionHrgn := GetProcAddress(gGDIPDLLHandle, 'GdipCreateRegionHrgn');
 @GdipCloneRegion := GetProcAddress(gGDIPDLLHandle, 'GdipCloneRegion');
 @GdipDeleteRegion := GetProcAddress(gGDIPDLLHandle, 'GdipDeleteRegion');
 @GdipSetInfinite := GetProcAddress(gGDIPDLLHandle, 'GdipSetInfinite');
 @GdipSetEmpty := GetProcAddress(gGDIPDLLHandle, 'GdipSetEmpty');
 @GdipCombineRegionRect := GetProcAddress(gGDIPDLLHandle, 'GdipCombineRegionRect');
 @GdipCombineRegionRectI := GetProcAddress(gGDIPDLLHandle, 'GdipCombineRegionRectI');
 @GdipCombineRegionPath := GetProcAddress(gGDIPDLLHandle, 'GdipCombineRegionPath');
 @GdipCombineRegionRegion := GetProcAddress(gGDIPDLLHandle, 'GdipCombineRegionRegion');
 @GdipTranslateRegion := GetProcAddress(gGDIPDLLHandle, 'GdipTranslateRegion');
 @GdipTranslateRegionI := GetProcAddress(gGDIPDLLHandle, 'GdipTranslateRegionI');
 @GdipTransformRegion := GetProcAddress(gGDIPDLLHandle, 'GdipTransformRegion');
 @GdipGetRegionBounds := GetProcAddress(gGDIPDLLHandle, 'GdipGetRegionBounds');
 @GdipGetRegionBoundsI := GetProcAddress(gGDIPDLLHandle, 'GdipGetRegionBoundsI');
 @GdipGetRegionHRgn := GetProcAddress(gGDIPDLLHandle, 'GdipGetRegionHRgn');
 @GdipIsEmptyRegion := GetProcAddress(gGDIPDLLHandle, 'GdipIsEmptyRegion');
 @GdipIsInfiniteRegion := GetProcAddress(gGDIPDLLHandle, 'GdipIsInfiniteRegion');
 @GdipIsEqualRegion := GetProcAddress(gGDIPDLLHandle, 'GdipIsEqualRegion');
 @GdipGetRegionDataSize := GetProcAddress(gGDIPDLLHandle, 'GdipGetRegionDataSize');
 @GdipGetRegionData := GetProcAddress(gGDIPDLLHandle, 'GdipGetRegionData');
 @GdipIsVisibleRegionPoint := GetProcAddress(gGDIPDLLHandle, 'GdipIsVisibleRegionPoint');
 @GdipIsVisibleRegionPointI := GetProcAddress(gGDIPDLLHandle, 'GdipIsVisibleRegionPointI');
 @GdipIsVisibleRegionRect := GetProcAddress(gGDIPDLLHandle, 'GdipIsVisibleRegionRect');
 @GdipIsVisibleRegionRectI := GetProcAddress(gGDIPDLLHandle, 'GdipIsVisibleRegionRectI');
 @GdipGetRegionScansCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetRegionScansCount');
 @GdipGetRegionScans := GetProcAddress(gGDIPDLLHandle, 'GdipGetRegionScans');
 @GdipGetRegionScansI := GetProcAddress(gGDIPDLLHandle, 'GdipGetRegionScansI');
 @GdipCloneBrush := GetProcAddress(gGDIPDLLHandle, 'GdipCloneBrush');
 @GdipDeleteBrush := GetProcAddress(gGDIPDLLHandle, 'GdipDeleteBrush');
 @GdipGetBrushType := GetProcAddress(gGDIPDLLHandle, 'GdipGetBrushType');
 @GdipCreateHatchBrush := GetProcAddress(gGDIPDLLHandle, 'GdipCreateHatchBrush');
 @GdipGetHatchStyle := GetProcAddress(gGDIPDLLHandle, 'GdipGetHatchStyle');
 @GdipGetHatchForegroundColor := GetProcAddress(gGDIPDLLHandle, 'GdipGetHatchForegroundColor');
 @GdipGetHatchBackgroundColor := GetProcAddress(gGDIPDLLHandle, 'GdipGetHatchBackgroundColor');
 @GdipCreateTexture := GetProcAddress(gGDIPDLLHandle, 'GdipCreateTexture');
 @GdipCreateTexture2 := GetProcAddress(gGDIPDLLHandle, 'GdipCreateTexture2');
 @GdipCreateTextureIA := GetProcAddress(gGDIPDLLHandle, 'GdipCreateTextureIA');
 @GdipCreateTexture2I := GetProcAddress(gGDIPDLLHandle, 'GdipCreateTexture2I');
 @GdipCreateTextureIAI := GetProcAddress(gGDIPDLLHandle, 'GdipCreateTextureIAI');
 @GdipGetTextureTransform := GetProcAddress(gGDIPDLLHandle, 'GdipGetTextureTransform');
 @GdipSetTextureTransform := GetProcAddress(gGDIPDLLHandle, 'GdipSetTextureTransform');
 @GdipResetTextureTransform := GetProcAddress(gGDIPDLLHandle, 'GdipResetTextureTransform');
 @GdipMultiplyTextureTransform := GetProcAddress(gGDIPDLLHandle, 'GdipMultiplyTextureTransform');
 @GdipTranslateTextureTransform := GetProcAddress(gGDIPDLLHandle, 'GdipTranslateTextureTransform');
 @GdipScaleTextureTransform := GetProcAddress(gGDIPDLLHandle, 'GdipScaleTextureTransform');
 @GdipRotateTextureTransform := GetProcAddress(gGDIPDLLHandle, 'GdipRotateTextureTransform');
 @GdipSetTextureWrapMode := GetProcAddress(gGDIPDLLHandle, 'GdipSetTextureWrapMode');
 @GdipGetTextureWrapMode := GetProcAddress(gGDIPDLLHandle, 'GdipGetTextureWrapMode');
 @GdipGetTextureImage := GetProcAddress(gGDIPDLLHandle, 'GdipGetTextureImage');
 @GdipCreateSolidFill := GetProcAddress(gGDIPDLLHandle, 'GdipCreateSolidFill');
 @GdipSetSolidFillColor := GetProcAddress(gGDIPDLLHandle, 'GdipSetSolidFillColor');
 @GdipGetSolidFillColor := GetProcAddress(gGDIPDLLHandle, 'GdipGetSolidFillColor');
 @GdipCreateLineBrush := GetProcAddress(gGDIPDLLHandle, 'GdipCreateLineBrush');
 @GdipCreateLineBrushI := GetProcAddress(gGDIPDLLHandle, 'GdipCreateLineBrushI');
 @GdipCreateLineBrushFromRect := GetProcAddress(gGDIPDLLHandle, 'GdipCreateLineBrushFromRect');
 @GdipCreateLineBrushFromRectI := GetProcAddress(gGDIPDLLHandle, 'GdipCreateLineBrushFromRectI');
 @GdipCreateLineBrushFromRectWithAngle := GetProcAddress(gGDIPDLLHandle, 'GdipCreateLineBrushFromRectWithAngle');
 @GdipCreateLineBrushFromRectWithAngleI := GetProcAddress(gGDIPDLLHandle, 'GdipCreateLineBrushFromRectWithAngleI');
 @GdipSetLineColors := GetProcAddress(gGDIPDLLHandle, 'GdipSetLineColors');
 @GdipGetLineColors := GetProcAddress(gGDIPDLLHandle, 'GdipGetLineColors');
 @GdipGetLineRect := GetProcAddress(gGDIPDLLHandle, 'GdipGetLineRect');
 @GdipGetLineRectI := GetProcAddress(gGDIPDLLHandle, 'GdipGetLineRectI');
 @GdipSetLineGammaCorrection := GetProcAddress(gGDIPDLLHandle, 'GdipSetLineGammaCorrection');
 @GdipGetLineGammaCorrection := GetProcAddress(gGDIPDLLHandle, 'GdipGetLineGammaCorrection');
 @GdipGetLineBlendCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetLineBlendCount');
 @GdipGetLineBlend := GetProcAddress(gGDIPDLLHandle, 'GdipGetLineBlend');
 @GdipSetLineBlend := GetProcAddress(gGDIPDLLHandle, 'GdipSetLineBlend');
 @GdipGetLinePresetBlendCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetLinePresetBlendCount');
 @GdipGetLinePresetBlend := GetProcAddress(gGDIPDLLHandle, 'GdipGetLinePresetBlend');
 @GdipSetLinePresetBlend := GetProcAddress(gGDIPDLLHandle, 'GdipSetLinePresetBlend');
 @GdipSetLineSigmaBlend := GetProcAddress(gGDIPDLLHandle, 'GdipSetLineSigmaBlend');
 @GdipSetLineLinearBlend := GetProcAddress(gGDIPDLLHandle, 'GdipSetLineLinearBlend');
 @GdipSetLineWrapMode := GetProcAddress(gGDIPDLLHandle, 'GdipSetLineWrapMode');
 @GdipGetLineWrapMode := GetProcAddress(gGDIPDLLHandle, 'GdipGetLineWrapMode');
 @GdipGetLineTransform := GetProcAddress(gGDIPDLLHandle, 'GdipGetLineTransform');
 @GdipSetLineTransform := GetProcAddress(gGDIPDLLHandle, 'GdipSetLineTransform');
 @GdipResetLineTransform := GetProcAddress(gGDIPDLLHandle, 'GdipResetLineTransform');
 @GdipMultiplyLineTransform := GetProcAddress(gGDIPDLLHandle, 'GdipMultiplyLineTransform');
 @GdipTranslateLineTransform := GetProcAddress(gGDIPDLLHandle, 'GdipTranslateLineTransform');
 @GdipScaleLineTransform := GetProcAddress(gGDIPDLLHandle, 'GdipScaleLineTransform');
 @GdipRotateLineTransform := GetProcAddress(gGDIPDLLHandle, 'GdipRotateLineTransform');
 @GdipCreatePathGradient := GetProcAddress(gGDIPDLLHandle, 'GdipCreatePathGradient');
 @GdipCreatePathGradientI := GetProcAddress(gGDIPDLLHandle, 'GdipCreatePathGradientI');
 @GdipCreatePathGradientFromPath := GetProcAddress(gGDIPDLLHandle, 'GdipCreatePathGradientFromPath');
 @GdipGetPathGradientCenterColor := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientCenterColor');
 @GdipSetPathGradientCenterColor := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientCenterColor');
 @GdipGetPathGradientSurroundColorsWithCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientSurroundColorsWithCount');
 @GdipSetPathGradientSurroundColorsWithCount := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientSurroundColorsWithCount');
 @GdipGetPathGradientPath := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientPath');
 @GdipSetPathGradientPath := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientPath');
 @GdipGetPathGradientCenterPoint := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientCenterPoint');
 @GdipGetPathGradientCenterPointI := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientCenterPointI');
 @GdipSetPathGradientCenterPoint := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientCenterPoint');
 @GdipSetPathGradientCenterPointI := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientCenterPointI');
 @GdipGetPathGradientRect := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientRect');
 @GdipGetPathGradientRectI := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientRectI');
 @GdipGetPathGradientPointCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientPointCount');
 @GdipGetPathGradientSurroundColorCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientSurroundColorCount');
 @GdipSetPathGradientGammaCorrection := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientGammaCorrection');
 @GdipGetPathGradientGammaCorrection := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientGammaCorrection');
 @GdipGetPathGradientBlendCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientBlendCount');
 @GdipGetPathGradientBlend := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientBlend');
 @GdipSetPathGradientBlend := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientBlend');
 @GdipGetPathGradientPresetBlendCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientPresetBlendCount');
 @GdipGetPathGradientPresetBlend := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientPresetBlend');
 @GdipSetPathGradientPresetBlend := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientPresetBlend');
 @GdipSetPathGradientSigmaBlend := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientSigmaBlend');
 @GdipSetPathGradientLinearBlend := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientLinearBlend');
 @GdipGetPathGradientWrapMode := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientWrapMode');
 @GdipSetPathGradientWrapMode := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientWrapMode');
 @GdipGetPathGradientTransform := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientTransform');
 @GdipSetPathGradientTransform := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientTransform');
 @GdipResetPathGradientTransform := GetProcAddress(gGDIPDLLHandle, 'GdipResetPathGradientTransform');
 @GdipMultiplyPathGradientTransform := GetProcAddress(gGDIPDLLHandle, 'GdipMultiplyPathGradientTransform');
 @GdipTranslatePathGradientTransform := GetProcAddress(gGDIPDLLHandle, 'GdipTranslatePathGradientTransform');
 @GdipScalePathGradientTransform := GetProcAddress(gGDIPDLLHandle, 'GdipScalePathGradientTransform');
 @GdipRotatePathGradientTransform := GetProcAddress(gGDIPDLLHandle, 'GdipRotatePathGradientTransform');
 @GdipGetPathGradientFocusScales := GetProcAddress(gGDIPDLLHandle, 'GdipGetPathGradientFocusScales');
 @GdipSetPathGradientFocusScales := GetProcAddress(gGDIPDLLHandle, 'GdipSetPathGradientFocusScales');
 @GdipCreatePen1 := GetProcAddress(gGDIPDLLHandle, 'GdipCreatePen1');
 @GdipCreatePen2 := GetProcAddress(gGDIPDLLHandle, 'GdipCreatePen2');
 @GdipClonePen := GetProcAddress(gGDIPDLLHandle, 'GdipClonePen');
 @GdipDeletePen := GetProcAddress(gGDIPDLLHandle, 'GdipDeletePen');
 @GdipSetPenWidth := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenWidth');
 @GdipGetPenWidth := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenWidth');
 @GdipSetPenUnit := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenUnit');
 @GdipGetPenUnit := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenUnit');
 @GdipSetPenLineCap197819 := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenLineCap197819');
 @GdipSetPenStartCap := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenStartCap');
 @GdipSetPenEndCap := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenEndCap');
 @GdipSetPenDashCap197819 := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenDashCap197819');
 @GdipGetPenStartCap := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenStartCap');
 @GdipGetPenEndCap := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenEndCap');
 @GdipGetPenDashCap197819 := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenDashCap197819');
 @GdipSetPenLineJoin := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenLineJoin');
 @GdipGetPenLineJoin := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenLineJoin');
 @GdipSetPenCustomStartCap := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenCustomStartCap');
 @GdipGetPenCustomStartCap := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenCustomStartCap');
 @GdipSetPenCustomEndCap := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenCustomEndCap');
 @GdipGetPenCustomEndCap := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenCustomEndCap');
 @GdipSetPenMiterLimit := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenMiterLimit');
 @GdipGetPenMiterLimit := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenMiterLimit');
 @GdipSetPenMode := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenMode');
 @GdipGetPenMode := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenMode');
 @GdipSetPenTransform := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenTransform');
 @GdipGetPenTransform := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenTransform');
 @GdipResetPenTransform := GetProcAddress(gGDIPDLLHandle, 'GdipResetPenTransform');
 @GdipMultiplyPenTransform := GetProcAddress(gGDIPDLLHandle, 'GdipMultiplyPenTransform');
 @GdipTranslatePenTransform := GetProcAddress(gGDIPDLLHandle, 'GdipTranslatePenTransform');
 @GdipScalePenTransform := GetProcAddress(gGDIPDLLHandle, 'GdipScalePenTransform');
 @GdipRotatePenTransform := GetProcAddress(gGDIPDLLHandle, 'GdipRotatePenTransform');
 @GdipSetPenColor := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenColor');
 @GdipGetPenColor := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenColor');
 @GdipSetPenBrushFill := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenBrushFill');
 @GdipGetPenBrushFill := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenBrushFill');
 @GdipGetPenFillType := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenFillType');
 @GdipGetPenDashStyle := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenDashStyle');
 @GdipSetPenDashStyle := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenDashStyle');
 @GdipGetPenDashOffset := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenDashOffset');
 @GdipSetPenDashOffset := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenDashOffset');
 @GdipGetPenDashCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenDashCount');
 @GdipSetPenDashArray := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenDashArray');
 @GdipGetPenDashArray := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenDashArray');
 @GdipGetPenCompoundCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenCompoundCount');
 @GdipSetPenCompoundArray := GetProcAddress(gGDIPDLLHandle, 'GdipSetPenCompoundArray');
 @GdipGetPenCompoundArray := GetProcAddress(gGDIPDLLHandle, 'GdipGetPenCompoundArray');
 @GdipCreateCustomLineCap := GetProcAddress(gGDIPDLLHandle, 'GdipCreateCustomLineCap');
 @GdipDeleteCustomLineCap := GetProcAddress(gGDIPDLLHandle, 'GdipDeleteCustomLineCap');
 @GdipCloneCustomLineCap := GetProcAddress(gGDIPDLLHandle, 'GdipCloneCustomLineCap');
 @GdipGetCustomLineCapType := GetProcAddress(gGDIPDLLHandle, 'GdipGetCustomLineCapType');
 @GdipSetCustomLineCapStrokeCaps := GetProcAddress(gGDIPDLLHandle, 'GdipSetCustomLineCapStrokeCaps');
 @GdipGetCustomLineCapStrokeCaps := GetProcAddress(gGDIPDLLHandle, 'GdipGetCustomLineCapStrokeCaps');
 @GdipSetCustomLineCapStrokeJoin := GetProcAddress(gGDIPDLLHandle, 'GdipSetCustomLineCapStrokeJoin');
 @GdipGetCustomLineCapStrokeJoin := GetProcAddress(gGDIPDLLHandle, 'GdipGetCustomLineCapStrokeJoin');
 @GdipSetCustomLineCapBaseCap := GetProcAddress(gGDIPDLLHandle, 'GdipSetCustomLineCapBaseCap');
 @GdipGetCustomLineCapBaseCap := GetProcAddress(gGDIPDLLHandle, 'GdipGetCustomLineCapBaseCap');
 @GdipSetCustomLineCapBaseInset := GetProcAddress(gGDIPDLLHandle, 'GdipSetCustomLineCapBaseInset');
 @GdipGetCustomLineCapBaseInset := GetProcAddress(gGDIPDLLHandle, 'GdipGetCustomLineCapBaseInset');
 @GdipSetCustomLineCapWidthScale := GetProcAddress(gGDIPDLLHandle, 'GdipSetCustomLineCapWidthScale');
 @GdipGetCustomLineCapWidthScale := GetProcAddress(gGDIPDLLHandle, 'GdipGetCustomLineCapWidthScale');
 @GdipCreateAdjustableArrowCap := GetProcAddress(gGDIPDLLHandle, 'GdipCreateAdjustableArrowCap');
 @GdipSetAdjustableArrowCapHeight := GetProcAddress(gGDIPDLLHandle, 'GdipSetAdjustableArrowCapHeight');
 @GdipGetAdjustableArrowCapHeight := GetProcAddress(gGDIPDLLHandle, 'GdipGetAdjustableArrowCapHeight');
 @GdipSetAdjustableArrowCapWidth := GetProcAddress(gGDIPDLLHandle, 'GdipSetAdjustableArrowCapWidth');
 @GdipGetAdjustableArrowCapWidth := GetProcAddress(gGDIPDLLHandle, 'GdipGetAdjustableArrowCapWidth');
 @GdipSetAdjustableArrowCapMiddleInset := GetProcAddress(gGDIPDLLHandle, 'GdipSetAdjustableArrowCapMiddleInset');
 @GdipGetAdjustableArrowCapMiddleInset := GetProcAddress(gGDIPDLLHandle, 'GdipGetAdjustableArrowCapMiddleInset');
 @GdipSetAdjustableArrowCapFillState := GetProcAddress(gGDIPDLLHandle, 'GdipSetAdjustableArrowCapFillState');
 @GdipGetAdjustableArrowCapFillState := GetProcAddress(gGDIPDLLHandle, 'GdipGetAdjustableArrowCapFillState');
 @GdipLoadImageFromStream := GetProcAddress(gGDIPDLLHandle, 'GdipLoadImageFromStream');
 @GdipLoadImageFromFile := GetProcAddress(gGDIPDLLHandle, 'GdipLoadImageFromFile');
 @GdipLoadImageFromStreamICM := GetProcAddress(gGDIPDLLHandle, 'GdipLoadImageFromStreamICM');
 @GdipLoadImageFromFileICM := GetProcAddress(gGDIPDLLHandle, 'GdipLoadImageFromFileICM');
 @GdipCloneImage := GetProcAddress(gGDIPDLLHandle, 'GdipCloneImage');
 @GdipDisposeImage := GetProcAddress(gGDIPDLLHandle, 'GdipDisposeImage');
 @GdipSaveImageToFile := GetProcAddress(gGDIPDLLHandle, 'GdipSaveImageToFile');
 @GdipSaveImageToStream := GetProcAddress(gGDIPDLLHandle, 'GdipSaveImageToStream');
 @GdipSaveAdd := GetProcAddress(gGDIPDLLHandle, 'GdipSaveAdd');
 @GdipSaveAddImage := GetProcAddress(gGDIPDLLHandle, 'GdipSaveAddImage');
 @GdipGetImageGraphicsContext := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageGraphicsContext');
 @GdipGetImageBounds := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageBounds');
 @GdipGetImageDimension := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageDimension');
 @GdipGetImageType := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageType');
 @GdipGetImageWidth := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageWidth');
 @GdipGetImageHeight := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageHeight');
 @GdipGetImageHorizontalResolution := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageHorizontalResolution');
 @GdipGetImageVerticalResolution := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageVerticalResolution');
 @GdipGetImageFlags := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageFlags');
 @GdipGetImageRawFormat := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageRawFormat');
 @GdipGetImagePixelFormat := GetProcAddress(gGDIPDLLHandle, 'GdipGetImagePixelFormat');
 @GdipGetImageThumbnail := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageThumbnail');
 @GdipGetEncoderParameterListSize := GetProcAddress(gGDIPDLLHandle, 'GdipGetEncoderParameterListSize');
 @GdipGetEncoderParameterList := GetProcAddress(gGDIPDLLHandle, 'GdipGetEncoderParameterList');
 @GdipImageGetFrameDimensionsCount := GetProcAddress(gGDIPDLLHandle, 'GdipImageGetFrameDimensionsCount');
 @GdipImageGetFrameDimensionsList := GetProcAddress(gGDIPDLLHandle, 'GdipImageGetFrameDimensionsList');
 @GdipImageGetFrameCount := GetProcAddress(gGDIPDLLHandle, 'GdipImageGetFrameCount');
 @GdipImageSelectActiveFrame := GetProcAddress(gGDIPDLLHandle, 'GdipImageSelectActiveFrame');
 @GdipImageRotateFlip := GetProcAddress(gGDIPDLLHandle, 'GdipImageRotateFlip');
 @GdipGetImagePalette := GetProcAddress(gGDIPDLLHandle, 'GdipGetImagePalette');
 @GdipSetImagePalette := GetProcAddress(gGDIPDLLHandle, 'GdipSetImagePalette');
 @GdipGetImagePaletteSize := GetProcAddress(gGDIPDLLHandle, 'GdipGetImagePaletteSize');
 @GdipGetPropertyCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetPropertyCount');
 @GdipGetPropertyIdList := GetProcAddress(gGDIPDLLHandle, 'GdipGetPropertyIdList');
 @GdipGetPropertyItemSize := GetProcAddress(gGDIPDLLHandle, 'GdipGetPropertyItemSize');
 @GdipGetPropertyItem := GetProcAddress(gGDIPDLLHandle, 'GdipGetPropertyItem');
 @GdipGetPropertySize := GetProcAddress(gGDIPDLLHandle, 'GdipGetPropertySize');
 @GdipGetAllPropertyItems := GetProcAddress(gGDIPDLLHandle, 'GdipGetAllPropertyItems');
 @GdipRemovePropertyItem := GetProcAddress(gGDIPDLLHandle, 'GdipRemovePropertyItem');
 @GdipSetPropertyItem := GetProcAddress(gGDIPDLLHandle, 'GdipSetPropertyItem');
 @GdipImageForceValidation := GetProcAddress(gGDIPDLLHandle, 'GdipImageForceValidation');
 @GdipCreateBitmapFromStream := GetProcAddress(gGDIPDLLHandle, 'GdipCreateBitmapFromStream');
 @GdipCreateBitmapFromFile := GetProcAddress(gGDIPDLLHandle, 'GdipCreateBitmapFromFile');
 @GdipCreateBitmapFromStreamICM := GetProcAddress(gGDIPDLLHandle, 'GdipCreateBitmapFromStreamICM');
 @GdipCreateBitmapFromFileICM := GetProcAddress(gGDIPDLLHandle, 'GdipCreateBitmapFromFileICM');
 @GdipCreateBitmapFromScan0 := GetProcAddress(gGDIPDLLHandle, 'GdipCreateBitmapFromScan0');
 @GdipCreateBitmapFromGraphics := GetProcAddress(gGDIPDLLHandle, 'GdipCreateBitmapFromGraphics');
 @GdipCreateBitmapFromDirectDrawSurface := GetProcAddress(gGDIPDLLHandle, 'GdipCreateBitmapFromDirectDrawSurface');
 @GdipCreateBitmapFromGdiDib := GetProcAddress(gGDIPDLLHandle, 'GdipCreateBitmapFromGdiDib');
 @GdipCreateBitmapFromHBITMAP := GetProcAddress(gGDIPDLLHandle, 'GdipCreateBitmapFromHBITMAP');
 @GdipCreateHBITMAPFromBitmap := GetProcAddress(gGDIPDLLHandle, 'GdipCreateHBITMAPFromBitmap');
 @GdipCreateBitmapFromHICON := GetProcAddress(gGDIPDLLHandle, 'GdipCreateBitmapFromHICON');
 @GdipCreateHICONFromBitmap := GetProcAddress(gGDIPDLLHandle, 'GdipCreateHICONFromBitmap');
 @GdipCreateBitmapFromResource := GetProcAddress(gGDIPDLLHandle, 'GdipCreateBitmapFromResource');
 @GdipCloneBitmapArea := GetProcAddress(gGDIPDLLHandle, 'GdipCloneBitmapArea');
 @GdipCloneBitmapAreaI := GetProcAddress(gGDIPDLLHandle, 'GdipCloneBitmapAreaI');
 @GdipBitmapLockBits := GetProcAddress(gGDIPDLLHandle, 'GdipBitmapLockBits');
 @GdipBitmapUnlockBits := GetProcAddress(gGDIPDLLHandle, 'GdipBitmapUnlockBits');
 @GdipBitmapGetPixel := GetProcAddress(gGDIPDLLHandle, 'GdipBitmapGetPixel');
 @GdipBitmapSetPixel := GetProcAddress(gGDIPDLLHandle, 'GdipBitmapSetPixel');
 @GdipBitmapSetResolution := GetProcAddress(gGDIPDLLHandle, 'GdipBitmapSetResolution');
 @GdipCreateImageAttributes := GetProcAddress(gGDIPDLLHandle, 'GdipCreateImageAttributes');
 @GdipCloneImageAttributes := GetProcAddress(gGDIPDLLHandle, 'GdipCloneImageAttributes');
 @GdipDisposeImageAttributes := GetProcAddress(gGDIPDLLHandle, 'GdipDisposeImageAttributes');
 @GdipSetImageAttributesToIdentity := GetProcAddress(gGDIPDLLHandle, 'GdipSetImageAttributesToIdentity');
 @GdipResetImageAttributes := GetProcAddress(gGDIPDLLHandle, 'GdipResetImageAttributes');
 @GdipSetImageAttributesColorMatrix := GetProcAddress(gGDIPDLLHandle, 'GdipSetImageAttributesColorMatrix');
 @GdipSetImageAttributesThreshold := GetProcAddress(gGDIPDLLHandle, 'GdipSetImageAttributesThreshold');
 @GdipSetImageAttributesGamma := GetProcAddress(gGDIPDLLHandle, 'GdipSetImageAttributesGamma');
 @GdipSetImageAttributesNoOp := GetProcAddress(gGDIPDLLHandle, 'GdipSetImageAttributesNoOp');
 @GdipSetImageAttributesColorKeys := GetProcAddress(gGDIPDLLHandle, 'GdipSetImageAttributesColorKeys');
 @GdipSetImageAttributesOutputChannel := GetProcAddress(gGDIPDLLHandle, 'GdipSetImageAttributesOutputChannel');
 @GdipSetImageAttributesOutputChannelColorProfile := GetProcAddress(gGDIPDLLHandle, 'GdipSetImageAttributesOutputChannelColorProfile');
 @GdipSetImageAttributesRemapTable := GetProcAddress(gGDIPDLLHandle, 'GdipSetImageAttributesRemapTable');
 @GdipSetImageAttributesWrapMode := GetProcAddress(gGDIPDLLHandle, 'GdipSetImageAttributesWrapMode');
 @GdipSetImageAttributesICMMode := GetProcAddress(gGDIPDLLHandle, 'GdipSetImageAttributesICMMode');
 @GdipGetImageAttributesAdjustedPalette := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageAttributesAdjustedPalette');
 @GdipFlush := GetProcAddress(gGDIPDLLHandle, 'GdipFlush');
 @GdipCreateFromHDC := GetProcAddress(gGDIPDLLHandle, 'GdipCreateFromHDC');
 @GdipCreateFromHDC2 := GetProcAddress(gGDIPDLLHandle, 'GdipCreateFromHDC2');
 @GdipCreateFromHWND := GetProcAddress(gGDIPDLLHandle, 'GdipCreateFromHWND');
 @GdipCreateFromHWNDICM := GetProcAddress(gGDIPDLLHandle, 'GdipCreateFromHWNDICM');
 @GdipDeleteGraphics := GetProcAddress(gGDIPDLLHandle, 'GdipDeleteGraphics');
 @GdipGetDC := GetProcAddress(gGDIPDLLHandle, 'GdipGetDC');
 @GdipReleaseDC := GetProcAddress(gGDIPDLLHandle, 'GdipReleaseDC');
 @GdipSetCompositingMode := GetProcAddress(gGDIPDLLHandle, 'GdipSetCompositingMode');
 @GdipGetCompositingMode := GetProcAddress(gGDIPDLLHandle, 'GdipGetCompositingMode');
 @GdipSetRenderingOrigin := GetProcAddress(gGDIPDLLHandle, 'GdipSetRenderingOrigin');
 @GdipGetRenderingOrigin := GetProcAddress(gGDIPDLLHandle, 'GdipGetRenderingOrigin');
 @GdipSetCompositingQuality := GetProcAddress(gGDIPDLLHandle, 'GdipSetCompositingQuality');
 @GdipGetCompositingQuality := GetProcAddress(gGDIPDLLHandle, 'GdipGetCompositingQuality');
 @GdipSetSmoothingMode := GetProcAddress(gGDIPDLLHandle, 'GdipSetSmoothingMode');
 @GdipGetSmoothingMode := GetProcAddress(gGDIPDLLHandle, 'GdipGetSmoothingMode');
 @GdipSetPixelOffsetMode := GetProcAddress(gGDIPDLLHandle, 'GdipSetPixelOffsetMode');
 @GdipGetPixelOffsetMode := GetProcAddress(gGDIPDLLHandle, 'GdipGetPixelOffsetMode');
 @GdipSetTextRenderingHint := GetProcAddress(gGDIPDLLHandle, 'GdipSetTextRenderingHint');
 @GdipGetTextRenderingHint := GetProcAddress(gGDIPDLLHandle, 'GdipGetTextRenderingHint');
 @GdipSetTextContrast := GetProcAddress(gGDIPDLLHandle, 'GdipSetTextContrast');
 @GdipGetTextContrast := GetProcAddress(gGDIPDLLHandle, 'GdipGetTextContrast');
 @GdipSetInterpolationMode := GetProcAddress(gGDIPDLLHandle, 'GdipSetInterpolationMode');
 @GdipGetInterpolationMode := GetProcAddress(gGDIPDLLHandle, 'GdipGetInterpolationMode');
 @GdipSetWorldTransform := GetProcAddress(gGDIPDLLHandle, 'GdipSetWorldTransform');
 @GdipResetWorldTransform := GetProcAddress(gGDIPDLLHandle, 'GdipResetWorldTransform');
 @GdipMultiplyWorldTransform := GetProcAddress(gGDIPDLLHandle, 'GdipMultiplyWorldTransform');
 @GdipTranslateWorldTransform := GetProcAddress(gGDIPDLLHandle, 'GdipTranslateWorldTransform');
 @GdipScaleWorldTransform := GetProcAddress(gGDIPDLLHandle, 'GdipScaleWorldTransform');
 @GdipRotateWorldTransform := GetProcAddress(gGDIPDLLHandle, 'GdipRotateWorldTransform');
 @GdipGetWorldTransform := GetProcAddress(gGDIPDLLHandle, 'GdipGetWorldTransform');
 @GdipResetPageTransform := GetProcAddress(gGDIPDLLHandle, 'GdipResetPageTransform');
 @GdipGetPageUnit := GetProcAddress(gGDIPDLLHandle, 'GdipGetPageUnit');
 @GdipGetPageScale := GetProcAddress(gGDIPDLLHandle, 'GdipGetPageScale');
 @GdipSetPageUnit := GetProcAddress(gGDIPDLLHandle, 'GdipSetPageUnit');
 @GdipSetPageScale := GetProcAddress(gGDIPDLLHandle, 'GdipSetPageScale');
 @GdipGetDpiX := GetProcAddress(gGDIPDLLHandle, 'GdipGetDpiX');
 @GdipGetDpiY := GetProcAddress(gGDIPDLLHandle, 'GdipGetDpiY');
 @GdipTransformPoints := GetProcAddress(gGDIPDLLHandle, 'GdipTransformPoints');
 @GdipTransformPointsI := GetProcAddress(gGDIPDLLHandle, 'GdipTransformPointsI');
 @GdipGetNearestColor := GetProcAddress(gGDIPDLLHandle, 'GdipGetNearestColor');
 @GdipCreateHalftonePalette := GetProcAddress(gGDIPDLLHandle, 'GdipCreateHalftonePalette');
 @GdipDrawLine := GetProcAddress(gGDIPDLLHandle, 'GdipDrawLine');
 @GdipDrawLineI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawLineI');
 @GdipDrawLines := GetProcAddress(gGDIPDLLHandle, 'GdipDrawLines');
 @GdipDrawLinesI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawLinesI');
 @GdipDrawArc := GetProcAddress(gGDIPDLLHandle, 'GdipDrawArc');
 @GdipDrawArcI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawArcI');
 @GdipDrawBezier := GetProcAddress(gGDIPDLLHandle, 'GdipDrawBezier');
 @GdipDrawBezierI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawBezierI');
 @GdipDrawBeziers := GetProcAddress(gGDIPDLLHandle, 'GdipDrawBeziers');
 @GdipDrawBeziersI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawBeziersI');
 @GdipDrawRectangle := GetProcAddress(gGDIPDLLHandle, 'GdipDrawRectangle');
 @GdipDrawRectangleI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawRectangleI');
 @GdipDrawRectangles := GetProcAddress(gGDIPDLLHandle, 'GdipDrawRectangles');
 @GdipDrawRectanglesI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawRectanglesI');
 @GdipDrawEllipse := GetProcAddress(gGDIPDLLHandle, 'GdipDrawEllipse');
 @GdipDrawEllipseI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawEllipseI');
 @GdipDrawPie := GetProcAddress(gGDIPDLLHandle, 'GdipDrawPie');
 @GdipDrawPieI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawPieI');
 @GdipDrawPolygon := GetProcAddress(gGDIPDLLHandle, 'GdipDrawPolygon');
 @GdipDrawPolygonI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawPolygonI');
 @GdipDrawPath := GetProcAddress(gGDIPDLLHandle, 'GdipDrawPath');
 @GdipDrawCurve := GetProcAddress(gGDIPDLLHandle, 'GdipDrawCurve');
 @GdipDrawCurveI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawCurveI');
 @GdipDrawCurve2 := GetProcAddress(gGDIPDLLHandle, 'GdipDrawCurve2');
 @GdipDrawCurve2I := GetProcAddress(gGDIPDLLHandle, 'GdipDrawCurve2I');
 @GdipDrawCurve3 := GetProcAddress(gGDIPDLLHandle, 'GdipDrawCurve3');
 @GdipDrawCurve3I := GetProcAddress(gGDIPDLLHandle, 'GdipDrawCurve3I');
 @GdipDrawClosedCurve := GetProcAddress(gGDIPDLLHandle, 'GdipDrawClosedCurve');
 @GdipDrawClosedCurveI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawClosedCurveI');
 @GdipDrawClosedCurve2 := GetProcAddress(gGDIPDLLHandle, 'GdipDrawClosedCurve2');
 @GdipDrawClosedCurve2I := GetProcAddress(gGDIPDLLHandle, 'GdipDrawClosedCurve2I');
 @GdipGraphicsClear := GetProcAddress(gGDIPDLLHandle, 'GdipGraphicsClear');
 @GdipFillRectangle := GetProcAddress(gGDIPDLLHandle, 'GdipFillRectangle');
 @GdipFillRectangleI := GetProcAddress(gGDIPDLLHandle, 'GdipFillRectangleI');
 @GdipFillRectangles := GetProcAddress(gGDIPDLLHandle, 'GdipFillRectangles');
 @GdipFillRectanglesI := GetProcAddress(gGDIPDLLHandle, 'GdipFillRectanglesI');
 @GdipFillPolygon := GetProcAddress(gGDIPDLLHandle, 'GdipFillPolygon');
 @GdipFillPolygonI := GetProcAddress(gGDIPDLLHandle, 'GdipFillPolygonI');
 @GdipFillPolygon2 := GetProcAddress(gGDIPDLLHandle, 'GdipFillPolygon2');
 @GdipFillPolygon2I := GetProcAddress(gGDIPDLLHandle, 'GdipFillPolygon2I');
 @GdipFillEllipse := GetProcAddress(gGDIPDLLHandle, 'GdipFillEllipse');
 @GdipFillEllipseI := GetProcAddress(gGDIPDLLHandle, 'GdipFillEllipseI');
 @GdipFillPie := GetProcAddress(gGDIPDLLHandle, 'GdipFillPie');
 @GdipFillPieI := GetProcAddress(gGDIPDLLHandle, 'GdipFillPieI');
 @GdipFillPath := GetProcAddress(gGDIPDLLHandle, 'GdipFillPath');
 @GdipFillClosedCurve := GetProcAddress(gGDIPDLLHandle, 'GdipFillClosedCurve');
 @GdipFillClosedCurveI := GetProcAddress(gGDIPDLLHandle, 'GdipFillClosedCurveI');
 @GdipFillClosedCurve2 := GetProcAddress(gGDIPDLLHandle, 'GdipFillClosedCurve2');
 @GdipFillClosedCurve2I := GetProcAddress(gGDIPDLLHandle, 'GdipFillClosedCurve2I');
 @GdipFillRegion := GetProcAddress(gGDIPDLLHandle, 'GdipFillRegion');
 @GdipDrawImage := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImage');
 @GdipDrawImageI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImageI');
 @GdipDrawImageRect := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImageRect');
 @GdipDrawImageRectI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImageRectI');
 @GdipDrawImagePoints := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImagePoints');
 @GdipDrawImagePointsI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImagePointsI');
 @GdipDrawImagePointRect := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImagePointRect');
 @GdipDrawImagePointRectI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImagePointRectI');
 @GdipDrawImageRectRect := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImageRectRect');
 @GdipDrawImageRectRectI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImageRectRectI');
 @GdipDrawImagePointsRect := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImagePointsRect');
 @GdipDrawImagePointsRectI := GetProcAddress(gGDIPDLLHandle, 'GdipDrawImagePointsRectI');
 @GdipEnumerateMetafileDestPoint := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileDestPoint');
 @GdipEnumerateMetafileDestPointI := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileDestPointI');
 @GdipEnumerateMetafileDestRect := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileDestRect');
 @GdipEnumerateMetafileDestRectI := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileDestRectI');
 @GdipEnumerateMetafileDestPoints := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileDestPoints');
 @GdipEnumerateMetafileDestPointsI := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileDestPointsI');
 @GdipEnumerateMetafileSrcRectDestPoint := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileSrcRectDestPoint');
 @GdipEnumerateMetafileSrcRectDestPointI := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileSrcRectDestPointI');
 @GdipEnumerateMetafileSrcRectDestRect := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileSrcRectDestRect');
 @GdipEnumerateMetafileSrcRectDestRectI := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileSrcRectDestRectI');
 @GdipEnumerateMetafileSrcRectDestPoints := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileSrcRectDestPoints');
 @GdipEnumerateMetafileSrcRectDestPointsI := GetProcAddress(gGDIPDLLHandle, 'GdipEnumerateMetafileSrcRectDestPointsI');
 @GdipPlayMetafileRecord := GetProcAddress(gGDIPDLLHandle, 'GdipPlayMetafileRecord');
 @GdipSetClipGraphics := GetProcAddress(gGDIPDLLHandle, 'GdipSetClipGraphics');
 @GdipSetClipRect := GetProcAddress(gGDIPDLLHandle, 'GdipSetClipRect');
 @GdipSetClipRectI := GetProcAddress(gGDIPDLLHandle, 'GdipSetClipRectI');
 @GdipSetClipPath := GetProcAddress(gGDIPDLLHandle, 'GdipSetClipPath');
 @GdipSetClipRegion := GetProcAddress(gGDIPDLLHandle, 'GdipSetClipRegion');
 @GdipSetClipHrgn := GetProcAddress(gGDIPDLLHandle, 'GdipSetClipHrgn');
 @GdipResetClip := GetProcAddress(gGDIPDLLHandle, 'GdipResetClip');
 @GdipTranslateClip := GetProcAddress(gGDIPDLLHandle, 'GdipTranslateClip');
 @GdipTranslateClipI := GetProcAddress(gGDIPDLLHandle, 'GdipTranslateClipI');
 @GdipGetClip := GetProcAddress(gGDIPDLLHandle, 'GdipGetClip');
 @GdipGetClipBounds := GetProcAddress(gGDIPDLLHandle, 'GdipGetClipBounds');
 @GdipGetClipBoundsI := GetProcAddress(gGDIPDLLHandle, 'GdipGetClipBoundsI');
 @GdipIsClipEmpty := GetProcAddress(gGDIPDLLHandle, 'GdipIsClipEmpty');
 @GdipGetVisibleClipBounds := GetProcAddress(gGDIPDLLHandle, 'GdipGetVisibleClipBounds');
 @GdipGetVisibleClipBoundsI := GetProcAddress(gGDIPDLLHandle, 'GdipGetVisibleClipBoundsI');
 @GdipIsVisibleClipEmpty := GetProcAddress(gGDIPDLLHandle, 'GdipIsVisibleClipEmpty');
 @GdipIsVisiblePoint := GetProcAddress(gGDIPDLLHandle, 'GdipIsVisiblePoint');
 @GdipIsVisiblePointI := GetProcAddress(gGDIPDLLHandle, 'GdipIsVisiblePointI');
 @GdipIsVisibleRect := GetProcAddress(gGDIPDLLHandle, 'GdipIsVisibleRect');
 @GdipIsVisibleRectI := GetProcAddress(gGDIPDLLHandle, 'GdipIsVisibleRectI');
 @GdipSaveGraphics := GetProcAddress(gGDIPDLLHandle, 'GdipSaveGraphics');
 @GdipRestoreGraphics := GetProcAddress(gGDIPDLLHandle, 'GdipRestoreGraphics');
 @GdipBeginContainer := GetProcAddress(gGDIPDLLHandle, 'GdipBeginContainer');
 @GdipBeginContainerI := GetProcAddress(gGDIPDLLHandle, 'GdipBeginContainerI');
 @GdipBeginContainer2 := GetProcAddress(gGDIPDLLHandle, 'GdipBeginContainer2');
 @GdipEndContainer := GetProcAddress(gGDIPDLLHandle, 'GdipEndContainer');
 @GdipGetMetafileHeaderFromWmf := GetProcAddress(gGDIPDLLHandle, 'GdipGetMetafileHeaderFromWmf');
 @GdipGetMetafileHeaderFromEmf := GetProcAddress(gGDIPDLLHandle, 'GdipGetMetafileHeaderFromEmf');
 @GdipGetMetafileHeaderFromFile := GetProcAddress(gGDIPDLLHandle, 'GdipGetMetafileHeaderFromFile');
 @GdipGetMetafileHeaderFromStream := GetProcAddress(gGDIPDLLHandle, 'GdipGetMetafileHeaderFromStream');
 @GdipGetMetafileHeaderFromMetafile := GetProcAddress(gGDIPDLLHandle, 'GdipGetMetafileHeaderFromMetafile');
 @GdipGetHemfFromMetafile := GetProcAddress(gGDIPDLLHandle, 'GdipGetHemfFromMetafile');
 @GdipCreateStreamOnFile := GetProcAddress(gGDIPDLLHandle, 'GdipCreateStreamOnFile');
 @GdipCreateMetafileFromWmf := GetProcAddress(gGDIPDLLHandle, 'GdipCreateMetafileFromWmf');
 @GdipCreateMetafileFromEmf := GetProcAddress(gGDIPDLLHandle, 'GdipCreateMetafileFromEmf');
 @GdipCreateMetafileFromFile := GetProcAddress(gGDIPDLLHandle, 'GdipCreateMetafileFromFile');
 @GdipCreateMetafileFromWmfFile := GetProcAddress(gGDIPDLLHandle, 'GdipCreateMetafileFromWmfFile');
 @GdipCreateMetafileFromStream := GetProcAddress(gGDIPDLLHandle, 'GdipCreateMetafileFromStream');
 @GdipRecordMetafile := GetProcAddress(gGDIPDLLHandle, 'GdipRecordMetafile');
 @GdipRecordMetafileI := GetProcAddress(gGDIPDLLHandle, 'GdipRecordMetafileI');
 @GdipRecordMetafileFileName := GetProcAddress(gGDIPDLLHandle, 'GdipRecordMetafileFileName');
 @GdipRecordMetafileFileNameI := GetProcAddress(gGDIPDLLHandle, 'GdipRecordMetafileFileNameI');
 @GdipRecordMetafileStream := GetProcAddress(gGDIPDLLHandle, 'GdipRecordMetafileStream');
 @GdipRecordMetafileStreamI := GetProcAddress(gGDIPDLLHandle, 'GdipRecordMetafileStreamI');
 @GdipSetMetafileDownLevelRasterizationLimit := GetProcAddress(gGDIPDLLHandle, 'GdipSetMetafileDownLevelRasterizationLimit');
 @GdipGetMetafileDownLevelRasterizationLimit := GetProcAddress(gGDIPDLLHandle, 'GdipGetMetafileDownLevelRasterizationLimit');
 @GdipGetImageDecodersSize := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageDecodersSize');
 @GdipGetImageDecoders := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageDecoders');
 @GdipGetImageEncodersSize := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageEncodersSize');
 @GdipGetImageEncoders := GetProcAddress(gGDIPDLLHandle, 'GdipGetImageEncoders');
 @GdipComment := GetProcAddress(gGDIPDLLHandle, 'GdipComment');
 @GdipCreateFontFamilyFromName := GetProcAddress(gGDIPDLLHandle, 'GdipCreateFontFamilyFromName');
 @GdipDeleteFontFamily := GetProcAddress(gGDIPDLLHandle, 'GdipDeleteFontFamily');
 @GdipCloneFontFamily := GetProcAddress(gGDIPDLLHandle, 'GdipCloneFontFamily');
 @GdipGetGenericFontFamilySansSerif := GetProcAddress(gGDIPDLLHandle, 'GdipGetGenericFontFamilySansSerif');
 @GdipGetGenericFontFamilySerif := GetProcAddress(gGDIPDLLHandle, 'GdipGetGenericFontFamilySerif');
 @GdipGetGenericFontFamilyMonospace := GetProcAddress(gGDIPDLLHandle, 'GdipGetGenericFontFamilyMonospace');
 @GdipGetFamilyName := GetProcAddress(gGDIPDLLHandle, 'GdipGetFamilyName');
 @GdipIsStyleAvailable := GetProcAddress(gGDIPDLLHandle, 'GdipIsStyleAvailable');
 @GdipFontCollectionEnumerable := GetProcAddress(gGDIPDLLHandle, 'GdipFontCollectionEnumerable');
 @GdipFontCollectionEnumerate := GetProcAddress(gGDIPDLLHandle, 'GdipFontCollectionEnumerate');
 @GdipGetEmHeight := GetProcAddress(gGDIPDLLHandle, 'GdipGetEmHeight');
 @GdipGetCellAscent := GetProcAddress(gGDIPDLLHandle, 'GdipGetCellAscent');
 @GdipGetCellDescent := GetProcAddress(gGDIPDLLHandle, 'GdipGetCellDescent');
 @GdipGetLineSpacing := GetProcAddress(gGDIPDLLHandle, 'GdipGetLineSpacing');
 @GdipCreateFontFromDC := GetProcAddress(gGDIPDLLHandle, 'GdipCreateFontFromDC');
 @GdipCreateFontFromLogfontA := GetProcAddress(gGDIPDLLHandle, 'GdipCreateFontFromLogfontA');
 @GdipCreateFontFromLogfontW := GetProcAddress(gGDIPDLLHandle, 'GdipCreateFontFromLogfontW');
 @GdipCreateFont := GetProcAddress(gGDIPDLLHandle, 'GdipCreateFont');
 @GdipCloneFont := GetProcAddress(gGDIPDLLHandle, 'GdipCloneFont');
 @GdipDeleteFont := GetProcAddress(gGDIPDLLHandle, 'GdipDeleteFont');
 @GdipGetFamily := GetProcAddress(gGDIPDLLHandle, 'GdipGetFamily');
 @GdipGetFontStyle := GetProcAddress(gGDIPDLLHandle, 'GdipGetFontStyle');
 @GdipGetFontSize := GetProcAddress(gGDIPDLLHandle, 'GdipGetFontSize');
 @GdipGetFontUnit := GetProcAddress(gGDIPDLLHandle, 'GdipGetFontUnit');
 @GdipGetFontHeight := GetProcAddress(gGDIPDLLHandle, 'GdipGetFontHeight');
 @GdipGetFontHeightGivenDPI := GetProcAddress(gGDIPDLLHandle, 'GdipGetFontHeightGivenDPI');
 @GdipGetLogFontA := GetProcAddress(gGDIPDLLHandle, 'GdipGetLogFontA');
 @GdipGetLogFontW := GetProcAddress(gGDIPDLLHandle, 'GdipGetLogFontW');
 @GdipNewInstalledFontCollection := GetProcAddress(gGDIPDLLHandle, 'GdipNewInstalledFontCollection');
 @GdipNewPrivateFontCollection := GetProcAddress(gGDIPDLLHandle, 'GdipNewPrivateFontCollection');
 @GdipDeletePrivateFontCollection := GetProcAddress(gGDIPDLLHandle, 'GdipDeletePrivateFontCollection');
 @GdipGetFontCollectionFamilyCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetFontCollectionFamilyCount');
 @GdipGetFontCollectionFamilyList := GetProcAddress(gGDIPDLLHandle, 'GdipGetFontCollectionFamilyList');
 @GdipPrivateAddFontFile := GetProcAddress(gGDIPDLLHandle, 'GdipPrivateAddFontFile');
 @GdipPrivateAddMemoryFont := GetProcAddress(gGDIPDLLHandle, 'GdipPrivateAddMemoryFont');
 @GdipDrawString := GetProcAddress(gGDIPDLLHandle, 'GdipDrawString');
 @GdipMeasureString := GetProcAddress(gGDIPDLLHandle, 'GdipMeasureString');
 @GdipMeasureCharacterRanges := GetProcAddress(gGDIPDLLHandle, 'GdipMeasureCharacterRanges');
 @GdipDrawDriverString := GetProcAddress(gGDIPDLLHandle, 'GdipDrawDriverString');
 @GdipMeasureDriverString := GetProcAddress(gGDIPDLLHandle, 'GdipMeasureDriverString');
 @GdipCreateStringFormat := GetProcAddress(gGDIPDLLHandle, 'GdipCreateStringFormat');
 @GdipStringFormatGetGenericDefault := GetProcAddress(gGDIPDLLHandle, 'GdipStringFormatGetGenericDefault');
 @GdipStringFormatGetGenericTypographic := GetProcAddress(gGDIPDLLHandle, 'GdipStringFormatGetGenericTypographic');
 @GdipDeleteStringFormat := GetProcAddress(gGDIPDLLHandle, 'GdipDeleteStringFormat');
 @GdipCloneStringFormat := GetProcAddress(gGDIPDLLHandle, 'GdipCloneStringFormat');
 @GdipSetStringFormatFlags := GetProcAddress(gGDIPDLLHandle, 'GdipSetStringFormatFlags');
 @GdipGetStringFormatFlags := GetProcAddress(gGDIPDLLHandle, 'GdipGetStringFormatFlags');
 @GdipSetStringFormatAlign := GetProcAddress(gGDIPDLLHandle, 'GdipSetStringFormatAlign');
 @GdipGetStringFormatAlign := GetProcAddress(gGDIPDLLHandle, 'GdipGetStringFormatAlign');
 @GdipSetStringFormatLineAlign := GetProcAddress(gGDIPDLLHandle, 'GdipSetStringFormatLineAlign');
 @GdipGetStringFormatLineAlign := GetProcAddress(gGDIPDLLHandle, 'GdipGetStringFormatLineAlign');
 @GdipSetStringFormatTrimming := GetProcAddress(gGDIPDLLHandle, 'GdipSetStringFormatTrimming');
 @GdipGetStringFormatTrimming := GetProcAddress(gGDIPDLLHandle, 'GdipGetStringFormatTrimming');
 @GdipSetStringFormatHotkeyPrefix := GetProcAddress(gGDIPDLLHandle, 'GdipSetStringFormatHotkeyPrefix');
 @GdipGetStringFormatHotkeyPrefix := GetProcAddress(gGDIPDLLHandle, 'GdipGetStringFormatHotkeyPrefix');
 @GdipSetStringFormatTabStops := GetProcAddress(gGDIPDLLHandle, 'GdipSetStringFormatTabStops');
 @GdipGetStringFormatTabStops := GetProcAddress(gGDIPDLLHandle, 'GdipGetStringFormatTabStops');
 @GdipGetStringFormatTabStopCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetStringFormatTabStopCount');
 @GdipSetStringFormatDigitSubstitution := GetProcAddress(gGDIPDLLHandle, 'GdipSetStringFormatDigitSubstitution');
 @GdipGetStringFormatDigitSubstitution := GetProcAddress(gGDIPDLLHandle, 'GdipGetStringFormatDigitSubstitution');
 @GdipGetStringFormatMeasurableCharacterRangeCount := GetProcAddress(gGDIPDLLHandle, 'GdipGetStringFormatMeasurableCharacterRangeCount');
 @GdipSetStringFormatMeasurableCharacterRanges := GetProcAddress(gGDIPDLLHandle, 'GdipSetStringFormatMeasurableCharacterRanges');
 @GdipCreateCachedBitmap := GetProcAddress(gGDIPDLLHandle, 'GdipCreateCachedBitmap');
 @GdipDeleteCachedBitmap := GetProcAddress(gGDIPDLLHandle, 'GdipDeleteCachedBitmap');
 @GdipDrawCachedBitmap := GetProcAddress(gGDIPDLLHandle, 'GdipDrawCachedBitmap');
 @GdipEmfToWmfBits := GetProcAddress(gGDIPDLLHandle, 'GdipEmfToWmfBits');
end;

function IsGDIPlus: Boolean;
begin
 if not gTriedToLoadGP then
  LoadGDIPlus;
 Result := gGDIPDLLHandle <> 0;
end;

procedure UnloadGDIPlus;
begin
 if gGDIPDLLHandle <> 0 then
  FreeLibrary(gGDIPDLLHandle);
end;
