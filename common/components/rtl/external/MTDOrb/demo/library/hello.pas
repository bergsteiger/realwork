...
type
  ...
  protected
    procedure hello(const s: AnsiString); virtual; abstract;
  ...
  protected
    procedure hello(const s: AnsiString); virtual;
    function narrow_helper(const str: RepositoryID): Pointer; override;
  end;
...
// THello_stub
//***********************************************************
procedure THello_stub.hello(const s: AnsiString);
var
  req: IStaticRequest;
  _s: IStaticAny;
begin
...
procedure THello_stub_clp.hello(const s: AnsiString);
var
  _srv: IServant;
  srv: IHello;
begin
...
begin
  ...
  if req.op_name = 'hello' then
    begin
      req.add_in_arg(StaticAny(stat_string,@hello_s) as IStaticAny);
