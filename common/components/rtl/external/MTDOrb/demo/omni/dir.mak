...
server.exe: helloworld.obj server.obj
...
veryclean::
  -del *.obj
  -del helloworld.* helloworld.h
  -del *.exe


helloworld.h helloworld.cpp: helloworld.idl
	$(TOP)\bin\x86_win32\omniidl -T -bcxx -Wbh=.h -Wbs=.cpp helloworld.idl

helloworld.idl: $(TOP)\idl\helloworld.idl
	copy $(TOP)\idl\helloworld.idl .
