...
var
  ...
  fl : TStream;
  ref: string;
  myintf: Ischott_demai_display_prodat_corba2ejb_ArtikelServer;
  prm: TStrings;
  i: Integer;
  //testArr: Tarr;
begin
  ...
  myintf := Tschott_demai_display_prodat_corba2ejb_ArtikelServer._narrow(obj);
  ref := 'Client';
  try
    ref := myintf.getArbeitsplatzList();
  except
    on E: Exception do
      WriteLn(E.Message);
  end;
...
begin
  ...
  if req.has_service_context(100) then begin
