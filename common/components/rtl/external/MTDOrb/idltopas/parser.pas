...
type
  ...
  private
    ...
    FNodeType : TNodeType;
    FIdent : AnsiString;
    FStringLiteral: AnsiString;
    FWStringLiteral: widestring;
    FIntegerLiteral : Int64;
    FCharacterLiteral : Ansichar;
    FWCharacterLiteral : widechar;
    ...
    FTopLevel : Boolean;
  public
    constructor Create(nodetype: TNodeType; sub: TNode = nil; sub2: TNode = nil;
      sub3: TNode = nil; sub4: TNode = nil;sub5: TNode = nil);
    destructor Destroy(); override;
    procedure setBranch(index: integer; node: TNode);
    function getBranch(index: integer): TNode;
    procedure setIdent(ident: AnsiString);
    function getIdent(): AnsiString;
    procedure setIntegerLiteral(int: Int64);
    procedure setStringLiteral(str: AnsiString);
    procedure setWStringLiteral(str: widestring);
    procedure setWCharacterLiteral(ch: widechar);
    procedure setCharacterLiteral(ch: AnsiChar);
    ...
    property integer_literal : Int64 read FIntegerLiteral;
    property character_literal : AnsiChar read FCharacterLiteral;
    property wcharacter_literal : widechar read FWCharacterLiteral;
    property boolean_literal : boolean read FBooleanLiteral;
    property float_literal : double read FDouble;
    property string_literal : AnsiString read FStringLiteral;
    property wstring_literal : widestring read FWStringLiteral;
    property top_level : Boolean read FTopLevel;
    property line_number: integer read FLineNumber;
    property file_name : AnsiString read FFileName;
  end;
...
// TNode
//*********************************************************************
constructor TNode.Create(nodetype: TNodeType; sub: TNode = nil; sub2: TNode = nil;
      sub3: TNode = nil; sub4: TNode = nil;sub5: TNode = nil);
begin
  FNodeType := nodetype;
  FBranches[1] := sub;
  ...
  FFileName := AnsiString(current_file);
...
function TNode.getIdent: AnsiString;
begin
  result := FIdent;
end;
...
procedure TNode.setCharacterLiteral(ch: AnsiChar);
begin
...
procedure TNode.setIdent(ident: AnsiString);
begin
  FIdent := ident
end;

procedure TNode.setIntegerLiteral(int: Int64);
begin
  FIntegerLiteral := int;
end;

procedure TNode.setStringLiteral(str: AnsiString);
begin
  FStringLiteral := str
end;
...
procedure TNode.setWStringLiteral(str: widestring);
begin
  FWStringLiteral := str
end;

procedure TNode.setWCharacterLiteral(ch: widechar);
begin
