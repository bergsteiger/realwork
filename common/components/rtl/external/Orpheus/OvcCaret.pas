...
const
  {Default values for TOvcCaretTypes, TOvcCarets and TOvcCaretPairs}
  DefAlign     = caLeft;
  DefBlinkTime = 0;
  DefCaretWd   = 2;
  DefCaretHt   = 10;
