...
uses
  ...
  ExtCtrls, CalUnit, OvcConst, OvcValid, OvcExcpt, OvcEditU, STDate;
...
begin
  ...
  try
    ...
    if CalForm.ModalResult = idOK then begin
      PF.AsOvcDate := CalForm.Calendar.CalendarDate;
...
procedure TAddrForm.OvcSpinner1Click(Sender: TObject; State: TSpinState;
  Delta: Double; Wrap: Boolean);
var
  CurState : string[2];
  I : Integer;
...
procedure TAddrForm.DisplayCalendar(Sender: TObject;
  Command: Word);
var
  PF : TOvcPictureField;
  D  : TOvcDate;
