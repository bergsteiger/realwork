...
type
  TfrmCal = class(TForm)
    ...
    procedure Spinner1Click(Sender: TObject; State: TSpinState;
      Delta: Double; Wrap: Boolean);
    procedure Spinner2Click(Sender: TObject; State: TSpinState;
      Delta: Double; Wrap: Boolean);
...
procedure TfrmCal.Spinner1Click(Sender: TObject; State: TSpinState;
  Delta: Double; Wrap: Boolean);
begin
  case State of
...
procedure TfrmCal.Spinner2Click(Sender: TObject; State: TSpinState;
  Delta: Double; Wrap: Boolean);
begin
  case State of
