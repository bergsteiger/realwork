...
uses
  ...
  STDate, ExtCtrls, CalUnit, OvcConst, OvcValid, OvcExcpt, OvcTCmmn, OvcMisc,
...
procedure TOrdEntryForm.OvcSpinner1Click(Sender: TObject; State: TSpinState;
  Delta: Double; Wrap: Boolean);
var
  CurState : string[2];
  I : Integer;
