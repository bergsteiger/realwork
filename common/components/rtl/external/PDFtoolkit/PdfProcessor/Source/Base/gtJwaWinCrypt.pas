...
// $Id: gtJwaWinCrypt.pas,v 1.1 2010/04/21 08:06:42 voba Exp $
...
function CertVerifyRevocation(dwEncodingType, dwRevType, cContext: DWORD;
  rgpvContext: LPVOID; dwFlags: DWORD; pRevPara: PCERT_REVOCATION_PARA;
...
//
  ...
  _CERT_SIMPLE_CHAIN = record
    ...
    TrustStatus: CERT_TRUST_STATUS;
    cElement: DWORD;
    rgpElement: array of PCERT_CHAIN_ELEMENT;
...
//
  ...
  _CERT_CHAIN_CONTEXT = record
    ...
    TrustStatus: CERT_TRUST_STATUS;
    cChain: DWORD;
    rgpChain: array of PCERT_SIMPLE_CHAIN;
  end;
