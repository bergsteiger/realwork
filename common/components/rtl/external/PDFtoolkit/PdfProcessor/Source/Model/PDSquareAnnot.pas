...
type
  ...
  TgtPDSquareAnnot = class(TgtPDAnnot)
  private
...
uses
  PDDictionary, PDArray, PDInteger, PDReal, PDName, PDDocument;

constructor TgtPDSquareAnnot.Create(AParentDoc: TgtObject;
  AParentElement: TgtPDElement; ABaseObject: TgtPDBaseObject);
begin
  FParentDoc := AParentDoc;
  FParentElement := AParentElement;
  FBaseObject := ABaseObject;
  AnnotType := annotSquare;
  FIntensity := -1;
end;

function TgtPDSquareAnnot.GetInteriorColor: TgtPDColorValue;
var
...
constructor TgtPDSquareAnnot.Create;
begin
  inherited;
  AnnotType := annotSquare;
  FIntensity := 0;
...
destructor TgtPDSquareAnnot.Destroy;
begin

  inherited;
end;

function TgtPDSquareAnnot.GetIntensity: Double;
var
  LObj: TgtPDBaseObject;
...
function TgtPDSquareAnnot.GetIsCloudy: Boolean;
var
  LObj: TgtPDBaseObject;
...
procedure TgtPDSquareAnnot.SetInteriorColor(const Value: TgtPDColorValue);
var
  LObj: TgtPDBaseObject;
  LColor: TgtPDBaseObject;
  LRealObj: TgtPDReal;
...
procedure TgtPDSquareAnnot.SetIntensity(const Value: Double);
var
  LObj: TgtPDBaseObject;
  LIntensity: TgtPDBaseObject;
  LRealObj: TgtPDReal;
...
procedure TgtPDSquareAnnot.SetIsCloudy(const Value: Boolean);
var
  LObj: TgtPDBaseObject;
  LCloudy: TgtPDBaseObject;
  LValue: AnsiString;
