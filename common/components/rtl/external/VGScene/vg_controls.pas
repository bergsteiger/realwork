...
begin
  ...
  begin
    ...
    { check }
    // проверяем в одном условии, чтобы не было - http://mdp.garant.ru/pages/viewpage.action?pageId=327816533
    ...
    { event }
    // вызываем всегда, даже на неизменившейся радиокнопке - http://mdp.garant.ru/pages/viewpage.action?pageId=327353074   
    if Assigned(FOnChange) then
      FOnChange(Self);
  end;
end;
