...
uses
  ...
  vg_effects, vgComponent,

  vgBitmap, vgCustomObject, vgCustomControl, vgScenePrim
  ;
...
begin
  ...
  TvgCanvas(tmp.Canvas).DrawBitmap(FBitmap, vgRect(0, 0, FBitmap.Width, FBitmap.Height), vgRect(0, 0, tmp.Width, tmp.Height), 1);
