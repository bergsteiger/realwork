...
begin
  ...
  pix := Bitmap.Scanline[0];
    ...
    l3System.GetLocalMem(r, wh * SizeOf(Integer));
    l3System.GetLocalMem(g, wh * SizeOf(Integer));
    l3System.GetLocalMem(b, wh * SizeOf(Integer));
    l3System.GetLocalMem(a, wh * SizeOf(Integer));
    l3System.GetLocalMem(vmin, max(w, h) * SizeOf(Integer));
    divsum := (vdiv + 1) shr 1;
    divsum := divsum * divsum;
    l3System.GetLocalMem(dv, 256 * divsum * SizeOf(Integer));
    ...
    l3System.GetLocalMem(stack, vdiv * SizeOf(TvgColor));
    ...
    l3System.FreeLocalMem(stack{, vdiv * SizeOf(TvgColor)});
    l3System.FreeLocalMem(dv{, 256 * divsum * SizeOf(Integer)});
    l3System.FreeLocalMem(vmin{, max(w, h) * SizeOf(Integer)});
    l3System.FreeLocalMem(a{, wh * SizeOf(Integer)});
    l3System.FreeLocalMem(r{, wh * SizeOf(Integer)});
    l3System.FreeLocalMem(g{, wh * SizeOf(Integer)});
    l3System.FreeLocalMem(b{, wh * SizeOf(Integer)});
end;
...
procedure TvgShadowEffect.Cleanup;
begin
  inherited;
end;
...
begin
  ...
  { free mask }
  l3System.FreeLocalMem(Mask{, Visual.Width * Visual.Height});
end;
...
procedure TvgBlurEffect.Cleanup;
begin
  inherited;
end;
...
procedure TvgGlowEffect.Cleanup;
begin
  inherited;
end;
...
procedure TvgInnerGlowEffect.Cleanup;
begin
  inherited;
end;
...
procedure TvgBevelEffect.Cleanup;
begin
  inherited;
end;
...
begin
  ...
  { copy bitmap }
  l3Move(DestBits^, Bits^, Visual.Width * Visual.Height * 4);
  { blur - make HeightMap }
...
procedure TvgReflectionEffect.Cleanup;
begin
  inherited;
end;
