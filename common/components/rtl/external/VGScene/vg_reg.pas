...
begin
  ...
  RegisterNoIcon([TvgRectAnimation,
    ...
    TvgHudRadioButton, TvgHudComboColorBox, TvgHudMemo,
    {$If Declared(TvgHudStringListBox)}
    TvgHudStringListBox,
    {$IfEnd}
    TvgHudTrack,
    TvgHudHorzImageListBox,
    ...
    {$If Declared(TvgHudComboTrackBar)}
    TvgHudComboTrackBar,
    {$IfEnd}
    TvgHudImageListBox, TvgHudSpinBox, TvgHudComboBox, TvgHudAngleButton, TvgHudButton,
    ...
    TvgNonVGLayout, TvgStringComboBox, TvgHorzImageListBox,
    {$If Declared(TvgStringListBox)}
    TvgStringListBox,
    {$IfEnd}
    TvgComboBox, TvgHorzListBox,
    ...
    TvgMemo, TvgCalendarTextBox, TvgSpinBox,
    {$If Declared(TvgComboTrackBar)}
    TvgComboTrackBar,
    {$IfEnd}
    TvgStatusBar, TvgToolButton, 
