...
type
  ...
  protected
    ...
    // l3System.GetLocalMem call.  The client must call l3System.FreeLocalMem on Data if it is not NIL.
...
// fRightEdge has to be set before FontChanged is called for the first time
  ...
  fFocusList := TvgObjectList.Create;
...
{  if WordWrap and fWordWrapGlyph.Visible then
  ...
  begin
    ...
    try
      ...
      l3System.FreeLocalMem(aGutterOffs);
    end;
  end
