...
begin
  inherited;
  FGlobalList := TvgObjectList.Create;
...
function CompareTreeItem(item1, item2: TvgCustomObject): integer;
begin
...
var
  ...
  begin
    ...
    P := TvgVisualObject(AItem.Parent.Visual).AbsoluteToLocal(P);
