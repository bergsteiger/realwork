{*********************************************************}
{* XMLPartner Pro: XpHash.PAS 2.56                       *}
...
type
  ...
  TXpStrHash = class(TPersistent)
    protected
      ...
      function XhAddPrim(aKey   : DOMString;
                         aValue : Pointer) : Boolean;
        {-Use this method to add an entry to the hash table.  Returns True if
          the key/value pair was added or False if the key is already in the
          hash table. }
...
{--------}
function TXpStrHash.Add(aKey   : DOMString;
                        aValue : Pointer): Boolean;
begin
...
{--------}
function TXpStrHash.XhAddPrim(aKey   : DOMString;
                              aValue : Pointer): Boolean;
var
  Inx  : Longint;
  Node : TXpStrHashNode;
