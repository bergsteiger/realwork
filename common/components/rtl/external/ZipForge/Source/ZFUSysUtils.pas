...
function WideFileSetAttr(const FileName: WideString; Attr: Cardinal): Boolean;
...
uses
  ...
  {$IFDEF COMPILER_9_UP} WideStrUtils, {$ENDIF} ZFUWideStrUtils,
  ZFUSystem, ZFUWindows, ZFUFormatStrUtils;
