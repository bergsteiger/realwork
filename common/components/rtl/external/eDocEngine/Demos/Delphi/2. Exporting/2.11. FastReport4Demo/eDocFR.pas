...
uses
  ...
  frxDesgn, frxDCtrl, frxChart, frxRich, frxCrypt, frxBarcode, ImgList,
...
begin
  ...
  SBMPDescription + SJPEGDescription + SEMFDescription + SWMFDescription +SGIFDescription+SXLSDescription;
  {$IFDEF gtPro}
  ...
  case SaveDialog1.FilterIndex of
    ...
    16: gtFRFilter.Engine := gtXLSEngine1;
    {$IFDEF gtPro}
    17: gtFRFilter.Engine := FfrmProComponent.gtSVGEngine1;
    18: gtFRFilter.Engine := FfrmProComponent.gtPNGEngine1;
    19: gtFRFilter.Engine := FfrmProComponent.gtTIFFEngine1;
    {$ENDIF}
  end;
