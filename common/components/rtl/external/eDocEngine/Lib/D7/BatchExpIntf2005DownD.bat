...
echo "ExpReg" >> %8
rem ----------------------------------------ExpReg.pas-------------------------------------------------
%1 -B %7 -I%3 -LN%4 -LE%4 -NB%4 -N0%4 -NH%4 -U%3 -U%4 -U%6 -$A+B-C-D-H+I-J-L-M-N+O+P+Q-R-S-T-U-V+W-X+Y- >> %8

echo "Runtime" >> %8   
rem ----------------------------------------Exp Intf Run Time for Delphi-------------------------------------------------
%1 -B %2 -I%3 -LN%4 -LE%4 -NB%4 -N0%4 -NH%4 -U%3 -U%4 -U%6 -$A+B-C-D-H+I-J-L-M-N+O+P+Q-R-S-T-U-V+W-X+Y- >> %8

echo "Designtime" >> %8
rem ----------------------------------------Exp Intf Design Time for Delphi----------------------------------------------
%1 -B %5 -I%3 -LN%4 -LE%4 -NB%4 -N0%4 -NH%4 -U%3 -U%4 -U%6 -$A+B-C-D-H+I-J-L-M-N+O+P+Q-R-S-T-U-V+W-X+Y- >> %8
