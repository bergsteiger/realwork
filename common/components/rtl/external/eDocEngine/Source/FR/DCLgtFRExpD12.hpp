...
// (DO NOT EDIT: machine generated header) 'Dclgtfrexpd12.pas' rev: 20.00

#ifndef Dclgtfrexpd12HPP
#define Dclgtfrexpd12HPP
...
#include <Gtfrexpreg.hpp>	// Pascal unit
...
#include <Gtglyphinfo.hpp>	// Pascal unit
#include <Gtpdffont3.hpp>	// Pascal unit
...
namespace Dclgtfrexpd12
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclgtfrexpd12 */
using namespace Dclgtfrexpd12;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Dclgtfrexpd12HPP
