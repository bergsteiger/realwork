...
{$EXTERNALSYM QualityMode}
  QualityMode = (QualityModeInvalid = -1, QualityModeDefault = 0,
...
{$EXTERNALSYM CompositingMode}
  CompositingMode = (CompositingModeSourceOver, // 0
...
{$EXTERNALSYM CompositingQuality}
  CompositingQuality = (CompositingQualityInvalid = ord(QualityModeInvalid),
...
{$ENDIF}
  ...
  // {$EXTERNALSYM Unit}
  Unit_ = (UnitWorld, // 0 -- World coordinate (non-physical unit)
...
{$EXTERNALSYM MetafileFrameUnit}
  MetafileFrameUnit = (MetafileFrameUnitPixel = ord(UnitPixel),
    MetafileFrameUnitPoint = ord(UnitPoint),
    MetafileFrameUnitInch = ord(UnitInch),
    MetafileFrameUnitDocument = ord(UnitDocument),
    MetafileFrameUnitMillimeter = ord(UnitMillimeter), MetafileFrameUnitGdi
    // GDI compatible .01 MM units
    );
...
{$EXTERNALSYM CoordinateSpace}
  CoordinateSpace = (CoordinateSpaceWorld, // 0
...
{$EXTERNALSYM HatchStyle}
  HatchStyle = (HatchStyleHorizontal, // = 0,
...
{$IFDEF DELPHI6_UP}
{$EXTERNALSYM DashCap}
  DashCap = (DashCapFlat = 0, DashCapRound = 2, DashCapTriangle = 3);
  TDashCap = DashCap;
{$ELSE}
{$EXTERNALSYM DashCap}
  DashCap = Integer;
...
{$IFDEF DELPHI6_UP}
{$EXTERNALSYM LineCap}
  LineCap = (LineCapFlat = 0, LineCapSquare = 1, LineCapRound = 2,
    LineCapTriangle = 3,
...
{$EXTERNALSYM CustomLineCapType}
  CustomLineCapType = (CustomLineCapTypeDefault,
...
{$EXTERNALSYM LineJoin}
  LineJoin = (LineJoinMiter, LineJoinBevel, LineJoinRound,
...
{$EXTERNALSYM PathPointType}
  PathPointType = (PathPointTypeStart = $00, // move
...
{$EXTERNALSYM WarpMode}
  WarpMode = (WarpModePerspective, // 0
    WarpModeBilinear // 1
    );
  TWarpMode = WarpMode;
...
{$EXTERNALSYM LinearGradientMode}
  LinearGradientMode = (LinearGradientModeHorizontal, // 0
...
{$EXTERNALSYM CombineMode}
  CombineMode = (CombineModeReplace, // 0
...
{$EXTERNALSYM InterpolationMode}
  InterpolationMode = (InterpolationModeInvalid = ord(QualityModeInvalid),
    ...
    InterpolationModeBilinear, InterpolationModeBicubic,
...
{$IFDEF DELPHI6_UP}
{$EXTERNALSYM PenType}
  PenType = (PenTypeSolidColor = ord(BrushTypeSolidColor),
    ...
    PenTypeLinearGradient = ord(BrushTypeLinearGradient), PenTypeUnknown = -1);
  TPenType = PenType;
{$ELSE}
{$EXTERNALSYM PenType}
  PenType = Integer;
...
{$EXTERNALSYM GenericFontFamily}
  GenericFontFamily = (GenericFontFamilySerif, GenericFontFamilySansSerif,
...
{$EXTERNALSYM SmoothingMode}
  SmoothingMode = (SmoothingModeInvalid = ord(QualityModeInvalid),
    SmoothingModeDefault = ord(QualityModeDefault),
    SmoothingModeHighSpeed = ord(QualityModeLow),
    SmoothingModeHighQuality = ord(QualityModeHigh), SmoothingModeNone,
...
{$EXTERNALSYM PixelOffsetMode}
  PixelOffsetMode = (PixelOffsetModeInvalid = ord(QualityModeInvalid),
    PixelOffsetModeDefault = ord(QualityModeDefault),
    PixelOffsetModeHighSpeed = ord(QualityModeLow),
    PixelOffsetModeHighQuality = ord(QualityModeHigh), PixelOffsetModeNone,
    // No pixel offset
...
{$EXTERNALSYM MetafileType}
  MetafileType = (MetafileTypeInvalid, // Invalid metafile
...
{$IFDEF DELPHI6_UP}
{$EXTERNALSYM EmfType}
  EmfType = (EmfTypeEmfOnly = ord(MetafileTypeEmf), // no EMF+, only EMF
...
{$EXTERNALSYM EmfPlusRecordType}
  EmfPlusRecordType = (
    ...
    WmfRecordTypeSetPolyFillMode = (META_SETPOLYFILLMODE or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeSetStretchBltMode =
    (META_SETSTRETCHBLTMODE or GDIP_WMF_RECORD_BASE),
    WmfRecordTypeSetTextCharExtra = (META_SETTEXTCHAREXTRA or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeSetTextColor = (META_SETTEXTCOLOR or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeSetTextJustification =
    (META_SETTEXTJUSTIFICATION or GDIP_WMF_RECORD_BASE),
    ...
    WmfRecordTypeOffsetWindowOrg = (META_OFFSETWINDOWORG or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeScaleWindowExt = (META_SCALEWINDOWEXT or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeOffsetViewportOrg =
    (META_OFFSETVIEWPORTORG or GDIP_WMF_RECORD_BASE),
    WmfRecordTypeScaleViewportExt = (META_SCALEVIEWPORTEXT or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeLineTo = (META_LINETO or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeMoveTo = (META_MOVETO or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeExcludeClipRect =
    (META_EXCLUDECLIPRECT or GDIP_WMF_RECORD_BASE),
    WmfRecordTypeIntersectClipRect = (META_INTERSECTCLIPRECT or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeArc = (META_ARC or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeEllipse = (META_ELLIPSE or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeFloodFill = (META_FLOODFILL or
    GDIP_WMF_RECORD_BASE), WmfRecordTypePie = (META_PIE or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeRectangle = (META_RECTANGLE or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeRoundRect = (META_ROUNDRECT or
    GDIP_WMF_RECORD_BASE), WmfRecordTypePatBlt = (META_PATBLT or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeSaveDC = (META_SAVEDC or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeSetPixel = (META_SETPIXEL or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeOffsetClipRgn = (META_OFFSETCLIPRGN or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeTextOut = (META_TEXTOUT or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeBitBlt = (META_BITBLT or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeStretchBlt = (META_STRETCHBLT or
    GDIP_WMF_RECORD_BASE), WmfRecordTypePolygon = (META_POLYGON or
    GDIP_WMF_RECORD_BASE), WmfRecordTypePolyline = (META_POLYLINE or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeEscape = (META_ESCAPE or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeRestoreDC = (META_RESTOREDC or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeFillRegion = (META_FILLREGION or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeFrameRegion = (META_FRAMEREGION or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeInvertRegion = (META_INVERTREGION or
    GDIP_WMF_RECORD_BASE), WmfRecordTypePaintRegion = (META_PAINTREGION or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeSelectClipRegion =
    (META_SELECTCLIPREGION or GDIP_WMF_RECORD_BASE),
    ...
    WmfRecordTypeDIBCreatePatternBrush = (META_DIBCREATEPATTERNBRUSH or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeStretchDIB = (META_STRETCHDIB or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeExtFloodFill = (META_EXTFLOODFILL or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeSetLayout = ($0149 or
    GDIP_WMF_RECORD_BASE), // META_SETLAYOUT
    ...
    // META_CREATEBRUSH
    WmfRecordTypeCreatePatternBrush = (META_CREATEPATTERNBRUSH or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeCreatePenIndirect =
    (META_CREATEPENINDIRECT or GDIP_WMF_RECORD_BASE),
    WmfRecordTypeCreateFontIndirect = (META_CREATEFONTINDIRECT or
    GDIP_WMF_RECORD_BASE), WmfRecordTypeCreateBrushIndirect =
    (META_CREATEBRUSHINDIRECT or GDIP_WMF_RECORD_BASE),
    ...
    EmfRecordTypePolygon = EMR_POLYGON, EmfRecordTypePolyline = EMR_POLYLINE,
    ...
    EmfRecordTypeSetBrushOrgEx = EMR_SETBRUSHORGEX, EmfRecordTypeEOF = EMR_EOF,
    ...
    EmfRecordTypeSaveDC = EMR_SAVEDC, EmfRecordTypeRestoreDC = EMR_RESTOREDC,
    ...
    EmfRecordTypeAngleArc = EMR_ANGLEARC, EmfRecordTypeEllipse = EMR_ELLIPSE,
    EmfRecordTypeRectangle = EMR_RECTANGLE,
    EmfRecordTypeRoundRect = EMR_ROUNDRECT, EmfRecordTypeArc = EMR_ARC,
    EmfRecordTypeChord = EMR_CHORD, EmfRecordTypePie = EMR_PIE,
    ...
    EmfRecordTypeLineTo = EMR_LINETO, EmfRecordTypeArcTo = EMR_ARCTO,
    EmfRecordTypePolyDraw = EMR_POLYDRAW,
    EmfRecordTypeSetArcDirection = EMR_SETARCDIRECTION,
    EmfRecordTypeSetMiterLimit = EMR_SETMITERLIMIT,
    EmfRecordTypeBeginPath = EMR_BEGINPATH, EmfRecordTypeEndPath = EMR_ENDPATH,
    ...
    EmfRecordTypeAbortPath = EMR_ABORTPATH, EmfRecordTypeReserved_069 = 69,
    // Not Used
    EmfRecordTypeGdiComment = EMR_GDICOMMENT,
    EmfRecordTypeFillRgn = EMR_FILLRGN, EmfRecordTypeFrameRgn = EMR_FRAMERGN,
    EmfRecordTypeInvertRgn = EMR_INVERTRGN,
    EmfRecordTypePaintRgn = EMR_PAINTRGN,
    EmfRecordTypeExtSelectClipRgn = EMR_EXTSELECTCLIPRGN,
    EmfRecordTypeBitBlt = EMR_BITBLT, EmfRecordTypeStretchBlt = EMR_STRETCHBLT,
    EmfRecordTypeMaskBlt = EMR_MASKBLT, EmfRecordTypePlgBlt = EMR_PLGBLT,
    ...
    EmfRecordTypePolyTextOutW = EMR_POLYTEXTOUTW, EmfRecordTypeSetICMMode = 98,
    // EMR_SETICMMODE,
    ...
    EmfPlusRecordTypeHeader, EmfPlusRecordTypeEndOfFile,
    ...
    EmfPlusRecordTypeDrawRects, EmfPlusRecordTypeFillPolygon,
    EmfPlusRecordTypeDrawLines, EmfPlusRecordTypeFillEllipse,
    EmfPlusRecordTypeDrawEllipse, EmfPlusRecordTypeFillPie,
    EmfPlusRecordTypeDrawPie, EmfPlusRecordTypeDrawArc,
    ...
    EmfPlusRecordTypeScaleWorldTransform, EmfPlusRecordTypeRotateWorldTransform,
    EmfPlusRecordTypeSetPageTransform, EmfPlusRecordTypeResetClip,
    EmfPlusRecordTypeSetClipRect, EmfPlusRecordTypeSetClipPath,
    EmfPlusRecordTypeSetClipRegion, EmfPlusRecordTypeOffsetClip,
...
const
  ...
  WmfRecordTypeSetStretchBltMode = (META_SETSTRETCHBLTMODE or
    GDIP_WMF_RECORD_BASE);
  WmfRecordTypeSetTextCharExtra = (META_SETTEXTCHAREXTRA or
    GDIP_WMF_RECORD_BASE);
  WmfRecordTypeSetTextColor = (META_SETTEXTCOLOR or GDIP_WMF_RECORD_BASE);
  WmfRecordTypeSetTextJustification = (META_SETTEXTJUSTIFICATION or
    GDIP_WMF_RECORD_BASE);
  WmfRecordTypeSetWindowOrg = (META_SETWINDOWORG or GDIP_WMF_RECORD_BASE);
  WmfRecordTypeSetWindowExt = (META_SETWINDOWEXT or GDIP_WMF_RECORD_BASE);
  WmfRecordTypeSetViewportOrg = (META_SETVIEWPORTORG or GDIP_WMF_RECORD_BASE);
  ...
  WmfRecordTypeOffsetViewportOrg = (META_OFFSETVIEWPORTORG or
    GDIP_WMF_RECORD_BASE);
  WmfRecordTypeScaleViewportExt = (META_SCALEVIEWPORTEXT or
    GDIP_WMF_RECORD_BASE);
  ...
  WmfRecordTypeSelectClipRegion = (META_SELECTCLIPREGION or
    GDIP_WMF_RECORD_BASE);
  WmfRecordTypeSelectObject = (META_SELECTOBJECT or GDIP_WMF_RECORD_BASE);
  WmfRecordTypeSetTextAlign = (META_SETTEXTALIGN or GDIP_WMF_RECORD_BASE);
  WmfRecordTypeDrawText = ($062F or GDIP_WMF_RECORD_BASE); // META_DRAWTEXT
  ...
  WmfRecordTypeCreatePatternBrush = (META_CREATEPATTERNBRUSH or
    GDIP_WMF_RECORD_BASE);
  WmfRecordTypeCreatePenIndirect = (META_CREATEPENINDIRECT or
    GDIP_WMF_RECORD_BASE);
  WmfRecordTypeCreateFontIndirect = (META_CREATEFONTINDIRECT or
    GDIP_WMF_RECORD_BASE);
  WmfRecordTypeCreateBrushIndirect = (META_CREATEBRUSHINDIRECT or
    GDIP_WMF_RECORD_BASE);
  WmfRecordTypeCreateBitmapIndirect = ($02FD or GDIP_WMF_RECORD_BASE);
  // META_CREATEBITMAPINDIRECT
  WmfRecordTypeCreateBitmap = ($06FE or GDIP_WMF_RECORD_BASE);
...
{$EXTERNALSYM StringTrimming}
  StringTrimming = (StringTrimmingNone, StringTrimmingCharacter,
    StringTrimmingWord, StringTrimmingEllipsisCharacter,
    StringTrimmingEllipsisWord, StringTrimmingEllipsisPath);
...
{$EXTERNALSYM StringDigitSubstitute}
  StringDigitSubstitute = (StringDigitSubstituteUser, // As NLS setting
    StringDigitSubstituteNone, StringDigitSubstituteNational,
...
const
  ...
  // 8-bit byte containing one 7-bit ASCII
...
{$EXTERNALSYM EncoderValue}
  EncoderValue = (EncoderValueColorTypeCMYK, EncoderValueColorTypeYCCK,
    ...
    EncoderValueScanMethodNonInterlaced, EncoderValueVersionGif87,
    EncoderValueVersionGif89, EncoderValueRenderProgressive,
    ...
    EncoderValueMultiFrame, EncoderValueLastFrame, EncoderValueFlush,
    EncoderValueFrameDimensionTime, EncoderValueFrameDimensionResolution,
...
{$EXTERNALSYM EmfToWmfBitsFlags}
  EmfToWmfBitsFlags = (EmfToWmfBitsFlagsDefault = $00000000,
...
type
{$EXTERNALSYM Status}
  Status = (Ok, GenericError, InvalidParameter, OutOfMemory, ObjectBusy,
...
type
  TPathData = packed class public Count: Integer;
Points:
PGPPointF;
Types:
PBYTE;
...
TCharacterRange = packed record First: Integer;
Length:
Integer;
end;
...
{$EXTERNALSYM PixelFormatDontCare}
      PixelFormat1bppIndexed = (1 or (1 shl 8) or PixelFormatIndexed or
        PixelFormatGDI);
{$EXTERNALSYM PixelFormat1bppIndexed}
      PixelFormat4bppIndexed = (2 or (4 shl 8) or PixelFormatIndexed or
        PixelFormatGDI);
{$EXTERNALSYM PixelFormat4bppIndexed}
      PixelFormat8bppIndexed = (3 or (8 shl 8) or PixelFormatIndexed or
        PixelFormatGDI);
...
{$EXTERNALSYM PixelFormat16bppRGB565}
      PixelFormat16bppARGB1555 = (7 or (16 shl 8) or PixelFormatAlpha or
        PixelFormatGDI);
...
{$EXTERNALSYM PixelFormat32bppARGB}
      PixelFormat32bppPARGB = (11 or (32 shl 8) or PixelFormatAlpha or
        PixelFormatPAlpha or PixelFormatGDI);
...
{$EXTERNALSYM PixelFormat48bppRGB}
      PixelFormat64bppARGB = (13 or (64 shl 8) or PixelFormatAlpha or
        PixelFormatCanonical or PixelFormatExtended);
{$EXTERNALSYM PixelFormat64bppARGB}
      PixelFormat64bppPARGB = (14 or (64 shl 8) or PixelFormatAlpha or
        PixelFormatPAlpha or PixelFormatExtended);
...
{$EXTERNALSYM PaletteFlags}
                PaletteFlags = (PaletteFlagsHasAlpha = $0001,
                  PaletteFlagsGrayScale = $0002, PaletteFlagsHalftone = $0004);
...
{$EXTERNALSYM ColorChannelFlags}
                ColorChannelFlags = (ColorChannelFlagsC, ColorChannelFlagsM,
                  ColorChannelFlagsY, ColorChannelFlagsK,
...
{$EXTERNALSYM WmfPlaceableFileHeader}
                                ...
                                TWmfPlaceableFileHeader =
                                  WmfPlaceableFileHeader;
                                PWmfPlaceableFileHeader = ^
                                  TWmfPlaceableFileHeader;
...
{$EXTERNALSYM GDIP_EMFPLUSFLAGS_DISPLAY}
                              type
                                TMetafileHeader = packed class public type_
                                  : TMetafileType;
                            size:
                              UINT; // Size of the metafile (in bytes)
                            Version:
                              UINT; // EMF+, EMF, or WMF version
                            EmfPlusFlags:
                              UINT;
                            DpiX:
                              Single;
                            DpiY:
                              Single;
                            X:
                              Integer; // Bounds in device units
                            Y:
                              Integer;
                            Width:
                              Integer;
                        ...
                        EmfPlusHeaderSize:
                          Integer; // size of the EMF+ header in file
                        LogicalDpiX:
                          Integer; // Logical Dpi of reference Hdc
                        LogicalDpiY:
                          Integer; // usually valid only for EMF+
                          public
                          ...
                          const
                            ImageFormatUndefined
                              : TGUID = '{b96b3ca9-0728-11d3-9d7b-0000f81ef32e}';
{$EXTERNALSYM ImageFormatUndefined}
                            ImageFormatMemoryBMP
                              : TGUID = '{b96b3caa-0728-11d3-9d7b-0000f81ef32e}';
{$EXTERNALSYM ImageFormatMemoryBMP}
                            ImageFormatBMP
                              : TGUID = '{b96b3cab-0728-11d3-9d7b-0000f81ef32e}';
{$EXTERNALSYM ImageFormatBMP}
                            ImageFormatEMF
                              : TGUID = '{b96b3cac-0728-11d3-9d7b-0000f81ef32e}';
{$EXTERNALSYM ImageFormatEMF}
                            ImageFormatWMF
                              : TGUID = '{b96b3cad-0728-11d3-9d7b-0000f81ef32e}';
{$EXTERNALSYM ImageFormatWMF}
                            ImageFormatJPEG
                              : TGUID = '{b96b3cae-0728-11d3-9d7b-0000f81ef32e}';
{$EXTERNALSYM ImageFormatJPEG}
                            ImageFormatPNG
                              : TGUID = '{b96b3caf-0728-11d3-9d7b-0000f81ef32e}';
{$EXTERNALSYM ImageFormatPNG}
                            ImageFormatGIF
                              : TGUID = '{b96b3cb0-0728-11d3-9d7b-0000f81ef32e}';
{$EXTERNALSYM ImageFormatGIF}
                            ImageFormatTIFF
                              : TGUID = '{b96b3cb1-0728-11d3-9d7b-0000f81ef32e}';
{$EXTERNALSYM ImageFormatTIFF}
                            ImageFormatEXIF
                              : TGUID = '{b96b3cb2-0728-11d3-9d7b-0000f81ef32e}';
{$EXTERNALSYM ImageFormatEXIF}
                            ImageFormatIcon
                              : TGUID = '{b96b3cb5-0728-11d3-9d7b-0000f81ef32e}';
{$EXTERNALSYM ImageFormatIcon}
                            ...
                            FrameDimensionTime
                              : TGUID = '{6aedbd6d-3fb5-418a-83a6-7f45229dc872}';
{$EXTERNALSYM FrameDimensionTime}
                            FrameDimensionResolution
                              : TGUID = '{84236f7b-3bd3-428f-8dab-4ea1439ca315}';
{$EXTERNALSYM FrameDimensionResolution}
                            FrameDimensionPage
                              : TGUID = '{7462dc86-6180-4c7e-8e3f-ee7333a7a483}';
{$EXTERNALSYM FrameDimensionPage}
                            ...
                            FormatIDImageInformation
                              : TGUID = '{e5836cbe-5eef-4f1d-acde-ae4c43b608ce}';
{$EXTERNALSYM FormatIDImageInformation}
                            FormatIDJpegAppHeaders
                              : TGUID = '{1c4afdcd-6177-43cf-abc7-5f51af39ee85}';
{$EXTERNALSYM FormatIDJpegAppHeaders}
                            ...
                            EncoderCompression
                              : TGUID = '{e09d739d-ccd4-44ee-8eba-3fbf8be4fc58}';
{$EXTERNALSYM EncoderCompression}
                            EncoderColorDepth
                              : TGUID = '{66087055-ad66-4c7c-9a18-38a2310b8337}';
{$EXTERNALSYM EncoderColorDepth}
                            EncoderScanMethod
                              : TGUID = '{3a4e2661-3109-4e56-8536-42c156e7dcfa}';
{$EXTERNALSYM EncoderScanMethod}
                            EncoderVersion
                              : TGUID = '{24d18c76-814a-41a4-bf53-1c219cccf797}';
{$EXTERNALSYM EncoderVersion}
                            EncoderRenderMethod
                              : TGUID = '{6d42c53a-229a-4825-8bb7-5c99e2b9a8b8}';
{$EXTERNALSYM EncoderRenderMethod}
                            EncoderQuality
                              : TGUID = '{1d5be4b5-fa4a-452d-9cdd-5db35105e7eb}';
{$EXTERNALSYM EncoderQuality}
                            EncoderTransformation
                              : TGUID = '{8d0eb2d1-a58e-4ea8-aa14-108074b7b6f9}';
{$EXTERNALSYM EncoderTransformation}
                            EncoderLuminanceTable
                              : TGUID = '{edb33bce-0266-4a77-b904-27216099e717}';
{$EXTERNALSYM EncoderLuminanceTable}
                            EncoderChrominanceTable
                              : TGUID = '{f2e455dc-09b3-4316-8260-676ada32481c}';
{$EXTERNALSYM EncoderChrominanceTable}
                            EncoderSaveFlag
                              : TGUID = '{292266fc-ac40-47bf-8cfc-a85b89a655de}';
{$EXTERNALSYM EncoderSaveFlag}
                            CodecIImageBytes
                              : TGUID = '{025d1823-6c7d-447b-bbdb-a3cbc3dfa2fc}';
...
{$EXTERNALSYM IImageBytes}
                            IImageBytes = Interface(IUnknown)
                              ...
                              function CountBytes(out pcb: UINT)
                                : HRESULT; stdcall;
                              // Locks "cb" bytes, starting from "ulOffset" in the stream, and returns the
                              // pointer to the beginning of the locked memory chunk in "ppvBytes"
                              function LockBytes(cb: UINT; ulOffset: ULONG;
                                out ppvBytes: pointer): HRESULT; stdcall;
                              // Unlocks "cb" bytes, pointed by "pvBytes", starting from "ulOffset" in the
                              // stream
                              function UnlockBytes(pvBytes: pointer; cb: UINT;
                                ulOffset: ULONG): HRESULT; stdcall;
                            end;
...
{$EXTERNALSYM RotateFlipType}
                            RotateFlipType = (RotateNoneFlipNone = 0,
                              Rotate90FlipNone = 1, Rotate180FlipNone = 2,
                              Rotate270FlipNone = 3,

                              RotateNoneFlipX = 4, Rotate90FlipX = 5,
...
{$EXTERNALSYM EncoderParameters}
                            ...
                            EncoderParameters = packed record
                              ...
                              Parameter: array [0 .. 1] of TEncoderParameter;
                              // Parameter values
                            end;
...
{$EXTERNALSYM PropertyItem}
                            ...
                            PropertyItem = record // NOT PACKED !!
                              ...
                              type_: Word;
                              // Type of the value, as one of TAG_TYPE_XXX
...
{$EXTERNALSYM ColorMatrix}
                            ColorMatrix = packed array [0 .. 4, 0 .. 4]
                              of Single;
...
{$EXTERNALSYM ColorAdjustType}
                            ColorAdjustType = (ColorAdjustTypeDefault,
                              ColorAdjustTypeBitmap, ColorAdjustTypeBrush,
                              ColorAdjustTypePen, ColorAdjustTypeText,
                              ColorAdjustTypeCount, ColorAdjustTypeAny
                              // Reserved
                              );
...
{$EXTERNALSYM GdipCreatePath}
                              function GdipCreatePath2(v1: GpPointF; v2: PBYTE;
                                v3: Integer; v4: GpFillMode; out path: GpPath)
                                : GpStatus; stdcall;
{$EXTERNALSYM GdipCreatePath2}
                                function GdipCreatePath2I(v1: GpPoint;
                                  v2: PBYTE; v3: Integer; v4: GpFillMode;
                                  out path: GpPath): GpStatus; stdcall;
...
{$EXTERNALSYM GdipClonePath}
                                    function GdipDeletePath(path: GpPath)
                                      : GpStatus; stdcall;
{$EXTERNALSYM GdipDeletePath}
                                      function GdipResetPath(path: GpPath)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipGetPointCount}
                                        function GdipGetPathTypes(path: GpPath;
                                        Types: PBYTE; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPathTypes}
                                        function GdipGetPathPoints(v1: GpPath;
                                        Points: GpPointF; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPathPoints}
                                        function GdipGetPathPointsI(v1: GpPath;
                                        Points: GpPoint; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPathPointsI}
                                        function GdipGetPathFillMode
                                        (path: GpPath; var FillMode: GpFillMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPathFillMode}
                                        function GdipSetPathFillMode
                                        (path: GpPath; FillMode: GpFillMode)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipAddPathLine}
                                        function GdipAddPathLine2(path: GpPath;
                                        Points: GpPointF; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathLine2}
                                        function GdipAddPathArc(path: GpPath;
...
{$EXTERNALSYM GdipAddPathBezier}
                                        ...
                                        (path: GpPath; Points: GpPointF;
                                        Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathBeziers}
                                        function GdipAddPathCurve(path: GpPath;
                                        Points: GpPointF; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathCurve}
                                        function GdipAddPathCurve2(path: GpPath;
                                        Points: GpPointF; Count: Integer;
                                        tension: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathCurve2}
                                        function GdipAddPathCurve3(path: GpPath;
                                        Points: GpPointF; Count: Integer;
                                        offset: Integer;
                                        numberOfSegments: Integer;
                                        tension: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathCurve3}
                                        function GdipAddPathClosedCurve
                                        (path: GpPath; Points: GpPointF;
                                        Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathClosedCurve}
                                        function GdipAddPathClosedCurve2
                                        (path: GpPath; Points: GpPointF;
                                        Count: Integer; tension: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathClosedCurve2}
                                        function GdipAddPathRectangle
                                        (path: GpPath; X: Single; Y: Single;
                                        Width: Single; Height: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathRectangle}
                                        function GdipAddPathRectangles
                                        (path: GpPath; rects: GpRectF;
                                        Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathRectangles}
                                        function GdipAddPathEllipse
                                        (path: GpPath; X: Single; Y: Single;
                                        Width: Single; Height: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathEllipse}
                                        function GdipAddPathPie(path: GpPath;
                                        X: Single; Y: Single; Width: Single;
                                        Height: Single; startAngle: Single;
                                        sweepAngle: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathPie}
                                        function GdipAddPathPolygon
                                        (path: GpPath; Points: GpPointF;
                                        Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathPolygon}
                                        function GdipAddPathPath(path: GpPath;
                                        addingPath: GpPath; connect: BOOL)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathPath}
                                        function GdipAddPathString(path: GpPath;
                                        string_: PWCHAR; Length: Integer;
                                        family: GpFontFamily; style: Integer;
                                        emSize: Single; layoutRect: PGPRectF;
                                        format: GpStringFormat)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathString}
                                        function GdipAddPathStringI
                                        (path: GpPath; string_: PWCHAR;
                                        Length: Integer; family: GpFontFamily;
                                        style: Integer; emSize: Single;
                                        layoutRect: PGPRect;
                                        format: GpStringFormat)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathStringI}
                                        function GdipAddPathLineI(path: GpPath;
                                        x1: Integer; y1: Integer; x2: Integer;
                                        y2: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathLineI}
                                        function GdipAddPathLine2I(path: GpPath;
                                        Points: GpPoint; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathLine2I}
                                        function GdipAddPathArcI(path: GpPath;
                                        X: Integer; Y: Integer; Width: Integer;
                                        Height: Integer; startAngle: Single;
                                        sweepAngle: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathArcI}
                                        function GdipAddPathBezierI
                                        (path: GpPath; x1: Integer; y1: Integer;
                                        x2: Integer; y2: Integer; x3: Integer;
                                        y3: Integer; x4: Integer; y4: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathBezierI}
                                        function GdipAddPathBeziersI
                                        (path: GpPath; Points: GpPoint;
                                        Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathBeziersI}
                                        function GdipAddPathCurveI(path: GpPath;
                                        Points: GpPoint; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathCurveI}
                                        function GdipAddPathCurve2I
                                        (path: GpPath; Points: GpPoint;
                                        Count: Integer; tension: Single)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipAddPathCurve3I}
                                        function GdipAddPathClosedCurveI
                                        (path: GpPath; Points: GpPoint;
                                        Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathClosedCurveI}
                                        function GdipAddPathClosedCurve2I
                                        (path: GpPath; Points: GpPoint;
                                        Count: Integer; tension: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathClosedCurve2I}
                                        function GdipAddPathRectangleI
                                        (path: GpPath; X: Integer; Y: Integer;
                                        Width: Integer; Height: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathRectangleI}
                                        function GdipAddPathRectanglesI
                                        (path: GpPath; rects: GpRect;
                                        Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathRectanglesI}
                                        function GdipAddPathEllipseI
                                        (path: GpPath; X: Integer; Y: Integer;
                                        Width: Integer; Height: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathEllipseI}
                                        function GdipAddPathPieI(path: GpPath;
                                        X: Integer; Y: Integer; Width: Integer;
                                        Height: Integer; startAngle: Single;
                                        sweepAngle: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathPieI}
                                        function GdipAddPathPolygonI
                                        (path: GpPath; Points: GpPoint;
                                        Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipAddPathPolygonI}
                                        function GdipFlattenPath(path: GpPath;
                                        matrix: GpMatrix; flatness: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipFlattenPath}
                                        function GdipWindingModeOutline
                                        (path: GpPath; matrix: GpMatrix;
                                        flatness: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipWindingModeOutline}
                                        function GdipWidenPath
                                        (nativePath: GpPath; pen: GpPen;
                                        matrix: GpMatrix; flatness: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipWidenPath}
                                        function GdipWarpPath(path: GpPath;
                                        matrix: GpMatrix; Points: GpPointF;
                                        Count: Integer; srcx: Single;
                                        srcy: Single; srcwidth: Single;
                                        srcheight: Single; WarpMode: WarpMode;
                                        flatness: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipWarpPath}
                                        function GdipTransformPath(path: GpPath;
                                        matrix: GpMatrix): GpStatus; stdcall;
{$EXTERNALSYM GdipTransformPath}
                                        function GdipGetPathWorldBounds
                                        (path: GpPath; bounds: GpRectF;
                                        matrix: GpMatrix; pen: GpPen)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPathWorldBounds}
                                        function GdipGetPathWorldBoundsI
                                        (path: GpPath; bounds: GpRect;
                                        matrix: GpMatrix; pen: GpPen)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipIsVisiblePathPointI}
                                        function GdipIsOutlineVisiblePathPoint
                                        (path: GpPath; X: Single; Y: Single;
                                        pen: GpPen; graphics: GpGraphics;
...
{$EXTERNALSYM GdipIsOutlineVisiblePathPointI}
                                        ...
                                        function GdipCreatePathIter
                                        (out iterator: GpPathIterator;
                                        path: GpPath): GpStatus; stdcall;
{$EXTERNALSYM GdipCreatePathIter}
                                        function GdipDeletePathIter
...
{$EXTERNALSYM GdipPathIterNextPathType}
                                        function GdipPathIterNextMarker
                                        (iterator: GpPathIterator;
                                        var resultCount: Integer;
                                        var startIndex: Integer;
                                        var endIndex: Integer)
...
{$EXTERNALSYM GdipPathIterGetCount}
                                        function GdipPathIterGetSubpathCount
                                        (iterator: GpPathIterator;
                                        out Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipPathIterGetSubpathCount}
                                        function GdipPathIterIsValid
                                        (iterator: GpPathIterator;
...
{$EXTERNALSYM GdipPathIterHasCurve}
                                        function GdipPathIterRewind
                                        (iterator: GpPathIterator)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipPathIterRewind}
                                        function GdipPathIterEnumerate
                                        (iterator: GpPathIterator;
                                        var resultCount: Integer;
                                        Points: GpPointF; Types: PBYTE;
                                        Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipPathIterEnumerate}
                                        function GdipPathIterCopyData
                                        (iterator: GpPathIterator;
                                        var resultCount: Integer;
                                        Points: GpPointF; Types: PBYTE;
...
{$EXTERNALSYM GdipCreateMatrix}
                                        function GdipCreateMatrix2(m11: Single;
                                        m12: Single; m21: Single; m22: Single;
                                        dx: Single; dy: Single;
                                        out matrix: GpMatrix)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateMatrix2}
                                        function GdipCreateMatrix3
                                        (Rect: GpRectF; dstplg: GpPointF;
                                        out matrix: GpMatrix)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateMatrix3}
                                        function GdipCreateMatrix3I
                                        (Rect: GpRect; dstplg: GpPoint;
                                        out matrix: GpMatrix)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateMatrix3I}
                                        function GdipCloneMatrix
                                        (matrix: GpMatrix;
                                        out cloneMatrix: GpMatrix)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipDeleteMatrix}
                                        ...
                                        (matrix: GpMatrix; m11: Single;
                                        m12: Single; m21: Single; m22: Single;
                                        dx: Single; dy: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetMatrixElements}
                                        function GdipMultiplyMatrix
                                        (matrix: GpMatrix; matrix2: GpMatrix;
                                        order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipMultiplyMatrix}
                                        function GdipTranslateMatrix
                                        (matrix: GpMatrix; offsetX: Single;
                                        offsetY: Single; order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipTranslateMatrix}
                                        function GdipScaleMatrix
                                        (matrix: GpMatrix; scaleX: Single;
                                        scaleY: Single; order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipScaleMatrix}
                                        function GdipRotateMatrix
                                        (matrix: GpMatrix; angle: Single;
                                        order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipRotateMatrix}
                                        function GdipShearMatrix
                                        (matrix: GpMatrix; shearX: Single;
                                        shearY: Single; order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipShearMatrix}
                                        function GdipInvertMatrix
                                        (matrix: GpMatrix): GpStatus; stdcall;
{$EXTERNALSYM GdipInvertMatrix}
                                        function GdipTransformMatrixPoints
                                        (matrix: GpMatrix; pts: GpPointF;
                                        Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipTransformMatrixPoints}
                                        function GdipTransformMatrixPointsI
                                        (matrix: GpMatrix; pts: GpPoint;
                                        Count: Integer): GpStatus; stdcall;
...
{$EXTERNALSYM GdipIsMatrixEqual}
                                        ...
                                        function GdipCreateRegion
                                        (out region: GpRegion)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateRegion}
                                        function GdipCreateRegionRect
                                        (Rect: GpRectF; out region: GpRegion)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateRegionRect}
                                        function GdipCreateRegionRectI
                                        (Rect: GpRect; out region: GpRegion)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateRegionRectI}
                                        function GdipCreateRegionPath
                                        (path: GpPath; out region: GpRegion)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateRegionPath}
                                        function GdipCreateRegionRgnData
                                        (regionData: PBYTE; size: Integer;
                                        out region: GpRegion)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateRegionRgnData}
                                        function GdipCreateRegionHrgn
                                        (hRgn: hRgn; out region: GpRegion)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateRegionHrgn}
                                        function GdipCloneRegion
                                        (region: GpRegion;
                                        out cloneRegion: GpRegion)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCloneRegion}
                                        function GdipDeleteRegion
                                        (region: GpRegion): GpStatus; stdcall;
{$EXTERNALSYM GdipDeleteRegion}
                                        function GdipSetInfinite
                                        (region: GpRegion): GpStatus; stdcall;
{$EXTERNALSYM GdipSetInfinite}
                                        function GdipSetEmpty(region: GpRegion)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetEmpty}
                                        function GdipCombineRegionRect
                                        (region: GpRegion; Rect: GpRectF;
                                        CombineMode: CombineMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCombineRegionRect}
                                        function GdipCombineRegionRectI
                                        (region: GpRegion; Rect: GpRect;
                                        CombineMode: CombineMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCombineRegionRectI}
                                        function GdipCombineRegionPath
                                        (region: GpRegion; path: GpPath;
                                        CombineMode: CombineMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCombineRegionPath}
                                        function GdipCombineRegionRegion
                                        (region: GpRegion; region2: GpRegion;
                                        CombineMode: CombineMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCombineRegionRegion}
                                        function GdipTranslateRegion
                                        (region: GpRegion; dx: Single;
                                        dy: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipTranslateRegion}
                                        function GdipTranslateRegionI
                                        (region: GpRegion; dx: Integer;
                                        dy: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipTranslateRegionI}
                                        function GdipTransformRegion
                                        (region: GpRegion; matrix: GpMatrix)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipTransformRegion}
                                        function GdipGetRegionBounds
                                        (region: GpRegion; graphics: GpGraphics;
                                        Rect: GpRectF): GpStatus; stdcall;
{$EXTERNALSYM GdipGetRegionBounds}
                                        function GdipGetRegionBoundsI
                                        (region: GpRegion; graphics: GpGraphics;
                                        Rect: GpRect): GpStatus; stdcall;
{$EXTERNALSYM GdipGetRegionBoundsI}
                                        function GdipGetRegionHRgn
                                        (region: GpRegion; graphics: GpGraphics;
                                        out hRgn: hRgn): GpStatus; stdcall;
{$EXTERNALSYM GdipGetRegionHRgn}
                                        function GdipIsEmptyRegion
                                        (region: GpRegion; graphics: GpGraphics;
                                        out result: BOOL): GpStatus; stdcall;
{$EXTERNALSYM GdipIsEmptyRegion}
                                        function GdipIsInfiniteRegion
                                        (region: GpRegion; graphics: GpGraphics;
                                        out result: BOOL): GpStatus; stdcall;
{$EXTERNALSYM GdipIsInfiniteRegion}
                                        function GdipIsEqualRegion
                                        (region: GpRegion; region2: GpRegion;
                                        graphics: GpGraphics; out result: BOOL)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipIsEqualRegion}
                                        function GdipGetRegionDataSize
                                        (region: GpRegion; out bufferSize: UINT)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetRegionDataSize}
                                        function GdipGetRegionData
                                        (region: GpRegion; buffer: PBYTE;
                                        bufferSize: UINT; sizeFilled: PUINT)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetRegionData}
                                        function GdipIsVisibleRegionPoint
                                        (region: GpRegion; X: Single; Y: Single;
                                        graphics: GpGraphics; out result: BOOL)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipIsVisibleRegionPoint}
                                        function GdipIsVisibleRegionPointI
                                        (region: GpRegion; X: Integer;
                                        Y: Integer; graphics: GpGraphics;
                                        out result: BOOL): GpStatus; stdcall;
{$EXTERNALSYM GdipIsVisibleRegionPointI}
                                        function GdipIsVisibleRegionRect
                                        (region: GpRegion; X: Single; Y: Single;
                                        Width: Single; Height: Single;
                                        graphics: GpGraphics; out result: BOOL)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipIsVisibleRegionRect}
                                        function GdipIsVisibleRegionRectI
                                        (region: GpRegion; X: Integer;
                                        Y: Integer; Width: Integer;
                                        Height: Integer; graphics: GpGraphics;
                                        out result: BOOL): GpStatus; stdcall;
{$EXTERNALSYM GdipIsVisibleRegionRectI}
                                        function GdipGetRegionScansCount
                                        (region: GpRegion; out Count: UINT;
                                        matrix: GpMatrix): GpStatus; stdcall;
{$EXTERNALSYM GdipGetRegionScansCount}
                                        function GdipGetRegionScans
                                        (region: GpRegion; rects: GpRectF;
                                        out Count: Integer; matrix: GpMatrix)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetRegionScans}
                                        function GdipGetRegionScansI
                                        (region: GpRegion; rects: GpRect;
                                        out Count: Integer; matrix: GpMatrix)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetRegionScansI}
                                        ...
                                        out cloneBrush: GpBrush)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCloneBrush}
                                        function GdipDeleteBrush(brush: GpBrush)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDeleteBrush}
                                        function GdipGetBrushType
                                        (brush: GpBrush; out type_: GpBrushType)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipGetHatchBackgroundColor}
                                        ...
                                        function GdipCreateTexture
                                        (image: GpImage; WrapMode: GpWrapMode;
                                        var texture: GpTexture)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateTexture}
                                        function GdipCreateTexture2
                                        (image: GpImage; WrapMode: GpWrapMode;
                                        X: Single; Y: Single; Width: Single;
                                        Height: Single; out texture: GpTexture)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipCreateTextureIA}
                                        ...
                                        (image: GpImage; WrapMode: GpWrapMode;
                                        X: Integer; Y: Integer; Width: Integer;
                                        Height: Integer; out texture: GpTexture)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipCreateTextureIAI}
                                        function GdipGetTextureTransform
                                        (brush: GpTexture; matrix: GpMatrix)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetTextureTransform}
                                        function GdipResetTextureTransform
                                        (brush: GpTexture): GpStatus; stdcall;
{$EXTERNALSYM GdipResetTextureTransform}
                                        function GdipMultiplyTextureTransform
                                        (brush: GpTexture; matrix: GpMatrix;
                                        order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipMultiplyTextureTransform}
                                        function GdipTranslateTextureTransform
                                        (brush: GpTexture; dx: Single;
                                        dy: Single; order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipTranslateTextureTransform}
                                        function GdipScaleTextureTransform
                                        (brush: GpTexture; sx: Single;
                                        sy: Single; order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipScaleTextureTransform}
                                        function GdipRotateTextureTransform
                                        (brush: GpTexture; angle: Single;
                                        order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipRotateTextureTransform}
                                        function GdipSetTextureWrapMode
                                        (brush: GpTexture; WrapMode: GpWrapMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetTextureWrapMode}
                                        function GdipGetTextureWrapMode
                                        (brush: GpTexture;
                                        var WrapMode: GpWrapMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetTextureWrapMode}
                                        function GdipGetTextureImage
                                        (brush: GpTexture; out image: GpImage)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetTextureImage}
                                        ...
                                        (color: ARGB; out brush: GpSolidFill)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateSolidFill}
                                        function GdipSetSolidFillColor
                                        (brush: GpSolidFill; color: ARGB)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetSolidFillColor}
                                        function GdipGetSolidFillColor
                                        (brush: GpSolidFill; out color: ARGB)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetSolidFillColor}
                                        ...
                                        function GdipCreateLineBrush
                                        (point1: GpPointF; point2: GpPointF;
                                        color1: ARGB; color2: ARGB;
                                        WrapMode: GpWrapMode;
                                        out lineGradient: GpLineGradient)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateLineBrush}
                                        function GdipCreateLineBrushI
                                        (point1: GpPoint; point2: GpPoint;
                                        color1: ARGB; color2: ARGB;
                                        WrapMode: GpWrapMode;
                                        out lineGradient: GpLineGradient)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateLineBrushI}
                                        ...
                                        (Rect: GpRectF; color1: ARGB;
                                        color2: ARGB; mode: LinearGradientMode;
                                        WrapMode: GpWrapMode;
                                        out lineGradient: GpLineGradient)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateLineBrushFromRect}
                                        function GdipCreateLineBrushFromRectI
                                        (Rect: GpRect; color1: ARGB;
                                        color2: ARGB; mode: LinearGradientMode;
                                        WrapMode: GpWrapMode;
                                        out lineGradient: GpLineGradient)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateLineBrushFromRectI}
                                        function GdipCreateLineBrushFromRectWithAngle
                                        (Rect: GpRectF; color1: ARGB;
                                        color2: ARGB; angle: Single;
                                        isAngleScalable: BOOL;
                                        WrapMode: GpWrapMode;
                                        out lineGradient: GpLineGradient)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateLineBrushFromRectWithAngle}
                                        function GdipCreateLineBrushFromRectWithAngleI
                                        (Rect: GpRect; color1: ARGB;
                                        color2: ARGB; angle: Single;
                                        isAngleScalable: BOOL;
                                        WrapMode: GpWrapMode;
...
{$EXTERNALSYM GdipCreateLineBrushFromRectWithAngleI}
                                        ...
                                        (brush: GpLineGradient; color1: ARGB;
                                        color2: ARGB): GpStatus; stdcall;
{$EXTERNALSYM GdipSetLineColors}
                                        function GdipGetLineColors
                                        (brush: GpLineGradient; colors: PARGB)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetLineColors}
                                        function GdipGetLineRect
                                        (brush: GpLineGradient; Rect: GpRectF)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetLineRect}
                                        function GdipGetLineRectI
                                        (brush: GpLineGradient; Rect: GpRect)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetLineRectI}
                                        function GdipSetLineGammaCorrection
                                        (brush: GpLineGradient;
                                        useGammaCorrection: BOOL)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetLineGammaCorrection}
                                        function GdipGetLineGammaCorrection
                                        (brush: GpLineGradient;
                                        out useGammaCorrection: BOOL)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipGetLineBlendCount}
                                        function GdipGetLineBlend
                                        (brush: GpLineGradient; blend: PSingle;
                                        positions: PSingle; Count: Integer)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetLinePresetBlend}
                                        function GdipSetLineSigmaBlend
                                        (brush: GpLineGradient; focus: Single;
                                        scale: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipSetLineSigmaBlend}
                                        function GdipSetLineLinearBlend
                                        (brush: GpLineGradient; focus: Single;
                                        scale: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipSetLineLinearBlend}
                                        function GdipSetLineWrapMode
                                        (brush: GpLineGradient;
                                        WrapMode: GpWrapMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetLineWrapMode}
                                        function GdipGetLineWrapMode
                                        (brush: GpLineGradient;
                                        out WrapMode: GpWrapMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetLineWrapMode}
                                        function GdipGetLineTransform
                                        (brush: GpLineGradient;
                                        matrix: GpMatrix): GpStatus; stdcall;
...
{$EXTERNALSYM GdipRotateLineTransform}
                                        ...
                                        function GdipCreatePathGradient
                                        (Points: GpPointF; Count: Integer;
                                        WrapMode: GpWrapMode;
                                        out polyGradient: GpPathGradient)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreatePathGradient}
                                        function GdipCreatePathGradientI
                                        (Points: GpPoint; Count: Integer;
                                        WrapMode: GpWrapMode;
                                        out polyGradient: GpPathGradient)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipCreatePathGradientFromPath}
                                        function GdipGetPathGradientCenterColor
...
{$EXTERNALSYM GdipSetPathGradientCenterPointI}
                                        function GdipGetPathGradientRect
                                        (brush: GpPathGradient; Rect: GpRectF)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPathGradientRect}
                                        function GdipGetPathGradientRectI
                                        (brush: GpPathGradient; Rect: GpRect)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPathGradientRectI}
                                        function GdipGetPathGradientPointCount
                                        (brush: GpPathGradient;
                                        var Count: Integer): GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetPathGradientGammaCorrection}
                                        function GdipGetPathGradientGammaCorrection
                                        (brush: GpPathGradient;
...
{$EXTERNALSYM GdipGetPathGradientBlendCount}
                                        ...
                                        (brush: GpPathGradient; blend: PSingle;
                                        positions: PSingle; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPathGradientBlend}
                                        function GdipSetPathGradientBlend
                                        (brush: GpPathGradient; blend: PSingle;
                                        positions: PSingle; Count: Integer)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipGetPathGradientPresetBlendCount}
                                        function GdipGetPathGradientPresetBlend
                                        (brush: GpPathGradient; blend: PARGB;
                                        positions: PSingle; Count: Integer)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetPathGradientPresetBlend}
                                        function GdipSetPathGradientSigmaBlend
                                        (brush: GpPathGradient; focus: Single;
                                        scale: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipSetPathGradientSigmaBlend}
                                        function GdipSetPathGradientLinearBlend
                                        (brush: GpPathGradient; focus: Single;
                                        scale: Single): GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetPathGradientWrapMode}
                                        function GdipGetPathGradientTransform
                                        (brush: GpPathGradient;
                                        matrix: GpMatrix): GpStatus; stdcall;
{$EXTERNALSYM GdipGetPathGradientTransform}
                                        function GdipSetPathGradientTransform
                                        (brush: GpPathGradient;
                                        matrix: GpMatrix): GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetPenStartCap}
                                        function GdipSetPenEndCap(pen: GpPen;
                                        endCap: GpLineCap): GpStatus; stdcall;
{$EXTERNALSYM GdipSetPenEndCap}
                                        function GdipSetPenDashCap197819
                                        (pen: GpPen; DashCap: GpDashCap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetPenDashCap197819}
                                        function GdipGetPenStartCap(pen: GpPen;
                                        out startCap: GpLineCap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPenStartCap}
                                        function GdipGetPenEndCap(pen: GpPen;
                                        out endCap: GpLineCap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPenEndCap}
                                        function GdipGetPenDashCap197819
                                        (pen: GpPen; out DashCap: GpDashCap)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetPenLineJoin}
                                        ...
                                        var LineJoin: GpLineJoin)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPenLineJoin}
                                        function GdipSetPenCustomStartCap
                                        (pen: GpPen; customCap: GpCustomLineCap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetPenCustomStartCap}
                                        function GdipGetPenCustomStartCap
                                        (pen: GpPen;
                                        out customCap: GpCustomLineCap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPenCustomStartCap}
                                        function GdipSetPenCustomEndCap
                                        (pen: GpPen; customCap: GpCustomLineCap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetPenCustomEndCap}
                                        function GdipGetPenCustomEndCap
                                        (pen: GpPen;
                                        out customCap: GpCustomLineCap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPenCustomEndCap}
                                        function GdipSetPenMiterLimit
                                        (pen: GpPen; miterLimit: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetPenMiterLimit}
                                        function GdipGetPenMiterLimit
                                        (pen: GpPen; out miterLimit: Single)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipGetPenTransform}
                                        ...
                                        (pen: GpPen): GpStatus; stdcall;
{$EXTERNALSYM GdipResetPenTransform}
                                        function GdipMultiplyPenTransform
                                        (pen: GpPen; matrix: GpMatrix;
                                        order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipMultiplyPenTransform}
                                        function GdipTranslatePenTransform
                                        (pen: GpPen; dx: Single; dy: Single;
                                        order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipTranslatePenTransform}
                                        function GdipScalePenTransform
                                        (pen: GpPen; sx: Single; sy: Single;
                                        order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipScalePenTransform}
                                        function GdipRotatePenTransform
                                        (pen: GpPen; angle: Single;
                                        order: GpMatrixOrder)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipRotatePenTransform}
                                        function GdipSetPenColor(pen: GpPen;
                                        ARGB: ARGB): GpStatus; stdcall;
{$EXTERNALSYM GdipSetPenColor}
                                        function GdipGetPenColor(pen: GpPen;
                                        out ARGB: ARGB): GpStatus; stdcall;
{$EXTERNALSYM GdipGetPenColor}
                                        function GdipSetPenBrushFill(pen: GpPen;
                                        brush: GpBrush): GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetPenDashStyle}
                                        function GdipGetPenDashOffset
                                        (pen: GpPen; out offset: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPenDashOffset}
                                        function GdipSetPenDashOffset
                                        (pen: GpPen; offset: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetPenDashOffset}
                                        function GdipGetPenDashCount(pen: GpPen;
                                        var Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipGetPenDashCount}
                                        function GdipSetPenDashArray(pen: GpPen;
                                        dash: PSingle; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetPenDashArray}
                                        function GdipGetPenDashArray(pen: GpPen;
                                        dash: PSingle; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPenDashArray}
                                        function GdipGetPenCompoundCount
                                        (pen: GpPen; out Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetPenCompoundCount}
                                        function GdipSetPenCompoundArray
                                        (pen: GpPen; dash: PSingle;
                                        Count: Integer): GpStatus; stdcall;
...
{$EXTERNALSYM GdipGetPenCompoundArray}
                                        ...
                                        function GdipCreateCustomLineCap
                                        (fillPath: GpPath; strokePath: GpPath;
...
{$EXTERNALSYM GdipDeleteCustomLineCap}
                                        function GdipCloneCustomLineCap
                                        (customCap: GpCustomLineCap;
                                        out clonedCap: GpCustomLineCap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCloneCustomLineCap}
                                        function GdipGetCustomLineCapType
                                        (customCap: GpCustomLineCap;
                                        var capType: CustomLineCapType)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetCustomLineCapType}
                                        function GdipSetCustomLineCapStrokeCaps
                                        (customCap: GpCustomLineCap;
                                        startCap: GpLineCap; endCap: GpLineCap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetCustomLineCapStrokeCaps}
                                        function GdipGetCustomLineCapStrokeCaps
                                        (customCap: GpCustomLineCap;
                                        var startCap: GpLineCap;
                                        var endCap: GpLineCap)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetCustomLineCapStrokeJoin}
                                        function GdipGetCustomLineCapStrokeJoin
                                        (customCap: GpCustomLineCap;
                                        var LineJoin: GpLineJoin)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetCustomLineCapBaseCap}
                                        function GdipGetCustomLineCapBaseCap
                                        (customCap: GpCustomLineCap;
                                        var baseCap: GpLineCap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetCustomLineCapBaseCap}
                                        function GdipSetCustomLineCapBaseInset
                                        (customCap: GpCustomLineCap;
                                        inset: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipSetCustomLineCapBaseInset}
                                        function GdipGetCustomLineCapBaseInset
                                        (customCap: GpCustomLineCap;
...
{$EXTERNALSYM GdipGetCustomLineCapWidthScale}
                                        ...
                                        isFilled: BOOL;
                                        out cap: GpAdjustableArrowCap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateAdjustableArrowCap}
                                        function GdipSetAdjustableArrowCapHeight
...
{$EXTERNALSYM GdipSetAdjustableArrowCapFillState}
                                        function GdipGetAdjustableArrowCapFillState
                                        (cap: GpAdjustableArrowCap;
...
{$EXTERNALSYM GdipGetAdjustableArrowCapFillState}
                                        ...
                                        (stream: ISTREAM; out image: GpImage)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipLoadImageFromStream}
                                        function GdipLoadImageFromFile
                                        (filename: PWCHAR; out image: GpImage)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipRemovePropertyItem}
                                        ...
                                        (image: GpImage; item: PPropertyItem)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetPropertyItem}
                                        function GdipImageForceValidation
                                        (image: GpImage): GpStatus; stdcall;
...
{$EXTERNALSYM GdipCreateBitmapFromResource}
                                        function GdipCloneBitmapArea(X: Single;
                                        Y: Single; Width: Single;
                                        Height: Single; format: PixelFormat;
                                        srcBitmap: GpBitmap;
                                        out dstBitmap: GpBitmap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCloneBitmapArea}
                                        function GdipCloneBitmapAreaI
                                        (X: Integer; Y: Integer; Width: Integer;
                                        Height: Integer; format: PixelFormat;
                                        srcBitmap: GpBitmap;
                                        out dstBitmap: GpBitmap)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCloneBitmapAreaI}
                                        function GdipBitmapLockBits
                                        (bitmap: GpBitmap; Rect: GpRect;
                                        flags: UINT; format: PixelFormat;
                                        lockedBitmapData: PBitmapData)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipBitmapUnlockBits}
                                        ...
                                        (bitmap: GpBitmap; X: Integer;
                                        Y: Integer; var color: ARGB)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipBitmapGetPixel}
                                        function GdipBitmapSetPixel
                                        (bitmap: GpBitmap; X: Integer;
                                        Y: Integer; color: ARGB)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipBitmapSetPixel}
                                        function GdipBitmapSetResolution
                                        (bitmap: GpBitmap; xdpi: Single;
...
{$EXTERNALSYM GdipSetImageAttributesToIdentity}
                                        function GdipResetImageAttributes
                                        (imageattr: GpImageAttributes;
                                        type_: ColorAdjustType)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipCreateFromHDC}
                                        function GdipCreateFromHDC2(hdc: hdc;
                                        hDevice: THandle;
                                        out graphics: GpGraphics)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipCreateFromHWND}
                                        ...
                                        (hwnd: hwnd; out graphics: GpGraphics)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipDeleteGraphics}
                                        function GdipGetDC(graphics: GpGraphics;
                                        var hdc: hdc): GpStatus; stdcall;
{$EXTERNALSYM GdipGetDC}
                                        function GdipReleaseDC
                                        (graphics: GpGraphics; hdc: hdc)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipReleaseDC}
                                        function GdipSetCompositingMode
                                        (graphics: GpGraphics;
                                        CompositingMode: CompositingMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetCompositingMode}
                                        function GdipGetCompositingMode
                                        (graphics: GpGraphics;
                                        var CompositingMode: CompositingMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetCompositingMode}
                                        function GdipSetRenderingOrigin
                                        (graphics: GpGraphics; X: Integer;
                                        Y: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipSetRenderingOrigin}
                                        function GdipGetRenderingOrigin
                                        (graphics: GpGraphics; var X: Integer;
                                        var Y: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipGetRenderingOrigin}
                                        function GdipSetCompositingQuality
                                        (graphics: GpGraphics;
                                        CompositingQuality: CompositingQuality)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetCompositingQuality}
                                        function GdipGetCompositingQuality
                                        (graphics: GpGraphics;
...
{$EXTERNALSYM GdipGetSmoothingMode}
                                        function GdipSetPixelOffsetMode
                                        (graphics: GpGraphics;
                                        PixelOffsetMode: PixelOffsetMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetPixelOffsetMode}
                                        function GdipGetPixelOffsetMode
                                        (graphics: GpGraphics;
                                        var PixelOffsetMode: PixelOffsetMode)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetTextRenderingHint}
                                        function GdipGetTextRenderingHint
                                        (graphics: GpGraphics;
                                        var mode: TextRenderingHint)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetTextRenderingHint}
                                        function GdipSetTextContrast
                                        (graphics: GpGraphics;
                                        contrast: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipSetTextContrast}
                                        function GdipGetTextContrast
                                        (graphics: GpGraphics;
...
{$EXTERNALSYM GdipSetInterpolationMode}
                                        function GdipGetInterpolationMode
                                        (graphics: GpGraphics;
                                        var InterpolationMode
                                        : InterpolationMode): GpStatus; stdcall;
{$EXTERNALSYM GdipGetInterpolationMode}
                                        function GdipSetWorldTransform
                                        (graphics: GpGraphics; matrix: GpMatrix)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipGetPageScale}
                                        function GdipSetPageUnit
                                        (graphics: GpGraphics; Unit_: GpUnit)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetPageUnit}
                                        function GdipSetPageScale
                                        (graphics: GpGraphics; scale: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetPageScale}
                                        function GdipGetDpiX
                                        (graphics: GpGraphics; var dpi: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetDpiX}
                                        function GdipGetDpiY
                                        (graphics: GpGraphics; var dpi: Single)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipDrawLineI}
                                        function GdipDrawLines
                                        (graphics: GpGraphics; pen: GpPen;
                                        Points: GpPointF; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawLines}
                                        function GdipDrawLinesI
                                        (graphics: GpGraphics; pen: GpPen;
                                        Points: GpPoint; Count: Integer)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipDrawArcI}
                                        ...
                                        (graphics: GpGraphics; pen: GpPen;
                                        x1: Single; y1: Single; x2: Single;
                                        y2: Single; x3: Single; y3: Single;
                                        x4: Single; y4: Single)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawBezier}
                                        function GdipDrawBezierI
                                        (graphics: GpGraphics; pen: GpPen;
                                        x1: Integer; y1: Integer; x2: Integer;
...
{$EXTERNALSYM GdipDrawBezierI}
                                        function GdipDrawBeziers
                                        (graphics: GpGraphics; pen: GpPen;
                                        Points: GpPointF; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawBeziers}
                                        function GdipDrawBeziersI
                                        (graphics: GpGraphics; pen: GpPen;
                                        Points: GpPoint; Count: Integer)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipDrawRectangle}
                                        function GdipDrawRectangleI
                                        (graphics: GpGraphics; pen: GpPen;
                                        X: Integer; Y: Integer; Width: Integer;
                                        Height: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipDrawRectangleI}
                                        function GdipDrawRectangles
                                        (graphics: GpGraphics; pen: GpPen;
                                        rects: GpRectF; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawRectangles}
                                        function GdipDrawRectanglesI
                                        (graphics: GpGraphics; pen: GpPen;
                                        rects: GpRect; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawRectanglesI}
                                        function GdipDrawEllipse
                                        (graphics: GpGraphics; pen: GpPen;
                                        X: Single; Y: Single; Width: Single;
                                        Height: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipDrawEllipse}
                                        function GdipDrawEllipseI
                                        (graphics: GpGraphics; pen: GpPen;
                                        X: Integer; Y: Integer; Width: Integer;
                                        Height: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipDrawEllipseI}
                                        function GdipDrawPie
                                        (graphics: GpGraphics; pen: GpPen;
                                        X: Single; Y: Single; Width: Single;
                                        Height: Single; startAngle: Single;
                                        sweepAngle: Single): GpStatus; stdcall;
...
{$EXTERNALSYM GdipDrawPath}
                                        function GdipDrawCurve
                                        (graphics: GpGraphics; pen: GpPen;
                                        Points: GpPointF; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawCurve}
                                        function GdipDrawCurveI
                                        (graphics: GpGraphics; pen: GpPen;
                                        Points: GpPoint; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawCurveI}
                                        function GdipDrawCurve2
                                        (graphics: GpGraphics; pen: GpPen;
                                        Points: GpPointF; Count: Integer;
                                        tension: Single): GpStatus; stdcall;
...
{$EXTERNALSYM GdipFillRectanglesI}
                                        function GdipFillPolygon
                                        (graphics: GpGraphics; brush: GpBrush;
                                        Points: GpPointF; Count: Integer;
                                        FillMode: GpFillMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipFillPolygon}
                                        function GdipFillPolygonI
                                        (graphics: GpGraphics; brush: GpBrush;
                                        Points: GpPoint; Count: Integer;
                                        FillMode: GpFillMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipFillPolygonI}
                                        function GdipFillPolygon2
                                        (graphics: GpGraphics; brush: GpBrush;
                                        Points: GpPointF; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipFillPolygon2}
                                        function GdipFillPolygon2I
                                        (graphics: GpGraphics; brush: GpBrush;
                                        Points: GpPoint; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipFillPolygon2I}
                                        function GdipFillEllipse
                                        (graphics: GpGraphics; brush: GpBrush;
                                        X: Single; Y: Single; Width: Single;
                                        Height: Single): GpStatus; stdcall;
...
{$EXTERNALSYM GdipFillPieI}
                                        function GdipFillPath
                                        (graphics: GpGraphics; brush: GpBrush;
                                        path: GpPath): GpStatus; stdcall;
{$EXTERNALSYM GdipFillPath}
                                        function GdipFillClosedCurve
                                        (graphics: GpGraphics; brush: GpBrush;
                                        Points: GpPointF; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipFillClosedCurve}
                                        function GdipFillClosedCurveI
                                        (graphics: GpGraphics; brush: GpBrush;
                                        Points: GpPoint; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipFillClosedCurveI}
                                        function GdipFillClosedCurve2
                                        (graphics: GpGraphics; brush: GpBrush;
                                        Points: GpPointF; Count: Integer;
                                        tension: Single; FillMode: GpFillMode)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipFillClosedCurve2I}
                                        function GdipFillRegion
                                        (graphics: GpGraphics; brush: GpBrush;
                                        region: GpRegion): GpStatus; stdcall;
{$EXTERNALSYM GdipFillRegion}
                                        function GdipDrawImage
                                        (graphics: GpGraphics; image: GpImage;
                                        X: Single; Y: Single)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipDrawImageRectI}
                                        function GdipDrawImagePoints
                                        (graphics: GpGraphics; image: GpImage;
                                        dstpoints: GpPointF; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawImagePoints}
                                        function GdipDrawImagePointsI
                                        (graphics: GpGraphics; image: GpImage;
                                        dstpoints: GpPoint; Count: Integer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawImagePointsI}
                                        function GdipDrawImagePointRect
                                        (graphics: GpGraphics; image: GpImage;
                                        X: Single; Y: Single; srcx: Single;
                                        srcy: Single; srcwidth: Single;
                                        srcheight: Single; srcUnit: GpUnit)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawImagePointRect}
                                        function GdipDrawImagePointRectI
                                        (graphics: GpGraphics; image: GpImage;
                                        X: Integer; Y: Integer; srcx: Integer;
                                        srcy: Integer; srcwidth: Integer;
                                        srcheight: Integer; srcUnit: GpUnit)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawImagePointRectI}
                                        function GdipDrawImageRectRect
                                        (graphics: GpGraphics; image: GpImage;
                                        dstx: Single; dsty: Single;
                                        dstwidth: Single; dstheight: Single;
                                        srcx: Single; srcy: Single;
                                        srcwidth: Single; srcheight: Single;
                                        srcUnit: GpUnit;
                                        imageAttributes: GpImageAttributes;
...
{$EXTERNALSYM GdipDrawImageRectRectI}
                                        function GdipDrawImagePointsRect
                                        (graphics: GpGraphics; image: GpImage;
                                        Points: GpPointF; Count: Integer;
                                        srcx: Single; srcy: Single;
                                        srcwidth: Single; srcheight: Single;
...
{$EXTERNALSYM GdipEnumerateMetafileDestRect}
                                        ...
                                        (graphics: GpGraphics;
                                        metafile: GpMetafile; destRect: PGPRect;
                                        callback: EnumerateMetafileProc;
                                        callbackData: pointer;
                                        imageAttributes: GpImageAttributes)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipEnumerateMetafileDestRectI}
                                        ...
                                        (graphics: GpGraphics;
                                        metafile: GpMetafile;
                                        destPoints: PGPPointF; Count: Integer;
                                        callback: EnumerateMetafileProc;
                                        callbackData: pointer;
                                        imageAttributes: GpImageAttributes)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipEnumerateMetafileDestPoints}
                                        ...
                                        (graphics: GpGraphics;
                                        metafile: GpMetafile;
                                        destPoints: PGPPoint; Count: Integer;
                                        callback: EnumerateMetafileProc;
                                        callbackData: pointer;
                                        imageAttributes: GpImageAttributes)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipEnumerateMetafileDestPointsI}
                                        ...
                                        (graphics: GpGraphics;
                                        metafile: GpMetafile;
                                        destPoint: PGPPointF; srcRect: PGPRectF;
                                        srcUnit: TUnit;
                                        callback: EnumerateMetafileProc;
                                        callbackData: pointer;
                                        imageAttributes: GpImageAttributes)
...
{$EXTERNALSYM GdipEnumerateMetafileSrcRectDestPoint}
                                        ...
                                        (graphics: GpGraphics;
                                        metafile: GpMetafile;
                                        destPoint: PGPPoint; srcRect: PGPRect;
                                        srcUnit: TUnit;
                                        callback: EnumerateMetafileProc;
                                        callbackData: pointer;
                                        imageAttributes: GpImageAttributes)
...
{$EXTERNALSYM GdipEnumerateMetafileSrcRectDestPointI}
                                        ...
                                        (graphics: GpGraphics;
                                        metafile: GpMetafile;
                                        destRect: PGPRectF; srcRect: PGPRectF;
                                        srcUnit: TUnit;
                                        callback: EnumerateMetafileProc;
                                        callbackData: pointer;
                                        imageAttributes: GpImageAttributes)
...
{$EXTERNALSYM GdipEnumerateMetafileSrcRectDestRectI}
                                        ...
                                        metafile: GpMetafile;
                                        destPoints: PGPPointF; Count: Integer;
                                        srcRect: PGPRectF; srcUnit: TUnit;
                                        callback: EnumerateMetafileProc;
                                        callbackData: pointer;
                                        imageAttributes: GpImageAttributes)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetClipRectI}
                                        ...
                                        (graphics: GpGraphics; path: GpPath;
                                        CombineMode: CombineMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetClipPath}
                                        function GdipSetClipRegion
                                        (graphics: GpGraphics; region: GpRegion;
                                        CombineMode: CombineMode)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetClipRegion}
                                        function GdipSetClipHrgn
                                        (graphics: GpGraphics; hRgn: hRgn;
                                        CombineMode: CombineMode)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipTranslateClip}
                                        ...
                                        (graphics: GpGraphics; dx: Integer;
                                        dy: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipTranslateClipI}
                                        function GdipGetClip
                                        (graphics: GpGraphics; region: GpRegion)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetClip}
                                        function GdipGetClipBounds
                                        (graphics: GpGraphics; Rect: GpRectF)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetClipBounds}
                                        function GdipGetClipBoundsI
                                        (graphics: GpGraphics; Rect: GpRect)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetClipBoundsI}
                                        function GdipIsClipEmpty
                                        (graphics: GpGraphics; result: PBool)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipIsClipEmpty}
                                        function GdipGetVisibleClipBounds
                                        (graphics: GpGraphics; Rect: GpRectF)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetVisibleClipBounds}
                                        function GdipGetVisibleClipBoundsI
                                        (graphics: GpGraphics; Rect: GpRect)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetVisibleClipBoundsI}
                                        function GdipIsVisibleClipEmpty
                                        (graphics: GpGraphics; var result: BOOL)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipIsVisibleClipEmpty}
                                        function GdipIsVisiblePoint
                                        (graphics: GpGraphics; X: Single;
                                        Y: Single; var result: BOOL)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipIsVisiblePoint}
                                        function GdipIsVisiblePointI
                                        (graphics: GpGraphics; X: Integer;
                                        Y: Integer; var result: BOOL)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipIsVisiblePointI}
                                        function GdipIsVisibleRect
                                        (graphics: GpGraphics; X: Single;
                                        Y: Single; Width: Single;
                                        Height: Single; var result: BOOL)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipIsVisibleRect}
                                        function GdipIsVisibleRectI
                                        (graphics: GpGraphics; X: Integer;
                                        Y: Integer; Width: Integer;
                                        Height: Integer; var result: BOOL)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipIsVisibleRectI}
                                        function GdipSaveGraphics
                                        (graphics: GpGraphics;
                                        var state: GraphicsState)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSaveGraphics}
                                        function GdipRestoreGraphics
                                        (graphics: GpGraphics;
                                        state: GraphicsState)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipRestoreGraphics}
                                        function GdipBeginContainer
                                        (graphics: GpGraphics; dstrect: GpRectF;
                                        srcRect: GpRectF; Unit_: GpUnit;
                                        var state: GraphicsContainer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipBeginContainer}
                                        function GdipBeginContainerI
                                        (graphics: GpGraphics; dstrect: GpRect;
                                        srcRect: GpRect; Unit_: GpUnit;
                                        var state: GraphicsContainer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipBeginContainerI}
                                        function GdipBeginContainer2
                                        (graphics: GpGraphics;
                                        var state: GraphicsContainer)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipEndContainer}
                                        function GdipGetMetafileHeaderFromWmf
                                        (hWmf: HMETAFILE;
                                        WmfPlaceableFileHeader
                                        : PWmfPlaceableFileHeader;
                                        Header: pointer): GpStatus; stdcall;
{$EXTERNALSYM GdipGetMetafileHeaderFromWmf}
                                        function GdipGetMetafileHeaderFromEmf
                                        (hEmf: HENHMETAFILE; Header: pointer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetMetafileHeaderFromEmf}
                                        function GdipGetMetafileHeaderFromFile
                                        (filename: PWCHAR; Header: pointer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetMetafileHeaderFromFile}
                                        function GdipGetMetafileHeaderFromStream
                                        (stream: ISTREAM; Header: pointer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetMetafileHeaderFromStream}
                                        function GdipGetMetafileHeaderFromMetafile
                                        (metafile: GpMetafile; Header: pointer)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetMetafileHeaderFromMetafile}
                                        function GdipGetHemfFromMetafile
                                        (metafile: GpMetafile;
                                        var hEmf: HENHMETAFILE)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetHemfFromMetafile}
                                        function GdipCreateStreamOnFile
                                        (filename: PWCHAR; access: UINT;
                                        out stream: ISTREAM): GpStatus; stdcall;
{$EXTERNALSYM GdipCreateStreamOnFile}
                                        function GdipCreateMetafileFromWmf
                                        (hWmf: HMETAFILE; deleteWmf: BOOL;
                                        WmfPlaceableFileHeader
                                        : PWmfPlaceableFileHeader;
                                        out metafile: GpMetafile)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateMetafileFromWmf}
                                        function GdipCreateMetafileFromEmf
                                        (hEmf: HENHMETAFILE; deleteEmf: BOOL;
                                        out metafile: GpMetafile)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateMetafileFromEmf}
                                        function GdipCreateMetafileFromFile
                                        (file_: PWCHAR;
                                        out metafile: GpMetafile)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipCreateMetafileFromWmfFile}
                                        function GdipCreateMetafileFromStream
                                        (stream: ISTREAM;
                                        out metafile: GpMetafile)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCreateMetafileFromStream}
                                        function GdipRecordMetafile
                                        (referenceHdc: hdc; type_: EmfType;
                                        frameRect: GpRectF;
...
{$EXTERNALSYM GdipRecordMetafileI}
                                        ...
                                        (filename: PWCHAR; referenceHdc: hdc;
                                        type_: EmfType; frameRect: GpRectF;
                                        frameUnit: MetafileFrameUnit;
                                        description: PWCHAR;
                                        out metafile: GpMetafile)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipRecordMetafileFileName}
                                        ...
                                        (filename: PWCHAR; referenceHdc: hdc;
                                        type_: EmfType; frameRect: GpRect;
                                        frameUnit: MetafileFrameUnit;
                                        description: PWCHAR;
                                        out metafile: GpMetafile)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipRecordMetafileFileNameI}
                                        ...
                                        (stream: ISTREAM; referenceHdc: hdc;
                                        type_: EmfType; frameRect: GpRectF;
                                        frameUnit: MetafileFrameUnit;
                                        description: PWCHAR;
                                        out metafile: GpMetafile)
...
{$EXTERNALSYM GdipDeleteFontFamily}
                                        function GdipCloneFontFamily
                                        (FontFamily: GpFontFamily;
                                        out clonedFontFamily: GpFontFamily)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipCloneFontFamily}
                                        function GdipGetGenericFontFamilySansSerif
                                        (out nativeFamily: GpFontFamily)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipGetGenericFontFamilyMonospace}
                                        function GdipGetFamilyName
                                        (family: GpFontFamily; name: PWideChar;
                                        language: LANGID): GpStatus; stdcall;
{$EXTERNALSYM GdipGetFamilyName}
                                        function GdipIsStyleAvailable
                                        (family: GpFontFamily; style: Integer;
                                        var IsStyleAvailable: BOOL)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipIsStyleAvailable}
                                        function GdipFontCollectionEnumerable
                                        (fontCollection: GpFontCollection;
                                        graphics: GpGraphics;
...
{$EXTERNALSYM GdipFontCollectionEnumerable}
                                        ...
                                        (fontCollection: GpFontCollection;
                                        numSought: Integer;
                                        gpfamilies: array of GpFontFamily;
                                        var numFound: Integer;
                                        graphics: GpGraphics)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipGetCellAscent}
                                        function GdipGetCellDescent
                                        (family: GpFontFamily; style: Integer;
                                        var CellDescent: UINT16)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetCellDescent}
                                        function GdipGetLineSpacing
                                        (family: GpFontFamily; style: Integer;
...
{$EXTERNALSYM GdipGetFontStyle}
                                        function GdipGetFontSize(font: GpFont;
                                        var size: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipGetFontSize}
                                        function GdipGetFontUnit(font: GpFont;
                                        var Unit_: TUnit): GpStatus; stdcall;
{$EXTERNALSYM GdipGetFontUnit}
                                        function GdipGetFontHeight(font: GpFont;
                                        graphics: GpGraphics;
                                        var Height: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipGetFontHeight}
                                        function GdipGetFontHeightGivenDPI
                                        (font: GpFont; dpi: Single;
                                        var Height: Single): GpStatus; stdcall;
{$EXTERNALSYM GdipGetFontHeightGivenDPI}
                                        function GdipGetLogFontA(font: GpFont;
                                        graphics: GpGraphics;
                                        var logfontA: logfontA)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetLogFontA}
                                        function GdipGetLogFontW(font: GpFont;
                                        graphics: GpGraphics;
                                        var logfontW: logfontW)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetLogFontW}
                                        function GdipNewInstalledFontCollection
                                        (out fontCollection: GpFontCollection)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipDeletePrivateFontCollection}
                                        function GdipGetFontCollectionFamilyCount
                                        (fontCollection: GpFontCollection;
                                        var numFound: Integer)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipPrivateAddMemoryFont}
                                        ...
                                        (graphics: GpGraphics; string_: PWCHAR;
                                        Length: Integer; font: GpFont;
                                        layoutRect: PGPRectF;
...
{$EXTERNALSYM GdipMeasureString}
                                        ...
                                        stringFormat: GpStringFormat;
                                        regionCount: Integer;
                                        const regions: GpRegion)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipMeasureCharacterRanges}
                                        function GdipDrawDriverString
                                        (graphics: GpGraphics;
                                        const text: PUINT16; Length: Integer;
                                        const font: GpFont;
                                        const brush: GpBrush;
                                        const positions: PGPPointF;
                                        flags: Integer; const matrix: GpMatrix)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipDrawDriverString}
                                        function GdipMeasureDriverString
                                        (graphics: GpGraphics; text: PUINT16;
                                        Length: Integer; font: GpFont;
                                        positions: PGPPointF; flags: Integer;
                                        matrix: GpMatrix; BoundingBox: PGPRectF)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetStringFormatAlign}
                                        function GdipGetStringFormatAlign
                                        (format: GpStringFormat;
                                        out align: StringAlignment)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetStringFormatLineAlign}
                                        function GdipGetStringFormatLineAlign
                                        (format: GpStringFormat;
                                        out align: StringAlignment)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipGetStringFormatLineAlign}
                                        function GdipSetStringFormatTrimming
                                        (format: GpStringFormat;
                                        trimming: StringTrimming)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetStringFormatTrimming}
                                        function GdipGetStringFormatTrimming
                                        (format: GpStringFormat;
                                        out trimming: StringTrimming)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetStringFormatHotkeyPrefix}
                                        function GdipGetStringFormatHotkeyPrefix
                                        (format: GpStringFormat;
                                        out HotkeyPrefix: Integer)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetStringFormatTabStops}
                                        function GdipGetStringFormatTabStops
                                        (format: GpStringFormat; Count: Integer;
                                        firstTabOffset: PSingle;
                                        tabStops: PSingle): GpStatus; stdcall;
{$EXTERNALSYM GdipGetStringFormatTabStops}
                                        function GdipGetStringFormatTabStopCount
                                        (format: GpStringFormat;
                                        out Count: Integer): GpStatus; stdcall;
{$EXTERNALSYM GdipGetStringFormatTabStopCount}
                                        function GdipSetStringFormatDigitSubstitution
                                        (format: GpStringFormat;
                                        language: LANGID;
                                        substitute: StringDigitSubstitute)
                                        : GpStatus; stdcall;
{$EXTERNALSYM GdipSetStringFormatDigitSubstitution}
                                        function GdipGetStringFormatDigitSubstitution
                                        (format: GpStringFormat;
                                        language: PUINT;
                                        substitute: PStringDigitSubstitute)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipSetStringFormatMeasurableCharacterRanges}
                                        ...
                                        (bitmap: GpBitmap; graphics: GpGraphics;
                                        out cachedBitmap: GpCachedBitmap)
                                        : GpStatus; stdcall;
...
{$EXTERNALSYM GdipDrawCachedBitmap}
                                        ...
                                        (hEmf: HENHMETAFILE; cbData16: UINT;
                                        pData16: PBYTE; iMapMode: Integer;
                                        eFlags: Integer): UINT; stdcall;
...
function GdipAddPathClosedCurve;
  external WINGDIPDLL name 'GdipAddPathClosedCurve';
function GdipAddPathClosedCurve2;
  external WINGDIPDLL name 'GdipAddPathClosedCurve2';
function GdipAddPathRectangle; external WINGDIPDLL name 'GdipAddPathRectangle';
function GdipAddPathRectangles;
  external WINGDIPDLL name 'GdipAddPathRectangles';
...
function GdipAddPathClosedCurveI;
  external WINGDIPDLL name 'GdipAddPathClosedCurveI';
function GdipAddPathClosedCurve2I;
  external WINGDIPDLL name 'GdipAddPathClosedCurve2I';
function GdipAddPathRectangleI;
  external WINGDIPDLL name 'GdipAddPathRectangleI';
function GdipAddPathRectanglesI;
  external WINGDIPDLL name 'GdipAddPathRectanglesI';
...
function GdipWindingModeOutline;
  external WINGDIPDLL name 'GdipWindingModeOutline';
...
function GdipGetPathWorldBounds;
  external WINGDIPDLL name 'GdipGetPathWorldBounds';
function GdipGetPathWorldBoundsI;
  external WINGDIPDLL name 'GdipGetPathWorldBoundsI';
function GdipIsVisiblePathPoint;
  external WINGDIPDLL name 'GdipIsVisiblePathPoint';
function GdipIsVisiblePathPointI;
  external WINGDIPDLL name 'GdipIsVisiblePathPointI';
function GdipIsOutlineVisiblePathPoint;
  external WINGDIPDLL name 'GdipIsOutlineVisiblePathPoint';
function GdipIsOutlineVisiblePathPointI;
  external WINGDIPDLL name 'GdipIsOutlineVisiblePathPointI';
...
function GdipPathIterNextSubpath;
  external WINGDIPDLL name 'GdipPathIterNextSubpath';
function GdipPathIterNextSubpathPath;
  external WINGDIPDLL name 'GdipPathIterNextSubpathPath';
function GdipPathIterNextPathType;
  external WINGDIPDLL name 'GdipPathIterNextPathType';
function GdipPathIterNextMarker;
  external WINGDIPDLL name 'GdipPathIterNextMarker';
function GdipPathIterNextMarkerPath;
  external WINGDIPDLL name 'GdipPathIterNextMarkerPath';
function GdipPathIterGetCount; external WINGDIPDLL name 'GdipPathIterGetCount';
function GdipPathIterGetSubpathCount;
  external WINGDIPDLL name 'GdipPathIterGetSubpathCount';
...
function GdipPathIterEnumerate;
  external WINGDIPDLL name 'GdipPathIterEnumerate';
...
function GdipSetMatrixElements;
  external WINGDIPDLL name 'GdipSetMatrixElements';
...
function GdipTransformMatrixPoints;
  external WINGDIPDLL name 'GdipTransformMatrixPoints';
function GdipTransformMatrixPointsI;
  external WINGDIPDLL name 'GdipTransformMatrixPointsI';
function GdipVectorTransformMatrixPoints;
  external WINGDIPDLL name 'GdipVectorTransformMatrixPoints';
function GdipVectorTransformMatrixPointsI;
  external WINGDIPDLL name 'GdipVectorTransformMatrixPointsI';
function GdipGetMatrixElements;
  external WINGDIPDLL name 'GdipGetMatrixElements';
function GdipIsMatrixInvertible;
  external WINGDIPDLL name 'GdipIsMatrixInvertible';
...
function GdipCreateRegionRectI;
  external WINGDIPDLL name 'GdipCreateRegionRectI';
function GdipCreateRegionPath; external WINGDIPDLL name 'GdipCreateRegionPath';
function GdipCreateRegionRgnData;
  external WINGDIPDLL name 'GdipCreateRegionRgnData';
...
function GdipCombineRegionRect;
  external WINGDIPDLL name 'GdipCombineRegionRect';
function GdipCombineRegionRectI;
  external WINGDIPDLL name 'GdipCombineRegionRectI';
function GdipCombineRegionPath;
  external WINGDIPDLL name 'GdipCombineRegionPath';
function GdipCombineRegionRegion;
  external WINGDIPDLL name 'GdipCombineRegionRegion';
...
function GdipGetRegionDataSize;
  external WINGDIPDLL name 'GdipGetRegionDataSize';
function GdipGetRegionData; external WINGDIPDLL name 'GdipGetRegionData';
function GdipIsVisibleRegionPoint;
  external WINGDIPDLL name 'GdipIsVisibleRegionPoint';
function GdipIsVisibleRegionPointI;
  external WINGDIPDLL name 'GdipIsVisibleRegionPointI';
function GdipIsVisibleRegionRect;
  external WINGDIPDLL name 'GdipIsVisibleRegionRect';
function GdipIsVisibleRegionRectI;
  external WINGDIPDLL name 'GdipIsVisibleRegionRectI';
function GdipGetRegionScansCount;
  external WINGDIPDLL name 'GdipGetRegionScansCount';
...
function GdipGetHatchForegroundColor;
  external WINGDIPDLL name 'GdipGetHatchForegroundColor';
function GdipGetHatchBackgroundColor;
  external WINGDIPDLL name 'GdipGetHatchBackgroundColor';
...
function GdipGetTextureTransform;
  external WINGDIPDLL name 'GdipGetTextureTransform';
function GdipSetTextureTransform;
  external WINGDIPDLL name 'GdipSetTextureTransform';
function GdipResetTextureTransform;
  external WINGDIPDLL name 'GdipResetTextureTransform';
function GdipMultiplyTextureTransform;
  external WINGDIPDLL name 'GdipMultiplyTextureTransform';
function GdipTranslateTextureTransform;
  external WINGDIPDLL name 'GdipTranslateTextureTransform';
function GdipScaleTextureTransform;
  external WINGDIPDLL name 'GdipScaleTextureTransform';
function GdipRotateTextureTransform;
  external WINGDIPDLL name 'GdipRotateTextureTransform';
function GdipSetTextureWrapMode;
  external WINGDIPDLL name 'GdipSetTextureWrapMode';
function GdipGetTextureWrapMode;
  external WINGDIPDLL name 'GdipGetTextureWrapMode';
...
function GdipSetSolidFillColor;
  external WINGDIPDLL name 'GdipSetSolidFillColor';
function GdipGetSolidFillColor;
  external WINGDIPDLL name 'GdipGetSolidFillColor';
...
function GdipCreateLineBrushFromRect;
  external WINGDIPDLL name 'GdipCreateLineBrushFromRect';
function GdipCreateLineBrushFromRectI;
  external WINGDIPDLL name 'GdipCreateLineBrushFromRectI';
function GdipCreateLineBrushFromRectWithAngle;
  external WINGDIPDLL name 'GdipCreateLineBrushFromRectWithAngle';
function GdipCreateLineBrushFromRectWithAngleI;
...
function GdipSetLineGammaCorrection;
  external WINGDIPDLL name 'GdipSetLineGammaCorrection';
function GdipGetLineGammaCorrection;
  external WINGDIPDLL name 'GdipGetLineGammaCorrection';
function GdipGetLineBlendCount;
  external WINGDIPDLL name 'GdipGetLineBlendCount';
...
function GdipGetLinePresetBlendCount;
  external WINGDIPDLL name 'GdipGetLinePresetBlendCount';
function GdipGetLinePresetBlend;
  external WINGDIPDLL name 'GdipGetLinePresetBlend';
function GdipSetLinePresetBlend;
  external WINGDIPDLL name 'GdipSetLinePresetBlend';
function GdipSetLineSigmaBlend;
  external WINGDIPDLL name 'GdipSetLineSigmaBlend';
function GdipSetLineLinearBlend;
  external WINGDIPDLL name 'GdipSetLineLinearBlend';
...
function GdipResetLineTransform;
  external WINGDIPDLL name 'GdipResetLineTransform';
function GdipMultiplyLineTransform;
  external WINGDIPDLL name 'GdipMultiplyLineTransform';
function GdipTranslateLineTransform;
  external WINGDIPDLL name 'GdipTranslateLineTransform';
function GdipScaleLineTransform;
  external WINGDIPDLL name 'GdipScaleLineTransform';
function GdipRotateLineTransform;
  external WINGDIPDLL name 'GdipRotateLineTransform';
function GdipCreatePathGradient;
  external WINGDIPDLL name 'GdipCreatePathGradient';
function GdipCreatePathGradientI;
  external WINGDIPDLL name 'GdipCreatePathGradientI';
function GdipCreatePathGradientFromPath;
  external WINGDIPDLL name 'GdipCreatePathGradientFromPath';
function GdipGetPathGradientCenterColor;
  external WINGDIPDLL name 'GdipGetPathGradientCenterColor';
function GdipSetPathGradientCenterColor;
  external WINGDIPDLL name 'GdipSetPathGradientCenterColor';
function GdipGetPathGradientSurroundColorsWithCount;
  external WINGDIPDLL name 'GdipGetPathGradientSurroundColorsWithCount';
function GdipSetPathGradientSurroundColorsWithCount;
  external WINGDIPDLL name 'GdipSetPathGradientSurroundColorsWithCount';
function GdipGetPathGradientPath;
  external WINGDIPDLL name 'GdipGetPathGradientPath';
function GdipSetPathGradientPath;
  external WINGDIPDLL name 'GdipSetPathGradientPath';
function GdipGetPathGradientCenterPoint;
  external WINGDIPDLL name 'GdipGetPathGradientCenterPoint';
function GdipGetPathGradientCenterPointI;
  external WINGDIPDLL name 'GdipGetPathGradientCenterPointI';
function GdipSetPathGradientCenterPoint;
  external WINGDIPDLL name 'GdipSetPathGradientCenterPoint';
function GdipSetPathGradientCenterPointI;
  external WINGDIPDLL name 'GdipSetPathGradientCenterPointI';
function GdipGetPathGradientRect;
  external WINGDIPDLL name 'GdipGetPathGradientRect';
function GdipGetPathGradientRectI;
  external WINGDIPDLL name 'GdipGetPathGradientRectI';
function GdipGetPathGradientPointCount;
  external WINGDIPDLL name 'GdipGetPathGradientPointCount';
function GdipGetPathGradientSurroundColorCount;
  external WINGDIPDLL name 'GdipGetPathGradientSurroundColorCount';
function GdipSetPathGradientGammaCorrection;
  external WINGDIPDLL name 'GdipSetPathGradientGammaCorrection';
function GdipGetPathGradientGammaCorrection;
  external WINGDIPDLL name 'GdipGetPathGradientGammaCorrection';
function GdipGetPathGradientBlendCount;
  external WINGDIPDLL name 'GdipGetPathGradientBlendCount';
function GdipGetPathGradientBlend;
  external WINGDIPDLL name 'GdipGetPathGradientBlend';
function GdipSetPathGradientBlend;
  external WINGDIPDLL name 'GdipSetPathGradientBlend';
function GdipGetPathGradientPresetBlendCount;
  external WINGDIPDLL name 'GdipGetPathGradientPresetBlendCount';
function GdipGetPathGradientPresetBlend;
  external WINGDIPDLL name 'GdipGetPathGradientPresetBlend';
function GdipSetPathGradientPresetBlend;
  external WINGDIPDLL name 'GdipSetPathGradientPresetBlend';
function GdipSetPathGradientSigmaBlend;
  external WINGDIPDLL name 'GdipSetPathGradientSigmaBlend';
function GdipSetPathGradientLinearBlend;
  external WINGDIPDLL name 'GdipSetPathGradientLinearBlend';
function GdipGetPathGradientWrapMode;
  external WINGDIPDLL name 'GdipGetPathGradientWrapMode';
function GdipSetPathGradientWrapMode;
  external WINGDIPDLL name 'GdipSetPathGradientWrapMode';
function GdipGetPathGradientTransform;
  external WINGDIPDLL name 'GdipGetPathGradientTransform';
function GdipSetPathGradientTransform;
  external WINGDIPDLL name 'GdipSetPathGradientTransform';
function GdipResetPathGradientTransform;
  external WINGDIPDLL name 'GdipResetPathGradientTransform';
function GdipMultiplyPathGradientTransform;
  external WINGDIPDLL name 'GdipMultiplyPathGradientTransform';
function GdipTranslatePathGradientTransform;
  external WINGDIPDLL name 'GdipTranslatePathGradientTransform';
function GdipScalePathGradientTransform;
  external WINGDIPDLL name 'GdipScalePathGradientTransform';
function GdipRotatePathGradientTransform;
  external WINGDIPDLL name 'GdipRotatePathGradientTransform';
function GdipGetPathGradientFocusScales;
  external WINGDIPDLL name 'GdipGetPathGradientFocusScales';
function GdipSetPathGradientFocusScales;
  external WINGDIPDLL name 'GdipSetPathGradientFocusScales';
...
function GdipSetPenLineCap197819;
  external WINGDIPDLL name 'GdipSetPenLineCap197819';
...
function GdipSetPenDashCap197819;
  external WINGDIPDLL name 'GdipSetPenDashCap197819';
...
function GdipGetPenDashCap197819;
  external WINGDIPDLL name 'GdipGetPenDashCap197819';
...
function GdipSetPenCustomStartCap;
  external WINGDIPDLL name 'GdipSetPenCustomStartCap';
function GdipGetPenCustomStartCap;
  external WINGDIPDLL name 'GdipGetPenCustomStartCap';
function GdipSetPenCustomEndCap;
  external WINGDIPDLL name 'GdipSetPenCustomEndCap';
function GdipGetPenCustomEndCap;
  external WINGDIPDLL name 'GdipGetPenCustomEndCap';
...
function GdipMultiplyPenTransform;
  external WINGDIPDLL name 'GdipMultiplyPenTransform';
function GdipTranslatePenTransform;
  external WINGDIPDLL name 'GdipTranslatePenTransform';
function GdipScalePenTransform;
  external WINGDIPDLL name 'GdipScalePenTransform';
function GdipRotatePenTransform;
  external WINGDIPDLL name 'GdipRotatePenTransform';
...
function GdipGetPenCompoundCount;
  external WINGDIPDLL name 'GdipGetPenCompoundCount';
function GdipSetPenCompoundArray;
  external WINGDIPDLL name 'GdipSetPenCompoundArray';
function GdipGetPenCompoundArray;
  external WINGDIPDLL name 'GdipGetPenCompoundArray';
function GdipCreateCustomLineCap;
  external WINGDIPDLL name 'GdipCreateCustomLineCap';
function GdipDeleteCustomLineCap;
  external WINGDIPDLL name 'GdipDeleteCustomLineCap';
function GdipCloneCustomLineCap;
  external WINGDIPDLL name 'GdipCloneCustomLineCap';
function GdipGetCustomLineCapType;
  external WINGDIPDLL name 'GdipGetCustomLineCapType';
function GdipSetCustomLineCapStrokeCaps;
  external WINGDIPDLL name 'GdipSetCustomLineCapStrokeCaps';
function GdipGetCustomLineCapStrokeCaps;
  external WINGDIPDLL name 'GdipGetCustomLineCapStrokeCaps';
function GdipSetCustomLineCapStrokeJoin;
  external WINGDIPDLL name 'GdipSetCustomLineCapStrokeJoin';
function GdipGetCustomLineCapStrokeJoin;
  external WINGDIPDLL name 'GdipGetCustomLineCapStrokeJoin';
function GdipSetCustomLineCapBaseCap;
  external WINGDIPDLL name 'GdipSetCustomLineCapBaseCap';
function GdipGetCustomLineCapBaseCap;
  external WINGDIPDLL name 'GdipGetCustomLineCapBaseCap';
function GdipSetCustomLineCapBaseInset;
  external WINGDIPDLL name 'GdipSetCustomLineCapBaseInset';
function GdipGetCustomLineCapBaseInset;
  external WINGDIPDLL name 'GdipGetCustomLineCapBaseInset';
function GdipSetCustomLineCapWidthScale;
  external WINGDIPDLL name 'GdipSetCustomLineCapWidthScale';
function GdipGetCustomLineCapWidthScale;
  external WINGDIPDLL name 'GdipGetCustomLineCapWidthScale';
function GdipCreateAdjustableArrowCap;
  external WINGDIPDLL name 'GdipCreateAdjustableArrowCap';
function GdipSetAdjustableArrowCapHeight;
  external WINGDIPDLL name 'GdipSetAdjustableArrowCapHeight';
function GdipGetAdjustableArrowCapHeight;
  external WINGDIPDLL name 'GdipGetAdjustableArrowCapHeight';
function GdipSetAdjustableArrowCapWidth;
  external WINGDIPDLL name 'GdipSetAdjustableArrowCapWidth';
function GdipGetAdjustableArrowCapWidth;
  external WINGDIPDLL name 'GdipGetAdjustableArrowCapWidth';
function GdipSetAdjustableArrowCapMiddleInset;
  external WINGDIPDLL name 'GdipSetAdjustableArrowCapMiddleInset';
function GdipGetAdjustableArrowCapMiddleInset;
  external WINGDIPDLL name 'GdipGetAdjustableArrowCapMiddleInset';
function GdipSetAdjustableArrowCapFillState;
  external WINGDIPDLL name 'GdipSetAdjustableArrowCapFillState';
function GdipGetAdjustableArrowCapFillState;
  external WINGDIPDLL name 'GdipGetAdjustableArrowCapFillState';
function GdipLoadImageFromStream;
  external WINGDIPDLL name 'GdipLoadImageFromStream';
function GdipLoadImageFromFile;
  external WINGDIPDLL name 'GdipLoadImageFromFile';
function GdipLoadImageFromStreamICM;
  external WINGDIPDLL name 'GdipLoadImageFromStreamICM';
function GdipLoadImageFromFileICM;
  external WINGDIPDLL name 'GdipLoadImageFromFileICM';
...
function GdipSaveImageToStream;
  external WINGDIPDLL name 'GdipSaveImageToStream';
...
function GdipGetImageGraphicsContext;
  external WINGDIPDLL name 'GdipGetImageGraphicsContext';
function GdipGetImageBounds; external WINGDIPDLL name 'GdipGetImageBounds';
function GdipGetImageDimension;
  external WINGDIPDLL name 'GdipGetImageDimension';
...
function GdipGetImageHorizontalResolution;
  external WINGDIPDLL name 'GdipGetImageHorizontalResolution';
function GdipGetImageVerticalResolution;
  external WINGDIPDLL name 'GdipGetImageVerticalResolution';
function GdipGetImageFlags; external WINGDIPDLL name 'GdipGetImageFlags';
function GdipGetImageRawFormat;
  external WINGDIPDLL name 'GdipGetImageRawFormat';
function GdipGetImagePixelFormat;
  external WINGDIPDLL name 'GdipGetImagePixelFormat';
function GdipGetImageThumbnail;
  external WINGDIPDLL name 'GdipGetImageThumbnail';
function GdipGetEncoderParameterListSize;
  external WINGDIPDLL name 'GdipGetEncoderParameterListSize';
function GdipGetEncoderParameterList;
  external WINGDIPDLL name 'GdipGetEncoderParameterList';
function GdipImageGetFrameDimensionsCount;
  external WINGDIPDLL name 'GdipImageGetFrameDimensionsCount';
function GdipImageGetFrameDimensionsList;
  external WINGDIPDLL name 'GdipImageGetFrameDimensionsList';
function GdipImageGetFrameCount;
  external WINGDIPDLL name 'GdipImageGetFrameCount';
function GdipImageSelectActiveFrame;
  external WINGDIPDLL name 'GdipImageSelectActiveFrame';
...
function GdipGetImagePaletteSize;
  external WINGDIPDLL name 'GdipGetImagePaletteSize';
function GdipGetPropertyCount; external WINGDIPDLL name 'GdipGetPropertyCount';
function GdipGetPropertyIdList;
  external WINGDIPDLL name 'GdipGetPropertyIdList';
function GdipGetPropertyItemSize;
  external WINGDIPDLL name 'GdipGetPropertyItemSize';
...
function GdipGetAllPropertyItems;
  external WINGDIPDLL name 'GdipGetAllPropertyItems';
function GdipRemovePropertyItem;
  external WINGDIPDLL name 'GdipRemovePropertyItem';
...
function GdipCreateBitmapFromStream;
  external WINGDIPDLL name 'GdipCreateBitmapFromStream';
function GdipCreateBitmapFromFile;
  external WINGDIPDLL name 'GdipCreateBitmapFromFile';
function GdipCreateBitmapFromStreamICM;
  external WINGDIPDLL name 'GdipCreateBitmapFromStreamICM';
function GdipCreateBitmapFromFileICM;
  external WINGDIPDLL name 'GdipCreateBitmapFromFileICM';
function GdipCreateBitmapFromScan0;
  external WINGDIPDLL name 'GdipCreateBitmapFromScan0';
function GdipCreateBitmapFromGraphics;
  external WINGDIPDLL name 'GdipCreateBitmapFromGraphics';
function GdipCreateBitmapFromDirectDrawSurface;
  external WINGDIPDLL name 'GdipCreateBitmapFromDirectDrawSurface';
function GdipCreateBitmapFromGdiDib;
  external WINGDIPDLL name 'GdipCreateBitmapFromGdiDib';
function GdipCreateBitmapFromHBITMAP;
  external WINGDIPDLL name 'GdipCreateBitmapFromHBITMAP';
function GdipCreateHBITMAPFromBitmap;
  external WINGDIPDLL name 'GdipCreateHBITMAPFromBitmap';
function GdipCreateBitmapFromHICON;
  external WINGDIPDLL name 'GdipCreateBitmapFromHICON';
function GdipCreateHICONFromBitmap;
  external WINGDIPDLL name 'GdipCreateHICONFromBitmap';
function GdipCreateBitmapFromResource;
  external WINGDIPDLL name 'GdipCreateBitmapFromResource';
...
function GdipBitmapSetResolution;
  external WINGDIPDLL name 'GdipBitmapSetResolution';
function GdipCreateImageAttributes;
  external WINGDIPDLL name 'GdipCreateImageAttributes';
function GdipCloneImageAttributes;
  external WINGDIPDLL name 'GdipCloneImageAttributes';
function GdipDisposeImageAttributes;
  external WINGDIPDLL name 'GdipDisposeImageAttributes';
function GdipSetImageAttributesToIdentity;
  external WINGDIPDLL name 'GdipSetImageAttributesToIdentity';
function GdipResetImageAttributes;
  external WINGDIPDLL name 'GdipResetImageAttributes';
function GdipSetImageAttributesColorMatrix;
  external WINGDIPDLL name 'GdipSetImageAttributesColorMatrix';
function GdipSetImageAttributesThreshold;
  external WINGDIPDLL name 'GdipSetImageAttributesThreshold';
function GdipSetImageAttributesGamma;
  external WINGDIPDLL name 'GdipSetImageAttributesGamma';
function GdipSetImageAttributesNoOp;
  external WINGDIPDLL name 'GdipSetImageAttributesNoOp';
function GdipSetImageAttributesColorKeys;
  external WINGDIPDLL name 'GdipSetImageAttributesColorKeys';
function GdipSetImageAttributesOutputChannel;
  external WINGDIPDLL name 'GdipSetImageAttributesOutputChannel';
function GdipSetImageAttributesOutputChannelColorProfile;
  external WINGDIPDLL name 'GdipSetImageAttributesOutputChannelColorProfile';
function GdipSetImageAttributesRemapTable;
  external WINGDIPDLL name 'GdipSetImageAttributesRemapTable';
function GdipSetImageAttributesWrapMode;
  external WINGDIPDLL name 'GdipSetImageAttributesWrapMode';
function GdipSetImageAttributesICMMode;
  external WINGDIPDLL name 'GdipSetImageAttributesICMMode';
function GdipGetImageAttributesAdjustedPalette;
  external WINGDIPDLL name 'GdipGetImageAttributesAdjustedPalette';
...
function GdipCreateFromHWNDICM;
  external WINGDIPDLL name 'GdipCreateFromHWNDICM';
...
function GdipSetCompositingMode;
  external WINGDIPDLL name 'GdipSetCompositingMode';
function GdipGetCompositingMode;
  external WINGDIPDLL name 'GdipGetCompositingMode';
function GdipSetRenderingOrigin;
  external WINGDIPDLL name 'GdipSetRenderingOrigin';
function GdipGetRenderingOrigin;
  external WINGDIPDLL name 'GdipGetRenderingOrigin';
function GdipSetCompositingQuality;
  external WINGDIPDLL name 'GdipSetCompositingQuality';
function GdipGetCompositingQuality;
  external WINGDIPDLL name 'GdipGetCompositingQuality';
...
function GdipSetPixelOffsetMode;
  external WINGDIPDLL name 'GdipSetPixelOffsetMode';
function GdipGetPixelOffsetMode;
  external WINGDIPDLL name 'GdipGetPixelOffsetMode';
function GdipSetTextRenderingHint;
  external WINGDIPDLL name 'GdipSetTextRenderingHint';
function GdipGetTextRenderingHint;
  external WINGDIPDLL name 'GdipGetTextRenderingHint';
...
function GdipSetInterpolationMode;
  external WINGDIPDLL name 'GdipSetInterpolationMode';
function GdipGetInterpolationMode;
  external WINGDIPDLL name 'GdipGetInterpolationMode';
function GdipSetWorldTransform;
  external WINGDIPDLL name 'GdipSetWorldTransform';
function GdipResetWorldTransform;
  external WINGDIPDLL name 'GdipResetWorldTransform';
function GdipMultiplyWorldTransform;
  external WINGDIPDLL name 'GdipMultiplyWorldTransform';
function GdipTranslateWorldTransform;
  external WINGDIPDLL name 'GdipTranslateWorldTransform';
function GdipScaleWorldTransform;
  external WINGDIPDLL name 'GdipScaleWorldTransform';
function GdipRotateWorldTransform;
  external WINGDIPDLL name 'GdipRotateWorldTransform';
function GdipGetWorldTransform;
  external WINGDIPDLL name 'GdipGetWorldTransform';
function GdipResetPageTransform;
  external WINGDIPDLL name 'GdipResetPageTransform';
...
function GdipCreateHalftonePalette;
  external WINGDIPDLL name 'GdipCreateHalftonePalette';
...
function GdipDrawClosedCurve2I;
  external WINGDIPDLL name 'GdipDrawClosedCurve2I';
...
function GdipFillClosedCurve2I;
  external WINGDIPDLL name 'GdipFillClosedCurve2I';
...
function GdipDrawImagePointRect;
  external WINGDIPDLL name 'GdipDrawImagePointRect';
function GdipDrawImagePointRectI;
  external WINGDIPDLL name 'GdipDrawImagePointRectI';
function GdipDrawImageRectRect;
  external WINGDIPDLL name 'GdipDrawImageRectRect';
function GdipDrawImageRectRectI;
  external WINGDIPDLL name 'GdipDrawImageRectRectI';
function GdipDrawImagePointsRect;
  external WINGDIPDLL name 'GdipDrawImagePointsRect';
function GdipDrawImagePointsRectI;
  external WINGDIPDLL name 'GdipDrawImagePointsRectI';
function GdipEnumerateMetafileDestPoint;
  external WINGDIPDLL name 'GdipEnumerateMetafileDestPoint';
function GdipEnumerateMetafileDestPointI;
  external WINGDIPDLL name 'GdipEnumerateMetafileDestPointI';
function GdipEnumerateMetafileDestRect;
  external WINGDIPDLL name 'GdipEnumerateMetafileDestRect';
function GdipEnumerateMetafileDestRectI;
  external WINGDIPDLL name 'GdipEnumerateMetafileDestRectI';
function GdipEnumerateMetafileDestPoints;
  external WINGDIPDLL name 'GdipEnumerateMetafileDestPoints';
function GdipEnumerateMetafileDestPointsI;
  external WINGDIPDLL name 'GdipEnumerateMetafileDestPointsI';
function GdipEnumerateMetafileSrcRectDestPoint;
  external WINGDIPDLL name 'GdipEnumerateMetafileSrcRectDestPoint';
function GdipEnumerateMetafileSrcRectDestPointI;
  external WINGDIPDLL name 'GdipEnumerateMetafileSrcRectDestPointI';
function GdipEnumerateMetafileSrcRectDestRect;
  external WINGDIPDLL name 'GdipEnumerateMetafileSrcRectDestRect';
function GdipEnumerateMetafileSrcRectDestRectI;
  external WINGDIPDLL name 'GdipEnumerateMetafileSrcRectDestRectI';
function GdipEnumerateMetafileSrcRectDestPoints;
  external WINGDIPDLL name 'GdipEnumerateMetafileSrcRectDestPoints';
function GdipEnumerateMetafileSrcRectDestPointsI;
  external WINGDIPDLL name 'GdipEnumerateMetafileSrcRectDestPointsI';
function GdipPlayMetafileRecord;
...
function GdipGetVisibleClipBounds;
  external WINGDIPDLL name 'GdipGetVisibleClipBounds';
function GdipGetVisibleClipBoundsI;
  external WINGDIPDLL name 'GdipGetVisibleClipBoundsI';
function GdipIsVisibleClipEmpty;
  external WINGDIPDLL name 'GdipIsVisibleClipEmpty';
...
function GdipGetMetafileHeaderFromWmf;
  external WINGDIPDLL name 'GdipGetMetafileHeaderFromWmf';
function GdipGetMetafileHeaderFromEmf;
  external WINGDIPDLL name 'GdipGetMetafileHeaderFromEmf';
function GdipGetMetafileHeaderFromFile;
  external WINGDIPDLL name 'GdipGetMetafileHeaderFromFile';
function GdipGetMetafileHeaderFromStream;
  external WINGDIPDLL name 'GdipGetMetafileHeaderFromStream';
function GdipGetMetafileHeaderFromMetafile;
  external WINGDIPDLL name 'GdipGetMetafileHeaderFromMetafile';
function GdipGetHemfFromMetafile;
  external WINGDIPDLL name 'GdipGetHemfFromMetafile';
function GdipCreateStreamOnFile;
  external WINGDIPDLL name 'GdipCreateStreamOnFile';
function GdipCreateMetafileFromWmf;
  external WINGDIPDLL name 'GdipCreateMetafileFromWmf';
function GdipCreateMetafileFromEmf;
  external WINGDIPDLL name 'GdipCreateMetafileFromEmf';
function GdipCreateMetafileFromFile;
  external WINGDIPDLL name 'GdipCreateMetafileFromFile';
function GdipCreateMetafileFromWmfFile;
  external WINGDIPDLL name 'GdipCreateMetafileFromWmfFile';
function GdipCreateMetafileFromStream;
  external WINGDIPDLL name 'GdipCreateMetafileFromStream';
...
function GdipRecordMetafileFileName;
  external WINGDIPDLL name 'GdipRecordMetafileFileName';
function GdipRecordMetafileFileNameI;
  external WINGDIPDLL name 'GdipRecordMetafileFileNameI';
function GdipRecordMetafileStream;
  external WINGDIPDLL name 'GdipRecordMetafileStream';
function GdipRecordMetafileStreamI;
  external WINGDIPDLL name 'GdipRecordMetafileStreamI';
function GdipSetMetafileDownLevelRasterizationLimit;
  external WINGDIPDLL name 'GdipSetMetafileDownLevelRasterizationLimit';
function GdipGetMetafileDownLevelRasterizationLimit;
  external WINGDIPDLL name 'GdipGetMetafileDownLevelRasterizationLimit';
function GdipGetImageDecodersSize;
  external WINGDIPDLL name 'GdipGetImageDecodersSize';
...
function GdipCreateFontFamilyFromName;
  external WINGDIPDLL name 'GdipCreateFontFamilyFromName';
...
function GdipGetGenericFontFamilySansSerif;
  external WINGDIPDLL name 'GdipGetGenericFontFamilySansSerif';
function GdipGetGenericFontFamilySerif;
  external WINGDIPDLL name 'GdipGetGenericFontFamilySerif';
function GdipGetGenericFontFamilyMonospace;
  external WINGDIPDLL name 'GdipGetGenericFontFamilyMonospace';
...
function GdipFontCollectionEnumerable;
  external WINGDIPDLL name 'GdipFontCollectionEnumerable';
function GdipFontCollectionEnumerate;
  external WINGDIPDLL name 'GdipFontCollectionEnumerate';
...
function GdipCreateFontFromLogfontA;
  external WINGDIPDLL name 'GdipCreateFontFromLogfontA';
function GdipCreateFontFromLogfontW;
  external WINGDIPDLL name 'GdipCreateFontFromLogfontW';
...
function GdipGetFontHeightGivenDPI;
  external WINGDIPDLL name 'GdipGetFontHeightGivenDPI';
...
function GdipNewInstalledFontCollection;
  external WINGDIPDLL name 'GdipNewInstalledFontCollection';
function GdipNewPrivateFontCollection;
  external WINGDIPDLL name 'GdipNewPrivateFontCollection';
function GdipDeletePrivateFontCollection;
  external WINGDIPDLL name 'GdipDeletePrivateFontCollection';
function GdipGetFontCollectionFamilyCount;
  external WINGDIPDLL name 'GdipGetFontCollectionFamilyCount';
function GdipGetFontCollectionFamilyList;
  external WINGDIPDLL name 'GdipGetFontCollectionFamilyList';
function GdipPrivateAddFontFile;
  external WINGDIPDLL name 'GdipPrivateAddFontFile';
function GdipPrivateAddMemoryFont;
  external WINGDIPDLL name 'GdipPrivateAddMemoryFont';
...
function GdipMeasureCharacterRanges;
  external WINGDIPDLL name 'GdipMeasureCharacterRanges';
function GdipDrawDriverString; external WINGDIPDLL name 'GdipDrawDriverString';
function GdipMeasureDriverString;
  external WINGDIPDLL name 'GdipMeasureDriverString';
function GdipCreateStringFormat;
  external WINGDIPDLL name 'GdipCreateStringFormat';
function GdipStringFormatGetGenericDefault;
  external WINGDIPDLL name 'GdipStringFormatGetGenericDefault';
function GdipStringFormatGetGenericTypographic;
  external WINGDIPDLL name 'GdipStringFormatGetGenericTypographic';
function GdipDeleteStringFormat;
  external WINGDIPDLL name 'GdipDeleteStringFormat';
function GdipCloneStringFormat;
  external WINGDIPDLL name 'GdipCloneStringFormat';
function GdipSetStringFormatFlags;
  external WINGDIPDLL name 'GdipSetStringFormatFlags';
function GdipGetStringFormatFlags;
  external WINGDIPDLL name 'GdipGetStringFormatFlags';
function GdipSetStringFormatAlign;
  external WINGDIPDLL name 'GdipSetStringFormatAlign';
function GdipGetStringFormatAlign;
  external WINGDIPDLL name 'GdipGetStringFormatAlign';
function GdipSetStringFormatLineAlign;
  external WINGDIPDLL name 'GdipSetStringFormatLineAlign';
function GdipGetStringFormatLineAlign;
  external WINGDIPDLL name 'GdipGetStringFormatLineAlign';
function GdipSetStringFormatTrimming;
  external WINGDIPDLL name 'GdipSetStringFormatTrimming';
function GdipGetStringFormatTrimming;
  external WINGDIPDLL name 'GdipGetStringFormatTrimming';
function GdipSetStringFormatHotkeyPrefix;
  external WINGDIPDLL name 'GdipSetStringFormatHotkeyPrefix';
function GdipGetStringFormatHotkeyPrefix;
  external WINGDIPDLL name 'GdipGetStringFormatHotkeyPrefix';
function GdipSetStringFormatTabStops;
  external WINGDIPDLL name 'GdipSetStringFormatTabStops';
function GdipGetStringFormatTabStops;
  external WINGDIPDLL name 'GdipGetStringFormatTabStops';
function GdipGetStringFormatTabStopCount;
  external WINGDIPDLL name 'GdipGetStringFormatTabStopCount';
function GdipSetStringFormatDigitSubstitution;
  external WINGDIPDLL name 'GdipSetStringFormatDigitSubstitution';
function GdipGetStringFormatDigitSubstitution;
  external WINGDIPDLL name 'GdipGetStringFormatDigitSubstitution';
function GdipGetStringFormatMeasurableCharacterRangeCount;
  external WINGDIPDLL name 'GdipGetStringFormatMeasurableCharacterRangeCount';
function GdipSetStringFormatMeasurableCharacterRanges;
  external WINGDIPDLL name 'GdipSetStringFormatMeasurableCharacterRanges';
function GdipCreateCachedBitmap;
  external WINGDIPDLL name 'GdipCreateCachedBitmap';
function GdipDeleteCachedBitmap;
  external WINGDIPDLL name 'GdipDeleteCachedBitmap';
