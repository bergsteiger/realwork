...
begin
  {$IFDEF gtDelphiXE3Up}
  Result := StrToFloat( (System.AnsiStrings.StringReplace(nodeValue, DEFAULT_DECIMALSEPARATOR,
    '.', [rfReplaceAll])));
  {$ELSE}
...
begin
  {$IFDEF gtDelphiXE3Up}
  Result := StrToCurr( (System.AnsiStrings.StringReplace(nodeValue, DEFAULT_DECIMALSEPARATOR,
    '.', [rfReplaceAll])));
  {$ELSE}
...
begin
  {$IFDEF gtDelphiXE3Up}
  Result :=(System.AnsiStrings.StringReplace(FloatToStr(value),
    '.', DEFAULT_DECIMALSEPARATOR, [rfReplaceAll]));
  {$ELSE}
...
begin
  {$IFDEF gtDelphiXE3Up}
  Result :=(System.AnsiStrings.StringReplace(CurrToStr(value),
    '.', DEFAULT_DECIMALSEPARATOR, [rfReplaceAll]));
  {$ELSE}
