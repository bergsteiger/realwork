...
uses
  Windows, SysUtils,Classes, gtJwaWinCrypt3, Dialogs, gtWinCrypt3;

type

  TgtPKCS7 = class
  private
  // Version 3.X supports only Ansistrings for PDF font names
  //  unicode strings are not supported for PDF font names.
...
//  pSignature, pSigByte: PByte;
  SigArray, EncodedSigArray: array of Byte;
  LMem: TMemoryStream;
//  LLength: Integer;
begin
