...
{ }
{ ****************************************************************************** }
// $Id: gtJwaWinBase3.pas,v 1.1 2014/08/27 08:16:16 dinishev Exp $
...
{$ENDIF USE_DELPHI_TYPES}
  gtJwaNtStatus3, gtJwaWinNT3, gtJwaWinType3;
{$ENDIF JWA_OMIT_SECTIONS}
...
{$IFDEF DELPHI2005_UP}inline; {$ENDIF}
{$EXTERNALSYM ZeroMemory}
//
...
{$EXTERNALSYM LPOVERLAPPED}
  ...
  _OVERLAPPED = record
    ...
    Union: record case Integer of 0: (Offset: DWORD; OffsetHigh: DWORD);
    1: (Pointer: PVOID);
  end;
...
_SECURITY_ATTRIBUTES = record nLength: DWORD;
...
_PROCESS_INFORMATION = record hProcess: HANDLE;
hThread:
HANDLE;
dwProcessId:
DWORD;
...
_FILETIME = record dwLowDateTime: DWORD;
dwHighDateTime:
DWORD;
end;
...
function(lpThreadParameter: LPVOID): DWORD;
stdcall;
...
procedure(lpFiberParameter: LPVOID);
stdcall;
...
{$EXTERNALSYM OFSTRUCT}
                ...
                function InterlockedCompareExchange64(var Destination: LONGLONG;
                  Exchange, Comperand: LONGLONG): LONGLONG; stdcall;
{$EXTERNALSYM InterlockedCompareExchange64}
                  function InterlockedAnd64(var Destination: LONGLONG;
                    Value: LONGLONG): LONGLONG;
{$EXTERNALSYM InterlockedAnd64}
                    function InterlockedOr64(var Destination: LONGLONG;
                      Value: LONGLONG): LONGLONG;
{$EXTERNALSYM InterlockedOr64}
                      function InterlockedXor64(var Destination: LONGLONG;
                        Value: LONGLONG): LONGLONG;
{$EXTERNALSYM InterlockedXor64}
                        function InterlockedIncrement64(var Addend: LONGLONG)
                          : LONGLONG;
{$EXTERNALSYM InterlockedIncrement64}
                          function InterlockedDecrement64(var Addend: LONGLONG)
                            : LONGLONG;
{$EXTERNALSYM InterlockedDecrement}
                            function InterlockedExchange64(var Target: LONGLONG;
                              Value: LONGLONG): LONGLONG;
{$EXTERNALSYM InterlockedExchange64}
                              function InterlockedExchangeAdd64
                                (var Addend: LONGLONG; Value: LONGLONG)
                                : LONGLONG;
...
{$EXTERNALSYM InterlockedCompareExchangePointer}
                                        ...
                                        (ListHead: PSLIST_HEADER); stdcall;
...
{$EXTERNALSYM QueryDepthSList}
                                        function FreeResource(hResData: HGLOBAL)
                                        : BOOL; stdcall;
{$EXTERNALSYM FreeResource}
                                        function LockResource(hResData: HGLOBAL)
                                        : LPVOID; stdcall;
{$EXTERNALSYM LockResource}
                                        function UnlockResource
                                        (hResData: HANDLE): BOOL;
...
{$EXTERNALSYM GlobalMemoryStatusEx}
                                        function LocalAlloc(uFlags: UINT;
                                        uBytes: SIZE_T): HLOCAL; stdcall;
{$EXTERNALSYM LocalAlloc}
                                        function LocalReAlloc(hMem: HLOCAL;
                                        uBytes: SIZE_T; uFlags: UINT)
                                        : HLOCAL; stdcall;
{$EXTERNALSYM LocalReAlloc}
                                        function LocalLock(hMem: HLOCAL)
                                        : LPVOID; stdcall;
{$EXTERNALSYM LocalLock}
                                        function LocalHandle(pMem: LPCVOID)
                                        : HLOCAL; stdcall;
{$EXTERNALSYM LocalHandle}
                                        function LocalUnlock(hMem: HLOCAL)
                                        : BOOL; stdcall;
{$EXTERNALSYM LocalUnlock}
                                        function LocalSize(hMem: HLOCAL)
                                        : SIZE_T; stdcall;
{$EXTERNALSYM LocalSize}
                                        function LocalFlags(hMem: HLOCAL)
                                        : UINT; stdcall;
{$EXTERNALSYM LocalFlags}
                                        function LocalFree(hMem: HLOCAL)
                                        : HLOCAL; stdcall;
{$EXTERNALSYM LocalFree}
                                        function LocalShrink(hMem: HLOCAL;
                                        cbNewSize: UINT): SIZE_T; stdcall;
{$EXTERNALSYM LocalShrink}
                                        function LocalCompact(uMinFree: UINT)
                                        : SIZE_T; stdcall;
{$EXTERNALSYM LocalCompact}
                                        function FlushInstructionCache
                                        (hProcess: HANDLE;
                                        lpBaseAddress: LPCVOID; dwSize: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM FlushInstructionCache}
                                        function VirtualAlloc(lpAddress: LPVOID;
                                        dwSize: SIZE_T; flAllocationType: DWORD;
                                        flProtect: DWORD): LPVOID; stdcall;
{$EXTERNALSYM VirtualAlloc}
                                        function VirtualFree(lpAddress: LPVOID;
                                        dwSize: SIZE_T; dwFreeType: DWORD)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM VirtualAllocEx}
                                        function GetWriteWatch(dwFlags: DWORD;
                                        lpBaseAddress: PVOID;
                                        dwRegionSize: SIZE_T;
                                        var lpAddresses: PVOID;
                                        var lpdwCount: ULONG_PTR;
                                        var lpdwGranularity: ULONG)
                                        : UINT; stdcall;
{$EXTERNALSYM GetWriteWatch}
                                        function ResetWriteWatch
                                        (lpBaseAddress: LPVOID;
                                        dwRegionSize: SIZE_T): UINT; stdcall;
...
{$EXTERNALSYM VirtualProtectEx}
                                        ...
                                        (hProcess: HANDLE; lpAddress: LPCVOID;
                                        var lpBuffer: MEMORY_BASIC_INFORMATION;
                                        dwLength: DWORD): DWORD; stdcall;
...
{$EXTERNALSYM HeapCreate}
                                        function HeapDestroy(hHeap: HANDLE)
                                        : BOOL; stdcall;
{$EXTERNALSYM HeapDestroy}
                                        function HeapAlloc(hHeap: HANDLE;
                                        dwFlags: DWORD; dwBytes: SIZE_T)
                                        : LPVOID; stdcall;
{$EXTERNALSYM HeapAlloc}
                                        function HeapReAlloc(hHeap: HANDLE;
                                        dwFlags: DWORD; lpMem: LPVOID;
                                        dwBytes: SIZE_T): LPVOID; stdcall;
{$EXTERNALSYM HeapReAlloc}
                                        function HeapFree(hHeap: HANDLE;
                                        dwFlags: DWORD; lpMem: LPVOID)
                                        : BOOL; stdcall;
{$EXTERNALSYM HeapFree}
                                        function HeapSize(hHeap: HANDLE;
                                        dwFlags: DWORD; lpMem: LPCVOID)
                                        : SIZE_T; stdcall;
{$EXTERNALSYM HeapSize}
                                        function HeapValidate(hHeap: HANDLE;
                                        dwFlags: DWORD; lpMem: LPCVOID)
                                        : BOOL; stdcall;
{$EXTERNALSYM HeapValidate}
                                        function HeapCompact(hHeap: HANDLE;
                                        dwFlags: DWORD): SIZE_T; stdcall;
...
{$EXTERNALSYM PROCESS_HEAP_ENTRY_DDESHARE}
                                        function HeapLock(hHeap: HANDLE)
                                        : BOOL; stdcall;
{$EXTERNALSYM HeapLock}
                                        function HeapUnlock(hHeap: HANDLE)
                                        : BOOL; stdcall;
{$EXTERNALSYM HeapUnlock}
                                        function HeapWalk(hHeap: HANDLE;
...
{$EXTERNALSYM HeapSetInformation}
                                        ...
                                        HeapInformation: PVOID;
                                        HeapInformationLength: SIZE_T;
                                        ReturnLength: PSIZE_T): BOOL; stdcall;
...
{$EXTERNALSYM SetProcessAffinityMask}
                                        ...
                                        (hProcess: HANDLE;
                                        out pdwHandleCount: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetProcessHandleCount}
                                        function GetProcessTimes
                                        (hProcess: HANDLE;
                                        var lpCreationTime, lpExitTime,
                                        lpKernelTime, lpUserTime: FILETIME)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetProcessTimes}
                                        function GetProcessIoCounters
                                        (hProcess: HANDLE;
                                        var lpIoCounters: IO_COUNTERS)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM SetProcessWorkingSetSizeEx}
                                        function OpenProcess(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
...
{$EXTERNALSYM UnhandledExceptionFilter}
                                        type
                                        PTOP_LEVEL_EXCEPTION_FILTER = function
                                        (ExceptionInfo: PEXCEPTION_POINTERS)
                                        : LONG; stdcall;
...
{$EXTERNALSYM SwitchToThread}
                                        function CreateThread(lpThreadAttributes
...
{$EXTERNALSYM GetCurrentThreadId}
                                        ...
                                        (Thread: HANDLE): DWORD; stdcall;
{$EXTERNALSYM GetProcessIdOfThread}
                                        function GetThreadId(Thread: HANDLE)
                                        : DWORD; stdcall;
{$EXTERNALSYM GetThreadId}
                                        function GetProcessId(Process: HANDLE)
                                        : DWORD; stdcall;
...
{$EXTERNALSYM GetThreadPriorityBoost}
                                        ...
                                        (hThread: HANDLE): Integer; stdcall;
{$EXTERNALSYM GetThreadPriority}
                                        function GetThreadTimes(hThread: HANDLE;
                                        var lpCreationTime, lpExitTime,
                                        lpKernelTime, lpUserTime: FILETIME)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetThreadTimes}
                                        ...
                                        (hThread: HANDLE;
                                        out lpIOIsPending: BOOL): BOOL; stdcall;
...
{$EXTERNALSYM SEM_NOOPENFILEERRORBOX}
                                        function SetErrorMode(uMode: UINT)
                                        : UINT; stdcall;
...
{$EXTERNALSYM ReadProcessMemory}
                                        ...
                                        (hProcess: HANDLE;
                                        lpBaseAddress: LPVOID; lpBuffer: LPVOID;
                                        nSize: DWORD;
...
{$EXTERNALSYM WriteProcessMemory}
                                        ...
                                        (hThread: HANDLE;
                                        var LPCONTEXT: CONTEXT): BOOL; stdcall;
...
{$EXTERNALSYM SetThreadContext}
                                        function SuspendThread(hThread: HANDLE)
                                        : DWORD; stdcall;
{$EXTERNALSYM SuspendThread}
                                        function ResumeThread(hThread: HANDLE)
                                        : DWORD; stdcall;
{$EXTERNALSYM ResumeThread}
                                        type
                                        PAPCFUNC = procedure
                                        (dwParam: ULONG_PTR); stdcall;
{$EXTERNALSYM PAPCFUNC}
                                        TApcFunc = PAPCFUNC;

                                        function QueueUserAPC(pfnAPC: PAPCFUNC;
                                        hThread: HANDLE; dwData: ULONG_PTR)
                                        : DWORD; stdcall;
...
{$EXTERNALSYM ContinueDebugEvent}
                                        ...
                                        (dwProcessId: DWORD): BOOL; stdcall;
...
{$EXTERNALSYM DebugActiveProcessStop}
                                        ...
                                        (KillOnExit: BOOL): BOOL; stdcall;
{$EXTERNALSYM DebugSetProcessKillOnExit}
                                        function DebugBreakProcess
                                        (Process: HANDLE): BOOL; stdcall;
{$EXTERNALSYM DebugBreakProcess}
                                        procedure InitializeCriticalSection
                                        (var lpCriticalSection
                                        : CRITICAL_SECTION); stdcall;
...
{$EXTERNALSYM LeaveCriticalSection}
                                        ...
                                        (var lpCriticalSection
                                        : CRITICAL_SECTION; dwSpinCount: DWORD)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM SetCriticalSectionSpinCount}
                                        ...
                                        (var lpCriticalSection
                                        : CRITICAL_SECTION): BOOL; stdcall;
{$EXTERNALSYM TryEnterCriticalSection}
                                        procedure DeleteCriticalSection
                                        (var lpCriticalSection
                                        : CRITICAL_SECTION); stdcall;
{$EXTERNALSYM DeleteCriticalSection}
                                        function SetEvent(hEvent: HANDLE)
                                        : BOOL; stdcall;
{$EXTERNALSYM SetEvent}
                                        function ResetEvent(hEvent: HANDLE)
                                        : BOOL; stdcall;
{$EXTERNALSYM ResetEvent}
                                        function PulseEvent(hEvent: HANDLE)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM ReleaseSemaphore}
                                        function ReleaseMutex(hMutex: HANDLE)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM WaitForSingleObject}
                                        ...
                                        (nCount: DWORD; lpHandles: PHANDLE;
                                        bWaitAll: BOOL; dwMilliseconds: DWORD)
                                        : DWORD; stdcall;
{$EXTERNALSYM WaitForMultipleObjects}
                                        procedure Sleep(dwMilliseconds
                                        : DWORD); stdcall;
{$EXTERNALSYM Sleep}
                                        function LoadResource(HMODULE: HMODULE;
                                        hResInfo: HRSRC): HGLOBAL; stdcall;
{$EXTERNALSYM LoadResource}
                                        function SizeofResource
                                        (HMODULE: HMODULE; hResInfo: HRSRC)
                                        : DWORD; stdcall;
{$EXTERNALSYM SizeofResource}
                                        function GlobalDeleteAtom(nAtom: ATOM)
                                        : ATOM; stdcall;
{$EXTERNALSYM GlobalDeleteAtom}
                                        function InitAtomTable(nSize: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM InitAtomTable}
                                        function DeleteAtom(nAtom: ATOM)
                                        : ATOM; stdcall;
{$EXTERNALSYM DeleteAtom}
                                        function SetHandleCount(uNumber: UINT)
                                        : UINT; stdcall;
...
{$EXTERNALSYM LPBY_HANDLE_FILE_INFORMATION}
                                        ...
                                        (hFile: HANDLE;
                                        var lpFileInformation
                                        : BY_HANDLE_FILE_INFORMATION)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetFileInformationByHandle}
                                        function GetFileType(hFile: HANDLE)
                                        : DWORD; stdcall;
{$EXTERNALSYM GetFileType}
                                        function GetFileSize(hFile: HANDLE;
                                        lpFileSizeHigh: LPDWORD)
                                        : DWORD; stdcall;
{$EXTERNALSYM GetFileSize}
                                        function GetFileSizeEx(hFile: HANDLE;
                                        var lpFileSize: LARGE_INTEGER)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetFileSizeEx}
                                        function GetStdHandle(nStdHandle: DWORD)
                                        : HANDLE; stdcall;
{$EXTERNALSYM GetStdHandle}
                                        function SetStdHandle(nStdHandle: DWORD;
                                        hHandle: HANDLE): BOOL; stdcall;
{$EXTERNALSYM SetStdHandle}
                                        function WriteFile(hFile: HANDLE;
                                        lpBuffer: LPCVOID;
...
{$EXTERNALSYM ReadFile}
                                        function FlushFileBuffers(hFile: HANDLE)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM SetFilePointerEx}
                                        function FindClose(hFindFile: HANDLE)
                                        : BOOL; stdcall;
{$EXTERNALSYM FindClose}
                                        function GetFileTime(hFile: HANDLE;
                                        lpCreationTime, lpLastAccessTime,
                                        lpLastWriteTime: PFileTime)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetFileTime}
                                        function SetFileTime(hFile: HANDLE;
                                        lpCreationTime, lpLastAccessTime,
                                        lpLastWriteTime: PFileTime)
                                        : BOOL; stdcall;
{$EXTERNALSYM SetFileTime}
                                        function SetFileValidData(hFile: HANDLE;
...
{$EXTERNALSYM SetFileShortNameW}
                                        function SetFileShortName(hFile: HANDLE;
                                        lpShortName: LPCTSTR): BOOL; stdcall;
{$EXTERNALSYM SetFileShortName}
                                        function CloseHandle(hObject: HANDLE)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM LoadModule}
                                        ...
                                        uCmdShow: UINT): UINT; stdcall;
{$EXTERNALSYM WinExec}
                                        function ClearCommBreak(hFile: HANDLE)
                                        : BOOL; stdcall;
{$EXTERNALSYM ClearCommBreak}
                                        function ClearCommError(hFile: HANDLE;
                                        var lpErrors: DWORD; lpStat: LPCOMSTAT)
                                        : BOOL; stdcall;
{$EXTERNALSYM ClearCommError}
                                        function SetupComm(hFile: HANDLE;
                                        dwInQueue: DWORD; dwOutQueue: DWORD)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM EscapeCommFunction}
                                        function GetCommConfig(hCommDev: HANDLE;
                                        var lpCC: COMMCONFIG;
                                        var lpdwSize: DWORD): BOOL; stdcall;
{$EXTERNALSYM GetCommConfig}
                                        function GetCommMask(hFile: HANDLE;
                                        var lpEvtMask: DWORD): BOOL; stdcall;
...
{$EXTERNALSYM GetCommProperties}
                                        ...
                                        (hFile: HANDLE; var lpModemStat: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetCommModemStatus}
                                        function GetCommState(hFile: HANDLE;
                                        var LPDCB: DCB): BOOL; stdcall;
{$EXTERNALSYM GetCommState}
                                        function GetCommTimeouts(hFile: HANDLE;
                                        var LPCOMMTIMEOUTS: COMMTIMEOUTS)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetCommTimeouts}
                                        function PurgeComm(hFile: HANDLE;
                                        dwFlags: DWORD): BOOL; stdcall;
{$EXTERNALSYM PurgeComm}
                                        function SetCommBreak(hFile: HANDLE)
                                        : BOOL; stdcall;
{$EXTERNALSYM SetCommBreak}
                                        function SetCommConfig(hCommDev: HANDLE;
                                        const lpCC: COMMCONFIG; dwSize: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM SetCommConfig}
                                        function SetCommMask(hFile: HANDLE;
                                        dwEvtMask: DWORD): BOOL; stdcall;
{$EXTERNALSYM SetCommMask}
                                        function SetCommState(hFile: HANDLE;
                                        const LPDCB: DCB): BOOL; stdcall;
{$EXTERNALSYM SetCommState}
                                        function SetCommTimeouts(hFile: HANDLE;
                                        const LPCOMMTIMEOUTS: COMMTIMEOUTS)
                                        : BOOL; stdcall;
{$EXTERNALSYM SetCommTimeouts}
                                        function TransmitCommChar(hFile: HANDLE;
                                        cChar: AnsiChar): BOOL; stdcall;
{$EXTERNALSYM TransmitCommChar}
                                        function WaitCommEvent(hFile: HANDLE;
                                        var lpEvtMask: DWORD;
                                        LPOVERLAPPED: LPOVERLAPPED)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM Beep}
                                        function MulDiv(nNumber, nNumerator,
...
{$EXTERNALSYM GetSystemTime}
                                        ...
                                        (var lpSystemTimeAsFileTime
                                        : FILETIME); stdcall;
{$EXTERNALSYM GetSystemTimeAsFileTime}
                                        function SetSystemTime(var LPSYSTEMTIME
                                        : SYSTEMTIME): BOOL; stdcall;
{$EXTERNALSYM SetSystemTime}
                                        procedure GetLocalTime(var LPSYSTEMTIME
                                        : SYSTEMTIME); stdcall;
{$EXTERNALSYM GetLocalTime}
                                        function SetLocalTime(var LPSYSTEMTIME
                                        : SYSTEMTIME): BOOL; stdcall;
{$EXTERNALSYM SetLocalTime}
                                        procedure GetSystemInfo(var lpSystemInfo
                                        : SYSTEM_INFO); stdcall;
{$EXTERNALSYM GetSystemInfo}
                                        function GetSystemRegistryQuota
                                        (out pdwQuotaAllowed,
                                        pdwQuotaUsed: DWORD): BOOL; stdcall;
{$EXTERNALSYM GetSystemRegistryQuota}
                                        function GetSystemTimes(lpIdleTime,
                                        lpKernelTime, lpUserTime: LPFILETIME)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetSystemTimes}
                                        procedure GetNativeSystemInfo
                                        (lpSystemInfo: LPSYSTEM_INFO); stdcall;
...
{$EXTERNALSYM FileTimeToLocalFileTime}
                                        ...
                                        (const lpLocalFileTime: FILETIME;
                                        var LPFILETIME: FILETIME)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM FileTimeToSystemTime}
                                        ...
                                        (const lpFileTime1,
                                        lpFileTime2: FILETIME): LONG; stdcall;
{$EXTERNALSYM CompareFileTime}
                                        function FileTimeToDosDateTime
                                        (const LPFILETIME: FILETIME;
                                        var lpFatDate, lpFatTime: Word)
                                        : BOOL; stdcall;
{$EXTERNALSYM FileTimeToDosDateTime}
                                        function DosDateTimeToFileTime(wFatDate,
                                        wFatTime: Word;
                                        var LPFILETIME: FILETIME)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM SetSystemTimeAdjustment}
                                        ...
                                        (var lpTimeAdjustment, lpTimeIncrement
                                        : DWORD; var lpTimeAdjustmentDisabled
                                        : BOOL): BOOL; stdcall;
{$EXTERNALSYM GetSystemTimeAdjustment}
                                        function FormatMessageA(dwFlags: DWORD;
                                        lpSource: LPCVOID; dwMessageId: DWORD;
                                        dwLanguageId: DWORD; lpBuffer: LPSTR;
                                        nSize: DWORD; Arguments: Pointer)
                                        : DWORD; stdcall;
{$EXTERNALSYM FormatMessageA}
                                        function FormatMessageW(dwFlags: DWORD;
                                        lpSource: LPCVOID; dwMessageId: DWORD;
                                        dwLanguageId: DWORD; lpBuffer: LPWSTR;
                                        nSize: DWORD; Arguments: Pointer)
                                        : DWORD; stdcall;
{$EXTERNALSYM FormatMessageW}
                                        function FormatMessage(dwFlags: DWORD;
                                        lpSource: LPCVOID; dwMessageId: DWORD;
                                        dwLanguageId: DWORD; lpBuffer: LPTSTR;
                                        nSize: DWORD; Arguments: Pointer)
                                        : DWORD; stdcall;
...
{$EXTERNALSYM FORMAT_MESSAGE_MAX_WIDTH_MASK}
                                        function CreatePipe(var hReadPipe,
                                        hWritePipe: HANDLE;
...
{$EXTERNALSYM SetNamedPipeHandleState}
                                        ...
                                        (hNamedPipe: HANDLE;
                                        lpFlags, lpOutBufferSize,
                                        lpInBufferSize, lpMaxInstances: LPDWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetNamedPipeInfo}
                                        function PeekNamedPipe
                                        (hNamedPipe: HANDLE; lpBuffer: LPVOID;
                                        nBufferSize: DWORD;
...
{$EXTERNALSYM PeekNamedPipe}
                                        ...
                                        (hNamedPipe: HANDLE; lpInBuffer: LPVOID;
                                        nInBufferSize: DWORD;
                                        lpOutBuffer: LPVOID;
                                        nOutBufferSize: DWORD;
                                        lpBytesRead: LPDWORD;
...
{$EXTERNALSYM TransactNamedPipe}
                                        function CreateMailslotA(lpName: LPCSTR;
                                        nMaxMessageSize, lReadTimeout: DWORD;
...
{$EXTERNALSYM CreateMailslotW}
                                        function CreateMailslot(lpName: LPCTSTR;
                                        nMaxMessageSize, lReadTimeout: DWORD;
                                        lpSecurityAttributes
                                        : LPSECURITY_ATTRIBUTES)
                                        : HANDLE; stdcall;
{$EXTERNALSYM CreateMailslot}
                                        ...
                                        (hMailslot: HANDLE;
                                        lpMaxMessageSize, lpNextSize,
                                        lpMessageCount, lpReadTimeout: LPDWORD)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM SetMailslotInfo}
                                        ...
                                        : DWORD; dwNumberOfBytesToMap: SIZE_T)
                                        : LPVOID; stdcall;
...
{$EXTERNALSYM FlushViewOfFile}
                                        ...
                                        (lpBaseAddress: LPCVOID): BOOL; stdcall;
...
{$EXTERNALSYM DecryptFileW}
                                        ...
                                        (lpFileName: LPCTSTR; dwReserved: DWORD)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM FILE_DIR_DISALLOWED}
                                        ...
                                        (lpFileName: LPCSTR;
                                        var lpStatus: DWORD): BOOL; stdcall;
...
{$EXTERNALSYM WriteEncryptedFileRaw}
                                        ...
                                        (pvContext: PVOID); stdcall;
{$EXTERNALSYM CloseEncryptedFileRaw}
                                        //
                                        // _l Compat Functions
                                        //

                                        function lstrcmpA(lpString1,
                                        lpString2: LPCSTR): Integer; stdcall;
{$EXTERNALSYM lstrcmpA}
                                        function lstrcmpW(lpString1,
                                        lpString2: LPCWSTR): Integer; stdcall;
{$EXTERNALSYM lstrcmpW}
                                        function lstrcmp(lpString1,
                                        lpString2: LPCTSTR): Integer; stdcall;
{$EXTERNALSYM lstrcmp}
                                        function lstrcmpiA(lpString1,
                                        lpString2: LPCSTR): Integer; stdcall;
{$EXTERNALSYM lstrcmpiA}
                                        function lstrcmpiW(lpString1,
                                        lpString2: LPCWSTR): Integer; stdcall;
{$EXTERNALSYM lstrcmpiW}
                                        function lstrcmpi(lpString1,
                                        lpString2: LPCTSTR): Integer; stdcall;
{$EXTERNALSYM lstrcmpi}
                                        function lstrcpynA(lpString1: LPSTR;
                                        lpString2: LPCSTR; iMaxLength: Integer)
                                        : LPSTR; stdcall;
{$EXTERNALSYM lstrcpynA}
                                        function lstrcpynW(lpString1: LPWSTR;
                                        lpString2: LPCWSTR; iMaxLength: Integer)
                                        : LPWSTR; stdcall;
{$EXTERNALSYM lstrcpynW}
                                        function lstrcpyn(lpString1: LPTSTR;
                                        lpString2: LPCTSTR; iMaxLength: Integer)
                                        : LPTSTR; stdcall;
{$EXTERNALSYM lstrcpyn}
                                        function lstrcpyA(lpString1: LPSTR;
                                        lpString2: LPCSTR): LPSTR; stdcall;
{$EXTERNALSYM lstrcpyA}
                                        function lstrcpyW(lpString1: LPWSTR;
                                        lpString2: LPCWSTR): LPWSTR; stdcall;
{$EXTERNALSYM lstrcpyW}
                                        function lstrcpy(lpString1: LPTSTR;
                                        lpString2: LPCTSTR): LPTSTR; stdcall;
{$EXTERNALSYM lstrcpy}
                                        function lstrcatA(lpString1: LPSTR;
                                        lpString2: LPCSTR): LPSTR; stdcall;
{$EXTERNALSYM lstrcatA}
                                        function lstrcatW(lpString1: LPWSTR;
                                        lpString2: LPCWSTR): LPWSTR; stdcall;
{$EXTERNALSYM lstrcatW}
                                        function lstrcat(lpString1: LPTSTR;
                                        lpString2: LPCTSTR): LPTSTR; stdcall;
{$EXTERNALSYM lstrcat}
                                        function lstrlenA(lpString: LPCSTR)
                                        : Integer; stdcall;
{$EXTERNALSYM lstrlenA}
                                        function lstrlenW(lpString: LPCWSTR)
                                        : Integer; stdcall;
{$EXTERNALSYM lstrlenW}
                                        function lstrlen(lpString: LPCTSTR)
                                        : Integer; stdcall;
{$EXTERNALSYM lstrlen}
                                        function OpenFile(lpFileName: LPCSTR;
                                        var lpReOpenBuff: OFSTRUCT;
                                        uStyle: UINT): hFile; stdcall;
{$EXTERNALSYM OpenFile}
                                        function _lopen(lpPathName: LPCSTR;
                                        iReadWrite: Integer): hFile; stdcall;
{$EXTERNALSYM _lopen}
                                        function _lcreat(lpPathName: LPCSTR;
                                        iAttribute: Integer): hFile; stdcall;
{$EXTERNALSYM _lcreat}
                                        function _lread(hFile: hFile;
                                        lpBuffer: LPVOID; uBytes: UINT)
                                        : UINT; stdcall;
{$EXTERNALSYM _lread}
                                        function _lwrite(hFile: hFile;
                                        lpBuffer: LPCSTR; uBytes: UINT)
                                        : UINT; stdcall;
{$EXTERNALSYM _lwrite}
                                        function _hread(hFile: hFile;
                                        lpBuffer: LPVOID; lBytes: Longint)
                                        : Longint; stdcall;
{$EXTERNALSYM _hread}
                                        function _hwrite(hFile: hFile;
                                        lpBuffer: LPCSTR; lBytes: Longint)
                                        : Longint; stdcall;
{$EXTERNALSYM _hwrite}
                                        function _lclose(hFile: hFile)
                                        : hFile; stdcall;
{$EXTERNALSYM _lclose}
                                        function _llseek(hFile: hFile;
                                        lOffset: LONG; iOrigin: Integer)
                                        : LONG; stdcall;
{$EXTERNALSYM _llseek}
                                        function IsTextUnicode(lpBuffer: LPVOID;
                                        cb: Integer; lpi: LPINT): BOOL; stdcall;
{$EXTERNALSYM IsTextUnicode}
                                        type
                                        PFLS_CALLBACK_FUNCTION = procedure
                                        (lpFlsData: PVOID); stdcall;
{$EXTERNALSYM PFLS_CALLBACK_FUNCTION}
                                        TFlsCallbackFunction =
...
{$EXTERNALSYM FlsAlloc}
                                        function FlsGetValue(dwFlsIndex: DWORD)
                                        : DWORD; stdcall;
{$EXTERNALSYM FlsGetValue}
                                        function FlsSetValue(dwFlsIndex: DWORD;
                                        lpFlsData: PVOID): DWORD; stdcall;
{$EXTERNALSYM FlsSetValue}
                                        function FlsFree(dwFlsIndex: DWORD)
                                        : DWORD; stdcall;
{$EXTERNALSYM FlsFree}
                                        const
...
{$EXTERNALSYM TlsAlloc}
                                        function TlsGetValue(dwTlsIndex: DWORD)
                                        : LPVOID; stdcall;
{$EXTERNALSYM TlsGetValue}
                                        function TlsSetValue(dwTlsIndex: DWORD;
                                        lpTlsValue: LPVOID): BOOL; stdcall;
{$EXTERNALSYM TlsSetValue}
                                        function TlsFree(dwTlsIndex: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM TlsFree}
                                        type
                                        LPOVERLAPPED_COMPLETION_ROUTINE =
                                        procedure(dwErrorCode: DWORD;
                                        dwNumberOfBytesTransfered: DWORD;
                                        LPOVERLAPPED: LPOVERLAPPED); stdcall;
{$EXTERNALSYM LPOVERLAPPED_COMPLETION_ROUTINE}
                                        TOverlappedCompletionRoutine =
                                        LPOVERLAPPED_COMPLETION_ROUTINE;
...
{$EXTERNALSYM SignalObjectAndWait}
                                        function ReadFileEx(hFile: HANDLE;
                                        lpBuffer: LPVOID;
                                        nNumberOfBytesToRead: DWORD;
                                        LPOVERLAPPED: LPOVERLAPPED;
                                        lpCompletionRoutine
...
{$EXTERNALSYM ReadFileEx}
                                        function WriteFileEx(hFile: HANDLE;
                                        lpBuffer: LPCVOID;
                                        nNumberOfBytesToWrite: DWORD;
                                        LPOVERLAPPED: LPOVERLAPPED;
                                        lpCompletionRoutine
...
{$EXTERNALSYM WriteFileEx}
                                        function BackupRead(hFile: HANDLE;
                                        lpBuffer: LPBYTE;
                                        nNumberOfBytesToRead: DWORD;
...
{$EXTERNALSYM BackupRead}
                                        function BackupSeek(hFile: HANDLE;
                                        dwLowBytesToSeek, dwHighBytesToSeek
                                        : DWORD; var lpdwLowByteSeeked,
                                        lpdwHighByteSeeked: DWORD;
                                        var LPCONTEXT: LPVOID): BOOL; stdcall;
{$EXTERNALSYM BackupSeek}
                                        function BackupWrite(hFile: HANDLE;
                                        lpBuffer: LPBYTE;
                                        nNumberOfBytesToWrite: DWORD;
...
{$EXTERNALSYM STREAM_SPARSE_ATTRIBUTE}
                                        function ReadFileScatter(hFile: HANDLE;
                                        aSegmentArray: PFILE_SEGMENT_ELEMENT;
                                        nNumberOfBytesToRead: DWORD;
                                        lpReserved: LPDWORD;
                                        LPOVERLAPPED: LPOVERLAPPED)
                                        : BOOL; stdcall;
{$EXTERNALSYM ReadFileScatter}
                                        function WriteFileGather(hFile: HANDLE;
                                        aSegmentArray: PFILE_SEGMENT_ELEMENT;
                                        nNumberOfBytesToWrite: DWORD;
                                        lpReserved: LPDWORD;
                                        LPOVERLAPPED: LPOVERLAPPED)
...
{$EXTERNALSYM SHUTDOWN_NORETRY}
                                        ...
                                        $0000FFFF;
{$EXTERNALSYM PROC_THREAD_ATTRIBUTE_NUMBER}
{$EXTERNALSYM SHUTDOWN_NORETRY}
                                        PROC_THREAD_ATTRIBUTE_THREAD =
                                        $00010000;
{$EXTERNALSYM PROC_THREAD_ATTRIBUTE_THREAD}
                                        // Attribute may be used with thread creation
{$EXTERNALSYM SHUTDOWN_NORETRY}
                                        PROC_THREAD_ATTRIBUTE_INPUT = $00020000;
{$EXTERNALSYM PROC_THREAD_ATTRIBUTE_INPUT}
                                        // Attribute is input only
{$EXTERNALSYM SHUTDOWN_NORETRY}
                                        PROC_THREAD_ATTRIBUTE_ADDITIVE =
                                        $00040000;
{$EXTERNALSYM PROC_THREAD_ATTRIBUTE_ADDITIVE}
...
{$EXTERNALSYM PROC_THREAD_ATTRIBUTE_NUM}
                                        ...
                                        _PROC_THREAD_ATTRIBUTE_NUM;
                                        PProcThreadAttributeNum = ^
                                        TProcThreadAttributeNum;

                                        { Macro function }
                                        function ProcThreadAttributeValue
                                        (const Number: DWORD;
                                        Thread, Input,
                                        Additive: Boolean): DWORD;
                                        { Macro function }
                                        function PROC_THREAD_ATTRIBUTE_PARENT_PROCESS
                                        : DWORD;
                                        { Macro function }
                                        function PROC_THREAD_ATTRIBUTE_EXTENDED_FLAGS
                                        : DWORD;
                                        { Macro function }
                                        function PROC_THREAD_ATTRIBUTE_HANDLE_LIST
                                        : DWORD;
...
{$EXTERNALSYM UpdateProcThreadAttribute}
                                        ...
                                        { __in_bcount_opt(cbSize) }
                                        lpValue: PVOID;
                                        { __in } cbSize: SIZE_T;
                                        { __out_bcount_opt(cbSize) }
...
{$EXTERNALSYM TStartupInfoA}
                                        PStartupInfoA = LPSTARTUPINFOA;
{$EXTERNALSYM PStartupInfoA}										
...
{$EXTERNALSYM TStartupInfo}
                                        PStartupInfo = PStartupInfoW;
{$EXTERNALSYM PStartupInfo}										
...
{$EXTERNALSYM TStartupInfoEx}						
                                        PStartupInfoEx = PStartupInfoExA;
{$EXTERNALSYM PStartupInfoEx}
...
{$EXTERNALSYM WIN32_FILE_ATTRIBUTE_DATA}
                                        ...
                                        WIN32_FILE_ATTRIBUTE_DATA;
                                        PWin32FileAttributeData =
                                        LPWIN32_FILE_ATTRIBUTE_DATA;

                                        function CreateMutexA(lpMutexAttributes
                                        : LPSECURITY_ATTRIBUTES;
                                        bInitialOwner: BOOL;
                                        lpName: LPCSTR): HANDLE;
{$EXTERNALSYM CreateMutexA}
                                        function CreateMutexW(lpMutexAttributes
                                        : LPSECURITY_ATTRIBUTES;
                                        bInitialOwner: BOOL;
...
{$EXTERNALSYM CreateMutex}
                                        function OpenMutexA(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCSTR): HANDLE; stdcall;
{$EXTERNALSYM OpenMutexA}
                                        function OpenMutexW(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCWSTR): HANDLE; stdcall;
{$EXTERNALSYM OpenMutexW}
                                        function OpenMutex(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCTSTR): HANDLE; stdcall;
{$EXTERNALSYM OpenMutex}
                                        function CreateEventA(lpEventAttributes
                                        : LPSECURITY_ATTRIBUTES;
                                        bManualReset, bInitialState: BOOL;
                                        lpName: LPCSTR): HANDLE; stdcall;
{$EXTERNALSYM CreateEventA}
                                        function CreateEventW(lpEventAttributes
                                        : LPSECURITY_ATTRIBUTES;
                                        bManualReset, bInitialState: BOOL;
                                        lpName: LPCWSTR): HANDLE; stdcall;
{$EXTERNALSYM CreateEventW}
                                        function CreateEvent(lpEventAttributes
                                        : LPSECURITY_ATTRIBUTES;
                                        bManualReset, bInitialState: BOOL;
                                        lpName: LPCTSTR): HANDLE; stdcall;
{$EXTERNALSYM CreateEvent}
                                        function OpenEventA(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCSTR): HANDLE; stdcall;
{$EXTERNALSYM OpenEventA}
                                        function OpenEventW(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCWSTR): HANDLE; stdcall;
{$EXTERNALSYM OpenEventW}
                                        function OpenEvent(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCTSTR): HANDLE; stdcall;
...
{$EXTERNALSYM CreateSemaphore}
                                        function OpenSemaphoreA(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCSTR): HANDLE; stdcall;
{$EXTERNALSYM OpenSemaphoreA}
                                        function OpenSemaphoreW(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCWSTR): HANDLE; stdcall;
{$EXTERNALSYM OpenSemaphoreW}
                                        function OpenSemaphore(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCTSTR): HANDLE; stdcall;
...
{$EXTERNALSYM PTIMERAPCROUTINE}
                                        ...
                                        (lpTimerAttributes
                                        : LPSECURITY_ATTRIBUTES;
                                        bManualReset: BOOL; lpTimerName: LPCSTR)
                                        : HANDLE; stdcall;
...
{$EXTERNALSYM CancelWaitableTimer}
                                        ...
                                        dwMaximumSizeLow: DWORD; lpName: LPCSTR)
                                        : HANDLE; stdcall;
...
{$EXTERNALSYM CreateFileMapping}
                                        ...
                                        (dwDesiredAccess: DWORD;
                                        bInheritHandle: BOOL; lpName: LPCSTR)
                                        : HANDLE; stdcall;
{$EXTERNALSYM OpenFileMappingA}
                                        function OpenFileMappingW
                                        (dwDesiredAccess: DWORD;
                                        bInheritHandle: BOOL; lpName: LPCWSTR)
                                        : HANDLE; stdcall;
{$EXTERNALSYM OpenFileMappingW}
                                        function OpenFileMapping(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCTSTR): HANDLE; stdcall;
...
{$EXTERNALSYM GetLogicalDriveStringsW}
                                        ...
                                        (nBufferLength: DWORD; lpBuffer: LPTSTR)
                                        : DWORD; stdcall;
...
{$EXTERNALSYM LOAD_IGNORE_CODE_AUTHZ_LEVEL}
                                        ...
                                        (HMODULE: HMODULE; lpFileName: LPSTR;
                                        nSize: DWORD): DWORD; stdcall;
{$EXTERNALSYM GetModuleFileNameA}
                                        function GetModuleFileNameW
                                        (HMODULE: HMODULE; lpFileName: LPWSTR;
                                        nSize: DWORD): DWORD; stdcall;
{$EXTERNALSYM GetModuleFileNameW}
                                        function GetModuleFileName
                                        (HMODULE: HMODULE; lpFileName: LPTSTR;
                                        nSize: DWORD): DWORD; stdcall;
...
{$EXTERNALSYM GET_MODULE_HANDLE_EX_FLAG_FROM_ADDRESS}
                                        ...
                                        (dwFlags: DWORD; lpModuleName: LPCSTR;
                                        var phModule: HMODULE): BOOL; stdcall;
{$EXTERNALSYM PGET_MODULE_HANDLE_EXA}
                                        PGET_MODULE_HANDLE_EXW = function
                                        (dwFlags: DWORD; lpModuleName: LPCWSTR;
                                        var phModule: HMODULE): BOOL; stdcall;
...
{$EXTERNALSYM NeedCurrentDirectoryForExePath}
                                        ...
                                        const LPSTARTUPINFO: STARTUPINFOA;
...
{$EXTERNALSYM CreateProcessW}
                                        function CreateProcess(lpApplicationName
                                        : LPCTSTR; lpCommandLine: LPTSTR;
                                        lpProcessAttributes, lpThreadAttributes
                                        : LPSECURITY_ATTRIBUTES;
                                        bInheritHandles: BOOL;
                                        dwCreationFlags: DWORD;
...
{$EXTERNALSYM ENUMRESTYPEPROC}
                                        ...
                                        ENUMRESNAMEPROCA = function
                                        (HMODULE: HMODULE; lpType: LPCSTR;
                                        lpName: LPSTR; lParam: LONG_PTR)
                                        : BOOL; stdcall;
{$EXTERNALSYM ENUMRESNAMEPROCA}
                                        ENUMRESNAMEPROCW = function
                                        (HMODULE: HMODULE; lpType: LPCWSTR;
                                        lpName: LPWSTR; lParam: LONG_PTR)
                                        : BOOL; stdcall;
{$EXTERNALSYM ENUMRESNAMEPROCW}
                                        ENUMRESNAMEPROC = function
                                        (HMODULE: HMODULE; lpType: LPCTSTR;
                                        lpName: LPTSTR; lParam: LONG_PTR)
                                        : BOOL; stdcall;
{$EXTERNALSYM ENUMRESNAMEPROC}
                                        ...
                                        ENUMRESLANGPROCA = function
                                        (HMODULE: HMODULE;
                                        lpType, lpName: LPCSTR; wLanguage: Word;
                                        lParam: LONG_PTR): BOOL; stdcall;
{$EXTERNALSYM ENUMRESLANGPROCA}
                                        ENUMRESLANGPROCW = function
                                        (HMODULE: HMODULE;
                                        lpType, lpName: LPCWSTR;
                                        wLanguage: Word; lParam: LONG_PTR)
                                        : BOOL; stdcall;
{$EXTERNALSYM ENUMRESLANGPROCW}
                                        ENUMRESLANGPROC = function
                                        (HMODULE: HMODULE;
                                        lpType, lpName: LPCTSTR;
                                        wLanguage: Word; lParam: LONG_PTR)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM BeginUpdateResource}
                                        ...
                                        (hUpdate: HANDLE;
                                        lpType, lpName: LPCSTR; wLanguage: Word;
                                        lpData: LPVOID; cbData: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM UpdateResourceA}
                                        function UpdateResourceW
                                        (hUpdate: HANDLE;
                                        lpType, lpName: LPCWSTR;
                                        wLanguage: Word; lpData: LPVOID;
                                        cbData: DWORD): BOOL; stdcall;
{$EXTERNALSYM UpdateResourceW}
                                        function UpdateResource(hUpdate: HANDLE;
                                        lpType, lpName: LPCTSTR;
                                        wLanguage: Word; lpData: LPVOID;
                                        cbData: DWORD): BOOL; stdcall;
{$EXTERNALSYM UpdateResource}
                                        function EndUpdateResourceA
                                        (hUpdate: HANDLE; fDiscard: BOOL)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM GlobalFindAtom}
                                        function GlobalGetAtomNameA(nAtom: ATOM;
                                        lpBuffer: LPSTR; nSize: Integer)
                                        : UINT; stdcall;
{$EXTERNALSYM GlobalGetAtomNameA}
                                        function GlobalGetAtomNameW(nAtom: ATOM;
                                        lpBuffer: LPWSTR; nSize: Integer)
                                        : UINT; stdcall;
{$EXTERNALSYM GlobalGetAtomNameW}
                                        function GlobalGetAtomName(nAtom: ATOM;
                                        lpBuffer: LPTSTR; nSize: Integer)
                                        : UINT; stdcall;
{$EXTERNALSYM GlobalGetAtomName}
                                        function AddAtomA(lpString: LPCSTR)
                                        : ATOM; stdcall;
{$EXTERNALSYM AddAtomA}
                                        function AddAtomW(lpString: LPCWSTR)
                                        : ATOM; stdcall;
{$EXTERNALSYM AddAtomW}
                                        function AddAtom(lpString: LPCTSTR)
                                        : ATOM; stdcall;
{$EXTERNALSYM AddAtom}
                                        function FindAtomA(lpString: LPCSTR)
                                        : ATOM; stdcall;
{$EXTERNALSYM FindAtomA}
                                        function FindAtomW(lpString: LPCWSTR)
                                        : ATOM; stdcall;
{$EXTERNALSYM FindAtomW}
                                        function FindAtom(lpString: LPCTSTR)
                                        : ATOM; stdcall;
{$EXTERNALSYM FindAtom}
                                        function GetAtomNameA(nAtom: ATOM;
                                        lpBuffer: LPSTR; nSize: Integer)
                                        : UINT; stdcall;
{$EXTERNALSYM GetAtomNameA}
                                        function GetAtomNameW(nAtom: ATOM;
                                        lpBuffer: LPWSTR; nSize: Integer)
                                        : UINT; stdcall;
{$EXTERNALSYM GetAtomNameW}
                                        function GetAtomName(nAtom: ATOM;
                                        lpBuffer: LPTSTR; nSize: Integer)
                                        : UINT; stdcall;
{$EXTERNALSYM GetAtomName}
                                        function GetProfileIntA(lpAppName,
                                        lpKeyName: LPCSTR; nDefault: Integer)
                                        : UINT; stdcall;
{$EXTERNALSYM GetProfileIntA}
                                        function GetProfileIntW(lpAppName,
                                        lpKeyName: LPCWSTR; nDefault: Integer)
                                        : UINT; stdcall;
{$EXTERNALSYM GetProfileIntW}
                                        function GetProfileInt(lpAppName,
                                        lpKeyName: LPCTSTR; nDefault: Integer)
                                        : UINT; stdcall;
{$EXTERNALSYM GetProfileInt}
                                        function GetProfileStringA(lpAppName,
                                        lpKeyName, lpDefault: LPCSTR;
                                        lpReturnedString: LPSTR; nSize: DWORD)
                                        : DWORD; stdcall;
{$EXTERNALSYM GetProfileStringA}
                                        function GetProfileStringW(lpAppName,
                                        lpKeyName, lpDefault: LPCWSTR;
                                        lpReturnedString: LPWSTR; nSize: DWORD)
                                        : DWORD; stdcall;
{$EXTERNALSYM GetProfileStringW}
                                        function GetProfileString(lpAppName,
                                        lpKeyName, lpDefault: LPCTSTR;
                                        lpReturnedString: LPTSTR; nSize: DWORD)
                                        : DWORD; stdcall;
{$EXTERNALSYM GetProfileString}
                                        function WriteProfileStringA(lpAppName,
                                        lpKeyName, lpString: LPCSTR)
                                        : BOOL; stdcall;
{$EXTERNALSYM WriteProfileStringA}
                                        function WriteProfileStringW(lpAppName,
                                        lpKeyName, lpString: LPCWSTR)
                                        : BOOL; stdcall;
{$EXTERNALSYM WriteProfileStringW}
                                        function WriteProfileString(lpAppName,
                                        lpKeyName, lpString: LPCTSTR)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM GetProfileSection}
                                        function WriteProfileSectionA(lpAppName,
                                        lpString: LPCSTR): BOOL; stdcall;
{$EXTERNALSYM WriteProfileSectionA}
                                        function WriteProfileSectionW(lpAppName,
                                        lpString: LPCWSTR): BOOL; stdcall;
{$EXTERNALSYM WriteProfileSectionW}
                                        function WriteProfileSection(lpAppName,
                                        lpString: LPCTSTR): BOOL; stdcall;
{$EXTERNALSYM WriteProfileSection}
                                        function GetPrivateProfileIntA
                                        (lpAppName, lpKeyName: LPCSTR;
                                        nDefault: Integer; lpFileName: LPCSTR)
                                        : UINT; stdcall;
{$EXTERNALSYM GetPrivateProfileIntA}
                                        function GetPrivateProfileIntW
                                        (lpAppName, lpKeyName: LPCWSTR;
                                        nDefault: Integer; lpFileName: LPCWSTR)
                                        : UINT; stdcall;
{$EXTERNALSYM GetPrivateProfileIntW}
                                        function GetPrivateProfileInt(lpAppName,
                                        lpKeyName: LPCTSTR; nDefault: Integer;
...
{$EXTERNALSYM WritePrivateProfileStruct}
                                        ...
                                        (lpRootPathName: LPCSTR): UINT; stdcall;
...
{$EXTERNALSYM GetDiskFreeSpaceEx}
                                        ...
                                        (lpPathName: LPCSTR;
                                        lpSecurityAttributes
                                        : LPSECURITY_ATTRIBUTES): BOOL; stdcall;
...
{$EXTERNALSYM RemoveDirectory}
                                        ...
                                        (lpFileName: LPCSTR;
                                        nBufferLength: DWORD; lpBuffer: LPSTR;
                                        var lpFilePart: LPSTR): DWORD; stdcall;
{$EXTERNALSYM GetFullPathNameA}
                                        function GetFullPathNameW
                                        (lpFileName: LPCWSTR;
                                        nBufferLength: DWORD; lpBuffer: LPWSTR;
                                        var lpFilePart: LPWSTR): DWORD; stdcall;
{$EXTERNALSYM GetFullPathNameA}
                                        function GetFullPathName
                                        (lpFileName: LPCTSTR;
                                        nBufferLength: DWORD; lpBuffer: LPTSTR;
                                        var lpFilePart: LPTSTR): DWORD; stdcall;
...
{$EXTERNALSYM CreateFileW}
                                        function CreateFile(lpFileName: LPCTSTR;
                                        dwDesiredAccess, dwShareMode: DWORD;
                                        lpSecurityAttributes
                                        : LPSECURITY_ATTRIBUTES;
                                        dwCreationDisposition: DWORD;
...
{$EXTERNALSYM GetCompressedFileSize}
                                        function DeleteFileA(lpFileName: LPCSTR)
                                        : BOOL; stdcall;
{$EXTERNALSYM DeleteFileA}
                                        function DeleteFileW
                                        (lpFileName: LPCWSTR): BOOL; stdcall;
{$EXTERNALSYM DeleteFileW}
                                        function DeleteFile(lpFileName: LPCTSTR)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM FindFirstFile}
                                        ...
                                        (hFindFile: HANDLE;
                                        var FindFileData: WIN32_FIND_DATAA)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM FindNextFile}
                                        function SearchPathA(lpPath, lpFileName,
                                        lpExtension: LPCSTR;
                                        nBufferLength: DWORD; lpBuffer: LPSTR;
                                        var lpFilePart: LPSTR): DWORD; stdcall;
{$EXTERNALSYM SearchPathA}
                                        function SearchPathW(lpPath, lpFileName,
                                        lpExtension: LPCWSTR;
                                        nBufferLength: DWORD; lpBuffer: LPWSTR;
                                        var lpFilePart: LPWSTR): DWORD; stdcall;
{$EXTERNALSYM SearchPathW}
                                        function SearchPath(lpPath, lpFileName,
                                        lpExtension: LPCTSTR;
                                        nBufferLength: DWORD; lpBuffer: LPTSTR;
                                        var lpFilePart: LPTSTR): DWORD; stdcall;
...
//                                        TProgressRoutine = LPPROGRESS_ROUTINE;
                                        ...
                                        function CopyFileExA(lpExistingFileName,
                                        lpNewFileName: LPCSTR;
                                        lpProgressRoutine: LPPROGRESS_ROUTINE;
                                        lpData: LPVOID; var pbCancel: BOOL;
                                        dwCopyFlags: DWORD): BOOL; stdcall;
{$EXTERNALSYM CopyFileExA}
                                        function CopyFileExW(lpExistingFileName,
                                        lpNewFileName: LPCWSTR;
                                        lpProgressRoutine: LPPROGRESS_ROUTINE;
                                        lpData: LPVOID; var pbCancel: BOOL;
                                        dwCopyFlags: DWORD): BOOL; stdcall;
{$EXTERNALSYM CopyFileExW}
                                        function CopyFileEx(lpExistingFileName,
                                        lpNewFileName: LPCTSTR;
                                        lpProgressRoutine: LPPROGRESS_ROUTINE;
                                        lpData: LPVOID; var pbCancel: BOOL;
                                        dwCopyFlags: DWORD): BOOL; stdcall;
{$EXTERNALSYM CopyFileEx}
                                        function MoveFileA(lpExistingFileName,
                                        lpNewFileName: LPCSTR): BOOL; stdcall;
{$EXTERNALSYM MoveFileA}
                                        function MoveFileW(lpExistingFileName,
                                        lpNewFileName: LPCWSTR): BOOL; stdcall;
{$EXTERNALSYM MoveFileW}
                                        function MoveFile(lpExistingFileName,
                                        lpNewFileName: LPCTSTR): BOOL; stdcall;
{$EXTERNALSYM MoveFile}
                                        function MoveFileExA(lpExistingFileName,
                                        lpNewFileName: LPCSTR; dwFlags: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM MoveFileExA}
                                        function MoveFileExW(lpExistingFileName,
                                        lpNewFileName: LPCWSTR; dwFlags: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM MoveFileExW}
                                        function MoveFileEx(lpExistingFileName,
                                        lpNewFileName: LPCTSTR; dwFlags: DWORD)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM MOVEFILE_FAIL_IF_NOT_TRACKABLE}
                                        ...
                                        : LPCSTR; dwReplaceFlags: DWORD;
                                        lpExclude: LPVOID; lpReserved: LPVOID)
                                        : BOOL; stdcall;
{$EXTERNALSYM ReplaceFileA}
                                        function ReplaceFileW
                                        (lpReplacedFileName,
                                        lpReplacementFileName, lpBackupFileName
                                        : LPCWSTR; dwReplaceFlags: DWORD;
                                        lpExclude: LPVOID; lpReserved: LPVOID)
                                        : BOOL; stdcall;
{$EXTERNALSYM ReplaceFileW}
                                        function ReplaceFile(lpReplacedFileName,
                                        lpReplacementFileName, lpBackupFileName
                                        : LPCTSTR; dwReplaceFlags: DWORD;
                                        lpExclude: LPVOID; lpReserved: LPVOID)
                                        : BOOL; stdcall;
{$EXTERNALSYM ReplaceFile}
                                        ...
                                        function CreateHardLinkA(lpFileName,
                                        lpExistingFileName: LPCSTR;
                                        lpSecurityAttributes
                                        : LPSECURITY_ATTRIBUTES): BOOL; stdcall;
{$EXTERNALSYM CreateHardLinkA}
                                        function CreateHardLinkW(lpFileName,
                                        lpExistingFileName: LPCWSTR;
                                        lpSecurityAttributes
                                        : LPSECURITY_ATTRIBUTES): BOOL; stdcall;
{$EXTERNALSYM CreateHardLinkW}
                                        function CreateHardLink(lpFileName,
...
{$EXTERNALSYM FindNextStreamW}
                                        ...
                                        (lpName: LPCSTR;
                                        dwOpenMode, dwPipeMode, nMaxInstances,
...
{$EXTERNALSYM GetNamedPipeHandleState}
                                        function CallNamedPipeA(lpNamedPipeName
                                        : LPCSTR; lpInBuffer: LPVOID;
                                        nInBufferSize: DWORD;
                                        lpOutBuffer: LPVOID;
                                        nOutBufferSize: DWORD;
                                        var lpBytesRead: DWORD; nTimeOut: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM CallNamedPipeA}
                                        function CallNamedPipeW(lpNamedPipeName
                                        : LPCWSTR; lpInBuffer: LPVOID;
                                        nInBufferSize: DWORD;
                                        lpOutBuffer: LPVOID;
                                        nOutBufferSize: DWORD;
                                        var lpBytesRead: DWORD; nTimeOut: DWORD)
...
{$EXTERNALSYM CallNamedPipeW}
                                        function CallNamedPipe(lpNamedPipeName
                                        : LPCTSTR; lpInBuffer: LPVOID;
                                        nInBufferSize: DWORD;
                                        lpOutBuffer: LPVOID;
                                        nOutBufferSize: DWORD;
                                        var lpBytesRead: DWORD; nTimeOut: DWORD)
...
{$EXTERNALSYM CallNamedPipe}
                                        function WaitNamedPipeA(lpNamedPipeName
                                        : LPCSTR; nTimeOut: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM WaitNamedPipeA}
                                        function WaitNamedPipeW(lpNamedPipeName
                                        : LPCWSTR; nTimeOut: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM WaitNamedPipeW}
                                        function WaitNamedPipe(lpNamedPipeName
                                        : LPCTSTR; nTimeOut: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM WaitNamedPipe}
                                        function SetVolumeLabelA(lpRootPathName,
                                        lpVolumeName: LPCSTR): BOOL; stdcall;
{$EXTERNALSYM SetVolumeLabelA}
                                        function SetVolumeLabelW(lpRootPathName,
                                        lpVolumeName: LPCWSTR): BOOL; stdcall;
{$EXTERNALSYM SetVolumeLabelW}
                                        function SetVolumeLabel(lpRootPathName,
                                        lpVolumeName: LPCTSTR): BOOL; stdcall;
...
{$EXTERNALSYM GetVolumeInformation}
                                        function CancelIo(hFile: HANDLE)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM ReadEventLogW}
                                        function ReadEventLog(hEventLog: HANDLE;
                                        dwReadFlags, dwRecordOffset: DWORD;
                                        lpBuffer: LPVOID;
                                        nNumberOfBytesToRead: DWORD;
                                        var pnBytesRead,
...
{$EXTERNALSYM ReadEventLog}
                                        function ReportEventA(hEventLog: HANDLE;
                                        wType, wCategory: Word;
                                        dwEventID: DWORD; lpUserSid: PSID;
                                        wNumStrings: Word; dwDataSize: DWORD;
                                        lpStrings: LPCSTR; lpRawData: LPVOID)
                                        : BOOL; stdcall;
{$EXTERNALSYM ReportEventA}
                                        function ReportEventW(hEventLog: HANDLE;
                                        wType, wCategory: Word;
                                        dwEventID: DWORD; lpUserSid: PSID;
                                        wNumStrings: Word; dwDataSize: DWORD;
                                        lpStrings: LPCWSTR; lpRawData: LPVOID)
                                        : BOOL; stdcall;
{$EXTERNALSYM ReportEventW}
                                        function ReportEvent(hEventLog: HANDLE;
                                        wType, wCategory: Word;
                                        dwEventID: DWORD; lpUserSid: PSID;
                                        wNumStrings: Word; dwDataSize: DWORD;
                                        lpStrings: LPCTSTR; lpRawData: LPVOID)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM EVENTLOG_FULL_INFORMATION}
                                        TEventlogFullInformation =
                                        EVENTLOG_FULL_INFORMATION;
                                        PEventlogFullInformation =
                                        LPEVENTLOG_FULL_INFORMATION;

                                        function GetEventLogInformation
                                        (hEventLog: HANDLE; dwInfoLevel: DWORD;
                                        lpBuffer: LPVOID; cbBufSize: DWORD;
...
{$EXTERNALSYM DuplicateToken}
                                        ...
                                        pSecurityDescriptor
                                        : PSECURITY_DESCRIPTOR; nLength: DWORD;
...
{$EXTERNALSYM AccessCheckByType}
                                        ...
                                        var PrivilegeSet: PRIVILEGE_SET;
                                        var PrivilegeSetLength,
                                        GrantedAccessList: DWORD;
                                        var AccessStatusList: DWORD)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM OpenProcessToken}
                                        ...
                                        (ThreadHandle: HANDLE;
                                        DesiredAccess: DWORD; OpenAsSelf: BOOL;
                                        var TokenHandle: HANDLE): BOOL; stdcall;
...
{$EXTERNALSYM PrivilegeCheck}
                                        ...
                                        HandleId: LPVOID;
                                        ObjectTypeName, ObjectName: LPSTR;
                                        SecurityDescriptor
                                        : PSECURITY_DESCRIPTOR;
                                        DesiredAccess: DWORD;
                                        const GenericMapping: GENERIC_MAPPING;
...
{$EXTERNALSYM AccessCheckAndAuditAlarmW}
                                        ...
                                        HandleId: LPVOID;
                                        ObjectTypeName, ObjectName: LPTSTR;
                                        SecurityDescriptor
                                        : PSECURITY_DESCRIPTOR;
                                        DesiredAccess: DWORD;
                                        const GenericMapping: GENERIC_MAPPING;
...
{$EXTERNALSYM AccessCheckByTypeAndAuditAlarmW}
                                        ...
                                        (SubsystemName: LPCTSTR;
                                        HandleId: LPVOID;
                                        ObjectTypeName, ObjectName: LPCTSTR;
                                        SecurityDescriptor
                                        : PSECURITY_DESCRIPTOR;
                                        PrincipalSelfSid: PSID;
                                        DesiredAccess: DWORD;
...
{$EXTERNALSYM AccessCheckByTypeAndAuditAlarmA}
                                        ...
                                        (SubsystemName: LPCSTR;
                                        HandleId: LPVOID;
                                        ObjectTypeName, ObjectName: LPCSTR;
                                        SecurityDescriptor
                                        : PSECURITY_DESCRIPTOR;
                                        PrincipalSelfSid: PSID;
                                        DesiredAccess: DWORD;
...
{$EXTERNALSYM AccessCheckByTypeResultListAndAuditAlarmA}
                                        ...
                                        (SubsystemName: LPCSTR;
                                        HandleId: LPVOID; ClientToken: HANDLE;
                                        ObjectTypeName, ObjectName: LPCSTR;
                                        SecurityDescriptor
                                        : PSECURITY_DESCRIPTOR;
                                        PrincipalSelfSid: PSID;
...
{$EXTERNALSYM AccessCheckByTypeResultListAndAuditAlarmByHandleA}
                                        ...
                                        ObjectTypeList: POBJECT_TYPE_LIST;
                                        ObjectTypeListLength: DWORD;
                                        const GenericMapping: PGENERIC_MAPPING;
                                        ObjectCreation: BOOL;
                                        var GrantedAccess, AccessStatusList
                                        : DWORD; var pfGenerateOnClose: BOOL)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM AccessCheckByTypeResultListAndAuditAlarmByHandle}
                                        ...
                                        (SubsystemName: LPCSTR;
                                        HandleId: LPVOID; ObjectTypeName: LPSTR;
                                        ObjectName: LPSTR;
                                        pSecurityDescriptor
                                        : PSECURITY_DESCRIPTOR;
                                        ClientToken: HANDLE;
...
{$EXTERNALSYM ObjectOpenAuditAlarmA}
                                        ...
                                        HandleId: LPVOID; ClientToken: HANDLE;
                                        DesiredAccess: DWORD;
                                        const Privileges: PRIVILEGE_SET;
...
{$EXTERNALSYM ObjectPrivilegeAuditAlarmA}
                                        ...
                                        (SubsystemName: LPCSTR;
                                        HandleId: LPVOID; GenerateOnClose: BOOL)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM GetSidLengthRequired}
                                        ...
                                        nSubAuthority2, nSubAuthority3,
                                        nSubAuthority4, nSubAuthority5,
                                        nSubAuthority6, nSubAuthority7: DWORD;
                                        var PSID: PSID): BOOL; stdcall;
{$EXTERNALSYM AllocateAndInitializeSid}
                                        function FreeSid(PSID: PSID)
                                        : PVOID; stdcall;
{$EXTERNALSYM FreeSid}
                                        function InitializeSid(Sid: PSID;
                                        pIdentifierAuthority
                                        : PSID_IDENTIFIER_AUTHORITY;
...
{$EXTERNALSYM GetSidIdentifierAuthority}
                                        function GetSidSubAuthority(PSID: PSID;
                                        nSubAuthority: DWORD): PDWORD; stdcall;
{$EXTERNALSYM GetSidSubAuthority}
                                        function GetSidSubAuthorityCount
                                        (PSID: PSID): PUCHAR; stdcall;
{$EXTERNALSYM GetSidSubAuthorityCount}
                                        function GetLengthSid(PSID: PSID)
                                        : DWORD; stdcall;
{$EXTERNALSYM GetLengthSid}
                                        function CopySid(nDestinationSidLength
                                        : DWORD; pDestinationSid: PSID;
                                        pSourceSid: PSID): BOOL; stdcall;
{$EXTERNALSYM CopySid}
                                        function AreAllAccessesGranted
                                        (GrantedAccess, DesiredAccess: DWORD)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM AreAnyAccessesGranted}
                                        ...
                                        var GenericMapping
                                        : GENERIC_MAPPING); stdcall;
{$EXTERNALSYM MapGenericMask}
                                        function IsValidAcl(pAcl: pAcl)
                                        : BOOL; stdcall;
{$EXTERNALSYM IsValidAcl}
                                        function InitializeAcl(pAcl: pAcl;
                                        nAclLength: DWORD; dwAclRevision: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM InitializeAcl}
                                        function GetAclInformation(pAcl: pAcl;
                                        pAclInformation: LPVOID;
                                        nAclInformationLength: DWORD;
                                        dwAclInformationClass
                                        : ACL_INFORMATION_CLASS): BOOL; stdcall;
{$EXTERNALSYM GetAclInformation}
                                        function SetAclInformation(pAcl: pAcl;
                                        pAclInformation: LPVOID;
                                        nAclInformationLength: DWORD;
                                        dwAclInformationClass
                                        : ACL_INFORMATION_CLASS): BOOL; stdcall;
{$EXTERNALSYM SetAclInformation}
                                        function AddAce(pAcl: pAcl;
                                        dwAceRevision: DWORD;
                                        dwStartingAceIndex: DWORD;
                                        pAceList: LPVOID; nAceListLength: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM AddAce}
                                        function DeleteAce(pAcl: pAcl;
                                        dwAceIndex: DWORD): BOOL; stdcall;
{$EXTERNALSYM DeleteAce}
                                        function GetAce(pAcl: pAcl;
                                        dwAceIndex: DWORD; var pAce: LPVOID)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetAce}
                                        function AddAccessAllowedAce(pAcl: pAcl;
                                        dwAceRevision, AccessMask: DWORD;
                                        PSID: PSID): BOOL; stdcall;
{$EXTERNALSYM AddAccessAllowedAce}
                                        function AddAccessAllowedAceEx
                                        (pAcl: pAcl;
                                        dwAceRevision, AceFlags,
                                        AccessMask: DWORD; PSID: PSID)
                                        : BOOL; stdcall;
{$EXTERNALSYM AddAccessAllowedAceEx}
                                        function AddAccessDeniedAce(pAcl: pAcl;
                                        dwAceRevision, AccessMask: DWORD;
                                        PSID: PSID): BOOL; stdcall;
{$EXTERNALSYM AddAccessDeniedAce}
                                        function AddAccessDeniedAceEx
                                        (pAcl: pAcl;
                                        dwAceRevision, AceFlags: DWORD;
                                        AccessMask: DWORD; PSID: PSID)
                                        : BOOL; stdcall;
{$EXTERNALSYM AddAccessDeniedAceEx}
                                        function AddAuditAccessAce(pAcl: pAcl;
                                        dwAceRevision, dwAccessMask: DWORD;
                                        PSID: PSID;
                                        bAuditSuccess, bAuditFailure: BOOL)
                                        : BOOL; stdcall;
{$EXTERNALSYM AddAuditAccessAce}
                                        function AddAuditAccessAceEx(pAcl: pAcl;
                                        dwAceRevision, AceFlags,
                                        dwAccessMask: DWORD; PSID: PSID;
                                        bAuditSuccess, bAuditFailure: BOOL)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM AddAuditAccessObjectAce}
                                        function FindFirstFreeAce(pAcl: pAcl;
                                        var pAce: LPVOID): BOOL; stdcall;
...
{$EXTERNALSYM SetSecurityDescriptorControl}
                                        ...
                                        (pSecurityDescriptor
                                        : PSECURITY_DESCRIPTOR;
                                        bDaclPresent: BOOL; pDacl: pAcl;
                                        bDaclDefaulted: BOOL): BOOL; stdcall;
{$EXTERNALSYM SetSecurityDescriptorDacl}
                                        ...
                                        var pDacl: pAcl;
                                        var lpbDaclDefaulted: BOOL)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetSecurityDescriptorDacl}
                                        function SetSecurityDescriptorSacl
                                        (pSecurityDescriptor
                                        : PSECURITY_DESCRIPTOR;
                                        bSaclPresent: BOOL; pSacl: pAcl;
                                        bSaclDefaulted: BOOL): BOOL; stdcall;
...
{$EXTERNALSYM CreatePrivateObjectSecurity}
                                        ...
                                        : PSECURITY_DESCRIPTOR;
                                        var NewSecurityDescriptor
                                        : PSECURITY_DESCRIPTOR;
                                        ObjectType: lpGuid;
                                        IsDirectoryObject: ByteBool;
                                        const GenericMapping: GENERIC_MAPPING)
                                        : BOOL; stdcall;
{$EXTERNALSYM ConvertToAutoInheritPrivateObjectSecurity}
                                        ...
                                        AutoInheritFlags: ULONG; Token: HANDLE;
                                        const GenericMapping: GENERIC_MAPPING)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM MakeSelfRelativeSD}
                                        ...
                                        pAbsoluteSecurityDescriptor
                                        : PSECURITY_DESCRIPTOR;
                                        var lpdwAbsoluteSecurityDescriptorSize
                                        : DWORD; pDacl: pAcl;
                                        var lpdwDaclSize: DWORD; pSacl: pAcl;
                                        var lpdwSaclSize: DWORD; pOwner: PSID;
                                        var lpdwOwnerSize: DWORD;
                                        pPrimaryGroup: PSID;
                                        var lpdwPrimaryGroupSize: DWORD)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM FindFirstChangeNotification}
                                        ...
                                        (hChangeHandle: HANDLE): BOOL; stdcall;
...
{$EXTERNALSYM FindCloseChangeNotification}
                                        ...
                                        (hDirectory: HANDLE; lpBuffer: LPVOID;
                                        nBufferLength: DWORD;
                                        bWatchSubtree: BOOL;
...
{$EXTERNALSYM ReadDirectoryChangesW}
                                        function VirtualLock(lpAddress: LPVOID;
                                        dwSize: SIZE_T): BOOL; stdcall;
...
{$EXTERNALSYM SetPriorityClass}
                                        ...
                                        (hProcess: HANDLE): DWORD; stdcall;
{$EXTERNALSYM GetPriorityClass}
                                        function IsBadReadPtr(lp: LPVOID;
                                        ucb: UINT_PTR): BOOL; stdcall;
{$EXTERNALSYM IsBadReadPtr}
                                        function IsBadWritePtr(lp: LPVOID;
                                        ucb: UINT_PTR): BOOL; stdcall;
{$EXTERNALSYM IsBadWritePtr}
                                        function IsBadHugeReadPtr(lp: LPVOID;
                                        ucb: UINT_PTR): BOOL; stdcall;
{$EXTERNALSYM IsBadHugeReadPtr}
                                        function IsBadHugeWritePtr(lp: LPVOID;
                                        ucb: UINT_PTR): BOOL; stdcall;
{$EXTERNALSYM IsBadHugeWritePtr}
                                        function IsBadCodePtr(lpfn: FARPROC)
                                        : BOOL; stdcall;
{$EXTERNALSYM IsBadCodePtr}
                                        function IsBadStringPtrA(lpsz: LPCSTR;
                                        ucchMax: UINT_PTR): BOOL; stdcall;
{$EXTERNALSYM IsBadStringPtrA}
                                        function IsBadStringPtrW(lpsz: LPCWSTR;
                                        ucchMax: UINT_PTR): BOOL; stdcall;
{$EXTERNALSYM IsBadStringPtrW}
                                        function IsBadStringPtr(lpsz: LPCTSTR;
                                        ucchMax: UINT_PTR): BOOL; stdcall;
{$EXTERNALSYM IsBadStringPtr}
                                        function LookupAccountSidA
                                        (lpSystemName: LPCSTR; Sid: PSID;
                                        Name: LPSTR; var cchName: DWORD;
...
{$EXTERNALSYM LookupAccountSidA}
                                        ...
                                        (lpSystemName: LPCWSTR; Sid: PSID;
                                        Name: LPWSTR; var cchName: DWORD;
                                        ReferencedDomainName: LPWSTR;
                                        var cchReferencedDomainName: DWORD;
                                        var peUse: SID_NAME_USE): BOOL; stdcall;
{$EXTERNALSYM LookupAccountSidW}
                                        function LookupAccountSid
                                        (lpSystemName: LPCTSTR; Sid: PSID;
...
{$EXTERNALSYM LookupAccountSid}
                                        ...
                                        (lpSystemName, lpAccountName: LPCSTR;
                                        Sid: PSID; var cbSid: DWORD;
                                        ReferencedDomainName: LPSTR;
                                        var cchReferencedDomainName: DWORD;
                                        var peUse: SID_NAME_USE): BOOL; stdcall;
{$EXTERNALSYM LookupAccountNameA}
                                        function LookupAccountNameW
                                        (lpSystemName, lpAccountName: LPCWSTR;
                                        Sid: PSID; var cbSid: DWORD;
                                        ReferencedDomainName: LPWSTR;
                                        var cchReferencedDomainName: DWORD;
                                        var peUse: SID_NAME_USE): BOOL; stdcall;
{$EXTERNALSYM LookupAccountNameW}
                                        ...
                                        lpAccountName: LPCTSTR; Sid: PSID;
                                        var cbSid: DWORD;
                                        ReferencedDomainName: LPTSTR;
                                        var cchReferencedDomainName: DWORD;
                                        var peUse: SID_NAME_USE): BOOL; stdcall;
...
{$EXTERNALSYM MAX_COMPUTERNAME_LENGTH}
                                        ...
                                        (lpBuffer: LPSTR; var nSize: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetComputerNameA}
                                        function GetComputerNameW
                                        (lpBuffer: LPWSTR; var nSize: DWORD)
                                        : BOOL; stdcall;
{$EXTERNALSYM GetComputerNameW}
                                        function GetComputerName
                                        (lpBuffer: LPTSTR; var nSize: DWORD)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM LOGON32_PROVIDER_WINNT50}
                                        function LogonUserA(lpszUsername,
                                        lpszDomain, lpszPassword: LPCSTR;
                                        dwLogonType, dwLogonProvider: DWORD;
                                        var phToken: HANDLE): BOOL; stdcall;
{$EXTERNALSYM LogonUserA}
                                        function LogonUserW(lpszUsername,
                                        lpszDomain, lpszPassword: LPCWSTR;
                                        dwLogonType, dwLogonProvider: DWORD;
                                        var phToken: HANDLE): BOOL; stdcall;
{$EXTERNALSYM LogonUserW}
                                        function LogonUser(lpszUsername,
                                        lpszDomain, lpszPassword: LPCTSTR;
                                        dwLogonType, dwLogonProvider: DWORD;
                                        var phToken: HANDLE): BOOL; stdcall;
{$EXTERNALSYM LogonUser}
                                        function LogonUserExA(lpszUsername,
                                        lpszDomain, lpszPassword: LPCSTR;
                                        dwLogonType, dwLogonProvider: DWORD;
                                        var phToken: HANDLE; ppLogonSid: PPSID;
                                        ppProfileBuffer: PPVOID;
                                        pdwProfileLength: LPDWORD;
                                        pQuotaLimits: PQUOTA_LIMITS)
                                        : BOOL; stdcall;
{$EXTERNALSYM LogonUserExA}
                                        function LogonUserExW(lpszUsername,
                                        lpszDomain, lpszPassword: LPCWSTR;
                                        dwLogonType, dwLogonProvider: DWORD;
                                        var phToken: HANDLE; ppLogonSid: PPSID;
                                        ppProfileBuffer: PPVOID;
...
{$EXTERNALSYM LogonUserExW}
                                        function LogonUserEx(lpszUsername,
                                        lpszDomain, lpszPassword: LPCTSTR;
                                        dwLogonType, dwLogonProvider: DWORD;
                                        var phToken: HANDLE; ppLogonSid: PPSID;
                                        ppProfileBuffer: PPVOID;
...
{$EXTERNALSYM LOGON_NETCREDENTIALS_ONLY}
                                        LOGON_ZERO_PASSWORD_BUFFER = DWORD
                                        ($80000000);
...
{$EXTERNALSYM CreateProcessWithTokenW}
                                        ...
                                        (ThreadHandle: HANDLE): BOOL; stdcall;
{$EXTERNALSYM ImpersonateAnonymousToken}
                                        ...
                                        var phNewToken: HANDLE): BOOL; stdcall;
{$EXTERNALSYM DuplicateTokenEx}
                                        function CreateRestrictedToken
                                        (ExistingTokenHandle: HANDLE;
                                        Flags: DWORD; DisableSidCount: DWORD;
...
{$EXTERNALSYM WAITORTIMERCALLBACK}
                                        ...
                                        (var phNewWaitObject: HANDLE;
                                        hObject: HANDLE;
                                        Callback: WAITORTIMERCALLBACK;
                                        CONTEXT: PVOID;
                                        dwMilliseconds, dwFlags: ULONG)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM RegisterWaitForSingleObjectEx}
                                        ...
                                        (WaitHandle: HANDLE): BOOL; stdcall;
{$EXTERNALSYM UnregisterWait}
                                        function UnregisterWaitEx(WaitHandle,
                                        CompletionEvent: HANDLE): BOOL; stdcall;
{$EXTERNALSYM UnregisterWaitEx}
                                        function QueueUserWorkItem
                                        (Function_: LPTHREAD_START_ROUTINE;
                                        CONTEXT: PVOID; Flags: ULONG)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM CreateTimerQueue}
                                        ...
                                        (var phNewTimer: HANDLE;
                                        TimerQueue: HANDLE;
                                        Callback: WAITORTIMERCALLBACK;
                                        Parameter: PVOID;
                                        DueTime, Period: DWORD; Flags: ULONG)
                                        : BOOL; stdcall;
{$EXTERNALSYM CreateTimerQueueTimer}
                                        function ChangeTimerQueueTimer
                                        (TimerQueue, Timer: HANDLE;
                                        DueTime, Period: ULONG): BOOL; stdcall;
...
{$EXTERNALSYM DeleteTimerQueueTimer}
                                        function DeleteTimerQueueEx(TimerQueue,
                                        CompletionEvent: HANDLE): BOOL; stdcall;
{$EXTERNALSYM DeleteTimerQueueEx}
                                        function SetTimerQueueTimer(TimerQueue,
                                        Callback: WAITORTIMERCALLBACK;
                                        Parameter: PVOID;
                                        DueTime, Period: DWORD; PreferIo: BOOL)
                                        : HANDLE; stdcall;
...
{$EXTERNALSYM CancelTimerQueueTimer}
                                        ...
                                        (TimerQueue: HANDLE): BOOL; stdcall;
...
{$EXTERNALSYM LPHW_PROFILE_INFOA}
                                        ...
                                        dwDockInfo: DWORD;
                                        szHwProfileGuid
                                        : array [0 .. HW_PROFILE_GUIDLEN - 1]
                                        of AnsiChar;
                                        szHwProfileName
                                        : array [0 .. MAX_PROFILE_LEN - 1]
                                        of AnsiChar;
                                        end;
...
{$EXTERNALSYM LPHW_PROFILE_INFOW}
                                        ...
                                        dwDockInfo: DWORD;
                                        szHwProfileGuid
                                        : array [0 .. HW_PROFILE_GUIDLEN -
                                        1] of WCHAR;
                                        szHwProfileName
                                        : array [0 .. MAX_PROFILE_LEN -
                                        1] of WCHAR;
                                        end;
...
{$EXTERNALSYM GetCurrentHwProfile}
                                        ...
                                        (var lpPerformanceCount: LARGE_INTEGER)
                                        : BOOL; stdcall;
{$EXTERNALSYM QueryPerformanceCounter}
                                        function QueryPerformanceFrequency
                                        (var lpFrequency: LARGE_INTEGER)
                                        : BOOL; stdcall;
...
{$EXTERNALSYM SYSTEM_POWER_STATUS}
                                        ...
                                        (var lpSystemPowerStatus
                                        : SYSTEM_POWER_STATUS): BOOL; stdcall;
{$EXTERNALSYM GetSystemPowerStatus}
                                        function SetSystemPowerState(fSuspend,
                                        fForce: BOOL): BOOL; stdcall;
...
{$EXTERNALSYM CreateJobObject}
                                        function OpenJobObjectA(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCSTR): HANDLE; stdcall;
{$EXTERNALSYM OpenJobObjectA}
                                        function OpenJobObjectW(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCWSTR): HANDLE; stdcall;
{$EXTERNALSYM OpenJobObjectW}
                                        function OpenJobObject(dwDesiredAccess
                                        : DWORD; bInheritHandle: BOOL;
                                        lpName: LPCTSTR): HANDLE; stdcall;
{$EXTERNALSYM OpenJobObject}
                                        function AssignProcessToJobObject(hJob,
                                        hProcess: HANDLE): BOOL; stdcall;
...
{$EXTERNALSYM SetInformationJobObject}
                                        function IsProcessInJob(ProcessHandle,
                                        JobHandle: HANDLE; var Result_: BOOL)
                                        : BOOL; stdcall;
{$EXTERNALSYM IsProcessInJob}
                                        function CreateJobSet(NumJob: ULONG;
...
{$EXTERNALSYM FindNextVolume}
                                        ...
                                        (hFindVolume: HANDLE): BOOL; stdcall;
...
{$EXTERNALSYM SetVolumeMountPointA}
                                        ...
                                        (lpszVolumeMountPoint,
                                        lpszVolumeName: LPCWSTR): BOOL; stdcall;
{$EXTERNALSYM SetVolumeMountPointW}
                                        function SetVolumeMountPoint
                                        (lpszVolumeMountPoint,
                                        lpszVolumeName: LPCTSTR): BOOL; stdcall;
...
{$EXTERNALSYM DeactivateActCtx}
                                        ...
                                        (var lphActCtx: HANDLE): BOOL; stdcall;
...
{$EXTERNALSYM PCACTCTX_SECTION_KEYED_DATA_2600}
                                        TActCtxSectionKeyedData2600 =
                                        ACTCTX_SECTION_KEYED_DATA_2600;
                                        PActCtxSectionKeyedData2600 =
                                        PACTCTX_SECTION_KEYED_DATA_2600;
...
{$EXTERNALSYM PCACTCTX_SECTION_KEYED_DATA_ASSEMBLY_METADATA}
                                        TActCtxSectionKeyedDataAssemblyMetadata =
                                        ACTCTX_SECTION_KEYED_DATA_ASSEMBLY_METADATA;
                                        PActCtxSectionKeyedDataAssemblyMetadata =
                                        PACTCTX_SECTION_KEYED_DATA_ASSEMBLY_METADATA;
...
{$EXTERNALSYM PCACTCTX_SECTION_KEYED_DATA}
                                        TActCtxSectionKeyedData =
                                        ACTCTX_SECTION_KEYED_DATA;
                                        PActCtxSectionKeyedData =
                                        PACTCTX_SECTION_KEYED_DATA;
...
{$EXTERNALSYM PACTIVATION_CONTEXT_BASIC_INFORMATION}
                                        ...
                                        ACTIVATION_CONTEXT_BASIC_INFORMATION;
                                        PActivationContextBasicInformation =
                                        PACTIVATION_CONTEXT_BASIC_INFORMATION;
...
{$EXTERNALSYM QUERY_ACTCTX_FLAG_NO_ADDREF}
                                        ...
                                        function QueryActCtxW(dwFlags: DWORD;
                                        hActCtx: HANDLE; pvSubInstance: PVOID;
                                        ulInfoClass: ULONG; pvBuffer: PVOID;
                                        cbBuffer: SIZE_T;
                                        pcbWrittenOrRequired: PSIZE_T)
                                        : BOOL; stdcall;
{$EXTERNALSYM QueryActCtxW}
                                        type
                                        PQUERYACTCTXW_FUNC = function
                                        (dwFlags: DWORD; hActCtx: HANDLE;
                                        pvSubInstance: PVOID;
                                        ulInfoClass: ULONG; pvBuffer: PVOID;
                                        cbBuffer: SIZE_T;
                                        pcbWrittenOrRequired: PSIZE_T)
...
{$EXTERNALSYM IsWow64Process}
                                        ...
                                        ReturnedLength: PDWORD): BOOL; stdcall;
...
begin
  repeat
    result := Destination;
  until (InterlockedCompareExchange64(Destination, result and Value, result)
    = result);
end;
...
begin
  repeat
    result := Destination;
  until (InterlockedCompareExchange64(Destination, result or Value, result)
    = result);
end;
...
begin
  repeat
    result := Destination;
  until (InterlockedCompareExchange64(Destination, result xor Value, result)
    = result);
end;
...
function InterlockedExchangeAdd64(var Addend: LONGLONG; Value: LONGLONG)
  : LONGLONG;
begin
  repeat
    result := Addend;
...
type
  TCreateMutexA = function(lpMutexAttributes: LPSECURITY_ATTRIBUTES;
    bInitialOwner: DWORD; lpName: LPCSTR): HANDLE; stdcall;
  TCreateMutexW = function(lpMutexAttributes: LPSECURITY_ATTRIBUTES;
    bInitialOwner: DWORD; lpName: LPCWSTR): HANDLE; stdcall;
...
begin
  ...
  result := TCreateMutexA(_CreateMutexA)(lpMutexAttributes,
    DWORD(Boolean(bInitialOwner)), lpName)
end;
...
begin
  ...
  result := TCreateMutexW(_CreateMutexW)(lpMutexAttributes,
    DWORD(Boolean(bInitialOwner)), lpName)
end;
...
begin
  GetProcedureAddress(_InterlockedCompareExchange64, kernel32,
...
function InterlockedExchangeAdd;
begin
  GetProcedureAddress(_InterlockedExchangeAdd, kernel32,
...
function InterlockedCompareExchange;
begin
  GetProcedureAddress(_InterlockedCompareExchange, kernel32,
...
function InterlockedPopEntrySList;
begin
  GetProcedureAddress(_InterlockedPopEntrySList, kernel32,
...
function InterlockedPushEntrySList;
begin
  GetProcedureAddress(_InterlockedPushEntrySList, kernel32,
...
function InterlockedFlushSList;
begin
  GetProcedureAddress(_InterlockedFlushSList, kernel32,
...
procedure FreeLibraryAndExitThread;
begin
  GetProcedureAddress(_FreeLibraryAndExitThread, kernel32,
...
function DisableThreadLibraryCalls;
begin
  GetProcedureAddress(_DisableThreadLibraryCalls, kernel32,
...
function FlushInstructionCache;
begin
  GetProcedureAddress(_FlushInstructionCache, kernel32,
...
function GetShortPathName;
begin
  GetProcedureAddress(_GetShortPathName, kernel32,
    'GetShortPathName' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetProcessAffinityMask;
begin
  GetProcedureAddress(_GetProcessAffinityMask, kernel32,
...
function SetProcessAffinityMask;
begin
  GetProcedureAddress(_SetProcessAffinityMask, kernel32,
...
function GetProcessHandleCount;
begin
  GetProcedureAddress(_GetProcessHandleCount, kernel32,
...
function GetProcessWorkingSetSize;
begin
  GetProcedureAddress(_GetProcessWorkingSetSize, kernel32,
...
function GetProcessWorkingSetSizeEx;
begin
  GetProcedureAddress(_GetProcessWorkingSetSizeEx, kernel32,
...
function SetProcessWorkingSetSize;
begin
  GetProcedureAddress(_SetProcessWorkingSetSize, kernel32,
...
function SetProcessWorkingSetSizeEx;
begin
  GetProcedureAddress(_SetProcessWorkingSetSizeEx, kernel32,
...
function GetEnvironmentStringsW;
begin
  GetProcedureAddress(_GetEnvironmentStringsW, kernel32,
...
function GetEnvironmentStrings;
begin
  GetProcedureAddress(_GetEnvironmentStrings, kernel32, 'GetEnvironmentStrings'
    + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetEnvironmentStringsA;
begin
  GetProcedureAddress(_GetEnvironmentStringsA, kernel32,
...
function SetEnvironmentStringsA;
begin
  GetProcedureAddress(_SetEnvironmentStringsA, kernel32,
...
function SetEnvironmentStringsW;
begin
  GetProcedureAddress(_SetEnvironmentStringsW, kernel32,
...
function SetEnvironmentStrings;
begin
  GetProcedureAddress(_SetEnvironmentStrings, kernel32, 'SetEnvironmentStrings'
    + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function FreeEnvironmentStringsA;
begin
  GetProcedureAddress(_FreeEnvironmentStringsA, kernel32,
...
function FreeEnvironmentStringsW;
begin
  GetProcedureAddress(_FreeEnvironmentStringsW, kernel32,
...
function FreeEnvironmentStrings;
begin
  GetProcedureAddress(_FreeEnvironmentStrings, kernel32,
    'FreeEnvironmentStrings' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function UnhandledExceptionFilter;
begin
  GetProcedureAddress(_UnhandledExceptionFilter, kernel32,
...
function SetUnhandledExceptionFilter;
begin
  GetProcedureAddress(_SetUnhandledExceptionFilter, kernel32,
...
function ConvertThreadToFiberEx;
begin
  GetProcedureAddress(_ConvertThreadToFiberEx, kernel32,
...
function GetCurrentProcessorNumber;
begin
  GetProcedureAddress(_GetCurrentProcessorNumber, kernel32,
...
function SetThreadAffinityMask;
begin
  GetProcedureAddress(_SetThreadAffinityMask, kernel32,
...
function SetThreadIdealProcessor;
begin
  GetProcedureAddress(_SetThreadIdealProcessor, kernel32,
...
function SetProcessPriorityBoost;
begin
  GetProcedureAddress(_SetProcessPriorityBoost, kernel32,
...
function GetProcessPriorityBoost;
begin
  GetProcedureAddress(_GetProcessPriorityBoost, kernel32,
...
function IsSystemResumeAutomatic;
begin
  GetProcedureAddress(_IsSystemResumeAutomatic, kernel32,
...
function SetThreadPriorityBoost;
begin
  GetProcedureAddress(_SetThreadPriorityBoost, kernel32,
...
function GetThreadPriorityBoost;
begin
  GetProcedureAddress(_GetThreadPriorityBoost, kernel32,
...
function GetThreadIOPendingFlag;
begin
  GetProcedureAddress(_GetThreadIOPendingFlag, kernel32,
...
function GetThreadSelectorEntry;
begin
  GetProcedureAddress(_GetThreadSelectorEntry, kernel32,
...
function SetThreadExecutionState;
begin
  GetProcedureAddress(_SetThreadExecutionState, kernel32,
...
function CreateIoCompletionPort;
begin
  GetProcedureAddress(_CreateIoCompletionPort, kernel32,
...
function GetQueuedCompletionStatus;
begin
  GetProcedureAddress(_GetQueuedCompletionStatus, kernel32,
...
function PostQueuedCompletionStatus;
begin
  GetProcedureAddress(_PostQueuedCompletionStatus, kernel32,
...
function CheckRemoteDebuggerPresent;
begin
  GetProcedureAddress(_CheckRemoteDebuggerPresent, kernel32,
...
function DebugActiveProcessStop;
begin
  GetProcedureAddress(_DebugActiveProcessStop, kernel32,
...
function DebugSetProcessKillOnExit;
begin
  GetProcedureAddress(_DebugSetProcessKillOnExit, kernel32,
...
procedure InitializeCriticalSection;
begin
  GetProcedureAddress(_InitializeCriticalSection, kernel32,
...
function InitializeCriticalSectionAndSpinCount;
begin
  GetProcedureAddress(_InitCritSectAndSpinCount, kernel32,
...
function SetCriticalSectionSpinCount;
begin
  GetProcedureAddress(_SetCriticalSectionSpinCount, kernel32,
...
function TryEnterCriticalSection;
begin
  GetProcedureAddress(_TryEnterCriticalSection, kernel32,
...
procedure DeleteCriticalSection;
begin
  GetProcedureAddress(_DeleteCriticalSection, kernel32,
...
function WaitForMultipleObjects;
begin
  GetProcedureAddress(_WaitForMultipleObjects, kernel32,
...
function GetFileInformationByHandle;
begin
  GetProcedureAddress(_GetFileInformationByHandle, kernel32,
...
function CancelDeviceWakeupRequest;
begin
  GetProcedureAddress(_CancelDeviceWakeupRequest, kernel32,
...
function SetMessageWaitingIndicator;
begin
  GetProcedureAddress(_SetMessageWaitingIndicator, kernel32,
...
begin
  GetProcedureAddress(_SetFileShortName, kernel32,
    'SetFileShortName' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
procedure GetSystemTimeAsFileTime;
begin
  GetProcedureAddress(_GetSystemTimeAsFileTime, kernel32,
...
function GetSystemRegistryQuota;
begin
  GetProcedureAddress(_GetSystemRegistryQuota, kernel32,
...
function IsProcessorFeaturePresent;
begin
  GetProcedureAddress(_IsProcessorFeaturePresent, kernel32,
...
function SystemTimeToTzSpecificLocalTime;
begin
  GetProcedureAddress(_SystemTimeToTzSpecificLocalTime, kernel32,
...
function TzSpecificLocalTimeToSystemTime;
begin
  GetProcedureAddress(_TzSpecificLocalTimeToSystemTime, kernel32,
...
function GetTimeZoneInformation;
begin
  GetProcedureAddress(_GetTimeZoneInformation, kernel32,
...
function SetTimeZoneInformation;
begin
  GetProcedureAddress(_SetTimeZoneInformation, kernel32,
...
function FileTimeToLocalFileTime;
begin
  GetProcedureAddress(_FileTimeToLocalFileTime, kernel32,
...
function LocalFileTimeToFileTime;
begin
  GetProcedureAddress(_LocalFileTimeToFileTime, kernel32,
...
function FileTimeToDosDateTime;
begin
  GetProcedureAddress(_FileTimeToDosDateTime, kernel32,
...
begin
  GetProcedureAddress(_DosDateTimeToFileTime, kernel32,
...
function SetSystemTimeAdjustment;
begin
  GetProcedureAddress(_SetSystemTimeAdjustment, kernel32,
...
function GetSystemTimeAdjustment;
begin
  GetProcedureAddress(_GetSystemTimeAdjustment, kernel32,
...
function SetNamedPipeHandleState;
begin
  GetProcedureAddress(_SetNamedPipeHandleState, kernel32,
...
function FileEncryptionStatusA;
begin
  GetProcedureAddress(_FileEncryptionStatusA, advapi32,
...
function FileEncryptionStatusW;
begin
  GetProcedureAddress(_FileEncryptionStatusW, advapi32,
...
function FileEncryptionStatus;
begin
  GetProcedureAddress(_FileEncryptionStatus, advapi32, 'FileEncryptionStatus' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function OpenEncryptedFileRawA;
begin
  GetProcedureAddress(_OpenEncryptedFileRawA, advapi32,
...
function OpenEncryptedFileRawW;
begin
  GetProcedureAddress(_OpenEncryptedFileRawW, advapi32,
...
function OpenEncryptedFileRaw;
begin
  GetProcedureAddress(_OpenEncryptedFileRaw, advapi32, 'OpenEncryptedFileRaw' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function WriteEncryptedFileRaw;
begin
  GetProcedureAddress(_WriteEncryptedFileRaw, advapi32,
...
procedure CloseEncryptedFileRaw;
begin
  GetProcedureAddress(_CloseEncryptedFileRaw, advapi32,
...
function WaitForSingleObjectEx;
begin
  GetProcedureAddress(_WaitForSingleObjectEx, kernel32,
...
function WaitForMultipleObjectsEx;
begin
  GetProcedureAddress(_WaitForMultipleObjectsEx, kernel32,
...
function CreateWaitableTimer;
begin
  GetProcedureAddress(_CreateWaitableTimer, kernel32, 'CreateWaitableTimer' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function OpenWaitableTimer;
begin
  GetProcedureAddress(_OpenWaitableTimer, kernel32, 'OpenWaitableTimer' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function CreateFileMapping;
begin
  GetProcedureAddress(_CreateFileMapping, kernel32, 'CreateFileMapping' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetLogicalDriveStringsA;
begin
  GetProcedureAddress(_GetLogicalDriveStringsA, kernel32,
...
function GetLogicalDriveStringsW;
begin
  GetProcedureAddress(_GetLogicalDriveStringsW, kernel32,
...
function GetLogicalDriveStrings;
begin
  GetProcedureAddress(_GetLogicalDriveStrings, kernel32,
    'GetLogicalDriveStrings' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function CreateMemoryResourceNotification;
begin
  GetProcedureAddress(_CreateMemResNotification, kernel32,
...
function QueryMemoryResourceNotification;
begin
  GetProcedureAddress(_QueryMemoryResourceNotification, kernel32,
...
function GetModuleFileName;
begin
  GetProcedureAddress(_GetModuleFileName, kernel32, 'GetModuleFileName' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function InitializeProcThreadAttributeList;
begin
  GetProcedureAddress(_InitializePTAttrList, kernel32,
...
procedure DeleteProcThreadAttributeList;
begin
  GetProcedureAddress(_DeleteProcTAttrList, kernel32,
...
function GetModuleHandleEx;
begin
  GetProcedureAddress(_GetModuleHandleEx, kernel32, 'GetModuleHandleEx' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function NeedCurrentDirectoryForExePathA;
begin
  GetProcedureAddress(_NeedCurrentDirectoryForExePathA, kernel32,
...
function NeedCurrentDirectoryForExePathW;
begin
  GetProcedureAddress(_NeedCurrentDirectoryForExePathW, kernel32,
...
function NeedCurrentDirectoryForExePath;
begin
  GetProcedureAddress(_NeedCurrentDirectoryForExePath, kernel32,
    'NeedCurrentDirectoryForExePath' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function SetProcessShutdownParameters;
begin
  GetProcedureAddress(_SetProcessShutdownParameters, kernel32,
...
function GetProcessShutdownParameters;
begin
  GetProcedureAddress(_GetProcessShutdownParameters, kernel32,
...
function GetEnvironmentVariableA;
begin
  GetProcedureAddress(_GetEnvironmentVariableA, kernel32,
...
function GetEnvironmentVariableW;
begin
  GetProcedureAddress(_GetEnvironmentVariableW, kernel32,
...
function GetEnvironmentVariable;
begin
  GetProcedureAddress(_GetEnvironmentVariable, kernel32,
    'GetEnvironmentVariable' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
begin
  GetProcedureAddress(_SetEnvironmentVariableA, kernel32,
...
begin
  GetProcedureAddress(_SetEnvironmentVariableW, kernel32,
...
begin
  GetProcedureAddress(_SetEnvironmentVariable, kernel32,
    'SetEnvironmentVariable' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function ExpandEnvironmentStringsA;
begin
  GetProcedureAddress(_ExpandEnvironmentStringsA, kernel32,
...
function ExpandEnvironmentStringsW;
begin
  GetProcedureAddress(_ExpandEnvironmentStringsW, kernel32,
...
function ExpandEnvironmentStrings;
begin
  GetProcedureAddress(_ExpandEnvironmentStrings, kernel32,
    'ExpandEnvironmentStrings' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetFirmwareEnvironmentVariableA;
begin
  GetProcedureAddress(_GetFirmwareEnvironmentVariableA, kernel32,
...
function GetFirmwareEnvironmentVariableW;
begin
  GetProcedureAddress(_GetFirmwareEnvironmentVariableW, kernel32,
...
function GetFirmwareEnvironmentVariable;
begin
  GetProcedureAddress(_GetFirmwareEnvironmentVariable, kernel32,
...
function SetFirmwareEnvironmentVariableA;
begin
  GetProcedureAddress(_SetFirmwareEnvironmentVariableA, kernel32,
...
function SetFirmwareEnvironmentVariableW;
begin
  GetProcedureAddress(_SetFirmwareEnvironmentVariableW, kernel32,
...
function SetFirmwareEnvironmentVariable;
begin
  GetProcedureAddress(_SetFirmwareEnvironmentVariable, kernel32,
...
procedure OutputDebugString;
begin
  GetProcedureAddress(_OutputDebugString, kernel32, 'OutputDebugString' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function EnumResourceTypes;
begin
  GetProcedureAddress(_EnumResourceTypes, kernel32, 'EnumResourceTypes' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function EnumResourceNames;
begin
  GetProcedureAddress(_EnumResourceNames, kernel32, 'EnumResourceNames' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function EnumResourceLanguagesA;
begin
  GetProcedureAddress(_EnumResourceLanguagesA, kernel32,
...
function EnumResourceLanguagesW;
begin
  GetProcedureAddress(_EnumResourceLanguagesW, kernel32,
...
function EnumResourceLanguages;
begin
  GetProcedureAddress(_EnumResourceLanguages, kernel32, 'EnumResourceLanguages'
    + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function BeginUpdateResource;
begin
  GetProcedureAddress(_BeginUpdateResource, kernel32, 'BeginUpdateResource' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function EndUpdateResource;
begin
  GetProcedureAddress(_EndUpdateResource, kernel32, 'EndUpdateResource' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
begin
  GetProcedureAddress(_GlobalGetAtomName, kernel32, 'GlobalGetAtomName' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
begin
  GetProcedureAddress(_GetProfileString, kernel32,
    'GetProfileString' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
begin
  GetProcedureAddress(_WriteProfileString, kernel32, 'WriteProfileString' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetProfileSection;
begin
  GetProcedureAddress(_GetProfileSection, kernel32, 'GetProfileSection' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
begin
  GetProcedureAddress(_WriteProfileSection, kernel32, 'WriteProfileSection' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetPrivateProfileIntA;
begin
  GetProcedureAddress(_GetPrivateProfileIntA, kernel32,
...
function GetPrivateProfileIntW;
begin
  GetProcedureAddress(_GetPrivateProfileIntW, kernel32,
...
begin
  GetProcedureAddress(_GetPrivateProfileInt, kernel32, 'GetPrivateProfileInt' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetPrivateProfileStringA;
begin
  GetProcedureAddress(_GetPrivateProfileStringA, kernel32,
...
function GetPrivateProfileStringW;
begin
  GetProcedureAddress(_GetPrivateProfileStringW, kernel32,
...
function GetPrivateProfileString;
begin
  GetProcedureAddress(_GetPrivateProfileString, kernel32,
    'GetPrivateProfileString' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function WritePrivateProfileStringA;
begin
  GetProcedureAddress(_WritePrivateProfileStringA, kernel32,
...
function WritePrivateProfileStringW;
begin
  GetProcedureAddress(_WritePrivateProfileStringW, kernel32,
...
function WritePrivateProfileString;
begin
  GetProcedureAddress(_WritePrivateProfileString, kernel32,
    'WritePrivateProfileString' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetPrivateProfileSectionA;
begin
  GetProcedureAddress(_GetPrivateProfileSectionA, kernel32,
...
function GetPrivateProfileSectionW;
begin
  GetProcedureAddress(_GetPrivateProfileSectionW, kernel32,
...
function GetPrivateProfileSection;
begin
  GetProcedureAddress(_GetPrivateProfileSection, kernel32,
    'GetPrivateProfileSection' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function WritePrivateProfileSectionA;
begin
  GetProcedureAddress(_WritePrivateProfileSectionA, kernel32,
...
function WritePrivateProfileSectionW;
begin
  GetProcedureAddress(_WritePrivateProfileSectionW, kernel32,
...
function WritePrivateProfileSection;
begin
  GetProcedureAddress(_WritePrivateProfileSection, kernel32,
    'WritePrivateProfileSection' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetPrivateProfileSectionNamesA;
begin
  GetProcedureAddress(_GetPrivateProfileSectionNamesA, kernel32,
...
function GetPrivateProfileSectionNamesW;
begin
  GetProcedureAddress(_GetPrivateProfileSectionNamesW, kernel32,
...
function GetPrivateProfileSectionNames;
begin
  GetProcedureAddress(_GetPrivateProfileSectionNames, kernel32,
    'GetPrivateProfileSectionNames' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetPrivateProfileStructA;
begin
  GetProcedureAddress(_GetPrivateProfileStructA, kernel32,
...
function GetPrivateProfileStructW;
begin
  GetProcedureAddress(_GetPrivateProfileStructW, kernel32,
...
function GetPrivateProfileStruct;
begin
  GetProcedureAddress(_GetPrivateProfileStruct, kernel32,
    'GetPrivateProfileStruct' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function WritePrivateProfileStructA;
begin
  GetProcedureAddress(_WritePrivateProfileStructA, kernel32,
...
function WritePrivateProfileStructW;
begin
  GetProcedureAddress(_WritePrivateProfileStructW, kernel32,
...
function WritePrivateProfileStruct;
begin
  GetProcedureAddress(_WritePrivateProfileStruct, kernel32,
    'WritePrivateProfileStruct' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetWindowsDirectory;
begin
  GetProcedureAddress(_GetWindowsDirectory, kernel32, 'GetWindowsDirectory' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetSystemWindowsDirectoryA;
begin
  GetProcedureAddress(_GetSystemWindowsDirectoryA, kernel32,
...
function GetSystemWindowsDirectoryW;
begin
  GetProcedureAddress(_GetSystemWindowsDirectoryW, kernel32,
...
function GetSystemWindowsDirectory;
begin
  GetProcedureAddress(_GetSystemWindowsDirectory, kernel32,
    'GetSystemWindowsDirectory' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetSystemWow64DirectoryA;
begin
  GetProcedureAddress(_GetSystemWow64DirectoryA, kernel32,
    'GetSystemWow64DirectoryA');
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetSystemWow64DirectoryW;
begin
  GetProcedureAddress(_GetSystemWow64DirectoryW, kernel32,
    'GetSystemWow64DirectoryW');
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetSystemWow64Directory;
begin
  GetProcedureAddress(_GetSystemWow64Directory, kernel32,
    'GetSystemWow64Directory' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function Wow64EnableWow64FsRedirection;
begin
  GetProcedureAddress(_Wow64EnableWow64FsRedirection, kernel32,
...
function SetCurrentDirectory;
begin
  GetProcedureAddress(_SetCurrentDirectory, kernel32, 'SetCurrentDirectory' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetCurrentDirectory;
begin
  GetProcedureAddress(_GetCurrentDirectory, kernel32, 'GetCurrentDirectory' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetDiskFreeSpace;
begin
  GetProcedureAddress(_GetDiskFreeSpace, kernel32,
    'GetDiskFreeSpace' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetDiskFreeSpaceEx;
begin
  GetProcedureAddress(_GetDiskFreeSpaceEx, kernel32, 'GetDiskFreeSpaceEx' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function CreateDirectoryEx;
begin
  GetProcedureAddress(_CreateDirectoryEx, kernel32, 'CreateDirectoryEx' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function SetFileAttributes;
begin
  GetProcedureAddress(_SetFileAttributes, kernel32, 'SetFileAttributes' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetFileAttributes;
begin
  GetProcedureAddress(_GetFileAttributes, kernel32, 'GetFileAttributes' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetFileAttributesEx;
begin
  GetProcedureAddress(_GetFileAttributesEx, kernel32, 'GetFileAttributesEx' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetCompressedFileSizeA;
begin
  GetProcedureAddress(_GetCompressedFileSizeA, kernel32,
...
function GetCompressedFileSizeW;
begin
  GetProcedureAddress(_GetCompressedFileSizeW, kernel32,
...
function GetCompressedFileSize;
begin
  GetProcedureAddress(_GetCompressedFileSize, kernel32, 'GetCompressedFileSize'
    + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function MoveFileWithProgressA;
begin
  GetProcedureAddress(_MoveFileWithProgressA, kernel32,
...
function MoveFileWithProgressW;
begin
  GetProcedureAddress(_MoveFileWithProgressW, kernel32,
...
function MoveFileWithProgress;
begin
  GetProcedureAddress(_MoveFileWithProgress, kernel32, 'MoveFileWithProgress' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetNamedPipeHandleStateA;
begin
  GetProcedureAddress(_GetNamedPipeHandleStateA, kernel32,
...
function GetNamedPipeHandleStateW;
begin
  GetProcedureAddress(_GetNamedPipeHandleStateW, kernel32,
...
function GetNamedPipeHandleState;
begin
  GetProcedureAddress(_GetNamedPipeHandleState, kernel32,
    'GetNamedPipeHandleState' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetVolumeInformationA;
begin
  GetProcedureAddress(_GetVolumeInformationA, kernel32,
...
function GetVolumeInformationW;
begin
  GetProcedureAddress(_GetVolumeInformationW, kernel32,
...
function GetVolumeInformation;
begin
  GetProcedureAddress(_GetVolumeInformation, kernel32, 'GetVolumeInformation' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function DeregisterEventSource;
begin
  GetProcedureAddress(_DeregisterEventSource, advapi32,
...
function GetNumberOfEventLogRecords;
begin
  GetProcedureAddress(_GetNumberOfEventLogRecords, advapi32,
...
function GetOldestEventLogRecord;
begin
  GetProcedureAddress(_GetOldestEventLogRecord, advapi32,
...
function RegisterEventSource;
begin
  GetProcedureAddress(_RegisterEventSource, advapi32, 'RegisterEventSource' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function OpenBackupEventLog;
begin
  GetProcedureAddress(_OpenBackupEventLog, advapi32, 'OpenBackupEventLog' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetEventLogInformation;
begin
  GetProcedureAddress(_GetEventLogInformation, advapi32,
...
function GetKernelObjectSecurity;
begin
  GetProcedureAddress(_GetKernelObjectSecurity, advapi32,
...
function ImpersonateNamedPipeClient;
begin
  GetProcedureAddress(_ImpersonateNamedPipeClient, advapi32,
...
function AccessCheckByTypeResultList;
begin
  GetProcedureAddress(_AccessCheckByTypeResultList, advapi32,
...
function AdjustTokenPrivileges;
begin
  GetProcedureAddress(_AdjustTokenPrivileges, advapi32,
...
function AccessCheckAndAuditAlarmA;
begin
  GetProcedureAddress(_AccessCheckAndAuditAlarmA, advapi32,
...
function AccessCheckAndAuditAlarmW;
begin
  GetProcedureAddress(_AccessCheckAndAuditAlarmW, advapi32,
...
function AccessCheckAndAuditAlarm;
begin
  GetProcedureAddress(_AccessCheckAndAuditAlarm, advapi32,
    'AccessCheckAndAuditAlarm' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function AccessCheckByTypeAndAuditAlarmA;
begin
  GetProcedureAddress(_AccessCheckByTypeAndAuditAlarmA, advapi32,
...
function AccessCheckByTypeAndAuditAlarmW;
begin
  GetProcedureAddress(_AccessCheckByTypeAndAuditAlarmW, advapi32,
...
function AccessCheckByTypeAndAuditAlarm;
begin
  GetProcedureAddress(_AccessCheckByTypeAndAuditAlarm, advapi32,
    'AccessCheckByTypeAndAuditAlarm' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function AccessCheckByTypeResultListAndAuditAlarmA;
begin
  GetProcedureAddress(_AccessCheckByTypeResultListAndA, advapi32,
...
function AccessCheckByTypeResultListAndAuditAlarmW;
begin
  GetProcedureAddress(_AccessCheckByTypeResultListAndW, advapi32,
...
function AccessCheckByTypeResultListAndAuditAlarm;
begin
  GetProcedureAddress(_AccessCheckByTypeResultListAnd, advapi32,
    'AccessCheckByTypeResultListAndAuditAlarm' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function AccessCheckByTypeResultListAndAuditAlarmByHandleA;
begin
  GetProcedureAddress(_AccessCheckByTRLAndAAByHA, advapi32,
...
function AccessCheckByTypeResultListAndAuditAlarmByHandleW;
begin
  GetProcedureAddress(_AccessCheckByTRLAndAAByHW, advapi32,
...
function AccessCheckByTypeResultListAndAuditAlarmByHandle;
begin
  GetProcedureAddress(_AccessCheckByTRLAndAAByH, advapi32,
    'AccessCheckByTypeResultListAndAuditAlarmByHandle' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function ObjectOpenAuditAlarmA;
begin
  GetProcedureAddress(_ObjectOpenAuditAlarmA, advapi32,
...
function ObjectOpenAuditAlarmW;
begin
  GetProcedureAddress(_ObjectOpenAuditAlarmW, advapi32,
...
function ObjectOpenAuditAlarm;
begin
  GetProcedureAddress(_ObjectOpenAuditAlarm, advapi32, 'ObjectOpenAuditAlarm' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function ObjectPrivilegeAuditAlarmA;
begin
  GetProcedureAddress(_ObjectPrivilegeAuditAlarmA, advapi32,
...
function ObjectPrivilegeAuditAlarmW;
begin
  GetProcedureAddress(_ObjectPrivilegeAuditAlarmW, advapi32,
...
function ObjectPrivilegeAuditAlarm;
begin
  GetProcedureAddress(_ObjectPrivilegeAuditAlarm, advapi32,
    'ObjectPrivilegeAuditAlarm' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function ObjectCloseAuditAlarmA;
begin
  GetProcedureAddress(_ObjectCloseAuditAlarmA, advapi32,
...
function ObjectCloseAuditAlarmW;
begin
  GetProcedureAddress(_ObjectCloseAuditAlarmW, advapi32,
...
function ObjectCloseAuditAlarm;
begin
  GetProcedureAddress(_ObjectCloseAuditAlarm, advapi32, 'ObjectCloseAuditAlarm'
    + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function ObjectDeleteAuditAlarmA;
begin
  GetProcedureAddress(_ObjectDeleteAuditAlarmA, advapi32,
...
function ObjectDeleteAuditAlarmW;
begin
  GetProcedureAddress(_ObjectDeleteAuditAlarmW, advapi32,
...
function ObjectDeleteAuditAlarm;
begin
  GetProcedureAddress(_ObjectDeleteAuditAlarm, advapi32,
    'ObjectDeleteAuditAlarm' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function PrivilegedServiceAuditAlarmA;
begin
  GetProcedureAddress(_PrivilegedServiceAuditAlarmA, advapi32,
...
function PrivilegedServiceAuditAlarmW;
begin
  GetProcedureAddress(_PrivilegedServiceAuditAlarmW, advapi32,
...
function PrivilegedServiceAuditAlarm;
begin
  GetProcedureAddress(_PrivilegedServiceAuditAlarm, advapi32,
    'PrivilegedServiceAuditAlarm' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetWindowsAccountDomainSid;
begin
  GetProcedureAddress(_GetWindowsAccountDomainSid, advapi32,
...
function AllocateAndInitializeSid;
begin
  GetProcedureAddress(_AllocateAndInitializeSid, advapi32,
...
function GetSidIdentifierAuthority;
begin
  GetProcedureAddress(_GetSidIdentifierAuthority, advapi32,
...
function GetSidSubAuthorityCount;
begin
  GetProcedureAddress(_GetSidSubAuthorityCount, advapi32,
...
function AreAllAccessesGranted;
begin
  GetProcedureAddress(_AreAllAccessesGranted, advapi32,
...
function AreAnyAccessesGranted;
begin
  GetProcedureAddress(_AreAnyAccessesGranted, advapi32,
...
function AddAccessAllowedAceEx;
begin
  GetProcedureAddress(_AddAccessAllowedAceEx, advapi32,
...
function AddAccessAllowedObjectAce;
begin
  GetProcedureAddress(_AddAccessAllowedObjectAce, advapi32,
...
function AddAccessDeniedObjectAce;
begin
  GetProcedureAddress(_AddAccessDeniedObjectAce, advapi32,
...
function AddAuditAccessObjectAce;
begin
  GetProcedureAddress(_AddAuditAccessObjectAce, advapi32,
...
function InitializeSecurityDescriptor;
begin
  GetProcedureAddress(_InitializeSecurityDescriptor, advapi32,
...
function IsValidSecurityDescriptor;
begin
  GetProcedureAddress(_IsValidSecurityDescriptor, advapi32,
...
function GetSecurityDescriptorLength;
begin
  GetProcedureAddress(_GetSecurityDescriptorLength, advapi32,
...
function GetSecurityDescriptorControl;
begin
  GetProcedureAddress(_GetSecurityDescriptorControl, advapi32,
...
function SetSecurityDescriptorControl;
begin
  GetProcedureAddress(_SetSecurityDescriptorControl, advapi32,
...
function SetSecurityDescriptorDacl;
begin
  GetProcedureAddress(_SetSecurityDescriptorDacl, advapi32,
...
function GetSecurityDescriptorDacl;
begin
  GetProcedureAddress(_GetSecurityDescriptorDacl, advapi32,
...
function SetSecurityDescriptorSacl;
begin
  GetProcedureAddress(_SetSecurityDescriptorSacl, advapi32,
...
function GetSecurityDescriptorSacl;
begin
  GetProcedureAddress(_GetSecurityDescriptorSacl, advapi32,
...
function SetSecurityDescriptorOwner;
begin
  GetProcedureAddress(_SetSecurityDescriptorOwner, advapi32,
...
function GetSecurityDescriptorOwner;
begin
  GetProcedureAddress(_GetSecurityDescriptorOwner, advapi32,
...
function SetSecurityDescriptorGroup;
begin
  GetProcedureAddress(_SetSecurityDescriptorGroup, advapi32,
...
function GetSecurityDescriptorGroup;
begin
  GetProcedureAddress(_GetSecurityDescriptorGroup, advapi32,
...
function SetSecurityDescriptorRMControl;
begin
  GetProcedureAddress(_SetSecurityDescriptorRMControl, advapi32,
...
function GetSecurityDescriptorRMControl;
begin
  GetProcedureAddress(_GetSecurityDescriptorRMControl, advapi32,
...
function CreatePrivateObjectSecurity;
begin
  GetProcedureAddress(_CreatePrivateObjectSecurity, advapi32,
...
function ConvertToAutoInheritPrivateObjectSecurity;
begin
  GetProcedureAddress(_ConvertToAutoInheritPrObjSec, advapi32,
...
function CreatePrivateObjectSecurityEx;
begin
  GetProcedureAddress(_CreatePrivateObjectSecurityEx, advapi32,
...
function SetPrivateObjectSecurity;
begin
  GetProcedureAddress(_SetPrivateObjectSecurity, advapi32,
...
function SetPrivateObjectSecurityEx;
begin
  GetProcedureAddress(_SetPrivateObjectSecurityEx, advapi32,
...
function GetPrivateObjectSecurity;
begin
  GetProcedureAddress(_GetPrivateObjectSecurity, advapi32,
...
function DestroyPrivateObjectSecurity;
begin
  GetProcedureAddress(_DestroyPrivateObjectSecurity, advapi32,
...
function SetKernelObjectSecurity;
begin
  GetProcedureAddress(_SetKernelObjectSecurity, advapi32,
...
function FindFirstChangeNotificationA;
begin
  GetProcedureAddress(_FindFirstChangeNotificationA, kernel32,
...
function FindFirstChangeNotificationW;
begin
  GetProcedureAddress(_FindFirstChangeNotificationW, kernel32,
...
function FindFirstChangeNotification;
begin
  GetProcedureAddress(_FindFirstChangeNotification, kernel32,
    'FindFirstChangeNotification' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function FindNextChangeNotification;
begin
  GetProcedureAddress(_FindNextChangeNotification, kernel32,
...
function FindCloseChangeNotification;
begin
  GetProcedureAddress(_FindCloseChangeNotification, kernel32,
...
function ReadDirectoryChangesW;
begin
  GetProcedureAddress(_ReadDirectoryChangesW, kernel32,
...
function LookupAccountSid;
begin
  GetProcedureAddress(_LookupAccountSid, advapi32,
    'LookupAccountSid' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function LookupAccountName;
begin
  GetProcedureAddress(_LookupAccountName, advapi32, 'LookupAccountName' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function LookupPrivilegeValueA;
begin
  GetProcedureAddress(_LookupPrivilegeValueA, advapi32,
...
function LookupPrivilegeValueW;
begin
  GetProcedureAddress(_LookupPrivilegeValueW, advapi32,
...
function LookupPrivilegeValue;
begin
  GetProcedureAddress(_LookupPrivilegeValue, advapi32, 'LookupPrivilegeValue' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function LookupPrivilegeName;
begin
  GetProcedureAddress(_LookupPrivilegeName, advapi32, 'LookupPrivilegeName' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function LookupPrivilegeDisplayNameA;
begin
  GetProcedureAddress(_LookupPrivilegeDisplayNameA, advapi32,
...
function LookupPrivilegeDisplayNameW;
begin
  GetProcedureAddress(_LookupPrivilegeDisplayNameW, advapi32,
...
function LookupPrivilegeDisplayName;
begin
  GetProcedureAddress(_LookupPrivilegeDisplayName, advapi32,
    'LookupPrivilegeDisplayName' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function AllocateLocallyUniqueId;
begin
  GetProcedureAddress(_AllocateLocallyUniqueId, advapi32,
...
function BuildCommDCBAndTimeoutsA;
begin
  GetProcedureAddress(_BuildCommDCBAndTimeoutsA, kernel32,
...
function BuildCommDCBAndTimeoutsW;
begin
  GetProcedureAddress(_BuildCommDCBAndTimeoutsW, kernel32,
...
function BuildCommDCBAndTimeouts;
begin
  GetProcedureAddress(_BuildCommDCBAndTimeouts, kernel32,
    'BuildCommDCBAndTimeouts' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetDefaultCommConfigA;
begin
  GetProcedureAddress(_GetDefaultCommConfigA, kernel32,
...
function GetDefaultCommConfigW;
begin
  GetProcedureAddress(_GetDefaultCommConfigW, kernel32,
...
function GetDefaultCommConfig;
begin
  GetProcedureAddress(_GetDefaultCommConfig, kernel32, 'GetDefaultCommConfig' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function SetDefaultCommConfigA;
begin
  GetProcedureAddress(_SetDefaultCommConfigA, kernel32,
...
function SetDefaultCommConfigW;
begin
  GetProcedureAddress(_SetDefaultCommConfigW, kernel32,
...
function SetDefaultCommConfig;
begin
  GetProcedureAddress(_SetDefaultCommConfig, kernel32, 'SetDefaultCommConfig' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetComputerNameEx;
begin
  GetProcedureAddress(_GetComputerNameEx, kernel32, 'GetComputerNameEx' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function SetComputerNameEx;
begin
  GetProcedureAddress(_SetComputerNameEx, kernel32, 'SetComputerNameEx' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function DnsHostnameToComputerNameA;
begin
  GetProcedureAddress(_DnsHostnameToComputerNameA, kernel32,
...
function DnsHostnameToComputerNameW;
begin
  GetProcedureAddress(_DnsHostnameToComputerNameW, kernel32,
...
function DnsHostnameToComputerName;
begin
  GetProcedureAddress(_DnsHostnameToComputerName, kernel32,
    'DnsHostnameToComputerName' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function ImpersonateLoggedOnUser;
begin
  GetProcedureAddress(_ImpersonateLoggedOnUser, advapi32,
...
function CreateProcessAsUser;
begin
  GetProcedureAddress(_CreateProcessAsUser, advapi32, 'CreateProcessAsUser' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function CreateProcessWithLogonW;
begin
  GetProcedureAddress(_CreateProcessWithLogonW, advapi32,
...
function CreateProcessWithTokenW;
begin
  GetProcedureAddress(_CreateProcessWithTokenW, advapi32,
...
function ImpersonateAnonymousToken;
begin
  GetProcedureAddress(_ImpersonateAnonymousToken, advapi32,
...
function CreateRestrictedToken;
begin
  GetProcedureAddress(_CreateRestrictedToken, advapi32,
...
function RegisterWaitForSingleObject;
begin
  GetProcedureAddress(_RegisterWaitForSingleObject, kernel32,
...
function RegisterWaitForSingleObjectEx;
begin
  GetProcedureAddress(_RegisterWaitForSingleObjectEx, kernel32,
...
function BindIoCompletionCallback;
begin
  GetProcedureAddress(_BindIoCompletionCallback, kernel32,
...
function CreateTimerQueueTimer;
begin
  GetProcedureAddress(_CreateTimerQueueTimer, kernel32,
...
function ChangeTimerQueueTimer;
begin
  GetProcedureAddress(_ChangeTimerQueueTimer, kernel32,
...
function DeleteTimerQueueTimer;
begin
  GetProcedureAddress(_DeleteTimerQueueTimer, kernel32,
...
function CancelTimerQueueTimer;
begin
  GetProcedureAddress(_CancelTimerQueueTimer, kernel32,
...
function GetCurrentHwProfile;
begin
  GetProcedureAddress(_GetCurrentHwProfile, advapi32, 'GetCurrentHwProfile' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function QueryPerformanceCounter;
begin
  GetProcedureAddress(_QueryPerformanceCounter, kernel32,
...
function QueryPerformanceFrequency;
begin
  GetProcedureAddress(_QueryPerformanceFrequency, kernel32,
...
function VerifyVersionInfo;
begin
  GetProcedureAddress(_VerifyVersionInfo, kernel32, 'VerifyVersionInfo' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function AllocateUserPhysicalPages;
begin
  GetProcedureAddress(_AllocateUserPhysicalPages, kernel32,
...
function FreeUserPhysicalPages;
begin
  GetProcedureAddress(_FreeUserPhysicalPages, kernel32,
...
function MapUserPhysicalPagesScatter;
begin
  GetProcedureAddress(_MapUserPhysicalPagesScatter, kernel32,
...
begin
  GetProcedureAddress(_AssignProcessToJobObject, kernel32,
...
function QueryInformationJobObject;
begin
  GetProcedureAddress(_QueryInformationJobObject, kernel32,
...
function SetInformationJobObject;
begin
  GetProcedureAddress(_SetInformationJobObject, kernel32,
...
function AddVectoredExceptionHandler;
begin
  GetProcedureAddress(_AddVectoredExceptionHandler, kernel32,
...
function RemoveVectoredExceptionHandler;
begin
  GetProcedureAddress(_RemoveVectoredExceptionHandler, kernel32,
...
function FindFirstVolumeMountPointA;
begin
  GetProcedureAddress(_FindFirstVolumeMountPointA, kernel32,
...
function FindFirstVolumeMountPointW;
begin
  GetProcedureAddress(_FindFirstVolumeMountPointW, kernel32,
...
function FindFirstVolumeMountPoint;
begin
  GetProcedureAddress(_FindFirstVolumeMountPoint, kernel32,
    'FindFirstVolumeMountPoint' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function FindNextVolumeMountPointA;
begin
  GetProcedureAddress(_FindNextVolumeMountPointA, kernel32,
...
function FindNextVolumeMountPointW;
begin
  GetProcedureAddress(_FindNextVolumeMountPointW, kernel32,
...
function FindNextVolumeMountPoint;
begin
  GetProcedureAddress(_FindNextVolumeMountPoint, kernel32,
    'FindNextVolumeMountPoint' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function FindVolumeMountPointClose;
begin
  GetProcedureAddress(_FindVolumeMountPointClose, kernel32,
...
function SetVolumeMountPoint;
begin
  GetProcedureAddress(_SetVolumeMountPoint, kernel32, 'SetVolumeMountPoint' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function DeleteVolumeMountPointA;
begin
  GetProcedureAddress(_DeleteVolumeMountPointA, kernel32,
...
function DeleteVolumeMountPointW;
begin
  GetProcedureAddress(_DeleteVolumeMountPointW, kernel32,
...
function DeleteVolumeMountPoint;
begin
  GetProcedureAddress(_DeleteVolumeMountPoint, kernel32,
...
function GetVolumeNameForVolumeMountPointA;
begin
  GetProcedureAddress(_GetVolumeNameForVolMountPointA, kernel32,
...
function GetVolumeNameForVolumeMountPointW;
begin
  GetProcedureAddress(_GetVolumeNameForVolMountPointW, kernel32,
...
function GetVolumeNameForVolumeMountPoint;
begin
  GetProcedureAddress(_GetVolumeNameForVolMountPoint, kernel32,
...
function GetVolumePathName;
begin
  GetProcedureAddress(_GetVolumePathName, kernel32, 'GetVolumePathName' +
    AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetVolumePathNamesForVolumeNameA;
begin
  GetProcedureAddress(_GetVolumePathNamesForVolNameA, kernel32,
...
function GetVolumePathNamesForVolumeNameW;
begin
  GetProcedureAddress(_GetVolumePathNamesForVolNameW, kernel32,
...
function GetVolumePathNamesForVolumeName;
begin
  GetProcedureAddress(_GetVolumePathNamesForVolName, kernel32,
    'GetVolumePathNamesForVolumeName' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function FindActCtxSectionStringA;
begin
  GetProcedureAddress(_FindActCtxSectionStringA, kernel32,
...
function FindActCtxSectionStringW;
begin
  GetProcedureAddress(_FindActCtxSectionStringW, kernel32,
...
function FindActCtxSectionString;
begin
  GetProcedureAddress(_FindActCtxSectionString, kernel32,
    'FindActCtxSectionString' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function FindActCtxSectionGuid;
begin
  GetProcedureAddress(_FindActCtxSectionGuid, kernel32,
...
function WTSGetActiveConsoleSessionId;
begin
  GetProcedureAddress(_WTSGetActiveConsoleSessionId, kernel32,
...
function GetLogicalProcessorInformation;
begin
  GetProcedureAddress(_GetLogicalProcessorInformation, kernel32,
...
function GetNumaHighestNodeNumber;
begin
  GetProcedureAddress(_GetNumaHighestNodeNumber, kernel32,
...
function GetNumaNodeProcessorMask;
begin
  GetProcedureAddress(_GetNumaNodeProcessorMask, kernel32,
...
function GetNumaAvailableMemoryNode;
begin
  GetProcedureAddress(_GetNumaAvailableMemoryNode, kernel32,
...
function GetNamedPipeServerSessionId;
begin
  GetProcedureAddress(_GetNamedPipeSrvSId, kernel32,
...
function GetNamedPipeServerProcessId;
begin
  GetProcedureAddress(_GetNamedPipeSrvProcId, kernel32,
...
function GetNamedPipeClientProcessId;
begin
  GetProcedureAddress(_GetNamedPipeClProcId, kernel32,
...
function GetNamedPipeClientSessionId;
begin
  GetProcedureAddress(_GetNamedPipeClSId, kernel32,
...
function GetNamedPipeClientComputerName;
begin
  GetProcedureAddress(_GetNamedPipeClCompName, kernel32,
    'GetNamedPipeClientComputerName' + AWSuffix);
  asm
    MOV     ESP, EBP
    POP     EBP
...
function GetNamedPipeClientComputerNameA;
begin
  GetProcedureAddress(_GetNamedPipeClCompNameA, kernel32,
...
function GetNamedPipeClientComputerNameW;
begin
  GetProcedureAddress(_GetNamedPipeClCompNameW, kernel32,
...
function InterlockedExchangeAdd;
  external kernel32 name 'InterlockedExchangeAdd';
function InterlockedCompareExchange;
...
function InterlockedPopEntrySList;
  external kernel32 name 'InterlockedPopEntrySList';
function InterlockedPushEntrySList;
  external kernel32 name 'InterlockedPushEntrySList';
...
procedure FreeLibraryAndExitThread;
  external kernel32 name 'FreeLibraryAndExitThread';
function DisableThreadLibraryCalls;
  external kernel32 name 'DisableThreadLibraryCalls';
...
function GetProcessAffinityMask;
  external kernel32 name 'GetProcessAffinityMask';
function SetProcessAffinityMask;
  external kernel32 name 'SetProcessAffinityMask';
...
function GetProcessWorkingSetSizeEx;
  external kernel32 name 'GetProcessWorkingSetSizeEx';
function SetProcessWorkingSetSize;
  external kernel32 name 'SetProcessWorkingSetSize';
function SetProcessWorkingSetSizeEx;
  external kernel32 name 'SetProcessWorkingSetSizeEx';
...
{$IFDEF WIN2003_UP}
function SetEnvironmentStringsA;
  external kernel32 name 'SetEnvironmentStringsA';
function SetEnvironmentStringsW;
  external kernel32 name 'SetEnvironmentStringsW';
function SetEnvironmentStrings; external kernel32 name 'SetEnvironmentStrings'
  + AWSuffix;
{$ENDIF WIN2003_UP}
function FreeEnvironmentStringsA;
  external kernel32 name 'FreeEnvironmentStringsA';
function FreeEnvironmentStringsW;
  external kernel32 name 'FreeEnvironmentStringsW';
function FreeEnvironmentStrings; external kernel32 name 'FreeEnvironmentStrings'
  + AWSuffix;
...
function ConvertThreadToFiberEx;
  external kernel32 name 'ConvertThreadToFiberEx';
...
function GetCurrentProcessorNumber;
  external kernel32 name 'GetCurrentProcessorNumber';
function SetThreadAffinityMask; external kernel32 name 'SetThreadAffinityMask';
function SetThreadIdealProcessor;
  external kernel32 name 'SetThreadIdealProcessor';
function SetProcessPriorityBoost;
  external kernel32 name 'SetProcessPriorityBoost';
function GetProcessPriorityBoost;
  external kernel32 name 'GetProcessPriorityBoost';
function RequestWakeupLatency; external kernel32 name 'RequestWakeupLatency';
function IsSystemResumeAutomatic;
  external kernel32 name 'IsSystemResumeAutomatic';
function OpenThread; external kernel32 name 'OpenThread';
function SetThreadPriority; external kernel32 name 'SetThreadPriority';
function SetThreadPriorityBoost;
  external kernel32 name 'SetThreadPriorityBoost';
function GetThreadPriorityBoost;
...
function GetThreadIOPendingFlag;
  external kernel32 name 'GetThreadIOPendingFlag';
...
function GetThreadSelectorEntry;
  external kernel32 name 'GetThreadSelectorEntry';
function SetThreadExecutionState;
...
function InitializeCriticalSectionAndSpinCount;
  external kernel32 name 'InitializeCriticalSectionAndSpinCount';
function SetCriticalSectionSpinCount;
  external kernel32 name 'SetCriticalSectionSpinCount';
function TryEnterCriticalSection;
  external kernel32 name 'TryEnterCriticalSection';
...
function GetFileInformationByHandle;
  external kernel32 name 'GetFileInformationByHandle';
...
function CancelDeviceWakeupRequest;
  external kernel32 name 'CancelDeviceWakeupRequest';
...
function GetSystemRegistryQuota;
  external kernel32 name 'GetSystemRegistryQuota';
...
function GetTimeZoneInformation;
  external kernel32 name 'GetTimeZoneInformation';
function SetTimeZoneInformation;
  external kernel32 name 'SetTimeZoneInformation';
...
function SetSystemTimeAdjustment;
  external kernel32 name 'SetSystemTimeAdjustment';
function GetSystemTimeAdjustment;
  external kernel32 name 'GetSystemTimeAdjustment';
...
function SetNamedPipeHandleState;
  external kernel32 name 'SetNamedPipeHandleState';
...
function FileEncryptionStatus; external advapi32 name 'FileEncryptionStatus'
  + AWSuffix;
...
function OpenEncryptedFileRaw; external advapi32 name 'OpenEncryptedFileRaw'
  + AWSuffix;
...
function WaitForMultipleObjectsEx;
  external kernel32 name 'WaitForMultipleObjectsEx';
...
function CreateWaitableTimer; external kernel32 name 'CreateWaitableTimer'
  + AWSuffix;
...
function OpenWaitableTimer; external kernel32 name 'OpenWaitableTimer'
  + AWSuffix;
...
function CreateFileMapping; external kernel32 name 'CreateFileMapping'
  + AWSuffix;
...
function GetLogicalDriveStringsA;
  external kernel32 name 'GetLogicalDriveStringsA';
function GetLogicalDriveStringsW;
  external kernel32 name 'GetLogicalDriveStringsW';
function GetLogicalDriveStrings; external kernel32 name 'GetLogicalDriveStrings'
  + AWSuffix;
function CreateMemoryResourceNotification;
  external kernel32 name 'CreateMemoryResourceNotification';
function QueryMemoryResourceNotification;
  external kernel32 name 'QueryMemoryResourceNotification';
...
function GetModuleFileName; external kernel32 name 'GetModuleFileName'
  + AWSuffix;
...
function GetModuleHandleEx; external kernel32 name 'GetModuleHandleEx'
  + AWSuffix;
function NeedCurrentDirectoryForExePathA;
  external kernel32 name 'NeedCurrentDirectoryForExePathA';
function NeedCurrentDirectoryForExePathW;
  external kernel32 name 'NeedCurrentDirectoryForExePathW';
function NeedCurrentDirectoryForExePath;
  external kernel32 name 'NeedCurrentDirectoryForExePath' + AWSuffix;
function SetProcessShutdownParameters;
  external kernel32 name 'SetProcessShutdownParameters';
function GetProcessShutdownParameters;
  external kernel32 name 'GetProcessShutdownParameters';
...
function GetEnvironmentVariableW;
  external kernel32 name 'GetEnvironmentVariableW';
function GetEnvironmentVariable; external kernel32 name 'GetEnvironmentVariable'
  + AWSuffix;
function SetEnvironmentVariableA;
  external kernel32 name 'SetEnvironmentVariableA';
function SetEnvironmentVariableW;
  external kernel32 name 'SetEnvironmentVariableW';
function SetEnvironmentVariable; external kernel32 name 'SetEnvironmentVariable'
  + AWSuffix;
function ExpandEnvironmentStringsA;
  external kernel32 name 'ExpandEnvironmentStringsA';
function ExpandEnvironmentStringsW;
  external kernel32 name 'ExpandEnvironmentStringsW';
function ExpandEnvironmentStrings;
  external kernel32 name 'ExpandEnvironmentStrings' + AWSuffix;
function GetFirmwareEnvironmentVariableA;
  external kernel32 name 'GetFirmwareEnvironmentVariableA';
function GetFirmwareEnvironmentVariableW;
  external kernel32 name 'GetFirmwareEnvironmentVariableW';
function GetFirmwareEnvironmentVariable;
  external kernel32 name 'GetFirmwareEnvironmentVariable' + AWSuffix;
function SetFirmwareEnvironmentVariableA;
  external kernel32 name 'SetFirmwareEnvironmentVariableA';
function SetFirmwareEnvironmentVariableW;
  external kernel32 name 'SetFirmwareEnvironmentVariableW';
function SetFirmwareEnvironmentVariable;
  external kernel32 name 'SetFirmwareEnvironmentVariable' + AWSuffix;
...
procedure OutputDebugString; external kernel32 name 'OutputDebugString'
  + AWSuffix;
...
function EnumResourceTypes; external kernel32 name 'EnumResourceTypes'
  + AWSuffix;
...
function EnumResourceNames; external kernel32 name 'EnumResourceNames'
  + AWSuffix;
function EnumResourceLanguagesA;
  external kernel32 name 'EnumResourceLanguagesA';
function EnumResourceLanguagesW;
  external kernel32 name 'EnumResourceLanguagesW';
function EnumResourceLanguages; external kernel32 name 'EnumResourceLanguages'
  + AWSuffix;
...
function BeginUpdateResource; external kernel32 name 'BeginUpdateResource'
  + AWSuffix;
...
function EndUpdateResource; external kernel32 name 'EndUpdateResource'
  + AWSuffix;
...
function GlobalGetAtomName; external kernel32 name 'GlobalGetAtomName'
  + AWSuffix;
...
function WriteProfileString; external kernel32 name 'WriteProfileString'
  + AWSuffix;
...
function GetProfileSection; external kernel32 name 'GetProfileSection'
  + AWSuffix;
...
function WriteProfileSection; external kernel32 name 'WriteProfileSection'
  + AWSuffix;
...
function GetPrivateProfileInt; external kernel32 name 'GetPrivateProfileInt'
  + AWSuffix;
function GetPrivateProfileStringA;
  external kernel32 name 'GetPrivateProfileStringA';
function GetPrivateProfileStringW;
  external kernel32 name 'GetPrivateProfileStringW';
function GetPrivateProfileString;
  external kernel32 name 'GetPrivateProfileString' + AWSuffix;
function WritePrivateProfileStringA;
  external kernel32 name 'WritePrivateProfileStringA';
function WritePrivateProfileStringW;
  external kernel32 name 'WritePrivateProfileStringW';
function WritePrivateProfileString;
  external kernel32 name 'WritePrivateProfileString' + AWSuffix;
function GetPrivateProfileSectionA;
  external kernel32 name 'GetPrivateProfileSectionA';
function GetPrivateProfileSectionW;
  external kernel32 name 'GetPrivateProfileSectionW';
function GetPrivateProfileSection;
  external kernel32 name 'GetPrivateProfileSection' + AWSuffix;
function WritePrivateProfileSectionA;
  external kernel32 name 'WritePrivateProfileSectionA';
function WritePrivateProfileSectionW;
  external kernel32 name 'WritePrivateProfileSectionW';
function WritePrivateProfileSection;
  external kernel32 name 'WritePrivateProfileSection' + AWSuffix;
function GetPrivateProfileSectionNamesA;
  external kernel32 name 'GetPrivateProfileSectionNamesA';
function GetPrivateProfileSectionNamesW;
  external kernel32 name 'GetPrivateProfileSectionNamesW';
function GetPrivateProfileSectionNames;
  external kernel32 name 'GetPrivateProfileSectionNames' + AWSuffix;
function GetPrivateProfileStructA;
  external kernel32 name 'GetPrivateProfileStructA';
function GetPrivateProfileStructW;
  external kernel32 name 'GetPrivateProfileStructW';
function GetPrivateProfileStruct;
  external kernel32 name 'GetPrivateProfileStruct' + AWSuffix;
function WritePrivateProfileStructA;
  external kernel32 name 'WritePrivateProfileStructA';
function WritePrivateProfileStructW;
  external kernel32 name 'WritePrivateProfileStructW';
function WritePrivateProfileStruct;
  external kernel32 name 'WritePrivateProfileStruct' + AWSuffix;
...
function GetSystemDirectory; external kernel32 name 'GetSystemDirectory'
  + AWSuffix;
...
function GetWindowsDirectory; external kernel32 name 'GetWindowsDirectory'
  + AWSuffix;
function GetSystemWindowsDirectoryA;
  external kernel32 name 'GetSystemWindowsDirectoryA';
function GetSystemWindowsDirectoryW;
  external kernel32 name 'GetSystemWindowsDirectoryW';
function GetSystemWindowsDirectory;
  external kernel32 name 'GetSystemWindowsDirectory' + AWSuffix;
function GetSystemWow64DirectoryA;
  external kernel32 name 'GetSystemWow64DirectoryA';
function GetSystemWow64DirectoryW;
  external kernel32 name 'GetSystemWow64DirectoryW';
function GetSystemWow64Directory;
  external kernel32 name 'GetSystemWow64Directory' + AWSuffix;
function Wow64EnableWow64FsRedirection;
  external kernel32 name 'Wow64EnableWow64FsRedirection';
...
function GetCurrentDirectory; external kernel32 name 'GetCurrentDirectory'
  + AWSuffix;
...
function GetDiskFreeSpaceEx; external kernel32 name 'GetDiskFreeSpaceEx'
  + AWSuffix;
...
function CreateDirectoryEx; external kernel32 name 'CreateDirectoryEx'
  + AWSuffix;
...
function SetFileAttributes; external kernel32 name 'SetFileAttributes'
  + AWSuffix;
...
function GetFileAttributes; external kernel32 name 'GetFileAttributes'
  + AWSuffix;
...
function GetFileAttributesEx; external kernel32 name 'GetFileAttributesEx'
  + AWSuffix;
function GetCompressedFileSizeA;
  external kernel32 name 'GetCompressedFileSizeA';
function GetCompressedFileSizeW;
  external kernel32 name 'GetCompressedFileSizeW';
function GetCompressedFileSize; external kernel32 name 'GetCompressedFileSize'
  + AWSuffix;
...
function MoveFileWithProgress; external kernel32 name 'MoveFileWithProgress'
  + AWSuffix;
...
function GetNamedPipeHandleState;
  external kernel32 name 'GetNamedPipeHandleState' + AWSuffix;
...
function GetVolumeInformation; external kernel32 name 'GetVolumeInformation'
  + AWSuffix;
...
function GetNumberOfEventLogRecords;
  external advapi32 name 'GetNumberOfEventLogRecords';
function GetOldestEventLogRecord;
  external advapi32 name 'GetOldestEventLogRecord';
...
function RegisterEventSource; external advapi32 name 'RegisterEventSource'
  + AWSuffix;
...
function OpenBackupEventLog; external advapi32 name 'OpenBackupEventLog'
  + AWSuffix;
...
function GetEventLogInformation;
  external advapi32 name 'GetEventLogInformation';
function DuplicateToken; external advapi32 name 'DuplicateToken';
function GetKernelObjectSecurity;
  external advapi32 name 'GetKernelObjectSecurity';
function ImpersonateNamedPipeClient;
  external advapi32 name 'ImpersonateNamedPipeClient';
...
function AccessCheckByTypeResultList;
  external advapi32 name 'AccessCheckByTypeResultList';
...
function AccessCheckAndAuditAlarmW;
  external advapi32 name 'AccessCheckAndAuditAlarmW';
function AccessCheckAndAuditAlarm;
  external advapi32 name 'AccessCheckAndAuditAlarm' + AWSuffix;
function AccessCheckByTypeAndAuditAlarmA;
...
function AccessCheckByTypeResultListAndAuditAlarm;
  external advapi32 name 'AccessCheckByTypeResultListAndAuditAlarm' + AWSuffix;
function AccessCheckByTypeResultListAndAuditAlarmByHandleA;
  external advapi32 name 'AccessCheckByTypeResultListAndAuditAlarmByHandleA';
function AccessCheckByTypeResultListAndAuditAlarmByHandleW;
  external advapi32 name 'AccessCheckByTypeResultListAndAuditAlarmByHandleW';
function AccessCheckByTypeResultListAndAuditAlarmByHandle;
...
function ObjectOpenAuditAlarm; external advapi32 name 'ObjectOpenAuditAlarm'
  + AWSuffix;
function ObjectPrivilegeAuditAlarmA;
  external advapi32 name 'ObjectPrivilegeAuditAlarmA';
function ObjectPrivilegeAuditAlarmW;
  external advapi32 name 'ObjectPrivilegeAuditAlarmW';
function ObjectPrivilegeAuditAlarm;
  external advapi32 name 'ObjectPrivilegeAuditAlarm' + AWSuffix;
function ObjectCloseAuditAlarmA;
  external advapi32 name 'ObjectCloseAuditAlarmA';
function ObjectCloseAuditAlarmW;
  external advapi32 name 'ObjectCloseAuditAlarmW';
function ObjectCloseAuditAlarm; external advapi32 name 'ObjectCloseAuditAlarm'
  + AWSuffix;
function ObjectDeleteAuditAlarmA;
  external advapi32 name 'ObjectDeleteAuditAlarmA';
function ObjectDeleteAuditAlarmW;
  external advapi32 name 'ObjectDeleteAuditAlarmW';
function ObjectDeleteAuditAlarm; external advapi32 name 'ObjectDeleteAuditAlarm'
  + AWSuffix;
function PrivilegedServiceAuditAlarmA;
  external advapi32 name 'PrivilegedServiceAuditAlarmA';
function PrivilegedServiceAuditAlarmW;
  external advapi32 name 'PrivilegedServiceAuditAlarmW';
function PrivilegedServiceAuditAlarm;
  external advapi32 name 'PrivilegedServiceAuditAlarm' + AWSuffix;
...
function GetWindowsAccountDomainSid;
  external advapi32 name 'GetWindowsAccountDomainSid';
...
function GetSidIdentifierAuthority;
  external advapi32 name 'GetSidIdentifierAuthority';
function GetSidSubAuthority; external advapi32 name 'GetSidSubAuthority';
function GetSidSubAuthorityCount;
  external advapi32 name 'GetSidSubAuthorityCount';
...
function AddAccessAllowedObjectAce;
  external advapi32 name 'AddAccessAllowedObjectAce';
function AddAccessDeniedObjectAce;
  external advapi32 name 'AddAccessDeniedObjectAce';
function AddAuditAccessObjectAce;
  external advapi32 name 'AddAuditAccessObjectAce';
function FindFirstFreeAce; external advapi32 name 'FindFirstFreeAce';
function InitializeSecurityDescriptor;
  external advapi32 name 'InitializeSecurityDescriptor';
function IsValidSecurityDescriptor;
  external advapi32 name 'IsValidSecurityDescriptor';
function GetSecurityDescriptorLength;
  external advapi32 name 'GetSecurityDescriptorLength';
function GetSecurityDescriptorControl;
  external advapi32 name 'GetSecurityDescriptorControl';
function SetSecurityDescriptorControl;
  external advapi32 name 'SetSecurityDescriptorControl';
function SetSecurityDescriptorDacl;
  external advapi32 name 'SetSecurityDescriptorDacl';
function GetSecurityDescriptorDacl;
  external advapi32 name 'GetSecurityDescriptorDacl';
function SetSecurityDescriptorSacl;
  external advapi32 name 'SetSecurityDescriptorSacl';
function GetSecurityDescriptorSacl;
  external advapi32 name 'GetSecurityDescriptorSacl';
function SetSecurityDescriptorOwner;
  external advapi32 name 'SetSecurityDescriptorOwner';
function GetSecurityDescriptorOwner;
  external advapi32 name 'GetSecurityDescriptorOwner';
function SetSecurityDescriptorGroup;
  external advapi32 name 'SetSecurityDescriptorGroup';
function GetSecurityDescriptorGroup;
  external advapi32 name 'GetSecurityDescriptorGroup';
function SetSecurityDescriptorRMControl;
  external advapi32 name 'SetSecurityDescriptorRMControl';
function GetSecurityDescriptorRMControl;
  external advapi32 name 'GetSecurityDescriptorRMControl';
function CreatePrivateObjectSecurity;
  external advapi32 name 'CreatePrivateObjectSecurity';
function ConvertToAutoInheritPrivateObjectSecurity;
  external advapi32 name 'ConvertToAutoInheritPrivateObjectSecurity';
function CreatePrivateObjectSecurityEx;
  external advapi32 name 'CreatePrivateObjectSecurityEx';
function SetPrivateObjectSecurity;
  external advapi32 name 'SetPrivateObjectSecurity';
function SetPrivateObjectSecurityEx;
  external advapi32 name 'SetPrivateObjectSecurityEx';
function GetPrivateObjectSecurity;
  external advapi32 name 'GetPrivateObjectSecurity';
function DestroyPrivateObjectSecurity;
  external advapi32 name 'DestroyPrivateObjectSecurity';
...
function SetKernelObjectSecurity;
  external advapi32 name 'SetKernelObjectSecurity';
function FindFirstChangeNotificationA;
  external kernel32 name 'FindFirstChangeNotificationA';
function FindFirstChangeNotificationW;
  external kernel32 name 'FindFirstChangeNotificationW';
function FindFirstChangeNotification;
  external kernel32 name 'FindFirstChangeNotification' + AWSuffix;
function FindNextChangeNotification;
...
function LookupAccountName; external advapi32 name 'LookupAccountName'
  + AWSuffix;
...
function LookupPrivilegeValue; external advapi32 name 'LookupPrivilegeValue'
  + AWSuffix;
...
function LookupPrivilegeName; external advapi32 name 'LookupPrivilegeName'
  + AWSuffix;
function LookupPrivilegeDisplayNameA;
  external advapi32 name 'LookupPrivilegeDisplayNameA';
function LookupPrivilegeDisplayNameW;
  external advapi32 name 'LookupPrivilegeDisplayNameW';
function LookupPrivilegeDisplayName;
  external advapi32 name 'LookupPrivilegeDisplayName' + AWSuffix;
function AllocateLocallyUniqueId;
  external advapi32 name 'AllocateLocallyUniqueId';
...
function BuildCommDCBAndTimeoutsA;
  external kernel32 name 'BuildCommDCBAndTimeoutsA';
function BuildCommDCBAndTimeoutsW;
  external kernel32 name 'BuildCommDCBAndTimeoutsW';
function BuildCommDCBAndTimeouts;
  external kernel32 name 'BuildCommDCBAndTimeouts' + AWSuffix;
...
function GetDefaultCommConfig; external kernel32 name 'GetDefaultCommConfig'
  + AWSuffix;
...
function SetDefaultCommConfig; external kernel32 name 'SetDefaultCommConfig'
  + AWSuffix;
...
function SetComputerNameEx; external kernel32 name 'SetComputerNameEx'
  + AWSuffix;
function DnsHostnameToComputerNameA;
  external kernel32 name 'DnsHostnameToComputerNameA';
function DnsHostnameToComputerNameW;
  external kernel32 name 'DnsHostnameToComputerNameW';
function DnsHostnameToComputerName;
  external kernel32 name 'DnsHostnameToComputerName' + AWSuffix;
...
function ImpersonateLoggedOnUser;
  external advapi32 name 'ImpersonateLoggedOnUser';
...
function CreateProcessAsUser; external advapi32 name 'CreateProcessAsUser'
  + AWSuffix;
function CreateProcessWithLogonW;
...
function ImpersonateAnonymousToken;
  external advapi32 name 'ImpersonateAnonymousToken';
...
function RegisterWaitForSingleObjectEx;
  external kernel32 name 'RegisterWaitForSingleObjectEx';
...
function BindIoCompletionCallback;
  external kernel32 name 'BindIoCompletionCallback';
...
function GetCurrentHwProfile; external advapi32 name 'GetCurrentHwProfile'
  + AWSuffix;
function QueryPerformanceCounter;
...
function VerifyVersionInfo; external kernel32 name 'VerifyVersionInfo'
  + AWSuffix;
...
function FindFirstVolumeMountPointA;
  external kernel32 name 'FindFirstVolumeMountPointA';
function FindFirstVolumeMountPointW;
  external kernel32 name 'FindFirstVolumeMountPointW';
function FindFirstVolumeMountPoint;
  external kernel32 name 'FindFirstVolumeMountPoint' + AWSuffix;
function FindNextVolumeMountPointA;
  external kernel32 name 'FindNextVolumeMountPointA';
function FindNextVolumeMountPointW;
  external kernel32 name 'FindNextVolumeMountPointW';
function FindNextVolumeMountPoint;
  external kernel32 name 'FindNextVolumeMountPoint' + AWSuffix;
function FindVolumeMountPointClose;
  external kernel32 name 'FindVolumeMountPointClose';
...
function SetVolumeMountPoint; external kernel32 name 'SetVolumeMountPoint'
  + AWSuffix;
function DeleteVolumeMountPointA;
  external kernel32 name 'DeleteVolumeMountPointA';
function DeleteVolumeMountPointW;
  external kernel32 name 'DeleteVolumeMountPointW';
function DeleteVolumeMountPoint; external kernel32 name 'DeleteVolumeMountPoint'
  + AWSuffix;
function GetVolumeNameForVolumeMountPointA;
  external kernel32 name 'GetVolumeNameForVolumeMountPointA';
function GetVolumeNameForVolumeMountPointW;
  external kernel32 name 'GetVolumeNameForVolumeMountPointW';
function GetVolumeNameForVolumeMountPoint;
  external kernel32 name 'GetVolumeNameForVolumeMountPoint' + AWSuffix;
...
function GetVolumePathName; external kernel32 name 'GetVolumePathName'
  + AWSuffix;
function GetVolumePathNamesForVolumeNameA;
  external kernel32 name 'GetVolumePathNamesForVolumeNameA';
function GetVolumePathNamesForVolumeNameW;
  external kernel32 name 'GetVolumePathNamesForVolumeNameW';
function GetVolumePathNamesForVolumeName;
  external kernel32 name 'GetVolumePathNamesForVolumeName' + AWSuffix;
...
function FindActCtxSectionStringA;
  external kernel32 name 'FindActCtxSectionStringA';
function FindActCtxSectionStringW;
  external kernel32 name 'FindActCtxSectionStringW';
function FindActCtxSectionString;
  external kernel32 name 'FindActCtxSectionString' + AWSuffix;
...
function GetNamedPipeClientSessionId;
  external kernel32 name 'GetNamedPipeClientSessionId';

function GetNamedPipeClientComputerName;
  external kernel32 name 'GetNamedPipeClientComputerName' + AWSuffix;
function GetNamedPipeClientComputerNameA;
  external kernel32 name 'GetNamedPipeClientComputerNameA';
function GetNamedPipeClientComputerNameW;
  external kernel32 name 'GetNamedPipeClientComputerNameW';
{$ENDIF WINVISTA_UP}
{$ENDIF DYNAMIC_LINK}
...
begin
  ...
  result := ProcThreadAttributeValue(DWORD(ProcThreadAttributeParentProcess),
    False, true, False);
end;
...
begin
  ...
  result := ProcThreadAttributeValue(DWORD(ProcThreadAttributeExtendedFlags),
    False, true, true);
end;
...
begin
  ...
  result := ProcThreadAttributeValue(DWORD(ProcThreadAttributeHandleList),
    False, true, False);
end;
...
{$EXTERNALSYM TStartupInfoA}
{$EXTERNALSYM STARTUPINFOA}
{$EXTERNALSYM PROC_THREAD_ATTRIBUTE_PARENT_PROCESS}
{$EXTERNALSYM PROC_THREAD_ATTRIBUTE_EXTENDED_FLAGS}
{$EXTERNALSYM PROC_THREAD_ATTRIBUTE_HANDLE_LIST}

{$EXTERNALSYM ProcThreadAttributeValue}
end.
{$ENDIF JWA_OMIT_SECTIONS}
