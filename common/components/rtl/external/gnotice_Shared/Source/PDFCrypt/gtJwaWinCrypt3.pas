...
// $Id: gtJwaWinCrypt3.pas,v 1.1 2014/08/27 08:16:16 dinishev Exp $
...
{$IFNDEF JWA_OMIT_SECTIONS}
{$EXTERNALSYM PVTableProvStruc}
{$EXTERNALSYM TVTableProvStruc}
{$EXTERNALSYM PHMacInfo}
{$EXTERNALSYM PProvEnumAlgs}
{$EXTERNALSYM PProvEnumAlgsEx}
{$EXTERNALSYM PCertFortezzaDataProp}
