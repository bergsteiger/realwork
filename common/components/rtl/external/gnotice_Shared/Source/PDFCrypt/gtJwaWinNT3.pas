...
// $Id: gtJwaWinNT3.pas,v 1.1 2014/08/27 08:16:16 dinishev Exp $
...
type
  ...
  {$EXTERNALSYM PSecurityDescriptorRelative}
...
type
  ...
  {$EXTERNALSYM TTokenAuditPolicyElement}
  PTokenAuditPolicyElement = PTOKEN_AUDIT_POLICY_ELEMENT;
  {$EXTERNALSYM PTokenAuditPolicyElement}
...
type
  ...
  {$EXTERNALSYM TRtlVerifierThunkDescriptor}
  PRtlVerifierThunkDescriptor = PRTL_VERIFIER_THUNK_DESCRIPTOR;
  {$EXTERNALSYM PRtlVerifierThunkDescriptor}
...
//emit
{$EXTERNALSYM PSecurityInformation}
{$EXTERNALSYM TImageDosHeader}
{$EXTERNALSYM PImageTlsDirectory32}
{$EXTERNALSYM PImageTlsDirectory}
{$EXTERNALSYM TImageLoadConfigDirectory32}
{$EXTERNALSYM TImageLoadConfigDirectory64}
{$EXTERNALSYM TImageLoadConfigDirectory}
{$EXTERNALSYM TRtlVerifierDllDescriptor}
{$EXTERNALSYM PRtlVerifierDllDescriptor}
{$EXTERNALSYM TRtlVerifierProviderDescriptor}
{$EXTERNALSYM PRtlVerifierProviderDescriptor}
