...
// $Id: gtJwaWinType3.pas,v 1.1 2014/08/27 08:16:16 dinishev Exp $
...
{$EXTERNALSYM LPWSTR}
  LPCWSTR = {$IFDEF USE_DELPHI_TYPES} Windows.LPCWSTR {$ELSE} PWideChar
{$ENDIF};
{$EXTERNALSYM LPCWSTR}
...
{$EXTERNALSYM PUWSTR}
  LCPUWSTR = {$IFDEF USE_DELPHI_TYPES} Windows.LPWSTR {$ELSE} PWideChar
{$ENDIF};
...
{$EXTERNALSYM TUnicodeString}
  PUnicodeString = PUNICODE_STRING;
{$EXTERNALSYM PUnicodeString}
  //
  // Boolean
  //
...
{$EXTERNALSYM PString32}
{$EXTERNALSYM _STRING32}

  STRING32 = _STRING32;
{$EXTERNALSYM STRING32}
  TString32 = STRING32;
{$EXTERNALSYM TString32}
...
{$EXTERNALSYM PString64}
{$EXTERNALSYM _STRING64}

  STRING64 = _STRING64;
{$EXTERNALSYM STRING64}
  TString64 = STRING64;
{$EXTERNALSYM TString64}
...
{$EXTERNALSYM TObjectAttributes}
{$EXTERNALSYM PObjectAttributes}
...
{$EXTERNALSYM HLOCAL}
  ...
  FARPROC = {$IFDEF USE_DELPHI_TYPES} Windows.FARPROC {$ELSE} function: Integer;
stdcall {$ENDIF};
{$EXTERNALSYM FARPROC}
NEARPROC =
function: Integer;
...
{$EXTERNALSYM HBRUSH}
HCOLORSPACE = {$IFDEF USE_DELPHI_TYPES} Windows.HCOLORSPACE {$ELSE} HANDLE
{$ENDIF};
...
{$EXTERNALSYM HDESK}
HENHMETAFILE = {$IFDEF USE_DELPHI_TYPES} Windows.HENHMETAFILE {$ELSE} HANDLE
{$ENDIF};
...
function JwaWinType_GetModuleHandle(lpModuleName: LPCSTR): HMODULE; stdcall;
  external kernel32 name 'GetModuleHandleA';
function JwaWinType_LoadLibrary(lpLibFileName: LPCSTR): HMODULE; stdcall;
  external kernel32 name 'LoadLibraryA';
function JwaWinType_GetProcAddress(HMODULE: HMODULE; lpProcName: LPCSTR)
  : FARPROC; stdcall; external kernel32 name 'GetProcAddress';
{$ELSE}
