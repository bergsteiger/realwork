...
// Начат: 14.11.2008 18:22
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<ControllerInterfaces::Category>> F1 Администратор::Admin::Admin::AdminInterfaces
//
//
...
type
 ...
 TbsGroupNodeType = (
   gntUnknown // Неизвестно
 , gntSystem // Системная группа
 , gntUsual // Обычная группа
 );//TbsGroupNodeType
