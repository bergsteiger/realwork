...
// Generated from UML model, root element: <<VCMTestTarget::Category>> F1 Ежедневные тесты Администратора::Admin
//
//
...
uses
  ...
  ,
  AdminMainKeywordsPack in 'AdminMainKeywordsPack.pas'
  ...
  {$If defined(Admin) AND not defined(NoScripts)}
  ,
  GroupPropertyKeywordsPack in 'View\Admin\GroupPropertyKeywordsPack.pas'
  {$IfEnd} //Admin AND not NoScripts
  ,
  ...
  {$If defined(Admin) AND not defined(NoScripts)}
  ,
  ForbidAutoregistrationKeywordsPack in 'View\Admin\ForbidAutoregistrationKeywordsPack.pas'
  {$IfEnd} //Admin AND not NoScripts
  ,
  ...
  {$If defined(Admin) AND not defined(NoScripts)}
  ,
  UserListKeywordsPack in 'View\Admin\UserListKeywordsPack.pas'
  {$IfEnd} //Admin AND not NoScripts
  ,
  ...
  {$If defined(Admin) AND not defined(NoScripts)}
  ,
  UserPropertyKeywordsPack in 'View\Admin\UserPropertyKeywordsPack.pas'
  {$IfEnd} //Admin AND not NoScripts
  ,
  PrimGroupList_admGroupList_UserType in 'View\Admin\Forms\PrimGroupList_admGroupList_UserType.pas',
  PrimGroupList_Form in 'View\Admin\Forms\PrimGroupList_Form.pas',
  PrimGroupListOptions_Form in 'View\Admin\Forms\PrimGroupListOptions_Form.pas',
  GroupList_Form in 'View\Admin\Forms\GroupList_Form.pas' {efGroupList: TvcmEntityForm}
  {$If defined(Admin) AND not defined(NoScripts)}
  ,
  GroupListKeywordsPack in 'View\Admin\GroupListKeywordsPack.pas'
  {$IfEnd} //Admin AND not NoScripts
  ,
  ...
  {$If defined(Admin) AND not defined(NoScripts)}
  ,
  AdminFormKeywordsPack in 'View\Admin\AdminFormKeywordsPack.pas'
  {$IfEnd} //Admin AND not NoScripts
  ,
  ...
  adminUserNodeList in 'Admin\adminUserNodeList.pas',
  ...
  {$IfEnd} //not NoScripts
  ,
  toKAdmin in 'toKAdmin.pas',
  AdminTestRes in 'AdminTestRes.pas' {AdminTestRes: TDataModule}
  ;
