...
uses
  ...
  l3InterfacedComponent, evSubPn, eeSubDescriptorsExport, Dialogs,
  vtSaveDialog;
...
type
  TnsDocumentRes = class(TDataModule)
    ...
    SubDescriptors: TeeSubDescriptors;
    LiteSubDescriptors: TeeSubDescriptors;
    CommentsImageList: TvtPngImageList;
    MainMenuImageList: TvtNonFixedPngImageList;
  private
...
initialization
 AddImageListCreator(@nsDocumentRes);
