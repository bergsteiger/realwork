...
{$If not defined(Admin) AND not defined(Monitorings)}
 ...
 _sdsBaseDocument_ = {abstract ucc} class(_vcmFormSetDataSource_, IsdsBaseDocument, IsdsGotoPointDataMaker {from IsdsBaseDocument}, IsdsPrimDocument {from IsdsBaseDocument})
  {* БОС, базовый для прецедента с документом }
 protected
 // realized methods
