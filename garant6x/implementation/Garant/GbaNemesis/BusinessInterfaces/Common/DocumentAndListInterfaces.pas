...
// Начат: 02.08.2005 11.49
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<ControllerInterfaces::Category>> F1 Core::Common::BusinessInterfaces::DocumentAndListInterfaces
//
...
type
 ...
 IdeSimpleTree = interface(IUnknown)
...
(*
 BaseSearchSupportQuery = PureMixIn
...
type
 ...
 IdsBaseDocument = interface(IvcmViewAreaController{, IucpHAFMacroReplacerFactory, IucpFilterInfoFactory})
 ...
 IdsList = interface(IdsSimpleTree{, IucbBaseSearchSupportQuery})
  {* Базовый список. }
...
Возвращает признак того, что чего-то сохранили }
 ...
 IbsChangeRedactionWorker = interface(IUnknown)
 ...
 IsdsGotoPointDataMaker = interface(IUnknown{, Консультации должны поддерживать ссылки на документы Гаранта})
 ...
 IdsDocument = interface(IdsBaseDocument{, IucbDocumentWithContents, IucbDocumentFromList, IucbBaseSearchSupportQuery})
 ...
 IbsUserCRListInfo = interface(IUnknown)
 ...
 InsWarningGenerator = interface(IUnknown{, Медали в системе})
 ...
 IsdsBaseDocument = interface(IvcmUseCaseController{, IsdsGotoPointDataMaker, IsdsPrimDocument})
