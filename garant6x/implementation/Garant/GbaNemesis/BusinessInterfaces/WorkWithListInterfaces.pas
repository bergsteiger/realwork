...
type
 ...
 TList_SynchroView_Areas = (
  {* Типы зон для "БОС синхронного просмотра" }
   sva_List_SynchroView_None // Зона не определена
 , sva_List_SynchroView_Document // Собственно документ
 , sva_List_SynchroView_RelatedDoc // справка к документу
 , sva_List_SynchroView_UserCR1 // БОФ пользовательский СКР1
 , sva_List_SynchroView_UserCR2 // БОФ пользовательский СКР2
 , sva_List_SynchroView_Attributes // атрибуты документа
 , sva_List_SynchroView_Annotation // аннотация к документу
 , sva_List_SynchroView_SimilarDocuments // БОФ похожие документы
 );//TList_SynchroView_Areas
