unit NOT_COMPLETED_nsChangesBetweenEditionsDocumentContainer;
 {* Контейнер документа для ОИД }

// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\ChangesBetweenEditions\NOT_COMPLETED_nsChangesBetweenEditionsDocumentContainer.pas"
