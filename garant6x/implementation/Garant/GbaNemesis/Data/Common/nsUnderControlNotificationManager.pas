...
//
// Библиотека "Data"
// Модуль: "w:/garant6x/implementation/Garant/GbaNemesis/Data/Common/nsUnderControlNotificationManager.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<SimpleClass::Class>> F1 Базовые определения предметной области::LegalDomain::Data::Common::TnsUnderControlNotificationManager
//
//
...
type
 InsUnderControlNotificationListener = interface(IUnknown)
...
{$Include w:\common\components\rtl\Garant\L3\l3InterfacePtrList.imp.pas}
 ...
 // public methods
   procedure ResetChangedNotification;
     {* Сигнатура метода ResetChangedNotification }
   ...
   procedure SetChangedNotification;
     {* Сигнатура метода SetChangedNotification }
...
// start class TnsUnderControlNotificationManager
