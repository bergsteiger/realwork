...
// Начат: 27.07.2009 11:28
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<ControllerInterfaces::Category>> F1 Пользовательские сервисы::CompareEditions::Editions::EditionsInterfaces
//
// Работа с редакциями
//
//
...
type
 ...
 public
   rParaID : Integer; // Параграф
   rBlock : IevDocumentPart; // Блок
   rLine : Integer; // Строка внутри параграфа
