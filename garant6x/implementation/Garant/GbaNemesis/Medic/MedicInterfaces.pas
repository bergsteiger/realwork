...
// Начат: 14.11.2008 16:27
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<ControllerInterfaces::Category>> F1 Встроенные продукты::Inpharm::Medic::MedicInterfaces
//
// Интерфейсы Инфарма
//
//
...
type
 ...
 TDrugList_SynchroView_Areas = (
  {* Типы зон для "Бизнес объект "Синхронный просмотра"" }
   sva_DrugList_SynchroView_None // Зона не определена
 , sva_DrugList_SynchroView_Document // Собственно документ
 , sva_DrugList_SynchroView_Attributes // атрибуты документа
 , sva_DrugList_SynchroView_DrugInternationalNameSynonims // Бизнес объект "Синонимы по международному названию"
 );//TDrugList_SynchroView_Areas
 ...
 TMedicFirmList_SynchroView_Areas = (
  {* Типы зон для "dsSynchroView" }
   sva_MedicFirmList_SynchroView_None // Зона не определена
 , sva_MedicFirmList_SynchroView_Document // Собственно документ
 , sva_MedicFirmList_SynchroView_Attributes // атрибуты документа
 , sva_MedicFirmList_SynchroView_DrugList // список производимых препаратов
 );//TMedicFirmList_SynchroView_Areas
