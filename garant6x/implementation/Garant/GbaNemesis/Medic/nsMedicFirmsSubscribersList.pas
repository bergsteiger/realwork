...
//
// Библиотека "Medic"
// Модуль: "w:/garant6x/implementation/Garant/GbaNemesis/Medic/nsMedicFirmsSubscribersList.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<SimpleClass::Class>> F1 Встроенные продукты::Inpharm::Medic::Medic$Unit::TnsMedicFirmsSubscribersList
//
//
