...
// ћодуль: "w:\garant6x\implementation\Garant\GbaNemesis\Model\SearchDomainInterfaces.pas"
// —тереотип: "Interfaces"
// Ёлемент модели: "SearchDomainInterfaces" MUID: (4990510C0026)
...
type
 ...
 InsTaggedTreeInfo = interface
  ...
  property LogicOperations: TLogicOperationSet
   ...
   {* допустимые дл€ дерева логические операции }
