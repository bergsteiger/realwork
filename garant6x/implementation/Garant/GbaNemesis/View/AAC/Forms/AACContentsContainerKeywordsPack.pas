...
// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\View\AAC\Forms\AACContentsContainerKeywordsPack.pas"
// Стереотип: "ScriptKeywordsPack"
// Элемент модели: "AACContentsContainerKeywordsPack" MUID: (4FF4543F014A_Pack)
...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4FF4543F014A_Packimpl_uses*
 //#UC END# *4FF4543F014A_Packimpl_uses*
;
...
[code]форма::AACContentsContainer TryFocus ASSERT[code] }
  protected
...
class procedure Tkw_Form_AACContentsContainer.RegisterInEngine;
begin
 inherited;
 TtfwClassRef.Register(TAACContentsContainerForm);
end;//Tkw_Form_AACContentsContainer.RegisterInEngine
