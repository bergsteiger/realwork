...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4AA8E4CD0348_Packimpl_uses*
 //#UC END# *4AA8E4CD0348_Packimpl_uses*
;
...
[code]форма::GroupList TryFocus ASSERT[code] }
  protected
...
----
*Пример использования*:
[code]контрол::GroupsTree TryFocus ASSERT[code] }
  protected
   function GetString: AnsiString; override;
   class procedure RegisterInEngine; override;
   class function GetWordNameForRegister: AnsiString; override;
...
----
*Пример использования*:
[code]контрол::GroupsTree:push pop:control:SetFocus ASSERT[code] }
  protected
   procedure DoDoIt(const aCtx: TtfwContext); override;
   class function GetWordNameForRegister: AnsiString; override;
...
class procedure Tkw_Form_GroupList.RegisterInEngine;
begin
 inherited;
 TtfwClassRef.Register(TefGroupList);
end;//Tkw_Form_GroupList.RegisterInEngine
