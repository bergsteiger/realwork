...
// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\View\Admin\Forms\UserListKeywordsPack.pas"
// Стереотип: "ScriptKeywordsPack"
// Элемент модели: "UserListKeywordsPack" MUID: (4AA8E45C00A8_Pack)
...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4AA8E45C00A8_Packimpl_uses*
 //#UC END# *4AA8E45C00A8_Packimpl_uses*
;
...
[code]форма::UserList TryFocus ASSERT[code] }
  protected
...
----
*Пример использования*:
[code]контрол::trUserList TryFocus ASSERT[code] }
  protected
   function GetString: AnsiString; override;
   class procedure RegisterInEngine; override;
   class function GetWordNameForRegister: AnsiString; override;
...
----
*Пример использования*:
[code]контрол::trUserList:push pop:control:SetFocus ASSERT[code] }
  protected
   procedure DoDoIt(const aCtx: TtfwContext); override;
   class function GetWordNameForRegister: AnsiString; override;
...
class procedure Tkw_Form_UserList.RegisterInEngine;
begin
 inherited;
 TtfwClassRef.Register(TefUserList);
end;//Tkw_Form_UserList.RegisterInEngine
