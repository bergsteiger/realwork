...
// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\View\BaseSearch\Forms\BaseSearchContainerKeywordsPack.pas"
// Стереотип: "ScriptKeywordsPack"
// Элемент модели: "BaseSearchContainerKeywordsPack" MUID: (4D7A458300CB_Pack)
...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4D7A458300CB_Packimpl_uses*
 //#UC END# *4D7A458300CB_Packimpl_uses*
;
...
[code]форма::BaseSearchContainer TryFocus ASSERT[code] }
  protected
...
class procedure Tkw_Form_BaseSearchContainer.RegisterInEngine;
begin
 inherited;
 TtfwClassRef.Register(TBaseSearchContainerForm);
end;//Tkw_Form_BaseSearchContainer.RegisterInEngine
