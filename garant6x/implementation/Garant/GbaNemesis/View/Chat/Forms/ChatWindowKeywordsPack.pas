...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4A6971E802F5_Packimpl_uses*
 //#UC END# *4A6971E802F5_Packimpl_uses*
;
...
[code]форма::ChatWindow TryFocus ASSERT[code] }
  protected
...
----
*Пример использования*:
[code]контрол::BottomEditor TryFocus ASSERT[code] }
  protected
   function GetString: AnsiString; override;
   class procedure RegisterInEngine; override;
   class function GetWordNameForRegister: AnsiString; override;
...
----
*Пример использования*:
[code]контрол::BottomEditor:push pop:control:SetFocus ASSERT[code] }
  protected
   procedure DoDoIt(const aCtx: TtfwContext); override;
   class function GetWordNameForRegister: AnsiString; override;
...
class procedure Tkw_Form_ChatWindow.RegisterInEngine;
begin
 inherited;
 TtfwClassRef.Register(TChatWindowForm);
end;//Tkw_Form_ChatWindow.RegisterInEngine
