...
// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\View\Common\Forms\EULAKeywordsPack.pas"
// Стереотип: "ScriptKeywordsPack"
// Элемент модели: "EULAKeywordsPack" MUID: (4A93FB8C0121_Pack)
...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4A93FB8C0121_Packimpl_uses*
 //#UC END# *4A93FB8C0121_Packimpl_uses*
;
...
[code]форма::EULA TryFocus ASSERT[code] }
  protected
...
----
*Пример использования*:
[code]контрол::eeMemoWithEditOperations1 TryFocus ASSERT[code] }
  protected
   function GetString: AnsiString; override;
   class procedure RegisterInEngine; override;
   class function GetWordNameForRegister: AnsiString; override;
...
----
*Пример использования*:
[code]контрол::eeMemoWithEditOperations1:push pop:control:SetFocus ASSERT[code] }
  protected
   procedure DoDoIt(const aCtx: TtfwContext); override;
   class function GetWordNameForRegister: AnsiString; override;
...
class procedure Tkw_Form_EULA.RegisterInEngine;
begin
 inherited;
 TtfwClassRef.Register(TefEULA);
end;//Tkw_Form_EULA.RegisterInEngine
