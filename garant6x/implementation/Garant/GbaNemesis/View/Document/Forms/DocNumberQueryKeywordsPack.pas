...
// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\View\Document\Forms\DocNumberQueryKeywordsPack.pas"
// Стереотип: "ScriptKeywordsPack"
// Элемент модели: "DocNumberQueryKeywordsPack" MUID: (4AB13348028C_Pack)
...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4AB13348028C_Packimpl_uses*
 //#UC END# *4AB13348028C_Packimpl_uses*
;
...
[code]форма::DocNumberQuery TryFocus ASSERT[code] }
  protected
...
----
*Пример использования*:
[code]контрол::edNumber TryFocus ASSERT[code] }
  protected
   function GetString: AnsiString; override;
   class procedure RegisterInEngine; override;
   class function GetWordNameForRegister: AnsiString; override;
...
----
*Пример использования*:
[code]контрол::edNumber:push pop:control:SetFocus ASSERT[code] }
  protected
   procedure DoDoIt(const aCtx: TtfwContext); override;
   class function GetWordNameForRegister: AnsiString; override;
...
----
*Пример использования*:
[code]контрол::cbInternal TryFocus ASSERT[code] }
  protected
   function GetString: AnsiString; override;
   class procedure RegisterInEngine; override;
   class function GetWordNameForRegister: AnsiString; override;
...
----
*Пример использования*:
[code]контрол::cbInternal:push pop:control:SetFocus ASSERT[code] }
  protected
   procedure DoDoIt(const aCtx: TtfwContext); override;
   class function GetWordNameForRegister: AnsiString; override;
...
class procedure Tkw_Form_DocNumberQuery.RegisterInEngine;
begin
 inherited;
 TtfwClassRef.Register(TDocNumberQueryForm);
end;//Tkw_Form_DocNumberQuery.RegisterInEngine
