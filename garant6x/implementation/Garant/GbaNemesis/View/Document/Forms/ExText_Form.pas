...
begin
 ...
 AddUserTypeExclude(dftNoneName, en_Document, op_AddToControl, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_GetRelatedDocFrmAct, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_UserCR1, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_UserCR2, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_GetCorrespondentList, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_GetRespondentList, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_GetCorrespondentListExFrmAct, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_GetRespondentListExFrmAct, False);
 AddUserTypeExclude(dftNoneName, en_TimeMachine, op_TimeMachineOnOff, False);
 AddUserTypeExclude(dftNoneName, en_TimeMachine, op_TimeMachineOffAndReset, False);
 AddUserTypeExclude(dftNoneName, en_Redactions, op_ActualRedaction, False);
 AddUserTypeExclude(dftNoneName, en_TimeMachine, op_TimeMachineOnOffNew, False);
 AddUserTypeExclude(dftNoneName, en_Redactions, op_OpenRedactionListFrmAct, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_GetAnnotationDocFrmAct, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_SimilarDocuments, False);
 AddUserTypeExclude(dftNoneName, en_DocumentBlockHeader, op_UserCR1, False);
 AddUserTypeExclude(dftNoneName, en_DocumentBlockHeader, op_UserCR2, False);
 AddUserTypeExclude(dftNoneName, en_DocumentBlockHeader, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftNoneName, en_Redactions, op_PrevRedaction, False);
 AddUserTypeExclude(dftNoneName, en_Redactions, op_NextRedaction, False);
 AddUserTypeExclude(dftNoneName, en_Text, op_AddToControl, False);
 AddUserTypeExclude(dftNoneName, en_Selection, op_ShowCorrespondentListToPart, False);
 AddUserTypeExclude(dftNoneName, en_Selection, op_ShowRespondentListToPart, False);
 AddUserTypeExclude(dftNoneName, en_WarnOnControl, op_ClearStatusSettings, False);
 AddUserTypeExclude(dftNoneName, en_TasksPanel, op_TimeMachineOnOff, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_AddToControl, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_GetRelatedDocFrmAct, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_UserCR1, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_UserCR2, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_GetCorrespondentList, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_GetRespondentList, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_GetCorrespondentListExFrmAct, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_GetRespondentListExFrmAct, False);
 AddUserTypeExclude(dftDocumentName, en_TimeMachine, op_TimeMachineOnOff, False);
 AddUserTypeExclude(dftDocumentName, en_TimeMachine, op_TimeMachineOffAndReset, False);
 AddUserTypeExclude(dftDocumentName, en_Redactions, op_ActualRedaction, False);
 AddUserTypeExclude(dftDocumentName, en_TimeMachine, op_TimeMachineOnOffNew, False);
 AddUserTypeExclude(dftDocumentName, en_Redactions, op_OpenRedactionListFrmAct, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_GetAnnotationDocFrmAct, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_SimilarDocuments, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlockHeader, op_UserCR1, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlockHeader, op_UserCR2, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlockHeader, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftDocumentName, en_Redactions, op_PrevRedaction, False);
 AddUserTypeExclude(dftDocumentName, en_Redactions, op_NextRedaction, False);
 AddUserTypeExclude(dftDocumentName, en_Text, op_AddToControl, False);
 AddUserTypeExclude(dftDocumentName, en_Selection, op_ShowCorrespondentListToPart, False);
 AddUserTypeExclude(dftDocumentName, en_Selection, op_ShowRespondentListToPart, False);
 AddUserTypeExclude(dftDocumentName, en_WarnOnControl, op_ClearStatusSettings, False);
 AddUserTypeExclude(dftDocumentName, en_TasksPanel, op_TimeMachineOnOff, False);
 ...
 AddUserTypeExclude(dftAACLeftName, en_Document, op_AddToControl, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_GetRelatedDocFrmAct, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_UserCR1, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_UserCR2, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_GetCorrespondentList, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_GetRespondentList, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_GetCorrespondentListExFrmAct, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_GetRespondentListExFrmAct, False);
 AddUserTypeExclude(dftAACLeftName, en_TimeMachine, op_TimeMachineOnOff, False);
 AddUserTypeExclude(dftAACLeftName, en_TimeMachine, op_TimeMachineOffAndReset, False);
 AddUserTypeExclude(dftAACLeftName, en_Redactions, op_ActualRedaction, False);
 AddUserTypeExclude(dftAACLeftName, en_TimeMachine, op_TimeMachineOnOffNew, False);
 AddUserTypeExclude(dftAACLeftName, en_Redactions, op_OpenRedactionListFrmAct, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_GetAnnotationDocFrmAct, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_SimilarDocuments, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlockHeader, op_UserCR1, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlockHeader, op_UserCR2, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlockHeader, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftAACLeftName, en_Redactions, op_PrevRedaction, False);
 AddUserTypeExclude(dftAACLeftName, en_Redactions, op_NextRedaction, False);
 AddUserTypeExclude(dftAACLeftName, en_Text, op_AddToControl, False);
 AddUserTypeExclude(dftAACLeftName, en_Selection, op_ShowCorrespondentListToPart, False);
 AddUserTypeExclude(dftAACLeftName, en_Selection, op_ShowRespondentListToPart, False);
 AddUserTypeExclude(dftAACLeftName, en_WarnOnControl, op_ClearStatusSettings, False);
 AddUserTypeExclude(dftAACLeftName, en_TasksPanel, op_TimeMachineOnOff, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_AddToControl, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_GetRelatedDocFrmAct, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_UserCR1, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_UserCR2, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_GetCorrespondentList, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_GetRespondentList, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_GetCorrespondentListExFrmAct, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_GetRespondentListExFrmAct, False);
 AddUserTypeExclude(dftAACRightName, en_TimeMachine, op_TimeMachineOnOff, False);
 AddUserTypeExclude(dftAACRightName, en_TimeMachine, op_TimeMachineOffAndReset, False);
 AddUserTypeExclude(dftAACRightName, en_Redactions, op_ActualRedaction, False);
 AddUserTypeExclude(dftAACRightName, en_TimeMachine, op_TimeMachineOnOffNew, False);
 AddUserTypeExclude(dftAACRightName, en_Redactions, op_OpenRedactionListFrmAct, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_GetAnnotationDocFrmAct, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_SimilarDocuments, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlockHeader, op_UserCR1, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlockHeader, op_UserCR2, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlockHeader, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftAACRightName, en_Redactions, op_PrevRedaction, False);
 AddUserTypeExclude(dftAACRightName, en_Redactions, op_NextRedaction, False);
 AddUserTypeExclude(dftAACRightName, en_Text, op_AddToControl, False);
 AddUserTypeExclude(dftAACRightName, en_Selection, op_ShowCorrespondentListToPart, False);
 AddUserTypeExclude(dftAACRightName, en_Selection, op_ShowRespondentListToPart, False);
 AddUserTypeExclude(dftAACRightName, en_WarnOnControl, op_ClearStatusSettings, False);
 AddUserTypeExclude(dftAACRightName, en_TasksPanel, op_TimeMachineOnOff, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_AddToControl, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_UserCR1, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_UserCR2, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_TimeMachine, op_TimeMachineOnOff, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_TimeMachine, op_TimeMachineOffAndReset, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Redactions, op_ActualRedaction, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_TimeMachine, op_TimeMachineOnOffNew, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Redactions, op_OpenRedactionListFrmAct, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_GetAnnotationDocFrmAct, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_SimilarDocuments, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlockHeader, op_UserCR1, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlockHeader, op_UserCR2, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlockHeader, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Redactions, op_PrevRedaction, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Redactions, op_NextRedaction, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Text, op_AddToControl, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Selection, op_ShowCorrespondentListToPart, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Selection, op_ShowRespondentListToPart, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_WarnOnControl, op_ClearStatusSettings, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_TasksPanel, op_TimeMachineOnOff, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_AddToControl, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_UserCR1, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_UserCR2, False);
 AddUserTypeExclude(dftAACContentsRightName, en_TimeMachine, op_TimeMachineOnOff, False);
 AddUserTypeExclude(dftAACContentsRightName, en_TimeMachine, op_TimeMachineOffAndReset, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Redactions, op_ActualRedaction, False);
 AddUserTypeExclude(dftAACContentsRightName, en_TimeMachine, op_TimeMachineOnOffNew, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Redactions, op_OpenRedactionListFrmAct, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_GetAnnotationDocFrmAct, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_SimilarDocuments, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlockHeader, op_UserCR1, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlockHeader, op_UserCR2, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlockHeader, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Redactions, op_PrevRedaction, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Redactions, op_NextRedaction, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Text, op_AddToControl, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Selection, op_ShowCorrespondentListToPart, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Selection, op_ShowRespondentListToPart, False);
 AddUserTypeExclude(dftAACContentsRightName, en_WarnOnControl, op_ClearStatusSettings, False);
 AddUserTypeExclude(dftAACContentsRightName, en_TasksPanel, op_TimeMachineOnOff, False);
 ...
 AddUserTypeExclude(dftNoneName, en_Document, op_NextDocumentInList, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_ReturnToList, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_PrevDocumentInList, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_NextDocumentInList, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_ReturnToList, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_PrevDocumentInList, False);
 ...
 AddUserTypeExclude(dftDrugName, en_Document, op_NextDocumentInList, False);
 AddUserTypeExclude(dftDrugName, en_Document, op_ReturnToList, False);
 AddUserTypeExclude(dftDrugName, en_Document, op_PrevDocumentInList, False);
 ...
 AddUserTypeExclude(dftAACLeftName, en_Document, op_NextDocumentInList, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_ReturnToList, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_PrevDocumentInList, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_NextDocumentInList, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_ReturnToList, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_PrevDocumentInList, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_NextDocumentInList, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_ReturnToList, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_PrevDocumentInList, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_NextDocumentInList, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_ReturnToList, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_PrevDocumentInList, False);
 ...
 AddUserTypeExclude(dftNoneName, en_DocumentBlock, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftNoneName, en_DocumentBlockHeader, op_AddBookmark, False);
 AddUserTypeExclude(dftNoneName, en_DocumentBlockHeader, op_ToMSWord, False);
 AddUserTypeExclude(dftNoneName, en_DocumentBlockHeader, op_Print, False);
 AddUserTypeExclude(dftNoneName, en_DocumentBlockHeader, op_PrintDialog, False);
 AddUserTypeExclude(dftNoneName, en_DocumentBlockBookmarks, op_AddBookmark, False);
 AddUserTypeExclude(dftNoneName, en_DocumentBlock, op_ToMSWord, False);
 AddUserTypeExclude(dftNoneName, en_DocumentBlock, op_PrintDialog, False);
 AddUserTypeExclude(dftNoneName, en_DocumentBlock, op_Copy, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_OpenContentsFrmAct, False);
 AddUserTypeExclude(dftNoneName, en_Document, op_ShowDocumentPicture, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlock, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlockHeader, op_AddBookmark, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlockHeader, op_ToMSWord, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlockHeader, op_Print, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlockHeader, op_PrintDialog, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlockBookmarks, op_AddBookmark, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlock, op_ToMSWord, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlock, op_PrintDialog, False);
 AddUserTypeExclude(dftDocumentName, en_DocumentBlock, op_Copy, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_OpenContentsFrmAct, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_ShowDocumentPicture, False);
 ...
 AddUserTypeExclude(dftDrugName, en_DocumentBlock, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftDrugName, en_DocumentBlockHeader, op_AddBookmark, False);
 AddUserTypeExclude(dftDrugName, en_DocumentBlockHeader, op_ToMSWord, False);
 AddUserTypeExclude(dftDrugName, en_DocumentBlockHeader, op_Print, False);
 AddUserTypeExclude(dftDrugName, en_DocumentBlockHeader, op_PrintDialog, False);
 AddUserTypeExclude(dftDrugName, en_DocumentBlockBookmarks, op_AddBookmark, False);
 AddUserTypeExclude(dftDrugName, en_DocumentBlock, op_ToMSWord, False);
 AddUserTypeExclude(dftDrugName, en_DocumentBlock, op_PrintDialog, False);
 AddUserTypeExclude(dftDrugName, en_DocumentBlock, op_Copy, False);
 AddUserTypeExclude(dftDrugName, en_Document, op_OpenContentsFrmAct, False);
 AddUserTypeExclude(dftDrugName, en_Document, op_ShowDocumentPicture, False);
 ...
 AddUserTypeExclude(dftDrugSynchroViewName, en_DocumentBlock, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_DocumentBlockHeader, op_AddBookmark, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_DocumentBlockHeader, op_ToMSWord, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_DocumentBlockHeader, op_Print, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_DocumentBlockHeader, op_PrintDialog, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_DocumentBlockBookmarks, op_AddBookmark, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_DocumentBlock, op_ToMSWord, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_DocumentBlock, op_PrintDialog, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_DocumentBlock, op_Copy, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_Document, op_OpenContentsFrmAct, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_Document, op_ShowDocumentPicture, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlock, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlockHeader, op_AddBookmark, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlockHeader, op_ToMSWord, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlockHeader, op_Print, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlockHeader, op_PrintDialog, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlockBookmarks, op_AddBookmark, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlock, op_ToMSWord, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlock, op_PrintDialog, False);
 AddUserTypeExclude(dftAACLeftName, en_DocumentBlock, op_Copy, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_OpenContentsFrmAct, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_ShowDocumentPicture, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlock, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlockHeader, op_AddBookmark, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlockHeader, op_ToMSWord, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlockHeader, op_Print, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlockHeader, op_PrintDialog, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlockBookmarks, op_AddBookmark, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlock, op_ToMSWord, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlock, op_PrintDialog, False);
 AddUserTypeExclude(dftAACRightName, en_DocumentBlock, op_Copy, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_OpenContentsFrmAct, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_ShowDocumentPicture, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlock, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlockHeader, op_AddBookmark, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlockHeader, op_ToMSWord, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlockHeader, op_Print, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlockHeader, op_PrintDialog, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlockBookmarks, op_AddBookmark, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlock, op_ToMSWord, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlock, op_PrintDialog, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_DocumentBlock, op_Copy, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_OpenContentsFrmAct, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_ShowDocumentPicture, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlock, op_GetTypedCorrespondentList, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlockHeader, op_AddBookmark, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlockHeader, op_ToMSWord, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlockHeader, op_Print, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlockHeader, op_PrintDialog, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlockBookmarks, op_AddBookmark, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlock, op_ToMSWord, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlock, op_PrintDialog, False);
 AddUserTypeExclude(dftAACContentsRightName, en_DocumentBlock, op_Copy, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_OpenContentsFrmAct, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_ShowDocumentPicture, False);
 ...
 AddUserTypeExclude(dftNoneName, en_Document, op_GetGraphicImage, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_GetGraphicImage, False);
 AddUserTypeExclude(dftRelatedDocName, en_Document, op_GetGraphicImage, False);
 ...
 AddUserTypeExclude(dftDrugName, en_Document, op_GetGraphicImage, False);
 ...
 AddUserTypeExclude(dftDrugSynchroViewName, en_Document, op_GetGraphicImage, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_GetGraphicImage, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_GetGraphicImage, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_GetGraphicImage, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_GetGraphicImage, False);
 AddUserTypeExclude(dftChronologyName, en_Document, op_GetGraphicImage, False);
 ...
 AddUserTypeExclude(dftDocSynchroViewName, en_Document, op_DocumentSynchroOpenWindow, True);
 AddUserTypeExclude(dftDocSynchroViewName, en_Document, op_DocumentSynchroOpenNewWindow, True);
 ...
 AddUserTypeExclude(dftAnnotationSynchroViewName, en_Document, op_DocumentSynchroOpenWindow, True);
 AddUserTypeExclude(dftAnnotationSynchroViewName, en_Document, op_DocumentSynchroOpenNewWindow, True);
 ...
 AddUserTypeExclude(dftMedicFirmSynchroViewName, en_Document, op_DocumentSynchroOpenWindow, True);
 AddUserTypeExclude(dftMedicFirmSynchroViewName, en_Document, op_DocumentSynchroOpenNewWindow, True);
 AddUserTypeExclude(dftDrugSynchroViewName, en_Document, op_DocumentSynchroOpenWindow, True);
 AddUserTypeExclude(dftDrugSynchroViewName, en_Document, op_DocumentSynchroOpenNewWindow, True);
 ...
 AddUserTypeExclude(dftDictEntryName, en_Document, op_DictListOpenFrmAct, False);
 ...
 AddUserTypeExclude(dftTipsName, en_Document, op_DictListOpenFrmAct, False);
 AddUserTypeExclude(dftMedDictEntryName, en_Document, op_DictListOpenFrmAct, False);
 AddUserTypeExclude(dftAutoreferatName, en_Document, op_DictListOpenFrmAct, False);
 AddUserTypeExclude(dftDrugName, en_Document, op_DictListOpenFrmAct, False);
 AddUserTypeExclude(dftMedicFirmName, en_Document, op_DictListOpenFrmAct, False);
 AddUserTypeExclude(dftMedicFirmSynchroViewName, en_Document, op_DictListOpenFrmAct, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_Document, op_DictListOpenFrmAct, False);
 ...
 AddUserTypeExclude(dftNoneName, en_Document, op_AddBookmarkFromContents, False);
 AddUserTypeExclude(dftDocumentName, en_Document, op_AddBookmarkFromContents, False);
 ...
 AddUserTypeExclude(dftAutoreferatAfterSearchName, en_Document, op_AddBookmarkFromContents, False);
 ...
 AddUserTypeExclude(dftAutoreferatName, en_Document, op_AddBookmarkFromContents, False);
 AddUserTypeExclude(dftDrugName, en_Document, op_AddBookmarkFromContents, False);
 AddUserTypeExclude(dftMedicFirmName, en_Document, op_AddBookmarkFromContents, False);
 AddUserTypeExclude(dftMedicFirmSynchroViewName, en_Document, op_AddBookmarkFromContents, False);
 AddUserTypeExclude(dftDrugSynchroViewName, en_Document, op_AddBookmarkFromContents, False);
 AddUserTypeExclude(dftAACLeftName, en_Document, op_AddBookmarkFromContents, False);
 AddUserTypeExclude(dftAACRightName, en_Document, op_AddBookmarkFromContents, False);
 AddUserTypeExclude(dftAACContentsLeftName, en_Document, op_AddBookmarkFromContents, False);
 AddUserTypeExclude(dftAACContentsRightName, en_Document, op_AddBookmarkFromContents, False);
 ...
 AddUserTypeExclude(dftDictEntryName, en_Document, op_LiteratureListForDictionary, False);
 ...
 AddUserTypeExclude(dftMedicFirmName, en_Document, op_OpenProducedDrugList, False);
 ...
 AddUserTypeExclude(dftDrugName, en_Document, op_OpenSimilarDrugList, False);
 ...
 AddUserTypeExclude(dftAACLeftName, en_BaseSearchPresentationHolder, op_GetBaseSearchPresentation, False);
