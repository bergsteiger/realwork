...
// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\View\Document\Forms\SynchroViewKeywordsPack.pas"
// Стереотип: "ScriptKeywordsPack"
// Элемент модели: "SynchroViewKeywordsPack" MUID: (4AB1359700D9_Pack)
...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4AB1359700D9_Packimpl_uses*
 //#UC END# *4AB1359700D9_Packimpl_uses*
;
...
[code]форма::SynchroView TryFocus ASSERT[code] }
  protected
...
----
*Пример использования*:
[code]контрол::DocView TryFocus ASSERT[code] }
  protected
   function GetString: AnsiString; override;
   class procedure RegisterInEngine; override;
   class function GetWordNameForRegister: AnsiString; override;
...
----
*Пример использования*:
[code]контрол::DocView:push pop:control:SetFocus ASSERT[code] }
  protected
   procedure DoDoIt(const aCtx: TtfwContext); override;
   class function GetWordNameForRegister: AnsiString; override;
