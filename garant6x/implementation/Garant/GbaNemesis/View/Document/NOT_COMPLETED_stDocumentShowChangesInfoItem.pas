unit NOT_COMPLETED_stDocumentShowChangesInfoItem;
 {* Визуализатор для настройки "Показывать историю изменений в документе" }

// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\View\Document\NOT_COMPLETED_stDocumentShowChangesInfoItem.pas"
