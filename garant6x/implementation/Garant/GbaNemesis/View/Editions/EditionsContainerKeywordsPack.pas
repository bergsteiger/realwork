...
// Generated from UML model, root element: <<ScriptKeywordsPack::Class>> F1 Пользовательские сервисы::CompareEditions::View::Editions::BaseEditions::EditionsContainerKeywordsPack
//
...
type
  Tkw_Form_EditionsContainer = {final scriptword} class(TtfwControlString)
...
type
  Tkw_EditionsContainer_Control_BackgroundPanel = {final scriptword} class(TtfwControlString)
...
// start class Tkw_EditionsContainer_Control_BackgroundPanel
...
type
  Tkw_EditionsContainer_Control_BackgroundPanel_Push = {final scriptword} class(TkwBynameControlPush)
...
// start class Tkw_EditionsContainer_Control_BackgroundPanel_Push
...
type
  Tkw_EditionsContainer_Control_pnLeft = {final scriptword} class(TtfwControlString)
...
// start class Tkw_EditionsContainer_Control_pnLeft
...
type
  Tkw_EditionsContainer_Control_pnLeft_Push = {final scriptword} class(TkwBynameControlPush)
...
// start class Tkw_EditionsContainer_Control_pnLeft_Push
...
type
  Tkw_EditionsContainer_Control_pnRight = {final scriptword} class(TtfwControlString)
...
// start class Tkw_EditionsContainer_Control_pnRight
...
type
  Tkw_EditionsContainer_Control_pnRight_Push = {final scriptword} class(TkwBynameControlPush)
...
// start class Tkw_EditionsContainer_Control_pnRight_Push
...
type
  TkwEditionsContainerFormBackgroundPanel = {final scriptword} class(TtfwPropertyLike)
...
// start class TkwEditionsContainerFormBackgroundPanel
...
procedure TkwEditionsContainerFormBackgroundPanel.DoDoIt(const aCtx: TtfwContext);
 {-}
var
 l_aEditionsContainerForm : TEditionsContainerForm;
begin
 try
...
type
  TkwEditionsContainerFormPnLeft = {final scriptword} class(TtfwPropertyLike)
...
// start class TkwEditionsContainerFormPnLeft
...
type
  TkwEditionsContainerFormPnRight = {final scriptword} class(TtfwPropertyLike)
...
// start class TkwEditionsContainerFormPnRight
