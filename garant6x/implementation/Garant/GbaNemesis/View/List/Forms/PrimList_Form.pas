...
begin
 ...
 AddUserTypeExclude(lftNoneName, en_TimeMachine, op_TimeMachineOffAndReset, False);
 ...
 AddUserTypeExclude(lftNoneName, en_List, op_SetCurrentVisible, False);
 ...
 AddUserTypeExclude(lftConsultationName, en_List, op_SetCurrentVisible, False);
 ...
 AddUserTypeExclude(lftNoneName, en_List, op_ListInfo, False);
 ...
 AddUserTypeExclude(lftNoneName, en_Filters, op_FiltersListOpen, False);
 ...
 AddUserTypeExclude(lftConsultationName, en_Filters, op_FiltersListOpen, False);
 ...
 AddUserTypeExclude(lftDrugListName, en_Filters, op_FiltersListOpen, False);
 ...
 AddUserTypeExclude(lftNoneName, en_File, op_LoadFromFolder, False);
 ...
 AddUserTypeExclude(lftConsultationName, en_File, op_LoadFromFolder, False);
 ...
 AddUserTypeExclude(lftNoneName, en_Filters, op_FiltersList, False);
 AddUserTypeExclude(lftNoneName, en_Filters, op_Clear, False);
 AddUserTypeExclude(lftNoneName, en_Filters, op_InternalClear, False);
 ...
 AddUserTypeExclude(lftConsultationName, en_Filters, op_FiltersList, False);
 AddUserTypeExclude(lftConsultationName, en_Filters, op_Clear, False);
 AddUserTypeExclude(lftConsultationName, en_Filters, op_InternalClear, False);
 ...
 AddUserTypeExclude(lftDrugListName, en_Filters, op_FiltersList, False);
 AddUserTypeExclude(lftDrugListName, en_Filters, op_Clear, False);
 AddUserTypeExclude(lftDrugListName, en_Filters, op_InternalClear, False);
 ...
 AddUserTypeExclude(lftDrugListName, en_LocalList, op_SearchDrugInList, False);
 AddUserTypeExclude(lftDrugInternationalNameSynonymsName, en_LocalList, op_SearchDrugInList, False);
 AddUserTypeExclude(lftProducedDrugsName, en_LocalList, op_SearchDrugInList, False);
 AddUserTypeExclude(lftProducedDrugsSynchroFormName, en_LocalList, op_SearchDrugInList, False);
 AddUserTypeExclude(lftDrugInternationalNameSynonymsSynchroFormName, en_LocalList, op_SearchDrugInList, False);
 ...
 AddUserTypeExclude(lftNoneName, en_Selection, op_Analize, False);
 ...
 AddUserTypeExclude(lftNoneName, en_Document, op_GetAttributesFrmAct, False);
 AddUserTypeExclude(lftNoneName, en_Document, op_GetRelatedDocFrmAct, False);
 ...
 AddUserTypeExclude(lftDrugListName, en_Document, op_GetAttributesFrmAct, False);
 AddUserTypeExclude(lftDrugListName, en_Document, op_GetRelatedDocFrmAct, False);
 ...
 AddUserTypeExclude(lftRespondentName, en_CRList, op_SetType, True);
 AddUserTypeExclude(lftCorrespondentName, en_CRList, op_SetType, True);
 AddUserTypeExclude(lftSynchroViewName, en_CRList, op_SetType, True);
 AddUserTypeExclude(lftCToPartName, en_CRList, op_SetType, True);
 ...
 AddUserTypeExclude(lftSimilarDocumentsSynchroViewName, en_CRList, op_SetType, True);
 AddUserTypeExclude(lftCorrespondentsSynchroFormName, en_CRList, op_SetType, True);
 ...
 AddUserTypeExclude(lftRToPartName, en_CRList, op_SetType, True);
