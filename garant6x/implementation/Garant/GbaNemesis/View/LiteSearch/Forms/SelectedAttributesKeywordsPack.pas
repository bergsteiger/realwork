...
// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\View\LiteSearch\Forms\SelectedAttributesKeywordsPack.pas"
// Стереотип: "ScriptKeywordsPack"
// Элемент модели: "SelectedAttributesKeywordsPack" MUID: (4AAF51FC0061_Pack)
...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4AAF51FC0061_Packimpl_uses*
 //#UC END# *4AAF51FC0061_Packimpl_uses*
;
...
[code]форма::SelectedAttributes TryFocus ASSERT[code] }
  protected
...
----
*Пример использования*:
[code]контрол::SelectedTree TryFocus ASSERT[code] }
  protected
   function GetString: AnsiString; override;
   class procedure RegisterInEngine; override;
   class function GetWordNameForRegister: AnsiString; override;
...
----
*Пример использования*:
[code]контрол::SelectedTree:push pop:control:SetFocus ASSERT[code] }
  protected
   procedure DoDoIt(const aCtx: TtfwContext); override;
   class function GetWordNameForRegister: AnsiString; override;
