unit NOT_COMPLETED_nsFindIteratorNewFindPositionList;
 {* Фасадная реализация IFindPositionList }

// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\View\NOT_COMPLETED_nsFindIteratorNewFindPositionList.pas"
