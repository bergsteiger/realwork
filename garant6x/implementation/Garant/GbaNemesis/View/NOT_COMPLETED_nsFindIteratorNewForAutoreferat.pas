unit NOT_COMPLETED_nsFindIteratorNewForAutoreferat;
 {* Реализация IFindIterator для нового представления автореферата }

// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\View\NOT_COMPLETED_nsFindIteratorNewForAutoreferat.pas"
