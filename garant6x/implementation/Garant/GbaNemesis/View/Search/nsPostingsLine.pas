...
// Модуль: "w:/garant6x/implementation/Garant/GbaNemesis/View/Search/nsPostingsLine.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<UtilityPack::Class>> F1 Common For Shell And Monitoring::Search::View$Strange::Search::nsPostingsLine
//
//
