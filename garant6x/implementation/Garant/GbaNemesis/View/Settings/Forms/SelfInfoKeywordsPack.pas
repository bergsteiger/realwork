...
// Модуль: "w:\garant6x\implementation\Garant\GbaNemesis\View\Settings\Forms\SelfInfoKeywordsPack.pas"
// Стереотип: "ScriptKeywordsPack"
// Элемент модели: "SelfInfoKeywordsPack" MUID: (4B5430AC0306_Pack)
...
uses
 ...
 , tfwScriptingTypes
 //#UC START# *4B5430AC0306_Packimpl_uses*
 //#UC END# *4B5430AC0306_Packimpl_uses*
;
...
[code]форма::SelfInfo TryFocus ASSERT[code] }
  protected
...
class procedure Tkw_Form_SelfInfo.RegisterInEngine;
begin
 inherited;
 TtfwClassRef.Register(TSelfInfoForm);
end;//Tkw_Form_SelfInfo.RegisterInEngine
