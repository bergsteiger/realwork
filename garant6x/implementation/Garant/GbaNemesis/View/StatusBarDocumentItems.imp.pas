...
//#UC START# *4A8E5E4702C6_498721A60125_impl*
 ...
 begin
  ...
  begin
   ...
   Add(l_Item);
   l_Operation := TnscStatusBarOperationDef.MakeSNoCaption(opcode_Document_DocumentIsUseful, False, False, 0, nsc_ttkNone);
   Add(l_Operation);
   Add(TnscStatusBarOperationDef.MakeSNoCaption(opcode_Document_DocumentIsUseless, False, False, 0, nsc_ttkNone));
  ...
  Add(TnscStatusBarOperationDef.MakeS(opcode_Document_PrevDocumentInList,
   False, str_PrevDocumentInList, True, False, 0, nsc_ttkNone));
  Add(TnscStatusBarOperationDef.MakeS(opcode_Document_ReturnToList,
   False, str_ListCaption, True, False, 0, nsc_ttkNone));
  Add(TnscStatusBarOperationDef.MakeS(opcode_Document_NextDocumentInList,
