...
var
 ...
 l_Cont : InevObjectHolder;
  ...
  // Вроде бы уже успешно сообщаем другим контейнерам, когда что-то происходит
  // с комментарием, по-другому. А здесь - ассерт
...
(* function DoContainer(aDoc: PIUnknown; anIndex: Integer): Boolean;
 ...
 begin//DoContainer
  ...
  begin
   // - это "тот же самый текст" - надо ему сообщить, что комментарий изменился
