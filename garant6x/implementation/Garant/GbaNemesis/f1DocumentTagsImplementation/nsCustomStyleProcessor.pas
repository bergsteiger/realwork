...
// Модуль: "w:/garant6x/implementation/Garant/GbaNemesis/f1DocumentTagsImplementation/nsCustomStyleProcessor.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<ServiceImplementation::Class>> F1 Базовые определения предметной области::LegalDomain::f1DocumentTagsImplementation::CustomStyle::TnsCustomStyleProcessor
//
//
...
type
 ...
 // property methods
   ...
   procedure pm_SetLinkViewKind(aSeg: Tl3Variant; aValue: TevLinkViewKind);
 public
 // realized methods
...
// start class TnsCustomStyleProcessor
...
procedure TnsCustomStyleProcessor.pm_SetLinkViewKind(aSeg: Tl3Variant; aValue: TevLinkViewKind);
