...
[WINDOWS]
Main="<xsl:value-of select="@title"/>","<xsl:value-of select="/help/@filename"/>.hhc","<xsl:value-of select="/help/@filename"/>.hhk","page-hello.htm","page-hello.htm",,,,,0x23520,,0x300c,[20,15,750,570],0xc0000,0x400,,,,,0
</xsl:template>                                                                                  
</xsl:stylesheet>