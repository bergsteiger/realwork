...
<xsl:template match="reference">
 ...
 <xsl:call-template name="summary">
  ...
  <xsl:with-param name="ann"   select="'Горячие клавиши, используемые для быстрого вызова команд утилиты настройки индивидуальной новостной ленты системы ГАРАНТ Платформа F1.'"/>
...
.<xsl:value-of select="/help/application/@versionminor"/>  -->
  ...
  <p>
   ...
   утилиты настройки индивидуальной новостной ленты системы ГАРАНТ. 
   Чтобы получить описание команды, 
