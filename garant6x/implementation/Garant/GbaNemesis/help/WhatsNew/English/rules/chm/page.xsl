...
<tr class="blue">
 <td align="left"  nowrap="true">
  ...
  >
GARANT System Platform F1 EXPERT. <xsl:value-of select="child::h3[@class='topic']"/>
<!--
...
<!-- вернул в список обрабатываемых шаблонов self::hr -->

 <xsl:apply-templates select="*[not(self::topic or self::h3[@class='topic'])]"/>
