...
[WINDOWS]
Main="<xsl:value-of select="@title"/>","<xsl:value-of select="/help/@filename"/>.hhc","<xsl:value-of select="/help/@filename"/>.hhk","page-main.htm","page-main.htm",,,,,0x3520,224,0x300c,[20,15,790,570],0xc0000,,,,,,0
</xsl:template>                                                                                  
</xsl:stylesheet>