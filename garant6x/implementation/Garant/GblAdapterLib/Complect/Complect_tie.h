////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/garant6x/implementation/Garant/GblAdapterLib/Complect/Complect_tie.h"
...
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef __GARANT6X_GBLADAPTERLIB_COMPLECT_TIE_H__
#define __GARANT6X_GBLADAPTERLIB_COMPLECT_TIE_H__
...
class IComplectInfoNode_tie: public INodeBase_tie {
public:

	virtual void __stdcall get_info (GCI::IO::IString_tie*& ret_) = 0;
};

class __declspec (dllexport) ComplectInfoNode_tie: public IComplectInfoNode_tie {
	SET_OBJECT_COUNTER (ComplectInfoNode_tie)
protected:
...
private:
	ComplectInfoNode_tie ();

	typedef ::Core::PoolObjectManager<ComplectInfoNode_tie>::PoolObjectManagerSingleton MyPool;
	typedef ::Core::PoolObjectManager<ComplectInfoNode_tie> Pool;
	friend class ::Core::PoolObjectManager<ComplectInfoNode_tie>;
	typedef ::Core::IidMapRegistrator<ComplectInfoNode_tie> IidRegistrator;
...
public:
	...
	static void make_cpp (const IComplectInfoNode_tie* obj, ComplectInfoNode*& ret_, bool interface_addref = false);

	static void make_tie (const ComplectInfoNode* obj, IComplectInfoNode_tie*& ret_, bool interface_addref = false);
	
	static void make_tie (const ComplectInfoNode& obj, IComplectInfoNode_tie*& ret_, const Core::TIEBase* owner);

	ComplectInfoNode* m_impl;
...
protected:
	...
	virtual void __stdcall get_info (GCI::IO::IString_tie*& ret_);
};

#pragma pack (push, 1)

struct VisualRepresentation_tie {
	GCI::IO::IString_tie* name;
	char percent;
	
	static void make_cpp (const VisualRepresentation_tie& obj, VisualRepresentation& ret_);

	static void make_tie (const VisualRepresentation& obj, VisualRepresentation_tie& ret_);
};

#pragma pack (pop)

class VisualRepresentationList_tie: public Core::TIEBase {
	SET_OBJECT_COUNTER (VisualRepresentationList_tie)
protected:
	virtual unsigned long __stdcall query_interface (
		const ::Core::ComIID& iid
		, void*& object
...
private:
	VisualRepresentationList_tie ();

	typedef ::Core::PoolObjectManager<VisualRepresentationList_tie>::PoolObjectManagerSingleton MyPool;
	typedef ::Core::PoolObjectManager<VisualRepresentationList_tie> Pool;
	friend class ::Core::PoolObjectManager<VisualRepresentationList_tie>;

public:
	static const ::Core::ComIID s_com_iid;
	
	static void make_cpp (const VisualRepresentationList_tie* obj, VisualRepresentationList*& ret_);

	static void make_tie (VisualRepresentationList* obj, VisualRepresentationList_tie*& ret_);
	
	static void make_tie (const VisualRepresentationList& obj, VisualRepresentationList_tie*& ret_);

	static void make_tie (const VisualRepresentationList& obj, VisualRepresentationList_tie*& ret_, const Core::TIEBase* owner);
	
	static void new_tie (VisualRepresentationList* obj, VisualRepresentationList_tie*& ret_);

	VisualRepresentationList* m_impl;
	bool m_orphan;
...
protected:
	...
	virtual void __stdcall get_item (size_t index, VisualRepresentation_tie& ret_);
	virtual void __stdcall set_item (size_t index, const VisualRepresentation_tie& item);
	virtual size_t __stdcall add (const VisualRepresentation_tie& item);
	virtual size_t __stdcall insert (size_t index, const VisualRepresentation_tie& item);
};

class IComplectInfo_tie: public ::Core::IIObject_tie {
public:

	virtual void __stdcall get_dealer_info (GCI::IO::IString_tie*& ret_) = 0;

	virtual void __stdcall get_visual_representation_data_53E0B7040233 (
		VisualRepresentationList_tie*& ret_
	) const = 0;


	virtual void __stdcall get_info  (INodeBase_tie*& ret_) /*throw (CanNotFindData_tie)*/ = 0;


	virtual void __stdcall get_old_base_warning (GCI::IO::IString_tie*& ret_) = 0;


	virtual void __stdcall get_owner  (GCI::IO::IString_tie*& ret_) = 0;


	virtual ComplectType __stdcall get_type () const = 0;


	virtual void __stdcall get_unexist_doc_message (GCI::IO::IString_tie*& ret_) = 0;
};

class __declspec (dllexport) ComplectInfo_tie: public IComplectInfo_tie {
	SET_OBJECT_COUNTER (ComplectInfo_tie)
protected:
	virtual unsigned long __stdcall query_interface (
		const ::Core::ComIID& iid
		, void*& object
...
private:
	...
	typedef ::Core::PoolObjectManager<ComplectInfo_tie>::PoolObjectManagerSingleton MyPool;
	typedef ::Core::PoolObjectManager<ComplectInfo_tie> Pool;
	friend class ::Core::PoolObjectManager<ComplectInfo_tie>;
	typedef ::Core::IidMapRegistrator<ComplectInfo_tie> IidRegistrator;
	static IidRegistrator s_iid_registrator;
...
public:
	...
	static void make_cpp (const IComplectInfo_tie* obj, ComplectInfo*& ret_, bool interface_addref = false);

	static void make_tie (const ComplectInfo* obj, IComplectInfo_tie*& ret_, bool interface_addref = false);
	
	static void make_tie (const ComplectInfo& obj, IComplectInfo_tie*& ret_, const Core::TIEBase* owner);

	ComplectInfo* m_impl;

protected:

	virtual void __stdcall get_dealer_info (GCI::IO::IString_tie*& ret_);
	...
	virtual void __stdcall get_info  (INodeBase_tie*& ret_) /*throw (CanNotFindData_tie)*/;


	virtual void __stdcall get_old_base_warning (GCI::IO::IString_tie*& ret_);


	virtual void __stdcall get_owner  (GCI::IO::IString_tie*& ret_);


	virtual ComplectType __stdcall get_type () const;


	virtual void __stdcall get_unexist_doc_message (GCI::IO::IString_tie*& ret_);
};

} // namespace GblAdapterLib
	

#endif //__GARANT6X_GBLADAPTERLIB_COMPLECT_TIE_H__
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
