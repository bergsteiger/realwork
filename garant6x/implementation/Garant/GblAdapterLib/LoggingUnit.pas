...
// Модуль: "w:/garant6x/implementation/Garant/GblAdapterLib/LoggingUnit.pas"
...
{ - предварительное описание ILogEventData. }

ILogManager = interface;
{ - предварительное описание ILogManager. }
...
ILogEventData = interface (IInterface) ['{4B1A4AE4-7B43-471C-8FC0-94167B5706BC}']
...
ILogManager = interface (IInterface) ['{23621F05-BC03-409D-8EBB-53D5BB3E1D95}']
	function DontUseMe: Pointer;
	procedure AddEvent (
		aLogEvent: TLogEvent;
		const aData: ILogEventData
	); stdcall;
end;
