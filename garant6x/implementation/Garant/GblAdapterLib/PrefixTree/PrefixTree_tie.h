////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/garant6x/implementation/Garant/GblAdapterLib/PrefixTree/PrefixTree_tie.h"
...
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef __GARANT6X_GBLADAPTERLIB_PREFIXTREE_TIE_H__
#define __GARANT6X_GBLADAPTERLIB_PREFIXTREE_TIE_H__
...
class IPrefixNode_tie: public INodeBase_tie {
public:

};

class __declspec (dllexport) PrefixNode_tie: public IPrefixNode_tie {
	SET_OBJECT_COUNTER (PrefixNode_tie)
protected:
...
private:
	...
	typedef ::Core::PoolObjectManager<PrefixNode_tie>::PoolObjectManagerSingleton MyPool;
	typedef ::Core::PoolObjectManager<PrefixNode_tie> Pool;
	friend class ::Core::PoolObjectManager<PrefixNode_tie>;
	typedef ::Core::IidMapRegistrator<PrefixNode_tie> IidRegistrator;
...
public:
	...
	static void make_cpp (const IPrefixNode_tie* obj, PrefixNode*& ret_, bool interface_addref = false);

	static void make_tie (const PrefixNode* obj, IPrefixNode_tie*& ret_, bool interface_addref = false);
	
	static void make_tie (const PrefixNode& obj, IPrefixNode_tie*& ret_, const Core::TIEBase* owner);
...
#endif //__GARANT6X_GBLADAPTERLIB_PREFIXTREE_TIE_H__
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
