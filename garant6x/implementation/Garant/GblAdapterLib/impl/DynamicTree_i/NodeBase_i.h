////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/garant6x/implementation/Garant/GblAdapterLib/impl/DynamicTree_i/NodeBase_i.h"
...
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef __GARANT6X_GBLADAPTERLIB_DYNAMICTREE_I_NODEBASE_I_H__
#define __GARANT6X_GBLADAPTERLIB_DYNAMICTREE_I_NODEBASE_I_H__
...
namespace ServerAdapterConverters {
	void convert (const NodePosition&, GTree::NodePosition&);
}
}

#define CHECK_AND_LOCK_TREE(RETURN_CODE)          \
	if (!this->owner_tree ()) {                            \
		RETURN_CODE                                   \
	}                                               \
	Core::Mutex* mutex_ = 0;                       \
	try {                                           \
		const TreeBase* t_b = this->owner_tree ();  \
		mutex_ = const_cast<TreeBase*> (t_b)->get_change_mutex (); \
...
class NodeBase_i; // self forward Var
typedef ::Core::Var<NodeBase_i> NodeBase_i_var;
typedef ::Core::Var<const NodeBase_i> NodeBase_i_cvar;

class NodeBase_i_factory;
class NodeBase_iServantFactory;

class NodeBase_i:
	virtual public NodeBase
	, virtual public ::Core::RefCountObjectBase
	, virtual public RealNodeBase
{
	SET_OBJECT_COUNTER (NodeBase_i)
	friend class NodeBase_i_factory; // self factory
	friend class NodeBase_iServantFactory;

//////////////////////////////////////////////////////////////////////////////////////////
// Memory Pool initialization
private:
	typedef ::Core::PoolMemoryManager<NodeBase_i>::PoolMemoryManagerSingleton PoolNodeBase_i;
	typedef ::Core::PoolMemoryManager<NodeBase_i> Pool;
	friend class ::Core::PoolMemoryManager<NodeBase_i>;
	void* operator new (size_t cs) {              
		return PoolNodeBase_i::instance()->malloc(cs);
	}
	void operator delete (void* p) {
		PoolNodeBase_i::instance()->free(p);
	}
//////////////////////////////////////////////////////////////////////////////////////////
// constructors and destructor
protected:
	NodeBase_i (TreeBase* owner_tree, const GTree::Node& snode);
...
private:
	friend void ServerAdapterConverters::convert (const NodePosition&, GTree::NodePosition&);
	friend NodeBase* make_tree_and_root (const char* key);
	friend NodeBase* make_from_owner_tree (FakeFacetForFactory* owner_tree, const GTree::Node& snode);
//#UC END# *45F7D7F503C8*
}; // class NodeBase_i
...
#endif //__GARANT6X_GBLADAPTERLIB_DYNAMICTREE_I_NODEBASE_I_H__
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
