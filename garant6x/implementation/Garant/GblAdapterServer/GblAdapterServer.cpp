////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/garant6x/implementation/Garant/GblAdapterServer/GblAdapterServer.cpp"
...
namespace GblAdapterServer {
	...
	void DllInintializator::init (unsigned long client_version, const char* locale_string) {
		...
		lhm.registrate_lib_home (&GblAdapterLibDesktop::LibHomeFactory::get ());
...
_DLL_TRY
	root = GblAdapterServer::Root::Singleton::instance();
	root->addref ();
_DLL_CATCH
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
