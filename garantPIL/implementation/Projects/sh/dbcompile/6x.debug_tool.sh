...
if test "$1" = "" ; then
echo "Usage: 63.debug_tool.sh <MPCXC_ROOT> <opt_flag> <tool_name> [<arg1> [<arg2> ...]] "
...
rm -f $testbase_dir/tmp.gdb
echo "set args $4 $5 $6 $7 $8 $9" > $testbase_dir/tmp.gdb
gdb -d $MPCXC_ROOT/src -x $testbase_dir/tmp.gdb $MPCXC_ROOT/out/$TAOACE_MPCXC_TARGET/bin/$3
