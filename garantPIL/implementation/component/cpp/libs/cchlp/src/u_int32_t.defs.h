...
#ifndef _u_int32_tdefs_h
#define _u_int32_tdefs_h 1
...
// equality operator
#ifndef u_int32_tEQ
#define u_int32_tEQ(a, b)  ((a) == (b))
#endif

// less-than-or-equal
#ifndef u_int32_tLE
#define u_int32_tLE(a, b)  ((a) <= (b))
#endif

// comparison : less-than -> < 0; equal -> 0; greater-than -> > 0
#ifndef u_int32_tCMP
#define u_int32_tCMP(a, b) ( ((a) <= (b))? (((a) == (b))? 0 : -1) : 1 )
#endif

// hash function
#ifndef u_int32_tHASH
#define u_int32_tHASH(x)  (x)
#endif
