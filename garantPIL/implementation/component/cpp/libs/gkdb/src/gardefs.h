...
#define QUICK_R_TOUPPER(ch) if(rv_uc(ch)==rv_uc('с')) lv_uc(ch)=rv_uc('…'); else if(rv_uc(ch)==rv_uc('р')) lv_uc(ch)=rv_uc('…'); else if(rv_uc(ch)>=rv_uc(' ')&&rv_uc(ch)<=rv_uc('Ї'))lv_uc(ch)+=rv_uc('Ђ')-rv_uc(' '); else if(rv_uc(ch)>=rv_uc('а')&&rv_uc(ch)<=rv_uc('п'))lv_uc(ch)+=rv_uc('ђ')-rv_uc('а'); else if(rv_uc(ch)>=rv_uc('a')&&rv_uc(ch)<=rv_uc('z'))lv_uc(ch)+=rv_uc('A')-rv_uc('a')
...
#define	QUICK_R_WIN_TOUPPER_WIN(ch) { if(rv_uc(ch)>=rv_uc('а')&&rv_uc(ch)<=rv_uc('я'))lv_uc(ch)+=rv_uc('А')-rv_uc('а'); else if(rv_uc(ch)==rv_uc('Ё')) lv_uc(ch)=rv_uc('Е'); else if(rv_uc(ch)==rv_uc('ё'))lv_uc(ch)=rv_uc('Е'); else if(rv_uc(ch)>=rv_uc('a')&&rv_uc(ch)<=rv_uc('z'))lv_uc(ch)+=rv_uc('A')-rv_uc('a');}

#define QUICK_R_DOS_TOUPPER_WIN(ch) {if(rv_uc(ch)==rv_uc('с')) lv_uc(ch)=rv_uc('Е'); else if(rv_uc(ch)==rv_uc('р')) lv_uc(ch)=rv_uc('Е');\
