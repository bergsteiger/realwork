# Microsoft Developer Studio Generated NMAKE File, Based on baseinfo.dsp
!IF "$(CFG)" == ""
CFG=baseinfo - Win32 Debug
!MESSAGE No configuration specified. Defaulting to baseinfo - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "baseinfo - Win32 Release" && "$(CFG)" != "baseinfo - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "baseinfo.mak" CFG="baseinfo - Win32 Debug"
!MESSAGE 
...
ALL : "$(OUTDIR)\baseinfo.exe"


CLEAN :
	-@erase "$(INTDIR)\adler32.obj"
	-@erase "$(INTDIR)\base.obj"
	-@erase "$(INTDIR)\baseinfo.obj"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\baseinfo.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libc.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\baseinfo.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\baseinfo.exe" /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
	"$(INTDIR)\basemask.obj" \
...
"$(OUTDIR)\baseinfo.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(INTDIR)\zutil.obj"
	-@erase "$(OUTDIR)\baseinfo.exe"
	-@erase "$(OUTDIR)\baseinfo.pdb"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /G6 /MLd /W3 /Gi /GX /Zi /Od /I "..\..\..\include" /I "..\..\..\include\win32" /I "..\..\..\libs\gkdb\src" /I "..\..\..\libs\gsscreen\src" /I "..\..\..\libs\cchlp\src" /I "..\..\..\libs\inifile\src" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\baseinfo.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\baseinfo.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\baseinfo.exe" /pdbtype:sept /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
	"$(INTDIR)\basemask.obj" \
...
!IF EXISTS("baseinfo.dep")
!INCLUDE "baseinfo.dep"
!ELSE 
!MESSAGE Warning: cannot find "baseinfo.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\baseinfo.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
