...
int garlink(Base *b_, ProgressScreen *screen, int baseType, int bCheckInfo, int bBreeder, int bWWW, int bG6, FILE *el, DBCore::RelevancyTuneData* chg_rel_data, int b_only_class6);
//
