# Microsoft Developer Studio Generated NMAKE File, Based on hisync.dsp
!IF "$(CFG)" == ""
CFG=hisync - Win32 Debug
!MESSAGE No configuration specified. Defaulting to hisync - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "hisync - Win32 Release" && "$(CFG)" != "hisync - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "hisync.mak" CFG="hisync - Win32 Debug"
!MESSAGE 
...
CLEAN :
	...
	-@erase "$(OUTDIR)\hisync.exe"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP=cl.exe
CPP_PROJ=/nologo /G4 /Zp1 /ML /W3 /Gi /GX /O2 /I "../../../include/msvc32" /I "../../../include" /I "../../../libs/gkdb/src" /I "../../../libs/mrglib/src" /I "../../../libs/gsscreen/src" /I "../../../libs/cchlp/src" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /Fp"$(INTDIR)\hisync.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
RSC=rc.exe
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\hisync.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=/nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\hisync.pdb" /machine:I386 /out:"$(OUTDIR)\hisync.exe" 
LINK32_OBJS= \
	"$(INTDIR)\cmdline.obj" \
	"$(INTDIR)\hisync.obj" \
	"$(INTDIR)\main.obj" \
...
"$(OUTDIR)\hisync.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "$(OUTDIR)\hisync.exe" "$(OUTDIR)\hisync.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\hisync.bsc"
	-@erase "$(OUTDIR)\hisync.exe"
	-@erase "$(OUTDIR)\hisync.ilk"
	-@erase "$(OUTDIR)\hisync.pdb"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP=cl.exe
CPP_PROJ=/nologo /G5 /Zp1 /ML /W3 /Gm /Gi /GX /ZI /Od /I "../../../include/msvc32" /I "../../../include" /I "../../../libs/gkdb/src" /I "../../../libs/mrglib/src" /I "../../../libs/gsscreen/src" /I "../../../libs/cchlp/src" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\hisync.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
"$(OUTDIR)\hisync.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
  $(BSC32_FLAGS) $(BSC32_SBRS)
<<

LINK32=link.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\hisync.pdb" /debug /machine:I386 /nodefaultlib:"libc.lib" /nodefaultlib /out:"$(OUTDIR)\hisync.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\cmdline.obj" \
	"$(INTDIR)\hisync.obj" \
	"$(INTDIR)\main.obj" \
...
!IF EXISTS("hisync.dep")
!INCLUDE "hisync.dep"
!ELSE 
!MESSAGE Warning: cannot find "hisync.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\hisync.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\hisync.obj"	"$(INTDIR)\hisync.sbr" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\synchind.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\synchind.obj"	"$(INTDIR)\synchind.sbr" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
