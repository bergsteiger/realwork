# Microsoft Developer Studio Generated NMAKE File, Based on basestat.dsp
!IF "$(CFG)" == ""
CFG=basestat - Win32 Debug
!MESSAGE No configuration specified. Defaulting to basestat - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "basestat - Win32 Release" && "$(CFG)" != "basestat - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "basestat.mak" CFG="basestat - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "basestat - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "basestat - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\basestat.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libc.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\basestat.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\basestat.exe" /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\getopt.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
"$(OUTDIR)\basestat.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "basestat - Win32 Debug"
...
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\basestat.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\basestat.exe" /pdbtype:sept /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\getopt.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
!IF EXISTS("basestat.dep")
!INCLUDE "basestat.dep"
!ELSE 
!MESSAGE Warning: cannot find "basestat.dep"
!ENDIF 
!ENDIF 
...
SOURCE=..\src\basestat.cpp

"$(INTDIR)\basestat.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
