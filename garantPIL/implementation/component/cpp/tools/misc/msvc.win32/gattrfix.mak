# Microsoft Developer Studio Generated NMAKE File, Based on gattrfix.dsp
!IF "$(CFG)" == ""
CFG=gattrfix - Win32 Debug
!MESSAGE No configuration specified. Defaulting to gattrfix - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "gattrfix - Win32 Release" && "$(CFG)" != "gattrfix - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "gattrfix.mak" CFG="gattrfix - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "gattrfix - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "gattrfix - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
CLEAN :
	...
	-@erase "$(INTDIR)\stringz.obj"
	-@erase "$(INTDIR)\trees.obj"
	-@erase "$(INTDIR)\unzip.obj"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\zutil.obj"
	-@erase "$(OUTDIR)\gattrfix.exe"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /ML /W3 /WX /Gi /GX /O2 /I "..\..\..\include" /I "..\..\..\include\win32" /I "..\..\..\libs\cchlp\src" /I "..\..\..\libs\gkdb\src" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gattrfix.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libc.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gattrfix.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gattrfix.exe" /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\logger.obj" \
	"$(INTDIR)\recode.obj" \
	"$(INTDIR)\stringz.obj" \
...
"$(OUTDIR)\gattrfix.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "gattrfix - Win32 Debug"
...
CLEAN :
	...
	-@erase "$(INTDIR)\zutil.obj"
	-@erase "$(OUTDIR)\gattrfix.exe"
	-@erase "$(OUTDIR)\gattrfix.pdb"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /G6 /MLd /W3 /Gi /GX /Zi /Od /I "..\..\..\include" /I "..\..\..\include\win32" /I "..\..\..\libs\cchlp\src" /I "..\..\..\libs\gkdb\src" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gattrfix.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gattrfix.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gattrfix.exe" /pdbtype:sept /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\logger.obj" \
	"$(INTDIR)\recode.obj" \
	"$(INTDIR)\stringz.obj" \
...
!IF EXISTS("gattrfix.dep")
!INCLUDE "gattrfix.dep"
!ELSE 
!MESSAGE Warning: cannot find "gattrfix.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\stringz.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
SOURCE=..\src\gattrfix.cpp

"$(INTDIR)\gattrfix.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
