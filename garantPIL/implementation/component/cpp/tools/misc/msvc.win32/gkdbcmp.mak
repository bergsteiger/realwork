# Microsoft Developer Studio Generated NMAKE File, Based on gkdbcmp.dsp
!IF "$(CFG)" == ""
CFG=gkdbcmp - Win32 Debug
!MESSAGE No configuration specified. Defaulting to gkdbcmp - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "gkdbcmp - Win32 Release" && "$(CFG)" != "gkdbcmp - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "gkdbcmp.mak" CFG="gkdbcmp - Win32 Debug"
!MESSAGE 
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gkdbcmp.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libc.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gkdbcmp.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gkdbcmp.exe" /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\logger.obj" \
	"$(INTDIR)\recode.obj" \
	"$(INTDIR)\stringz.obj" \
...
"$(OUTDIR)\gkdbcmp.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gkdbcmp.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gkdbcmp.exe" /pdbtype:sept /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\logger.obj" \
	"$(INTDIR)\recode.obj" \
	"$(INTDIR)\stringz.obj" \
...
!IF EXISTS("gkdbcmp.dep")
!INCLUDE "gkdbcmp.dep"
!ELSE 
!MESSAGE Warning: cannot find "gkdbcmp.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\gkdbcmp.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
