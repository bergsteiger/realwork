# Microsoft Developer Studio Generated NMAKE File, Based on gkdumpi.dsp
!IF "$(CFG)" == ""
CFG=gkdumpi - Win32 Debug
!MESSAGE No configuration specified. Defaulting to gkdumpi - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "gkdumpi - Win32 Release" && "$(CFG)" != "gkdumpi - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "gkdumpi.mak" CFG="gkdumpi - Win32 Debug"
!MESSAGE 
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gkdumpi.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libc.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gkdumpi.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gkdumpi.exe" /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\recode.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
"$(OUTDIR)\gkdumpi.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gkdumpi.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gkdumpi.exe" /pdbtype:sept /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\recode.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
!IF EXISTS("gkdumpi.dep")
!INCLUDE "gkdumpi.dep"
!ELSE 
!MESSAGE Warning: cannot find "gkdumpi.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\gkdumpi.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
