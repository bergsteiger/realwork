# Microsoft Developer Studio Generated NMAKE File, Based on gkdumps.dsp
!IF "$(CFG)" == ""
CFG=gkdumps - Win32 Debug
!MESSAGE No configuration specified. Defaulting to gkdumps - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "gkdumps - Win32 Release" && "$(CFG)" != "gkdumps - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "gkdumps.mak" CFG="gkdumps - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "gkdumps - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "gkdumps - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gkdumps.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libc.lib libci.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gkdumps.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gkdumps.exe" /fixed:no 
LINK32_OBJS= \
...
"$(OUTDIR)\gkdumps.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "gkdumps - Win32 Debug"
...
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib libcid.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gkdumps.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gkdumps.exe" /pdbtype:sept /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\errhandler.obj" \
	"$(INTDIR)\long.set.obj" \
	"$(INTDIR)\long.splayset.obj" \
...
!IF EXISTS("gkdumps.dep")
!INCLUDE "gkdumps.dep"
!ELSE 
!MESSAGE Warning: cannot find "gkdumps.dep"
!ENDIF 
!ENDIF 
...
SOURCE=..\src\gkdumps.cpp

"$(INTDIR)\gkdumps.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
