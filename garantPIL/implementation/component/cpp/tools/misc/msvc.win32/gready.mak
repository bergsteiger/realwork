# Microsoft Developer Studio Generated NMAKE File, Based on gready.dsp
!IF "$(CFG)" == ""
CFG=gready - Win32 Debug
!MESSAGE No configuration specified. Defaulting to gready - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "gready - Win32 Release" && "$(CFG)" != "gready - Win32 Debug"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gready.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libc.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gready.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gready.exe" /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\getopt.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
"$(OUTDIR)\gready.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gready.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gready.exe" /pdbtype:sept /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\getopt.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
!IF EXISTS("gready.dep")
!INCLUDE "gready.dep"
!ELSE 
!MESSAGE Warning: cannot find "gready.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\gready.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
