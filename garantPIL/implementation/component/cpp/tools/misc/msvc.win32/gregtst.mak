# Microsoft Developer Studio Generated NMAKE File, Based on gregtst.dsp
!IF "$(CFG)" == ""
CFG=gregtst - Win32 Debug
!MESSAGE No configuration specified. Defaulting to gregtst - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "gregtst - Win32 Release" && "$(CFG)" != "gregtst - Win32 Debug"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gregtst.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libc.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gregtst.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gregtst.exe" /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\hnode.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
"$(OUTDIR)\gregtst.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gregtst.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gregtst.exe" /pdbtype:sept /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\hnode.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
!IF EXISTS("gregtst.dep")
!INCLUDE "gregtst.dep"
!ELSE 
!MESSAGE Warning: cannot find "gregtst.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\gregtst.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
