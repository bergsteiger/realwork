# Microsoft Developer Studio Generated NMAKE File, Based on gsetname.dsp
!IF "$(CFG)" == ""
CFG=gsetname - Win32 Debug
!MESSAGE No configuration specified. Defaulting to gsetname - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "gsetname - Win32 Release" && "$(CFG)" != "gsetname - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "gsetname.mak" CFG="gsetname - Win32 Debug"
!MESSAGE 
...
CLEAN :
	...
	-@erase "$(OUTDIR)\gsetname.exe"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /ML /W3 /WX /Gi /GX /O2 /I "..\..\..\include" /I "..\..\..\include\win32" /I "..\..\..\libs\cchlp\src" /I "..\..\..\libs\gkdb\src" /I "..\..\..\libs\gsscreen\src" /I "..\..\..\libs\inifile\src" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gsetname.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libc.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gsetname.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gsetname.exe" /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\getopt.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
"$(OUTDIR)\gsetname.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(INTDIR)\zutil.obj"
	-@erase "$(OUTDIR)\gsetname.exe"
	-@erase "$(OUTDIR)\gsetname.pdb"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /G6 /MLd /W3 /Gi /GX /Zi /Od /I "..\..\..\include" /I "..\..\..\include\win32" /I "..\..\..\libs\cchlp\src" /I "..\..\..\libs\gkdb\src" /I "..\..\..\libs\gsscreen\src" /I "..\..\..\libs\inifile\src" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gsetname.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gsetname.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gsetname.exe" /pdbtype:sept /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\getopt.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
!IF EXISTS("gsetname.dep")
!INCLUDE "gsetname.dep"
!ELSE 
!MESSAGE Warning: cannot find "gsetname.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\gsetname.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
