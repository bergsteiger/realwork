# Microsoft Developer Studio Generated NMAKE File, Based on gsstat.dsp
!IF "$(CFG)" == ""
CFG=gsstat - Win32 Debug
!MESSAGE No configuration specified. Defaulting to gsstat - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "gsstat - Win32 Release" && "$(CFG)" != "gsstat - Win32 Debug"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\gsstat.exe"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /ML /W3 /WX /Gi /GX /O2 /I "..\..\..\include" /I "..\..\..\include\win32" /I "..\..\..\libs\gkdb\src" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gsstat.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libc.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gsstat.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gsstat.exe" /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
	"$(INTDIR)\basemask.obj" \
...
"$(OUTDIR)\gsstat.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(INTDIR)\zutil.obj"
	-@erase "$(OUTDIR)\gsstat.exe"
	-@erase "$(OUTDIR)\gsstat.pdb"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /G6 /MLd /W3 /Gi /GX /Zi /Od /I "..\..\..\include" /I "..\..\..\include\win32" /I "..\..\..\libs\gkdb\src" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gsstat.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gsstat.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gsstat.exe" /pdbtype:sept /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
	"$(INTDIR)\basemask.obj" \
...
!IF EXISTS("gsstat.dep")
!INCLUDE "gsstat.dep"
!ELSE 
!MESSAGE Warning: cannot find "gsstat.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\gstat.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
