# Microsoft Developer Studio Generated NMAKE File, Based on gsstatus.dsp
!IF "$(CFG)" == ""
CFG=gsstatus - Win32 Debug
!MESSAGE No configuration specified. Defaulting to gsstatus - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "gsstatus - Win32 Release" && "$(CFG)" != "gsstatus - Win32 Debug"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gsstatus.bsc" 
BSC32_SBRS= \
	
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libc.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gsstatus.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gsstatus.exe" /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\recode.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
"$(OUTDIR)\gsstatus.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
LINK32=xilink6.exe
LINK32_FLAGS=oldnames.lib kernel32.lib libcd.lib /nologo /stack:0xa00000,0x100000 /subsystem:console /incremental:no /pdb:"$(OUTDIR)\gsstatus.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\gsstatus.exe" /pdbtype:sept /fixed:no 
LINK32_OBJS= \
	"$(INTDIR)\recode.obj" \
	"$(INTDIR)\adler32.obj" \
	"$(INTDIR)\base.obj" \
...
!IF EXISTS("gsstatus.dep")
!INCLUDE "gsstatus.dep"
!ELSE 
!MESSAGE Warning: cannot find "gsstatus.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\gstatus.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
