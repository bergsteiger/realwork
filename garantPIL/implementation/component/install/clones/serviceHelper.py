...
if __name__ == '__main__':
    print ServiceHelper().set_corba_port('5140').set_zope_port('8040').set_force_mode(True).stop()
    print ServiceHelper().set_corba_port('5140').set_zope_port('8040').set_force_mode(True).start()