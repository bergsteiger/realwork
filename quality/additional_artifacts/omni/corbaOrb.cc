...
/*
  $Log: corbaOrb.cc,v $
  Revision 1.1  2002/01/23 13:33:34  dimab
  added
...
extern omniInitialiser& garant_Client_initialiser_;
		...
		const char* options[][2])
{
  ...
  try {
    ...
    garant_Client_initialiser_.attach();
...
omniOrbORB::destroy()
{
  ...
  omniOrbORB* orb;
  {
    ...
    garant_Client_initialiser_.detach();
