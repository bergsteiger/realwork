...
uses
 ...
 , XMLIntf {$IfNDef XE4} in 'w:\common\components\rtl\external\Borland\Delphi\Internet\XMLIntf.pas' {$EndIf}
 ...
 , XMLDoc {$IfNDef XE4} in 'w:\common\components\rtl\external\Borland\Delphi\Internet\XMLDoc.pas' {$EndIf}
