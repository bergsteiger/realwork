...
// ћодуль: "w:\quality\test\garant6x\AdapterTest\CoreObjects\atParameter.pas"
// —тереотип: "SimpleClass"
// Ёлемент модели: "TatParameter" MUID: (48086D7103BE)
...
//#UC START# *48086F180372_48086D7103BEget_impl*
    ...
    begin
      if NOT IsDefaultSet then
        raise EHasNotSet.Create('ѕараметр не инициализирован!')
      else
