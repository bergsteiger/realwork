...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Áèáëèîòåêà "AdapterTest"
// Ìîäóëü: "w:/quality/test/garant6x/AdapterTest/atCommon.pas"
// Ğîäíûå Delphi èíòåğôåéñû (.pas)
// Generated from UML model, root element: <<UtilityPack::Class>> garant6x_test::AdapterTest::Common::atCommon
//
//
// Âñå ïğàâà ïğèíàäëåæàò ÎÎÎ ÍÏÏ "Ãàğàíò-Ñåğâèñ".
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

// ! Ïîëíîñòüş ãåíåğèğóåòñÿ ñ ìîäåëè. Ïğàâèòü ğóêàìè - íåëüçÿ. !
...
//#UC START# *48172C380180_48172C290190_var*
  const
    chars = '1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZabxdefghijklmnopqratuvwxyzÀÁÂÃÄÅ¨ÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäå¸æçèéêëìíîïğñòóôõö÷øùúûüışÿ';
  var
    i, chrLen : integer;
