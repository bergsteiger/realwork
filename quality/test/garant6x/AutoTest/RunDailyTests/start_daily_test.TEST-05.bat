SET NETDRV=R:
SET XML_FILE="R:\.PERFOMANCE\quality\test\garant6x\AutoTest\RunDailyTests\perfomance.73.xml"
...
SET TC_BIN="C:\Program Files\Automated QA\TestExecute 5\Bin\TestExecute.exe"
SET SERVER_NAME=\\test-04
SET BUILD_NAME=!daily-GARANTF1-7_03
...
:start_main
%REPATH%\00.Main_Run_All_Autotest.bat %NETDRV% %TC_BIN% %SERVER_NAME% %BUILD_NAME% %ETALON_FILE% %XML_FILE% /V:ON 1>>%REPATH%\00.Main_Run_All_Autotest.%COMPUTERNAME%.log 2>>&1
goto end
