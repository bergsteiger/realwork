...
IQueryexecuteProgressIndicator* Progress_i::make_interface (IQuery* aQuery, IList* aFiltrateList, MyStopWatch* sw)
{
...
Progress_i::Progress_i (IQuery* aQuery, IList* aFiltrateList, MyStopWatch* sw) :
	RefCountObjectBase ()
{
