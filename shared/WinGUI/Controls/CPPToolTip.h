////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/shared/WinGUI/Controls/CPPToolTip.h"
...
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef __SHARED_WINGUI_CONTROLS_CPPTOOLTIP_H__
#define __SHARED_WINGUI_CONTROLS_CPPTOOLTIP_H__

#include "shared/Core/sys/std_inc.h"

//#UC START# *4700B6AC00CB_CUSTOM_INCLUDES*
#include "shared/WinGUI/Controls/CPPHtmlDrawer.h"
#include <vector>
#include <map>
#include <afxext.h>
...
public:
	...
	typedef boost::function<bool (PPTOOLTIP_INFO & ti)> ExternalFindCallback;
	typedef void* DynamicToolID;
	// Operations
protected:
	enum TooltipState {  
	...
	DynamicToolID m_last_dynamic_tool;
	...
	HWND  m_hwndNextTool;
	DynamicToolID  m_next_dynamic_tool;
	...
	typedef std::map<DynamicToolID, ExternalFindCallback> CallBackMap;
	CallBackMap m_dynamic_tools; //dynamic tools - определяют возможность показа
								  //тултипа на основе callback'а
...
public:
	...
	//add external tools
	void AddDynamicTool(DynamicToolID tool, const ExternalFindCallback& callback);

	void RemoveTool(CWnd * pWnd, LPCRECT lpRectBounds = NULL);
	void RemoveDynamicTool(DynamicToolID tool);
	void RemoveAllTools();
...
protected:
	...
	void SetNewTooltip(HWND hWnd, DynamicToolID toolID, const PPTOOLTIP_INFO & ti, BOOL bDisplayWithDelay = TRUE, TooltipType type = PPTOOLTIP_NORMAL);
...
#endif //__SHARED_WINGUI_CONTROLS_CPPTOOLTIP_H__
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
