////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/shared/WinGUI/OptionTreeControls/COptionTreeColorPopUp.cpp"
...
void COptionTreeColorPopUp::EndSelection(int nMessage)
{
    ...
    if (nMessage != OT_COLOR_SELENDCANCEL && m_nCurrentSel == OT_COLOR_CUSTOMBOXVALUE)
    {
        ...
        CColorDialog dlg(
			m_crInitialColor != OT_COLOR_NO_SELECTION ? m_crInitialColor : RGB(0, 0, 0)
...
COptionTreeColorPopUp::~COptionTreeColorPopUp () {
	//#UC START# *470AFD9300DA_DESTR_BODY*
	 // Delete variables
	...
	//#UC END# *470AFD9300DA_DESTR_BODY*
}

//////////////////////////////////////////////////////////////////////////////////////////
// self implementation
BEGIN_MESSAGE_MAP(COptionTreeColorPopUp, CWnd)
	//#UC START# *470AFD9300DA_MESSAGE_MAP*
    ON_WM_NCDESTROY()
    ON_WM_LBUTTONUP()
    ON_WM_PAINT()
    ON_WM_MOUSEMOVE()
	...
	ON_WM_KILLFOCUS()
	ON_WM_ACTIVATEAPP()
	//#UC END# *470AFD9300DA_MESSAGE_MAP*
END_MESSAGE_MAP()

IMPLEMENT_DYNAMIC(COptionTreeColorPopUp, CWnd)
