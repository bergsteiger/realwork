////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/shared/WinGUI/OptionTreeControls/COptionTreeFontSel.cpp"
...
COptionTreeFontSel::COptionTreeFontSel ()
	: CDialog (COptionTreeFontSel::IDD)
//#UC START# *470AFEDC003E_CTOR_BASE_INIT*
//#UC END# *470AFEDC003E_CTOR_BASE_INIT*
{
	//#UC START# *470AFEDC003E_CTOR*
	// Initialize variables
	m_strCustomSample = _T("");
	m_bStrikeOut = FALSE;
	m_bUnderline = FALSE;
	m_dwDialogFlags = NULL;
	m_uControlID = 0;
	//#UC END# *470AFEDC003E_CTOR*
}


COptionTreeFontSel::~COptionTreeFontSel () {
	//#UC START# *470AFEDC003E_DESTR_BODY*
	// Reallocate
	if (m_fSampleFont.GetSafeHandle() != NULL)
	{
		m_fSampleFont.DeleteObject();
	}
	//#UC END# *470AFEDC003E_DESTR_BODY*
}

//////////////////////////////////////////////////////////////////////////////////////////
// self implementation
BEGIN_MESSAGE_MAP(COptionTreeFontSel, CDialog)
	//#UC START# *470AFEDC003E_MESSAGE_MAP*
	ON_WM_PAINT()
	...
	//#UC END# *470AFEDC003E_MESSAGE_MAP*
END_MESSAGE_MAP()

IMPLEMENT_DYNAMIC(COptionTreeFontSel, CDialog)

void COptionTreeFontSel::DoDataExchange(CDataExchange* pDX) {
	CDialog::DoDataExchange(pDX);
	//#UC START# *470AFEDC003E_DO_DATA_EXCHANGE*
	...
	//#UC END# *470AFEDC003E_DO_DATA_EXCHANGE*
}
...
BOOL COptionTreeFontSel::OnInitDialog () {
	...
	try {
		...
		//#UC END# *470AFEDC003E_ON_INIT_DLG*
	} catch (...) {
		::MessageBox (
			0
			, "В процессе инициализации диалога \"COptionTreeFontSel\" произошло неизвестное исключение"
			, "Ошибка"
			, MB_ICONEXCLAMATION
		);
