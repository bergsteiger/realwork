////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/shared/WinGUI/OptionTreeControls/COptionTreeImagePopUp.cpp"
...
COptionTreeImagePopUp::~COptionTreeImagePopUp () {
	//#UC START# *470AFFF6030D_DESTR_BODY*
	m_strText.RemoveAll();
	//#UC END# *470AFFF6030D_DESTR_BODY*
}

//////////////////////////////////////////////////////////////////////////////////////////
// self implementation
BEGIN_MESSAGE_MAP(COptionTreeImagePopUp, CWnd)
	//#UC START# *470AFFF6030D_MESSAGE_MAP*
	ON_WM_DESTROY()
	ON_WM_ERASEBKGND()
	ON_WM_NCDESTROY()
	ON_WM_ACTIVATEAPP()
	...
	ON_WM_KILLFOCUS()
	ON_WM_KEYDOWN()
	//#UC END# *470AFFF6030D_MESSAGE_MAP*
END_MESSAGE_MAP()

IMPLEMENT_DYNAMIC(COptionTreeImagePopUp, CWnd)
