////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/shared/WinGUI/OptionTreeControls/COptionTreeItemHyperLink.cpp"
...
BEGIN_MESSAGE_MAP(COptionTreeItemHyperLink, CWnd)
	...
	ON_WM_KILLFOCUS()
	ON_WM_SETFOCUS()
	//#UC END# *470B04000119_MESSAGE_MAP*
END_MESSAGE_MAP()

IMPLEMENT_DYNAMIC(COptionTreeItemHyperLink, CWnd)
