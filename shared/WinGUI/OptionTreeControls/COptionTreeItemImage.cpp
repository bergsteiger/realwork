////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/shared/WinGUI/OptionTreeControls/COptionTreeItemImage.cpp"
...
COptionTreeItemImage::~COptionTreeItemImage () {
	//#UC START# *470B043B030D_DESTR_BODY*
	// Reallocate
	if (m_imgImages.GetSafeHandle() != NULL)
	{
		m_imgImages.DeleteImageList();
	...
	m_strText.RemoveAll();
	//#UC END# *470B043B030D_DESTR_BODY*
}

//////////////////////////////////////////////////////////////////////////////////////////
// self implementation
BEGIN_MESSAGE_MAP(COptionTreeItemImage, CWnd)
	//#UC START# *470B043B030D_MESSAGE_MAP*
	ON_WM_LBUTTONUP()
	ON_WM_KILLFOCUS()
	ON_WM_SETFOCUS()
	ON_WM_PAINT()
	...
	//#UC END# *470B043B030D_MESSAGE_MAP*
END_MESSAGE_MAP()

IMPLEMENT_DYNAMIC(COptionTreeItemImage, CWnd)
