////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/shared/WinGUI/OptionTreeControls/COptionTreeRadioButton.cpp"
...
COptionTreeRadioButton::~COptionTreeRadioButton () {
	//#UC START# *470B06DC0177_DESTR_BODY*
	// Delete all nodes
	Node_DeleteAll();
	//#UC END# *470B06DC0177_DESTR_BODY*
}

//////////////////////////////////////////////////////////////////////////////////////////
// self implementation
BEGIN_MESSAGE_MAP(COptionTreeRadioButton, CWnd)
	//#UC START# *470B06DC0177_MESSAGE_MAP*
	ON_WM_ERASEBKGND()
	ON_WM_PAINT()
	ON_WM_LBUTTONUP()
	ON_WM_MOVE()
	ON_WM_SIZE()
	//#UC END# *470B06DC0177_MESSAGE_MAP*
END_MESSAGE_MAP()

IMPLEMENT_DYNAMIC(COptionTreeRadioButton, CWnd)
