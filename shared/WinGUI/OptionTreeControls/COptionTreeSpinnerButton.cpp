////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Модуль: "w:/shared/WinGUI/OptionTreeControls/COptionTreeSpinnerButton.cpp"
...
COptionTreeSpinnerButton::~COptionTreeSpinnerButton () {
	//#UC START# *470B06290251_DESTR_BODY*
	//#UC END# *470B06290251_DESTR_BODY*
}
...
BEGIN_MESSAGE_MAP(COptionTreeSpinnerButton, CWnd)
	...
	ON_WM_TIMER()
	//#UC END# *470B06290251_MESSAGE_MAP*
END_MESSAGE_MAP()

IMPLEMENT_DYNAMIC(COptionTreeSpinnerButton, CWnd)
